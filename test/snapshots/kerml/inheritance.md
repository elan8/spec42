  ...
  (document "memory://snapshot/inheritance.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (source "semantic")
        (range (start 10 2) (end 10 7))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_reference")
        (source "semantic")
        (range (start 10 8) (end 10 9))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_reference")
        (source "semantic")
        (range (start 10 10) (end 10 13))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_reference")
...
(semantic-model
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/inheritance.md") (qualified-name "Inheritance::y"))) (kind featureTyping) (ordinal 0))
      (authored-target "A")
      (outcome (status resolved) (target (node (document "memory://snapshot/inheritance.md") (qualified-name "Inheritance::A")))))
    (reference (id (source (node (document "memory://snapshot/inheritance.md") (qualified-name "Inheritance::y"))) (kind expressionOperand) (ordinal 0))
      (authored-target "alias")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/inheritance.md") (qualified-name "Inheritance::y"))) (kind expressionOperand) (ordinal 1))
      (authored-target "x")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/inheritance.md") (qualified-name "Inheritance::y"))) (kind expressionOperand) (ordinal 2))
      (authored-target "for")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/inheritance.md") (qualified-name "Inheritance::y"))) (kind expressionOperand) (ordinal 3))
      (authored-target "B::f")
      (outcome (status unresolved)))
...
(navigation
  ...
  (query (document "memory://snapshot/inheritance.md") (range (start 10 2) (end 10 7)) (probe (position 10 2))
    (reference (id (source (node (document "memory://snapshot/inheritance.md") (qualified-name "Inheritance::y"))) (kind expressionOperand) (ordinal 0) (authored-target "alias")
      (outcome (status unresolved)))
    )
  )
  (query (document "memory://snapshot/inheritance.md") (range (start 10 8) (end 10 9)) (probe (position 10 8))
    (reference (id (source (node (document "memory://snapshot/inheritance.md") (qualified-name "Inheritance::y"))) (kind expressionOperand) (ordinal 1) (authored-target "x")
      (outcome (status unresolved)))
    )
  )
  (query (document "memory://snapshot/inheritance.md") (range (start 10 10) (end 10 13)) (probe (position 10 10))
    (reference (id (source (node (document "memory://snapshot/inheritance.md") (qualified-name "Inheritance::y"))) (kind expressionOperand) (ordinal 2) (authored-target "for")
      (outcome (status unresolved)))
    )
  )
  (query (document "memory://snapshot/inheritance.md") (range (start 10 14) (end 10 18)) (probe (position 10 14))
    (reference (id (source (node (document "memory://snapshot/inheritance.md") (qualified-name "Inheritance::y"))) (kind expressionOperand) (ordinal 3) (authored-target "B::f")
      (outcome (status unresolved)))
    )
  )
