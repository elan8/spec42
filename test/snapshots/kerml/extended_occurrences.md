...
(types
    ...
    (declaration (id (node (document "memory://snapshot/extended_occurrences.md") (qualified-name "ExtendedOccurrences::Snapshot")))
      (supertype (node (document "memory://snapshot/extended_occurrences.md") (qualified-name "ExtendedOccurrences::Timeslice")) (scopes any subclassification))
      (subtype (node (document "memory://snapshot/extended_occurrences.md") (path (named (kind package) (name "ExtendedOccurrences")) (named (kind class-def) (name "Snapshot")) (anonymous (kind attribute) (ordinal 0)))) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/extended_occurrences.md") (path (named (kind package) (name "ExtendedOccurrences")) (named (kind class-def) (name "Snapshot")) (anonymous (kind attribute) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/extended_occurrences.md") (qualified-name "ExtendedOccurrences::Snapshot")))
      (type (node (document "memory://snapshot/extended_occurrences.md") (qualified-name "ExtendedOccurrences::Snapshot")) (provenance authored))
      (effective-type (node (document "memory://snapshot/extended_occurrences.md") (qualified-name "ExtendedOccurrences::Snapshot")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/extended_occurrences.md") (qualified-name "ExtendedOccurrences::Timeslice")))
      (subtype (node (document "memory://snapshot/extended_occurrences.md") (path (named (kind package) (name "ExtendedOccurrences")) (named (kind class-def) (name "ExtendedOccurrence")) (anonymous (kind attribute) (ordinal 0)))) (scopes any))
      ...
      (subtype (node (document "memory://snapshot/extended_occurrences.md") (path (named (kind package) (name "ExtendedOccurrences")) (named (kind class-def) (name "Timeslice")) (anonymous (kind attribute) (ordinal 0)))) (scopes any))
    )
