  ...
  (document "memory://snapshot/expressions.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 61 1) (end 61 18))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 62 1) (end 62 18))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 64 1) (end 64 23))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_package_member")
      ...
      (diagnostic
        ...
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 72 1) (end 72 21))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 73 1) (end 73 20))
      )
    )
  )
)
