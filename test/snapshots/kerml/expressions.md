  ...
  (document "memory://snapshot/expressions.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (source "semantic")
        (range (start 64 9) (end 64 22))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 65 9) (end 65 19))
      )
      (diagnostic
        (severity error)
        (code "unrecognized_declaration_in_scope")
...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/expressions.md") (qualified-name "Expressions::test1"))) (kind default-reference) (membership (kind feature) (visibility default)))
    (declaration (id (node (document "memory://snapshot/expressions.md") (qualified-name "Expressions::test2"))) (kind default-reference) (membership (kind feature) (visibility default)))
