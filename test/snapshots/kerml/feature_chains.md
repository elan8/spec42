...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/feature_chains.md") (path (name "FeatureChains") (name "b") (anonymous (kind kerml-binding) (ordinal 0)))))) (kind kerml-binding) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (bindSource (reference "f::a")) (bindTarget (reference "a::g"))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/feature_chains.md") (path (name "FeatureChains") (name "b") (anonymous (kind kerml-binding) (ordinal 0)))))) (kind bindSource) (ordinal 0))
      (authored-target "f::a")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/feature_chains.md") (path (name "FeatureChains") (name "b") (anonymous (kind kerml-binding) (ordinal 0)))))) (kind bindTarget) (ordinal 0))
      (authored-target "a::g")
      (outcome (status unresolved)))
...
(navigation
  ...
  (query (document "memory://snapshot/feature_chains.md") (range (start 18 12) (end 18 15)) (probe (position 18 12))
    (reference (id (source (node (document "memory://snapshot/feature_chains.md") (path (name "FeatureChains") (name "b") (anonymous (kind kerml-binding) (ordinal 0)))))) (kind bindSource) (ordinal 0) (authored-target "f::a")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/feature_chains.md") (range (start 18 18) (end 18 21)) (probe (position 18 18))
    (reference (id (source (node (document "memory://snapshot/feature_chains.md") (path (name "FeatureChains") (name "b") (anonymous (kind kerml-binding) (ordinal 0)))))) (kind bindTarget) (ordinal 0) (authored-target "a::g")
      (outcome (status unresolved)))
  )
