...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/associations.md") (anonymous (kind kerml-end) (ordinal 0))))) (kind kerml-end) (membership (kind feature) (visibility default)) (facts (multiplicity (lower 0) (upper unbounded))))
    ...
    (declaration (id (node (document "memory://snapshot/associations.md") (anonymous (kind kerml-end) (ordinal 0))))) (kind kerml-end) (membership (kind feature) (visibility default)) (facts (multiplicity (lower 1) (upper 1))))
    ...
    (declaration (id (node (document "memory://snapshot/associations.md") (anonymous (kind kerml-end) (ordinal 0))))) (kind kerml-end) (membership (kind feature) (visibility default)) (facts (multiplicity (lower 0) (upper 1))))
