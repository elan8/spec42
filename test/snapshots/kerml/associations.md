...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/associations.md") (path (named (kind package) (name "Associations")) (named (kind kerml-classifier) (name "B")) (anonymous (kind kerml-end) (ordinal 0)))))) (kind kerml-end) (membership (kind feature) (visibility default)) (facts (multiplicity (lower 0) (upper unbounded))))
    (declaration (id (node (document "memory://snapshot/associations.md") (path (named (kind package) (name "Associations")) (named (kind kerml-classifier) (name "B")) (anonymous (kind kerml-end) (ordinal 0)) (named (kind kerml-feature) (name "y1")))))) (kind kerml-feature) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "y"))))
    ...
    (declaration (id (node (document "memory://snapshot/associations.md") (path (named (kind package) (name "Associations")) (named (kind kerml-classifier) (name "C")) (anonymous (kind kerml-end) (ordinal 0)))))) (kind kerml-end) (membership (kind feature) (visibility default)) (facts (multiplicity (lower 1) (upper 1))))
    (declaration (id (node (document "memory://snapshot/associations.md") (path (named (kind package) (name "Associations")) (named (kind kerml-classifier) (name "C")) (anonymous (kind kerml-end) (ordinal 0)) (named (kind kerml-feature) (name "a")))))) (kind kerml-feature) (membership (kind feature) (visibility default)))
    ...
    (declaration (id (node (document "memory://snapshot/associations.md") (path (named (kind package) (name "Associations")) (named (kind kerml-classifier) (name "XY")) (anonymous (kind kerml-end) (ordinal 0)))))) (kind kerml-end) (membership (kind feature) (visibility default)) (facts (multiplicity (lower 0) (upper 1))))
    (declaration (id (node (document "memory://snapshot/associations.md") (path (named (kind package) (name "Associations")) (named (kind kerml-classifier) (name "XY")) (anonymous (kind kerml-end) (ordinal 0)) (named (kind kerml-feature) (name "x")))))) (kind kerml-feature) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "X")) (metadataAnnotation (reference "M"))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/associations.md") (path (named (kind package) (name "Associations")) (named (kind kerml-classifier) (name "B")) (anonymous (kind kerml-end) (ordinal 0)) (named (kind kerml-feature) (name "y1")))))) (kind redefinition) (ordinal 0))
      (authored-target "y")
      (outcome (status unresolved)))
    ...
    (reference (id (source (node (document "memory://snapshot/associations.md") (qualified-name "Associations::C"))) (kind expressionOperand) (ordinal 1))
      (authored-target "const")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/associations.md") (path (named (kind package) (name "Associations")) (named (kind kerml-classifier) (name "XY")) (anonymous (kind kerml-end) (ordinal 0)) (named (kind kerml-feature) (name "x")))))) (kind featureTyping) (ordinal 0))
      (authored-target "X")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/associations.md") (path (named (kind package) (name "Associations")) (named (kind kerml-classifier) (name "XY")) (anonymous (kind kerml-end) (ordinal 0)) (named (kind kerml-feature) (name "x")))))) (kind metadataAnnotation) (ordinal 0))
      (authored-target "M")
      (outcome (status unresolved)))
...
(navigation
  ...
  (query (document "memory://snapshot/associations.md") (range (start 11 34) (end 11 35)) (probe (position 11 34))
    (reference (id (source (node (document "memory://snapshot/associations.md") (path (named (kind package) (name "Associations")) (named (kind kerml-classifier) (name "B")) (anonymous (kind kerml-end) (ordinal 0)) (named (kind kerml-feature) (name "y1")))))) (kind redefinition) (ordinal 0) (authored-target "y")
      (outcome (status unresolved)))
  )
  ...
  (query (document "memory://snapshot/associations.md") (range (start 21 25) (end 21 26)) (probe (position 21 25))
    (reference (id (source (node (document "memory://snapshot/associations.md") (path (named (kind package) (name "Associations")) (named (kind kerml-classifier) (name "XY")) (anonymous (kind kerml-end) (ordinal 0)) (named (kind kerml-feature) (name "x")))))) (kind featureTyping) (ordinal 0) (authored-target "X")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/associations.md") (range (start 22 4) (end 22 5)) (probe (position 22 4))
    (reference (id (source (node (document "memory://snapshot/associations.md") (path (named (kind package) (name "Associations")) (named (kind kerml-classifier) (name "XY")) (anonymous (kind kerml-end) (ordinal 0)) (named (kind kerml-feature) (name "x")))))) (kind metadataAnnotation) (ordinal 0) (authored-target "M")
      (outcome (status unresolved)))
  )
