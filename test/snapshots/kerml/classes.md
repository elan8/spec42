...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/classes.md") (qualified-name "Classes::B"))) (kind kerml-classifier) (membership (kind owning) (visibility default)) (facts (short-name "2") (modifiers abstract)) (authored (membership (kind owning) (visibility default)) (relationships (expressionOperand (reference "package")) (expressionOperand (reference "P"))))
