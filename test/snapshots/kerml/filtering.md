...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/filtering.md") (qualified-name "Filtering::DesignModel::System::::approved"))) (kind attribute) (membership (kind feature) (visibility default)) (feature-value (kind bind)))
    (declaration (id (node (document "memory://snapshot/filtering.md") (qualified-name "Filtering::DesignModel::System::::approver"))) (kind attribute) (membership (kind feature) (visibility default)) (feature-value (kind bind)))
    (declaration (id (node (document "memory://snapshot/filtering.md") (qualified-name "Filtering::DesignModel::System::::level"))) (kind attribute) (membership (kind feature) (visibility default)) (feature-value (kind bind)))
