...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/features.md") (qualified-name "Features::adult"))) (kind kerml-feature) (membership (kind feature) (visibility default)))
    ...
    (declaration (id (node (document "memory://snapshot/features.md") (qualified-name "Features::z1"))) (kind kerml-feature) (membership (kind feature) (visibility default)))
  )
  (references
