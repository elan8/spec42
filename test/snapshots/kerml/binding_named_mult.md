...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/binding_named_mult.md") (anonymous (kind bind) (ordinal 0))))) (kind bind) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (bindSource (reference "startShot")) (bindTarget (reference "endShot"))))
    ...
    (declaration (id (node (document "memory://snapshot/binding_named_mult.md") (anonymous (kind bind) (ordinal 3))))) (kind bind) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (bindSource (reference "a")) (bindTarget (reference "b"))))
  )
  (references
