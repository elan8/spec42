  ...
  (document "memory://snapshot/10d_dynamics_analysis.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (source "semantic")
        (range (start 66 5) (end 66 33))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_action_usage_member")
        (source "semantic")
        (range (start 67 5) (end 67 28))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_action_usage_member")
        (source "semantic")
        (range (start 68 5) (end 68 25))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_action_usage_member")
        (source "semantic")
        (range (start 69 5) (end 69 24))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_action_usage_member")
        (source "semantic")
        (range (start 70 5) (end 70 21))
      )
    )
  )
)
