...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/10d_dynamics_analysis.md") (anonymous (kind perform-parameter-binding) (ordinal 0))))) (kind perform-parameter-binding) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "vehicle::mass")) (performParameterTarget (reference "mass"))))
    (declaration (id (node (document "memory://snapshot/10d_dynamics_analysis.md") (anonymous (kind perform-parameter-binding) (ordinal 1))))) (kind perform-parameter-binding) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "deltaT")) (performParameterTarget (reference "delta_t"))))
    (declaration (id (node (document "memory://snapshot/10d_dynamics_analysis.md") (anonymous (kind perform-parameter-binding) (ordinal 2))))) (kind perform-parameter-binding) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "position")) (performParameterTarget (reference "x_in"))))
    (declaration (id (node (document "memory://snapshot/10d_dynamics_analysis.md") (anonymous (kind perform-parameter-binding) (ordinal 3))))) (kind perform-parameter-binding) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "speed")) (performParameterTarget (reference "v_in"))))
    (declaration (id (node (document "memory://snapshot/10d_dynamics_analysis.md") (qualified-name "10d-Dynamics Analysis::AnalysisModel::DynamicsAnalysis::::dynamics::power"))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "powerProfile")) (expressionOperand (reference "i"))))
    ...
    (declaration (id (node (document "memory://snapshot/10d_dynamics_analysis.md") (qualified-name "10d-Dynamics Analysis::AnalysisModel::DynamicsAnalysis::accelerationProfile"))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (subsetting (reference "ISQ::acceleration"))))
    ...
    (declaration (id (node (document "memory://snapshot/10d_dynamics_analysis.md") (qualified-name "10d-Dynamics Analysis::DynamicsModel::StraightLineDynamics::a_out"))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "AccelerationValue") (direction out)) (expressionOperand (reference "power")) (expressionOperand (reference "mass")) (expressionOperand (reference "v_in")) (invocationCallee (reference "Acceleration"))))
    ...
    (declaration (id (node (document "memory://snapshot/10d_dynamics_analysis.md") (qualified-name "10d-Dynamics Analysis::DynamicsModel::StraightLineDynamics::v_out"))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "SpeedValue") (direction out)) (expressionOperand (reference "v_in")) (expressionOperand (reference "a_out")) (expressionOperand (reference "delta_t")) (invocationCallee (reference "Velocity"))))
