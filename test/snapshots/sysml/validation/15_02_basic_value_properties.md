...
(semantic-model
  ...
  (evaluation
    (evaluated (declaration (node (document "memory://snapshot/15_02_basic_value_properties.md") (anonymous (kind attribute) (ordinal 0))))) (value (kind string) (value "Michelin")))
