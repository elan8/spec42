...
(semantic-model
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/3d_function_based_behavior_item.md") (anonymous (kind perform-parameter-binding) (ordinal 0))))) (kind expressionOperand) (ordinal 0))
      (authored-target "fuelInPort::fuel")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/3d_function_based_behavior_item.md") (anonymous (kind perform-parameter-binding) (ordinal 1))))) (kind expressionOperand) (ordinal 0))
      (authored-target "fuelOutPort::fuel")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/3d_function_based_behavior_item.md") (anonymous (kind perform-parameter-binding) (ordinal 0))))) (kind performParameterTarget) (ordinal 0))
      (authored-target "fuelIn")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/3d_function_based_behavior_item.md") (anonymous (kind perform-parameter-binding) (ordinal 1))))) (kind performParameterTarget) (ordinal 0))
  ...
  (evaluation
    (evaluated (declaration (node (document "memory://snapshot/3d_function_based_behavior_item.md") (anonymous (kind perform-parameter-binding) (ordinal 0))))) (value (kind unresolved-operand)))
    (evaluated (declaration (node (document "memory://snapshot/3d_function_based_behavior_item.md") (anonymous (kind perform-parameter-binding) (ordinal 1))))) (value (kind unresolved-operand)))
  )
)
~~~
# NAVIGATION
...
(navigation
  ...
  (query (document "memory://snapshot/3d_function_based_behavior_item.md") (range (start 53 17) (end 53 32)) (probe (position 53 17))
    (reference (id (source (node (document "memory://snapshot/3d_function_based_behavior_item.md") (anonymous (kind perform-parameter-binding) (ordinal 0))))) (kind expressionOperand) (ordinal 0) (authored-target "fuelInPort::fuel")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/3d_function_based_behavior_item.md") (range (start 54 19) (end 54 35)) (probe (position 54 19))
    (reference (id (source (node (document "memory://snapshot/3d_function_based_behavior_item.md") (anonymous (kind perform-parameter-binding) (ordinal 1))))) (kind expressionOperand) (ordinal 0) (authored-target "fuelOutPort::fuel")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/3d_function_based_behavior_item.md") (range (start 53 8) (end 53 14)) (probe (position 53 8))
    (reference (id (source (node (document "memory://snapshot/3d_function_based_behavior_item.md") (anonymous (kind perform-parameter-binding) (ordinal 0))))) (kind performParameterTarget) (ordinal 0) (authored-target "fuelIn")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/3d_function_based_behavior_item.md") (range (start 54 9) (end 54 16)) (probe (position 54 9))
    (reference (id (source (node (document "memory://snapshot/3d_function_based_behavior_item.md") (anonymous (kind perform-parameter-binding) (ordinal 1))))) (kind performParameterTarget) (ordinal 0) (authored-target "fuelOut")
      (outcome (status unresolved)))
  )
