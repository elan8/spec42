  ...
  (document "memory://snapshot/15_04_logical_expressions.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (code "unsupported_constraint_definition_member")
        (source "semantic")
        (range (start 23 4) (end 23 30))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_constraint_definition_member")
        (source "semantic")
        (range (start 24 4) (end 24 42))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_constraint_definition_member")
        (source "semantic")
        (range (start 25 4) (end 25 30))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_constraint_definition_member")
        (source "semantic")
        (range (start 26 4) (end 26 45))
      )
    )
  )
)
...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/15_04_logical_expressions.md") (anonymous (kind constraint) (ordinal 1))))) (kind constraint) (membership (kind feature) (visibility default)))
