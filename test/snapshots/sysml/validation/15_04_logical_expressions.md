...
(semantic-model
  ...
  (evaluation
    (evaluated (declaration (node (document "memory://snapshot/15_04_logical_expressions.md") (path (named (kind package) (name "15_04-Logical Expressions")) (named (kind part-def) (name "Vehicle")) (anonymous (kind assert-constraint) (ordinal 1)))))) (value (kind non-constant)))
  )
)
~~~
# NAVIGATION
