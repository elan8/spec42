...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/8_requirements.md") (anonymous (kind satisfy) (ordinal 1))))) (kind satisfy) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (satisfySource (reference "engine-v1 Specification"))))
