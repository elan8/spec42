...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/7b_variant_configurations.md") (qualified-name "7b-Variant Configurations::VariabilityModel::anyVehicleConfig::engineRqtChoice"))) (kind requirement) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "EnginePerformanceRequirement")) (variant (reference "highPerformanceRequirement")) (variant (reference "normalPerformanceRequirement"))))
