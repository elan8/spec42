...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/7b_variant_configurations.md") (anonymous (kind bind) (ordinal 0))))) (kind bind) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (bindSource (reference "fuelCmdPort"))))
