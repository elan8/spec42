...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/2a_parts_interconnection.md") (anonymous (kind interface) (ordinal 1))))) (kind interface) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "DriveshaftInterface"))))
    ...
    (declaration (id (node (document "memory://snapshot/2a_parts_interconnection.md") (anonymous (kind interface) (ordinal 0))))) (kind interface) (membership (kind feature) (visibility default)))
    (declaration (id (node (document "memory://snapshot/2a_parts_interconnection.md") (anonymous (kind interface) (ordinal 1))))) (kind interface) (membership (kind feature) (visibility default)))
