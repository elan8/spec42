  ...
  (document "memory://snapshot/2c_parts_interconnection_multiple_decompositions.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (code "unsupported_part_definition_member")
        (source "semantic")
        (range (start 22 2) (end 22 10))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_part_definition_member")
        (source "semantic")
        (range (start 25 2) (end 25 10))
      )
      (diagnostic
        (severity warning)
      ...
      (diagnostic
        ...
        (code "unsupported_part_usage_member")
        (source "semantic")
        (range (start 41 3) (end 49 4))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_part_usage_member")
        (source "semantic")
        (range (start 56 3) (end 56 23))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_part_usage_member")
      ...
      (diagnostic
        ...
        (code "unsupported_part_usage_member")
        (source "semantic")
        (range (start 74 3) (end 74 27))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_part_usage_member")
        (source "semantic")
        (range (start 75 3) (end 75 27))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_part_usage_member")
      ...
      (diagnostic
        ...
        (code "unsupported_part_usage_member")
        (source "semantic")
        (range (start 79 3) (end 79 23))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_part_usage_member")
        (source "semantic")
        (range (start 83 3) (end 83 27))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_part_usage_member")
        (source "semantic")
        (range (start 84 3) (end 84 27))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_part_usage_member")
        (source "semantic")
        (range (start 86 3) (end 86 23))
      )
    )
  )
)
