...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/1d_parts_tree_with_reference.md") (path (named (kind package) (name "1d-Parts Tree with Reference")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle_trailer_system")) (anonymous (kind bind) (ordinal 0))))) (kind bind) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (memberAccessOperand (reference "vehicle1_c1::hitchBall")) (memberAccessOperand (reference "trailerHitch::hitchBall")))))
