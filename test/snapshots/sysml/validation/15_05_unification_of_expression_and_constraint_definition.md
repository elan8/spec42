  ...
  (document "memory://snapshot/15_05_unification_of_expression_and_constraint_definition.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (code "unresolved_reference")
        (source "semantic")
        (range (start 47 22) (end 47 46))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_reference")
        (source "semantic")
        (range (start 48 14) (end 48 30))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_type_reference")
...
(semantic-model
  ...
  (evaluation
    (evaluated (declaration (node (document "memory://snapshot/15_05_unification_of_expression_and_constraint_definition.md") (qualified-name "15_05-Unification of Expression and Constraint Definition::Vehicle_2::discBrakeConstraint::wheelAssy"))) (value (kind unresolved-operand)))
    (evaluated (declaration (node (document "memory://snapshot/15_05_unification_of_expression_and_constraint_definition.md") (qualified-name "15_05-Unification of Expression and Constraint Definition::WheelAssy::discBrakeFitConstraint_Alt::discBrakeAssy"))) (value (kind unresolved-operand)))
    (evaluated (declaration (node (document "memory://snapshot/15_05_unification_of_expression_and_constraint_definition.md") (qualified-name "15_05-Unification of Expression and Constraint Definition::WheelAssy::discBrakeFitConstraint_Alt::wheel"))) (value (kind unresolved-operand)))
  )
)
~~~
# NAVIGATION
