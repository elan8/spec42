...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/15_05_unification_of_expression_and_constraint_definition.md") (qualified-name "15_05-Unification of Expression and Constraint Definition::DiscBrakeFitConstraint_Alt"))) (kind constraint-def) (membership (kind owning) (visibility default)) (authored (membership (kind owning) (visibility default)) (relationships (memberAccessOperand (reference "wheel::outerDiameter"))))
...
(navigation
  ...
  (query (document "memory://snapshot/15_05_unification_of_expression_and_constraint_definition.md") (range (start 17 29) (end 17 48)) (probe (position 17 29))
    (reference (id (source (node (document "memory://snapshot/15_05_unification_of_expression_and_constraint_definition.md") (qualified-name "15_05-Unification of Expression and Constraint Definition::DiscBrakeFitConstraint_Alt"))) (kind memberAccessOperand) (ordinal 0) (authored-target "wheel::outerDiameter")
      (outcome (status unresolved)))
  )
