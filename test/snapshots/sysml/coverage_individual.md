...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/coverage_individual.md") (qualified-name "CoverageIndividual::a1"))) (kind action) (membership (kind feature) (visibility default)) (facts (modifiers individual)))
