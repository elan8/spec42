...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/12_binding_connectors_example_2.md") (path (name "Binding Connectors Example-2") (name "vehicle") (name "tank") (anonymous (kind port) (ordinal 0)))))) (kind port) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "fuelTankPort"))))
  ...
  (references
    (reference (id (source (node (document "memory://snapshot/12_binding_connectors_example_2.md") (path (name "Binding Connectors Example-2") (anonymous (kind import) (ordinal 0)))))) (kind namespaceImport) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/12_binding_connectors_example_2.md") (qualified-name "Binding Connectors Example-2::vehicle::tank"))) (kind featureTyping) (ordinal 0))
      ...
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/12_binding_connectors_example_2.md") (path (name "Binding Connectors Example-2") (name "vehicle") (name "tank") (anonymous (kind port) (ordinal 0)))))) (kind redefinition) (ordinal 0))
...
(navigation
  (query (document "memory://snapshot/12_binding_connectors_example_2.md") (range (start 1 16) (end 1 33)) (probe (position 1 16))
    (reference (id (source (node (document "memory://snapshot/12_binding_connectors_example_2.md") (path (name "Binding Connectors Example-2") (anonymous (kind import) (ordinal 0)))))) (kind namespaceImport) (ordinal 0) (authored-target "Port Example")
      (outcome (status unresolved)))
  )
  ...
  (query (document "memory://snapshot/12_binding_connectors_example_2.md") (range (start 9 18) (end 9 30)) (probe (position 9 18))
    (reference (id (source (node (document "memory://snapshot/12_binding_connectors_example_2.md") (path (name "Binding Connectors Example-2") (name "vehicle") (name "tank") (anonymous (kind port) (ordinal 0)))))) (kind redefinition) (ordinal 0) (authored-target "fuelTankPort")
      (outcome (status unresolved)))
  )
