...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/36_variation_definitions.md") (anonymous (kind part) (ordinal 0))))) (kind part) (membership (kind feature) (visibility default)) (facts (multiplicity (lower 4) (upper 4))) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "cylinder"))))
    ...
    (declaration (id (node (document "memory://snapshot/36_variation_definitions.md") (anonymous (kind part) (ordinal 0))))) (kind part) (membership (kind feature) (visibility default)) (facts (multiplicity (lower 6) (upper 6))) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "cylinder"))))
