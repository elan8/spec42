...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/31_derivation_constraints.md") (qualified-name "Derivation Constraints::Dynamics"))) (kind constraint-def) (membership (kind owning) (visibility default)))
