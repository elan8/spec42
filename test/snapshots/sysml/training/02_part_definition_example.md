...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Vehicle::driver"))) (kind part) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Person"))))
