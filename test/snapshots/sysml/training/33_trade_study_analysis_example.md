...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/33_trade_study_analysis_example.md") (anonymous (kind parameter) (ordinal 0))))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Real"))))
    ...
    (declaration (id (node (document "memory://snapshot/33_trade_study_analysis_example.md") (anonymous (kind parameter) (ordinal 0))))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "ISQ::MassValue"))))
    ...
    (declaration (id (node (document "memory://snapshot/33_trade_study_analysis_example.md") (anonymous (kind parameter) (ordinal 0))))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "ISQ::PowerValue"))))
    ...
    (declaration (id (node (document "memory://snapshot/33_trade_study_analysis_example.md") (anonymous (kind parameter) (ordinal 0))))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Engine")) (redefinition (reference "selectedAlternative"))))
    ...
    (declaration (id (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::costRollup::cost"))) (kind parameter) (membership (kind feature) (visibility default)))
    (declaration (id (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::costRollup::engine"))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction in)) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "anEngine"))))
    ...
    (declaration (id (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::efficiencyRollup::efficiency"))) (kind parameter) (membership (kind feature) (visibility default)))
    (declaration (id (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::efficiencyRollup::engine"))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction in)) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "anEngine"))))
    ...
    (declaration (id (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::massRollup::mass"))) (kind parameter) (membership (kind feature) (visibility default)))
    ...
    (declaration (id (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::powerRollup::engine"))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction in)) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "anEngine"))))
    (declaration (id (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::powerRollup::power"))) (kind parameter) (membership (kind feature) (visibility default)))
    (declaration (id (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::result"))) (kind parameter) (membership (kind feature) (visibility default)) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Real")) (memberAccessOperand (reference "powerRollup::power")) (memberAccessOperand (reference "massRollup::mass")) (memberAccessOperand (reference "efficiencyRollup::efficiency")) (memberAccessOperand (reference "costRollup::cost")) (invocationCallee (reference "EngineEvaluation"))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (anonymous (kind import) (ordinal 0))))) (kind membershipImport) (ordinal 0))
      ...
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (anonymous (kind parameter) (ordinal 0))))) (kind featureTyping) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (anonymous (kind calc) (ordinal 0))))) (kind redefinition) (ordinal 0))
      ...
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (anonymous (kind parameter) (ordinal 0))))) (kind redefinition) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::costRollup::engine"))) (kind expressionOperand) (ordinal 0))
      (authored-target "anEngine")
      (outcome (status resolved) (target (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::anEngine")))))
    ...
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::efficiencyRollup::engine"))) (kind expressionOperand) (ordinal 0))
      (authored-target "anEngine")
      (outcome (status resolved) (target (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::anEngine")))))
    ...
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::massRollup::engine"))) (kind expressionOperand) (ordinal 0))
      (authored-target "anEngine")
      (outcome (status resolved) (target (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::anEngine")))))
    ...
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::powerRollup::engine"))) (kind expressionOperand) (ordinal 0))
      (authored-target "anEngine")
      (outcome (status resolved) (target (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::anEngine")))))
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::result"))) (kind featureTyping) (ordinal 0))
      (authored-target "Real")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::result"))) (kind memberAccessOperand) (ordinal 0))
      (authored-target "powerRollup::power")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::result"))) (kind memberAccessOperand) (ordinal 1))
      (authored-target "massRollup::mass")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::result"))) (kind memberAccessOperand) (ordinal 2))
      (authored-target "efficiencyRollup::efficiency")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::result"))) (kind memberAccessOperand) (ordinal 3))
      (authored-target "costRollup::cost")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::result"))) (kind invocationCallee) (ordinal 0))
  ...
  (relationships
    ...
    (relationship (kind typing) (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (anonymous (kind parameter) (ordinal 0))))) (target (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::Engine"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (anonymous (kind parameter) (ordinal 0))))) (kind featureTyping) (ordinal 0)))
    ...
    (relationship (kind expressionOperand) (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::costRollup::engine"))) (target (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::anEngine"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::costRollup::engine"))) (kind expressionOperand) (ordinal 0)))
    ...
    (relationship (kind expressionOperand) (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::efficiencyRollup::engine"))) (target (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::anEngine"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::efficiencyRollup::engine"))) (kind expressionOperand) (ordinal 0)))
    ...
    (relationship (kind expressionOperand) (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::massRollup::engine"))) (target (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::anEngine"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::massRollup::engine"))) (kind expressionOperand) (ordinal 0)))
    ...
    (relationship (kind expressionOperand) (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::powerRollup::engine"))) (target (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::anEngine"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::powerRollup::engine"))) (kind expressionOperand) (ordinal 0)))
    (relationship (kind invocationCallee) (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::result"))) (target (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::EngineEvaluation"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::result"))) (kind invocationCallee) (ordinal 0)))
  )
  (evaluation
    (evaluated (declaration (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::costRollup::engine"))) (value (kind non-constant)))
    (evaluated (declaration (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::efficiencyRollup::engine"))) (value (kind non-constant)))
    (evaluated (declaration (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::massRollup::engine"))) (value (kind non-constant)))
    (evaluated (declaration (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::powerRollup::engine"))) (value (kind non-constant)))
  )
)
~~~
# NAVIGATION
...
(navigation
  ...
  (query (document "memory://snapshot/33_trade_study_analysis_example.md") (range (start 11 52) (end 11 56)) (probe (position 11 52))
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (anonymous (kind parameter) (ordinal 0))))) (kind featureTyping) (ordinal 0) (authored-target "Real")
      (outcome (status unresolved)))
  )
  ...
  (query (document "memory://snapshot/33_trade_study_analysis_example.md") (range (start 9 52) (end 9 66)) (probe (position 9 52))
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (anonymous (kind parameter) (ordinal 0))))) (kind featureTyping) (ordinal 0) (authored-target "ISQ::MassValue")
      (outcome (status unresolved)))
  )
  ...
  (query (document "memory://snapshot/33_trade_study_analysis_example.md") (range (start 8 53) (end 8 68)) (probe (position 8 53))
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (anonymous (kind parameter) (ordinal 0))))) (kind featureTyping) (ordinal 0) (authored-target "ISQ::PowerValue")
      (outcome (status unresolved)))
  )
  ...
  (query (document "memory://snapshot/33_trade_study_analysis_example.md") (range (start 39 40) (end 39 46)) (probe (position 39 40))
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (anonymous (kind parameter) (ordinal 0))))) (kind featureTyping) (ordinal 0) (authored-target "Engine")
      (outcome (status resolved) (target (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::Engine")))))
  )
  ...
  (query (document "memory://snapshot/33_trade_study_analysis_example.md") (range (start 39 18) (end 39 37)) (probe (position 39 18))
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (anonymous (kind parameter) (ordinal 0))))) (kind redefinition) (ordinal 0) (authored-target "selectedAlternative")
      (outcome (status unresolved)))
  )
  ...
  (query (document "memory://snapshot/33_trade_study_analysis_example.md") (range (start 32 45) (end 32 53)) (probe (position 32 45))
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::costRollup::engine"))) (kind expressionOperand) (ordinal 0) (authored-target "anEngine")
      (outcome (status resolved) (target (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::anEngine")))))
  )
  ...
  (query (document "memory://snapshot/33_trade_study_analysis_example.md") (range (start 31 57) (end 31 65)) (probe (position 31 57))
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::efficiencyRollup::engine"))) (kind expressionOperand) (ordinal 0) (authored-target "anEngine")
      (outcome (status resolved) (target (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::anEngine")))))
  )
  ...
  (query (document "memory://snapshot/33_trade_study_analysis_example.md") (range (start 30 45) (end 30 53)) (probe (position 30 45))
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::massRollup::engine"))) (kind expressionOperand) (ordinal 0) (authored-target "anEngine")
      (outcome (status resolved) (target (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::anEngine")))))
  )
  ...
  (query (document "memory://snapshot/33_trade_study_analysis_example.md") (range (start 29 47) (end 29 55)) (probe (position 29 47))
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::powerRollup::engine"))) (kind expressionOperand) (ordinal 0) (authored-target "anEngine")
      (outcome (status resolved) (target (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::anEngine")))))
  )
  (query (document "memory://snapshot/33_trade_study_analysis_example.md") (range (start 34 23) (end 34 27)) (probe (position 34 23))
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::result"))) (kind featureTyping) (ordinal 0) (authored-target "Real")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/33_trade_study_analysis_example.md") (range (start 35 4) (end 35 21)) (probe (position 35 4))
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::result"))) (kind memberAccessOperand) (ordinal 0) (authored-target "powerRollup::power")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/33_trade_study_analysis_example.md") (range (start 35 23) (end 35 38)) (probe (position 35 23))
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::result"))) (kind memberAccessOperand) (ordinal 1) (authored-target "massRollup::mass")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/33_trade_study_analysis_example.md") (range (start 35 40) (end 35 67)) (probe (position 35 40))
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::result"))) (kind memberAccessOperand) (ordinal 2) (authored-target "efficiencyRollup::efficiency")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/33_trade_study_analysis_example.md") (range (start 35 69) (end 35 84)) (probe (position 35 69))
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::result"))) (kind memberAccessOperand) (ordinal 3) (authored-target "costRollup::cost")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/33_trade_study_analysis_example.md") (range (start 34 30) (end 34 46)) (probe (position 34 30))
    (reference (id (source (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::engineTradeStudy::::result"))) (kind invocationCallee) (ordinal 0) (authored-target "EngineEvaluation")
      (outcome (status resolved) (target (node (document "memory://snapshot/33_trade_study_analysis_example.md") (qualified-name "Trade Study Analysis Example::EngineEvaluation")))))
  )
