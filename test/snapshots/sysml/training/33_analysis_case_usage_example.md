...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/33_analysis_case_usage_example.md") (anonymous (kind attribute) (ordinal 0))))) (kind attribute) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "fuelEconomy_city")) (memberAccessOperand (reference "cityAnalysis::fuelEconomyResult"))))
