...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/05_redefinition_example.md") (anonymous (kind part) (ordinal 0))))) (kind part) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "cyl"))))
    ...
    (declaration (id (node (document "memory://snapshot/05_redefinition_example.md") (qualified-name "Redefinition Example::Engine::cyl"))) (kind part) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Cylinder"))))
