...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/42_viewpoint_example.md") (anonymous (kind constraint) (ordinal 0))))) (kind constraint) (membership (kind feature) (visibility default)) (documentation (doc (text "\n\t\t\t * A system structure view shall show the hierarchical \n\t\t\t * part decomposition of a system, starting with a \n\t\t\t * specified root part.\n\t\t\t "))))
