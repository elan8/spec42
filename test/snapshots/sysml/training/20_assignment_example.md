...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 2))))) (kind assign) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (assignTarget (reference "positions"))))
