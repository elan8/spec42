  ...
  (document "memory://snapshot/20_assignment_example.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (source "semantic")
        (range (start 26 4) (end 26 28))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_action_usage_member")
        (source "semantic")
        (range (start 27 4) (end 27 26))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_action_usage_member")
        (source "semantic")
        (range (start 28 4) (end 28 24))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_action_usage_member")
        (source "semantic")
        (range (start 29 4) (end 29 23))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_action_usage_member")
        (source "semantic")
        (range (start 30 4) (end 30 20))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_action_usage_member")
        (source "semantic")
        (range (start 31 4) (end 31 14))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_action_usage_member")
        (source "semantic")
        (range (start 32 4) (end 32 14))
      )
      (diagnostic
        (severity warning)
...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind for-loop) (ordinal 0))))) (kind for-loop) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "powerProfile"))))
    (declaration (id (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 0))))) (kind assign) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (memberAccessOperand (reference "dynamics::x_out")) (assignTarget (reference "position"))))
    (declaration (id (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 1))))) (kind assign) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (memberAccessOperand (reference "dynamics::v_out")) (assignTarget (reference "speed"))))
    (declaration (id (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 2))))) (kind assign) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "positions")) (expressionOperand (reference "position")) (assignTarget (reference "positions"))))
    (declaration (id (node (document "memory://snapshot/20_assignment_example.md") (qualified-name "For Loop Example::ComputeMotion::::dynamics"))) (kind perform-action) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "StraightLineDynamics"))))
    (declaration (id (node (document "memory://snapshot/20_assignment_example.md") (qualified-name "For Loop Example::ComputeMotion::::vehiclePower"))) (kind for-loop-variable) (membership (kind feature) (visibility default)))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind for-loop) (ordinal 0))))) (kind expressionOperand) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 2))))) (kind expressionOperand) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 2))))) (kind expressionOperand) (ordinal 1))
      (authored-target "position")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 0))))) (kind memberAccessOperand) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 1))))) (kind memberAccessOperand) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 0))))) (kind assignTarget) (ordinal 0))
      (authored-target "position")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 1))))) (kind assignTarget) (ordinal 0))
      (authored-target "speed")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 2))))) (kind assignTarget) (ordinal 0))
      (authored-target "positions")
      (outcome (status resolved) (target (node (document "memory://snapshot/20_assignment_example.md") (qualified-name "For Loop Example::ComputeMotion::positions")))))
    (reference (id (source (node (document "memory://snapshot/20_assignment_example.md") (qualified-name "For Loop Example::ComputeMotion::::dynamics"))) (kind featureTyping) (ordinal 0))
  ...
  (relationships
    (relationship (kind expressionOperand) (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind for-loop) (ordinal 0))))) (target (node (document "memory://snapshot/20_assignment_example.md") (qualified-name "For Loop Example::ComputeMotion::powerProfile"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind for-loop) (ordinal 0))))) (kind expressionOperand) (ordinal 0)))
    (relationship (kind expressionOperand) (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 2))))) (target (node (document "memory://snapshot/20_assignment_example.md") (qualified-name "For Loop Example::ComputeMotion::positions"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 2))))) (kind expressionOperand) (ordinal 0)))
    (relationship (kind memberAccessOperand) (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 0))))) (target (node (document "memory://snapshot/20_assignment_example.md") (qualified-name "For Loop Example::StraightLineDynamics::x_out"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 0))))) (kind memberAccessOperand) (ordinal 0)))
    (relationship (kind memberAccessOperand) (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 1))))) (target (node (document "memory://snapshot/20_assignment_example.md") (qualified-name "For Loop Example::StraightLineDynamics::v_out"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 1))))) (kind memberAccessOperand) (ordinal 0)))
    (relationship (kind assignTarget) (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 2))))) (target (node (document "memory://snapshot/20_assignment_example.md") (qualified-name "For Loop Example::ComputeMotion::positions"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 2))))) (kind assignTarget) (ordinal 0)))
    (relationship (kind typing) (source (node (document "memory://snapshot/20_assignment_example.md") (qualified-name "For Loop Example::ComputeMotion::::dynamics"))) (target (node (document "memory://snapshot/20_assignment_example.md") (qualified-name "For Loop Example::StraightLineDynamics"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/20_assignment_example.md") (qualified-name "For Loop Example::ComputeMotion::::dynamics"))) (kind featureTyping) (ordinal 0)))
  )
  (evaluation
    (evaluated (declaration (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind for-loop) (ordinal 0))))) (value (kind non-constant)))
    (evaluated (declaration (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 2))))) (value (kind non-constant)))
  )
)
~~~
# NAVIGATION
...
(navigation
  ...
  (query (document "memory://snapshot/20_assignment_example.md") (range (start 24 22) (end 24 34)) (probe (position 24 22))
    (reference (id (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind for-loop) (ordinal 0))))) (kind expressionOperand) (ordinal 0) (authored-target "powerProfile")
      (outcome (status resolved) (target (node (document "memory://snapshot/20_assignment_example.md") (qualified-name "For Loop Example::ComputeMotion::powerProfile")))))
  )
  (query (document "memory://snapshot/20_assignment_example.md") (range (start 36 28) (end 36 37)) (probe (position 36 28))
    (reference (id (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 2))))) (kind expressionOperand) (ordinal 0) (authored-target "positions")
      (outcome (status resolved) (target (node (document "memory://snapshot/20_assignment_example.md") (qualified-name "For Loop Example::ComputeMotion::positions")))))
  )
  (query (document "memory://snapshot/20_assignment_example.md") (range (start 36 49) (end 36 57)) (probe (position 36 49))
    (reference (id (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 2))))) (kind expressionOperand) (ordinal 1) (authored-target "position")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/20_assignment_example.md") (range (start 34 27) (end 34 41)) (probe (position 34 27))
    (reference (id (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 0))))) (kind memberAccessOperand) (ordinal 0) (authored-target "dynamics::x_out")
      (outcome (status resolved) (target (node (document "memory://snapshot/20_assignment_example.md") (qualified-name "For Loop Example::StraightLineDynamics::x_out")))))
  )
  (query (document "memory://snapshot/20_assignment_example.md") (range (start 35 24) (end 35 38)) (probe (position 35 24))
    (reference (id (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 1))))) (kind memberAccessOperand) (ordinal 0) (authored-target "dynamics::v_out")
      (outcome (status resolved) (target (node (document "memory://snapshot/20_assignment_example.md") (qualified-name "For Loop Example::StraightLineDynamics::v_out")))))
  )
  (query (document "memory://snapshot/20_assignment_example.md") (range (start 34 15) (end 34 23)) (probe (position 34 15))
    (reference (id (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 0))))) (kind assignTarget) (ordinal 0) (authored-target "position")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/20_assignment_example.md") (range (start 35 15) (end 35 20)) (probe (position 35 15))
    (reference (id (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 1))))) (kind assignTarget) (ordinal 0) (authored-target "speed")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/20_assignment_example.md") (range (start 36 15) (end 36 24)) (probe (position 36 15))
    (reference (id (source (node (document "memory://snapshot/20_assignment_example.md") (anonymous (kind assign) (ordinal 2))))) (kind assignTarget) (ordinal 0) (authored-target "positions")
      (outcome (status resolved) (target (node (document "memory://snapshot/20_assignment_example.md") (qualified-name "For Loop Example::ComputeMotion::positions")))))
  )
  (query (document "memory://snapshot/20_assignment_example.md") (range (start 25 29) (end 25 49)) (probe (position 25 29))
    (reference (id (source (node (document "memory://snapshot/20_assignment_example.md") (qualified-name "For Loop Example::ComputeMotion::::dynamics"))) (kind featureTyping) (ordinal 0) (authored-target "StraightLineDynamics")
      (outcome (status resolved) (target (node (document "memory://snapshot/20_assignment_example.md") (qualified-name "For Loop Example::StraightLineDynamics")))))
  )
