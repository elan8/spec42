...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/17_control_structures_example.md") (anonymous (kind then-continuation) (ordinal 0))))) (kind then-continuation) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (thenTarget (reference "done"))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/17_control_structures_example.md") (qualified-name "Control Structures Example::AddCharge::charge"))) (kind featureTyping) (ordinal 0))
      ...
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/17_control_structures_example.md") (anonymous (kind then-continuation) (ordinal 0))))) (kind thenTarget) (ordinal 0))
...
(navigation
  ...
  (query (document "memory://snapshot/17_control_structures_example.md") (range (start 26 7) (end 26 11)) (probe (position 26 7))
    (reference (id (source (node (document "memory://snapshot/17_control_structures_example.md") (anonymous (kind then-continuation) (ordinal 0))))) (kind thenTarget) (ordinal 0) (authored-target "done")
      (outcome (status unresolved)))
  )
