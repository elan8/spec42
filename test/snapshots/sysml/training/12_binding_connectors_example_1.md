...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/12_binding_connectors_example_1.md") (path (name "Binding Connectors Example-1") (name "vehicle") (name "tank") (anonymous (kind port) (ordinal 0)))))) (kind port) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "fuelTankPort"))))
    (declaration (id (node (document "memory://snapshot/12_binding_connectors_example_1.md") (path (name "Binding Connectors Example-1") (name "vehicle") (name "tank") (anonymous (kind bind) (ordinal 0)))))) (kind bind) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (memberAccessOperand (reference "fuelTankPort::fuelSupply")) (memberAccessOperand (reference "pump::pumpOut"))))
    (declaration (id (node (document "memory://snapshot/12_binding_connectors_example_1.md") (path (name "Binding Connectors Example-1") (name "vehicle") (name "tank") (anonymous (kind bind) (ordinal 1)))))) (kind bind) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (memberAccessOperand (reference "fuelTankPort::fuelReturn")) (memberAccessOperand (reference "tank::fuelIn"))))
  ...
  (references
    (reference (id (source (node (document "memory://snapshot/12_binding_connectors_example_1.md") (path (name "Binding Connectors Example-1") (anonymous (kind import) (ordinal 0)))))) (kind namespaceImport) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/12_binding_connectors_example_1.md") (qualified-name "Binding Connectors Example-1::vehicle::tank"))) (kind featureTyping) (ordinal 0))
      ...
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/12_binding_connectors_example_1.md") (path (name "Binding Connectors Example-1") (name "vehicle") (name "tank") (anonymous (kind port) (ordinal 0)))))) (kind redefinition) (ordinal 0))
      (authored-target "fuelTankPort")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/12_binding_connectors_example_1.md") (path (name "Binding Connectors Example-1") (name "vehicle") (name "tank") (anonymous (kind bind) (ordinal 0)))))) (kind memberAccessOperand) (ordinal 0))
      (authored-target "fuelTankPort::fuelSupply")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/12_binding_connectors_example_1.md") (path (name "Binding Connectors Example-1") (name "vehicle") (name "tank") (anonymous (kind bind) (ordinal 1)))))) (kind memberAccessOperand) (ordinal 0))
      (authored-target "fuelTankPort::fuelReturn")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/12_binding_connectors_example_1.md") (path (name "Binding Connectors Example-1") (name "vehicle") (name "tank") (anonymous (kind bind) (ordinal 0)))))) (kind memberAccessOperand) (ordinal 1))
      (authored-target "pump::pumpOut")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/12_binding_connectors_example_1.md") (path (name "Binding Connectors Example-1") (name "vehicle") (name "tank") (anonymous (kind bind) (ordinal 1)))))) (kind memberAccessOperand) (ordinal 1))
...
(navigation
  (query (document "memory://snapshot/12_binding_connectors_example_1.md") (range (start 1 16) (end 1 33)) (probe (position 1 16))
    (reference (id (source (node (document "memory://snapshot/12_binding_connectors_example_1.md") (path (name "Binding Connectors Example-1") (anonymous (kind import) (ordinal 0)))))) (kind namespaceImport) (ordinal 0) (authored-target "Port Example")
      (outcome (status unresolved)))
  )
  ...
  (query (document "memory://snapshot/12_binding_connectors_example_1.md") (range (start 9 18) (end 9 30)) (probe (position 9 18))
    (reference (id (source (node (document "memory://snapshot/12_binding_connectors_example_1.md") (path (name "Binding Connectors Example-1") (name "vehicle") (name "tank") (anonymous (kind port) (ordinal 0)))))) (kind redefinition) (ordinal 0) (authored-target "fuelTankPort")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/12_binding_connectors_example_1.md") (range (start 14 8) (end 14 31)) (probe (position 14 8))
    (reference (id (source (node (document "memory://snapshot/12_binding_connectors_example_1.md") (path (name "Binding Connectors Example-1") (name "vehicle") (name "tank") (anonymous (kind bind) (ordinal 0)))))) (kind memberAccessOperand) (ordinal 0) (authored-target "fuelTankPort::fuelSupply")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/12_binding_connectors_example_1.md") (range (start 15 8) (end 15 31)) (probe (position 15 8))
    (reference (id (source (node (document "memory://snapshot/12_binding_connectors_example_1.md") (path (name "Binding Connectors Example-1") (name "vehicle") (name "tank") (anonymous (kind bind) (ordinal 1)))))) (kind memberAccessOperand) (ordinal 0) (authored-target "fuelTankPort::fuelReturn")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/12_binding_connectors_example_1.md") (range (start 14 34) (end 14 46)) (probe (position 14 34))
    (reference (id (source (node (document "memory://snapshot/12_binding_connectors_example_1.md") (path (name "Binding Connectors Example-1") (name "vehicle") (name "tank") (anonymous (kind bind) (ordinal 0)))))) (kind memberAccessOperand) (ordinal 1) (authored-target "pump::pumpOut")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/12_binding_connectors_example_1.md") (range (start 15 34) (end 15 45)) (probe (position 15 34))
    (reference (id (source (node (document "memory://snapshot/12_binding_connectors_example_1.md") (path (name "Binding Connectors Example-1") (name "vehicle") (name "tank") (anonymous (kind bind) (ordinal 1)))))) (kind memberAccessOperand) (ordinal 1) (authored-target "tank::fuelIn")
      (outcome (status unresolved)))
  )
