...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/32_requirement_groups.md") (path (named (kind package) (name "Requirement Groups")) (named (kind requirement) (name "engineSpecification")) (named (kind requirement) (name "drivePowerInterface")) (anonymous (kind subject) (ordinal 0))))) (kind subject) (membership (kind feature) (visibility default)))
    ...
    (declaration (id (node (document "memory://snapshot/32_requirement_groups.md") (path (named (kind package) (name "Requirement Groups")) (named (kind requirement) (name "engineSpecification")) (named (kind requirement) (name "torqueGeneration")) (anonymous (kind subject) (ordinal 0))))) (kind subject) (membership (kind feature) (visibility default)))
