  ...
  (document "memory://snapshot/31_analytical_constraints.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (source "semantic")
        (range (start 5 2) (end 5 20))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_constraint_definition_member")
        (source "semantic")
        (range (start 6 2) (end 6 19))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_constraint_definition_member")
      ...
      (diagnostic
        ...
        (code "unsupported_constraint_definition_member")
        (source "semantic")
        (range (start 8 2) (end 8 23))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_constraint_definition_member")
        (source "semantic")
        (range (start 9 2) (end 9 22))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_constraint_definition_member")
        (source "semantic")
        (range (start 10 2) (end 10 23))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_constraint_definition_member")
        (source "semantic")
        (range (start 11 2) (end 11 22))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_constraint_definition_member")
...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/31_analytical_constraints.md") (qualified-name "Analytical Constraints::StraightLineDynamicsEquations"))) (kind constraint-def) (membership (kind owning) (visibility default)))
  )
  (references
