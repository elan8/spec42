...
(semantic-model
  ...
  (evaluation
    (evaluated (declaration (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation"))) (value (kind unresolved-operand)))
    (evaluated (declaration (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation"))) (value (kind unresolved-operand)))
    (evaluated (declaration (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation"))) (value (kind unresolved-operand)))
    (evaluated (declaration (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation"))) (value (kind unresolved-operand)))
    (evaluated (declaration (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation"))) (value (kind unresolved-operand)))
