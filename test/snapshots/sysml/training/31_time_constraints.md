...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/31_time_constraints.md") (anonymous (kind transition) (ordinal 0))))) (kind transition) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (transitionTarget (reference "maintenance")) (memberAccessOperand (reference "vehicle::maintenanceTime"))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/31_time_constraints.md") (anonymous (kind transition) (ordinal 0))))) (kind memberAccessOperand) (ordinal 0))
  ...
  (relationships
    ...
    (relationship (kind memberAccessOperand) (source (node (document "memory://snapshot/31_time_constraints.md") (anonymous (kind transition) (ordinal 0))))) (target (node (document "memory://snapshot/31_time_constraints.md") (qualified-name "Time Constraints::Vehicle::maintenanceTime"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/31_time_constraints.md") (anonymous (kind transition) (ordinal 0))))) (kind memberAccessOperand) (ordinal 0)))
...
(navigation
  ...
  (query (document "memory://snapshot/31_time_constraints.md") (range (start 23 12) (end 23 35)) (probe (position 23 12))
    (reference (id (source (node (document "memory://snapshot/31_time_constraints.md") (anonymous (kind transition) (ordinal 0))))) (kind memberAccessOperand) (ordinal 0) (authored-target "vehicle::maintenanceTime")
      (outcome (status resolved) (target (node (document "memory://snapshot/31_time_constraints.md") (qualified-name "Time Constraints::Vehicle::maintenanceTime")))))
  )
