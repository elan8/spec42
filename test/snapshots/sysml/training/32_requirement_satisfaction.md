...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/32_requirement_satisfaction.md") (anonymous (kind satisfy) (ordinal 1))))) (kind satisfy) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (satisfySource (reference "engineSpecification"))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/32_requirement_satisfaction.md") (anonymous (kind import) (ordinal 1))))) (kind namespaceImport) (ordinal 0))
      ...
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/32_requirement_satisfaction.md") (anonymous (kind satisfy) (ordinal 0))))) (kind satisfySource) (ordinal 0))
      (authored-target "vehicleSpecification")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/32_requirement_satisfaction.md") (anonymous (kind satisfy) (ordinal 1))))) (kind satisfySource) (ordinal 0))
...
(navigation
  ...
  (query (document "memory://snapshot/32_requirement_satisfaction.md") (range (start 21 10) (end 21 30)) (probe (position 21 10))
    (reference (id (source (node (document "memory://snapshot/32_requirement_satisfaction.md") (anonymous (kind satisfy) (ordinal 0))))) (kind satisfySource) (ordinal 0) (authored-target "vehicleSpecification")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/32_requirement_satisfaction.md") (range (start 22 10) (end 22 29)) (probe (position 22 10))
    (reference (id (source (node (document "memory://snapshot/32_requirement_satisfaction.md") (anonymous (kind satisfy) (ordinal 1))))) (kind satisfySource) (ordinal 0) (authored-target "engineSpecification")
      (outcome (status unresolved)))
  )
