...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation false) (source-digest "blake3:4e5e022421faaf34783c440a612d48a28954703b6e5c82f9d328a0e83223089a") (contract-version "parser-owned-resolution-v1"))
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/10_port_example.md") (qualified-name "Port Example::FuelInPort::fuelReturn"))) (kind item) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Fuel"))))
    (declaration (id (node (document "memory://snapshot/10_port_example.md") (qualified-name "Port Example::FuelInPort::fuelSupply"))) (kind item) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Fuel"))))
    ...
    (declaration (id (node (document "memory://snapshot/10_port_example.md") (qualified-name "Port Example::FuelOutPort::fuelReturn"))) (kind item) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Fuel"))))
    (declaration (id (node (document "memory://snapshot/10_port_example.md") (qualified-name "Port Example::FuelOutPort::fuelSupply"))) (kind item) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Fuel"))))
