...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/occurrence_test.md") (qualified-name "OccurrenceTest::ind"))) (kind occurrence) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Ind"))))
    (declaration (id (node (document "memory://snapshot/occurrence_test.md") (qualified-name "OccurrenceTest::ind::s3"))) (kind occurrence) (membership (kind feature) (visibility default)))
