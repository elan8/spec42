...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/analysis_individual_example.md") (anonymous (kind attribute) (ordinal 0))))) (kind attribute) (membership (kind feature) (visibility default)) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "power")) (memberAccessOperand (reference "engine::peakPower"))))
    ...
    (declaration (id (node (document "memory://snapshot/analysis_individual_example.md") (anonymous (kind attribute) (ordinal 0))))) (kind attribute) (membership (kind feature) (visibility default)) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "quantityPowerFactors")) (expressionOperand (reference "distancePF")) (expressionOperand (reference "volumePF"))))
    ...
    (declaration (id (node (document "memory://snapshot/analysis_individual_example.md") (anonymous (kind attribute) (ordinal 1))))) (kind attribute) (membership (kind feature) (visibility default)) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "exponent"))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/analysis_individual_example.md") (anonymous (kind attribute) (ordinal 0))))) (kind redefinition) (ordinal 0))
      ...
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/analysis_individual_example.md") (anonymous (kind attribute) (ordinal 0))))) (kind expressionOperand) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/analysis_individual_example.md") (anonymous (kind attribute) (ordinal 0))))) (kind expressionOperand) (ordinal 1))
  ...
  (evaluation
    ...
    (evaluated (declaration (node (document "memory://snapshot/analysis_individual_example.md") (anonymous (kind attribute) (ordinal 0))))) (value (kind non-constant)))
...
(navigation
  ...
  (query (document "memory://snapshot/analysis_individual_example.md") (range (start 12 71) (end 12 81)) (probe (position 12 71))
    (reference (id (source (node (document "memory://snapshot/analysis_individual_example.md") (anonymous (kind attribute) (ordinal 0))))) (kind expressionOperand) (ordinal 0) (authored-target "distancePF")
      (outcome (status resolved) (target (node (document "memory://snapshot/analysis_individual_example.md") (qualified-name "AnalysisIndividualExample::VehicleQuantities::DistancePerVolumeUnit::distancePF")))))
  )
  (query (document "memory://snapshot/analysis_individual_example.md") (range (start 12 83) (end 12 91)) (probe (position 12 83))
    (reference (id (source (node (document "memory://snapshot/analysis_individual_example.md") (anonymous (kind attribute) (ordinal 0))))) (kind expressionOperand) (ordinal 1) (authored-target "volumePF")
      (outcome (status resolved) (target (node (document "memory://snapshot/analysis_individual_example.md") (qualified-name "AnalysisIndividualExample::VehicleQuantities::DistancePerVolumeUnit::volumePF")))))
  )
