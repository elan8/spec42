...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/analysis_individual_example.md") (qualified-name "AnalysisIndividualExample::FuelEconomyAnalysisModel::FuelConsumption::fuelEconomy"))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "DistancePerVolumeValue") (direction out))))
    (declaration (id (node (document "memory://snapshot/analysis_individual_example.md") (qualified-name "AnalysisIndividualExample::FuelEconomyAnalysisModel::FuelConsumption::power"))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "PowerValue") (direction in))))
    ...
    (declaration (id (node (document "memory://snapshot/analysis_individual_example.md") (qualified-name "AnalysisIndividualExample::FuelEconomyAnalysisModel::FuelEconomyAnalysis::fuelConsumption::fuelEconomy"))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "DistancePerVolumeValue") (direction out))))
    (declaration (id (node (document "memory://snapshot/analysis_individual_example.md") (qualified-name "AnalysisIndividualExample::FuelEconomyAnalysisModel::FuelEconomyAnalysis::fuelConsumption::power"))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (memberAccessOperand (reference "vehicle::power"))))
    ...
    (declaration (id (node (document "memory://snapshot/analysis_individual_example.md") (qualified-name "AnalysisIndividualExample::IndividualAnalysisModel::FuelConsumption_1"))) (kind action-def) (membership (kind owning) (visibility default)) (authored (membership (kind owning) (visibility default)) (relationships (specialization (reference "FuelConsumption"))))
    (declaration (id (node (document "memory://snapshot/analysis_individual_example.md") (qualified-name "AnalysisIndividualExample::IndividualAnalysisModel::FuelEconomyAnalysis_1"))) (kind analysis-def) (membership (kind owning) (visibility default)) (authored (membership (kind owning) (visibility default)) (relationships (specialization (reference "FuelEconomyAnalysis"))))
    ...
    (declaration (id (node (document "memory://snapshot/analysis_individual_example.md") (qualified-name "AnalysisIndividualExample::IndividualAnalysisModel::fuelEconomyAnalysis_1"))) (kind analysis) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "FuelEconomyAnalysis_1"))))
    ...
    (declaration (id (node (document "memory://snapshot/analysis_individual_example.md") (anonymous (kind attribute) (ordinal 0))))) (kind attribute) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "power")) (memberAccessOperand (reference "engine::peakPower"))))
    ...
    (declaration (id (node (document "memory://snapshot/analysis_individual_example.md") (anonymous (kind attribute) (ordinal 0))))) (kind attribute) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "quantity")) (memberAccessOperand (reference "isq::L"))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/analysis_individual_example.md") (anonymous (kind attribute) (ordinal 0))))) (kind redefinition) (ordinal 0))
      ...
      (outcome (status resolved) (target (node (document "memory://snapshot/analysis_individual_example.md") (qualified-name "AnalysisIndividualExample::VehicleModel::Vehicle::power")))))
    (reference (id (source (node (document "memory://snapshot/analysis_individual_example.md") (anonymous (kind attribute) (ordinal 0))))) (kind memberAccessOperand) (ordinal 0))
  ...
  (evaluation
    ...
    (evaluated (declaration (node (document "memory://snapshot/analysis_individual_example.md") (qualified-name "AnalysisIndividualExample::VehicleQuantities::hp"))) (value (kind quantity) (magnitude (value (kind real) (real 745.7))) (unit "SI::W")))
...
(navigation
  ...
  (query (document "memory://snapshot/analysis_individual_example.md") (range (start 38 28) (end 38 44)) (probe (position 38 28))
    (reference (id (source (node (document "memory://snapshot/analysis_individual_example.md") (anonymous (kind attribute) (ordinal 0))))) (kind memberAccessOperand) (ordinal 0) (authored-target "engine::peakPower")
      (outcome (status resolved) (target (node (document "memory://snapshot/analysis_individual_example.md") (qualified-name "AnalysisIndividualExample::VehicleModel::Engine::peakPower")))))
  )
  ...
  (query (document "memory://snapshot/analysis_individual_example.md") (range (start 10 76) (end 10 81)) (probe (position 10 76))
    (reference (id (source (node (document "memory://snapshot/analysis_individual_example.md") (anonymous (kind attribute) (ordinal 0))))) (kind memberAccessOperand) (ordinal 0) (authored-target "isq::L")
      (outcome (status unresolved)))
  )
