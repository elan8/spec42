...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/root_package_test.md") (path (name "P2") (anonymous (kind import) (ordinal 0)))))) (kind import) (membership (kind import) (visibility private)) (authored (membership (kind import) (visibility private)) (relationships (namespaceImport (reference "P1") (import (shape namespace) (recursive false)))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/root_package_test.md") (path (name "P2") (anonymous (kind import) (ordinal 0)))))) (kind namespaceImport) (ordinal 0))
      (authored-target "P1")
...
(navigation
  ...
  (query (document "memory://snapshot/root_package_test.md") (range (start 5 16) (end 5 21)) (probe (position 5 16))
    (reference (id (source (node (document "memory://snapshot/root_package_test.md") (path (name "P2") (anonymous (kind import) (ordinal 0)))))) (kind namespaceImport) (ordinal 0) (authored-target "P1")
      (outcome (status resolved) (target (node (document "memory://snapshot/root_package_test.md") (qualified-name "P1")))))
  )
