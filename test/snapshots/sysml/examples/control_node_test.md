...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/control_node_test.md") (anonymous (kind flow) (ordinal 0))))) (kind flow) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (memberAccessOperand (reference "A2::a")) (memberAccessOperand (reference "F::a"))))
    ...
    (declaration (id (node (document "memory://snapshot/control_node_test.md") (anonymous (kind flow) (ordinal 1))))) (kind flow) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (memberAccessOperand (reference "F::b1")) (memberAccessOperand (reference "B1::b"))))
    (declaration (id (node (document "memory://snapshot/control_node_test.md") (anonymous (kind flow) (ordinal 2))))) (kind flow) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (memberAccessOperand (reference "F::b2")) (memberAccessOperand (reference "B2::b"))))
    ...
    (declaration (id (node (document "memory://snapshot/control_node_test.md") (qualified-name "ControlNodeTest::::a"))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction in)))
    (declaration (id (node (document "memory://snapshot/control_node_test.md") (qualified-name "ControlNodeTest::::b1"))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction out)))
    (declaration (id (node (document "memory://snapshot/control_node_test.md") (qualified-name "ControlNodeTest::::b2"))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction out)))
  ...
  (references
    (reference (id (source (node (document "memory://snapshot/control_node_test.md") (anonymous (kind flow) (ordinal 0))))) (kind memberAccessOperand) (ordinal 0))
      (authored-target "A2::a")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/control_node_test.md") (anonymous (kind flow) (ordinal 1))))) (kind memberAccessOperand) (ordinal 0))
      (authored-target "F::b1")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/control_node_test.md") (anonymous (kind flow) (ordinal 2))))) (kind memberAccessOperand) (ordinal 0))
      (authored-target "F::b2")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/control_node_test.md") (anonymous (kind flow) (ordinal 0))))) (kind memberAccessOperand) (ordinal 1))
      (authored-target "F::a")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/control_node_test.md") (anonymous (kind flow) (ordinal 1))))) (kind memberAccessOperand) (ordinal 1))
      (authored-target "B1::b")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/control_node_test.md") (anonymous (kind flow) (ordinal 2))))) (kind memberAccessOperand) (ordinal 1))
...
(navigation
  (query (document "memory://snapshot/control_node_test.md") (range (start 9 6) (end 9 10)) (probe (position 9 6))
    (reference (id (source (node (document "memory://snapshot/control_node_test.md") (anonymous (kind flow) (ordinal 0))))) (kind memberAccessOperand) (ordinal 0) (authored-target "A2::a")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/control_node_test.md") (range (start 20 6) (end 20 10)) (probe (position 20 6))
    (reference (id (source (node (document "memory://snapshot/control_node_test.md") (anonymous (kind flow) (ordinal 1))))) (kind memberAccessOperand) (ordinal 0) (authored-target "F::b1")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/control_node_test.md") (range (start 21 6) (end 21 10)) (probe (position 21 6))
    (reference (id (source (node (document "memory://snapshot/control_node_test.md") (anonymous (kind flow) (ordinal 2))))) (kind memberAccessOperand) (ordinal 0) (authored-target "F::b2")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/control_node_test.md") (range (start 9 14) (end 9 17)) (probe (position 9 14))
    (reference (id (source (node (document "memory://snapshot/control_node_test.md") (anonymous (kind flow) (ordinal 0))))) (kind memberAccessOperand) (ordinal 1) (authored-target "F::a")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/control_node_test.md") (range (start 20 14) (end 20 18)) (probe (position 20 14))
    (reference (id (source (node (document "memory://snapshot/control_node_test.md") (anonymous (kind flow) (ordinal 1))))) (kind memberAccessOperand) (ordinal 1) (authored-target "B1::b")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/control_node_test.md") (range (start 21 14) (end 21 18)) (probe (position 21 14))
    (reference (id (source (node (document "memory://snapshot/control_node_test.md") (anonymous (kind flow) (ordinal 2))))) (kind memberAccessOperand) (ordinal 1) (authored-target "B2::b")
      (outcome (status unresolved)))
  )
