...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/server_sequence_model_outside.md") (anonymous (kind occurrence) (ordinal 0))))) (kind occurrence) (membership (kind feature) (visibility default)) (facts (modifiers event)) (feature-value (kind bind)))
