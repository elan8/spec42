...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/server_sequence_model_outside.md") (path (named (kind package) (name "ServerSequenceModelOutside")) (named (kind part-def) (name "PubSubSequenceOutside")) (anonymous (kind part) (ordinal 2)))))) (kind part) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "consumer"))))
