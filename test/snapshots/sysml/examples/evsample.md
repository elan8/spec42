...
(types
    ...
    (declaration (id (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::largeEVRangeContext::efficiencyAnalysisLarge")))
      ...
      (supertype (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::largeEVRangeContext::largeEVAnalysis")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::largeEVRangeContext::efficiencyRequirementLarge")))
      (supertype (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::EfficiencyRequirement")) (scopes any))
      (supertype (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::VehicleRequirement")) (scopes any))
      (supertype (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::largeEVRangeContext::largeEVRequirement")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/evsample.md") (path (named (kind package) (name "EVSample")) (named (kind part) (name "largeEVRangeContext")) (named (kind requirement) (name "efficiencyRequirementLarge")) (anonymous (kind attribute) (ordinal 0)))))
      (supertype (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::EfficiencyRequirement::requiredEfficiency")) (scopes any))
    )
    ...
    (declaration (id (node (document "memory://snapshot/evsample.md") (path (named (kind package) (name "EVSample")) (named (kind part) (name "largeEVRangeContext")) (named (kind requirement) (name "maxSpeedRequirementLarge")) (anonymous (kind attribute) (ordinal 0)))))
      (supertype (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::MaxSpeedRequirement::requiredMaxSpeed")) (scopes any))
    )
    ...
    (declaration (id (node (document "memory://snapshot/evsample.md") (path (named (kind package) (name "EVSample")) (named (kind part) (name "largeEVRangeContext")) (named (kind requirement) (name "rangeRequirementLarge")) (anonymous (kind attribute) (ordinal 0)))))
      (supertype (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::RangeRequirement::requiredRange")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::smallEVRangeContext::efficiencyAnalysisSmall")))
      (supertype (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::EfficiencyAnalysis")) (scopes any))
      (supertype (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::VehicleAnalysis")) (scopes any))
      (supertype (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::smallEVRangeContext::smallEVAnalysis")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::smallEVRangeContext::efficiencyRequirementSmall")))
      (supertype (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::EfficiencyRequirement")) (scopes any))
      (supertype (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::VehicleRequirement")) (scopes any))
      (supertype (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::smallEVRangeContext::smallEVRequirement")) (scopes any))
    )
    ...
    (declaration (id (node (document "memory://snapshot/evsample.md") (path (named (kind package) (name "EVSample")) (named (kind part) (name "vehicle")) (anonymous (kind attribute) (ordinal 0)))))
      (supertype (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::Vehicle::mass")) (scopes any))
    )
    ...
    (declaration (id (node (document "memory://snapshot/evsample.md") (path (named (kind package) (name "EVSample")) (named (kind part) (name "vehicle")) (named (kind part) (name "battery")) (anonymous (kind attribute) (ordinal 0)))))
      (supertype (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::Battery::baseVoltage")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/evsample.md") (path (named (kind package) (name "EVSample")) (named (kind part) (name "vehicle")) (named (kind part) (name "battery")) (anonymous (kind attribute) (ordinal 1)))))
      (supertype (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::Battery::capacity")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/evsample.md") (path (named (kind package) (name "EVSample")) (named (kind part) (name "vehicle")) (named (kind part) (name "battery")) (anonymous (kind attribute) (ordinal 2)))))
      (supertype (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::Battery::socInit")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/evsample.md") (path (named (kind package) (name "EVSample")) (named (kind part) (name "vehicle")) (named (kind part) (name "battery")) (anonymous (kind attribute) (ordinal 3)))))
      (supertype (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::Battery::internalResistance")) (scopes any))
    )
    ...
    (declaration (id (node (document "memory://snapshot/evsample.md") (path (named (kind package) (name "EVSample")) (named (kind part) (name "vehicle")) (named (kind part) (name "motor")) (anonymous (kind attribute) (ordinal 0)))))
      (supertype (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::Motor::motR")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/evsample.md") (path (named (kind package) (name "EVSample")) (named (kind part) (name "vehicle")) (named (kind part) (name "motor")) (anonymous (kind attribute) (ordinal 1)))))
      (supertype (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::Motor::motL")) (scopes any))
    )
    ...
    (declaration (id (node (document "memory://snapshot/evsample.md") (path (named (kind package) (name "EVSample")) (named (kind part) (name "vehicle")) (named (kind part) (name "tire")) (anonymous (kind attribute) (ordinal 0)))))
      (supertype (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::Tire::moment")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/evsample.md") (path (named (kind package) (name "EVSample")) (named (kind part) (name "vehicle")) (named (kind part) (name "tire")) (anonymous (kind attribute) (ordinal 1)))))
      (supertype (node (document "memory://snapshot/evsample.md") (qualified-name "EVSample::Tire::radius")) (scopes any))
    )
