...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/use_case_test.md") (path (name "UseCaseTest") (name "system") (anonymous (kind perform-action) (ordinal 0)))))) (kind perform-action) (membership (kind feature) (visibility default)))
  ...
  (evaluation
    (evaluated (declaration (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::UseSystem"))) (value (kind unresolved-operand)))
    (evaluated (declaration (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::UseSystem"))) (value (kind unresolved-operand)))
    (evaluated (declaration (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::UseSystem"))) (value (kind unresolved-operand)))
    (evaluated (declaration (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::UseSystem"))) (value (kind unresolved-operand)))
    (evaluated (declaration (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::UseSystem"))) (value (kind unresolved-operand)))
    ...
    (evaluated (declaration (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::UseSystem"))) (value (kind unresolved-operand)))
    (evaluated (declaration (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::UseSystem"))) (value (kind unresolved-operand)))
    (evaluated (declaration (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::uc3"))) (value (kind unresolved-operand)))
  )
)
~~~
# NAVIGATION
