...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/server_sequence_outside_realization_2.md") (anonymous (kind attribute) (ordinal 0))))) (kind attribute) (membership (kind feature) (visibility default)) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "incomingTransferSort")) (expressionOperand (reference "Occurrences::earlierFirstIncomingTransferSort"))))
