  ...
  (document "memory://snapshot/vehicle_variability_model.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 49 6) (end 49 32))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 50 6) (end 50 31))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 51 6) (end 51 30))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 55 6) (end 55 49))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 56 6) (end 56 49))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 58 6) (end 58 49))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 59 6) (end 59 52))
      )
      (diagnostic
        (severity warning)
      ...
      (diagnostic
        ...
        (code "unsupported_reference")
        (source "semantic")
        (range (start 98 19) (end 98 25))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_reference")
        (source "semantic")
        (range (start 101 29) (end 101 41))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_part_usage_member")
...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness parse-recovery) (has-evaluation false) (source-digest "blake3:59530216f265c60bb22bc958bfc380a0cd13183f66813b38fb3d5d1430e1736b") (contract-version "parser-owned-resolution-v1"))
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/vehicle_variability_model.md") (anonymous (kind part) (ordinal 0))))) (kind part) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "engine"))))
    (declaration (id (node (document "memory://snapshot/vehicle_variability_model.md") (anonymous (kind part) (ordinal 1))))) (kind part) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "transmission"))))
    ...
    (declaration (id (node (document "memory://snapshot/vehicle_variability_model.md") (qualified-name "VehicleVariabilityModel::150% Model::PartsTree::EngineChoices"))) (kind part-def) (membership (kind owning) (visibility default)) (authored (membership (kind owning) (visibility default)) (relationships (specialization (reference "Engine"))))
    ...
    (declaration (id (node (document "memory://snapshot/vehicle_variability_model.md") (qualified-name "VehicleVariabilityModel::DesignModel::PartDefinitions::Cylinder::diameter"))) (kind attribute) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Diameter"))))
    ...
    (declaration (id (node (document "memory://snapshot/vehicle_variability_model.md") (anonymous (kind part) (ordinal 0))))) (kind part) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "cylinder"))))
    ...
    (declaration (id (node (document "memory://snapshot/vehicle_variability_model.md") (qualified-name "VehicleVariabilityModel::DesignModel::PartsTree::engine::cylinder"))) (kind part) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Cylinder"))))
    ...
    (declaration (id (node (document "memory://snapshot/vehicle_variability_model.md") (qualified-name "VehicleVariabilityModel::DesignModel::PartsTree::vehicle::engine"))) (kind part) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Engine"))))
    (declaration (id (node (document "memory://snapshot/vehicle_variability_model.md") (qualified-name "VehicleVariabilityModel::DesignModel::PartsTree::vehicle::sunroof"))) (kind part) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Sunroof"))))
    (declaration (id (node (document "memory://snapshot/vehicle_variability_model.md") (qualified-name "VehicleVariabilityModel::DesignModel::PartsTree::vehicle::transmission"))) (kind part) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Transmission"))))
  )
  (references
  ...
  (relationships
    ...
    (relationship (kind typing) (source (node (document "memory://snapshot/vehicle_variability_model.md") (anonymous (kind part) (ordinal 1))))) (target (node (document "memory://snapshot/vehicle_variability_model.md") (qualified-name "VehicleVariabilityModel::DesignModel::PartDefinitions::Transmission"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/vehicle_variability_model.md") (anonymous (kind part) (ordinal 1))))) (kind featureTyping) (ordinal 0)))
