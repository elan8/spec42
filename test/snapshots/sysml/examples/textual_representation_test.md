...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/textual_representation_test.md") (qualified-name "TextualRepresentationTest::C::x_constraint"))) (kind assert-constraint) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "rep")) (expressionOperand (reference "inOCL")) (expressionOperand (reference "language")))))
  ...
  (evaluation
    (evaluated (declaration (node (document "memory://snapshot/textual_representation_test.md") (qualified-name "TextualRepresentationTest::C::x_constraint"))) (state evaluated) (value (kind string) (value "ocl")))
    (evaluated (declaration (node (document "memory://snapshot/textual_representation_test.md") (qualified-name "TextualRepresentationTest::C::x_constraint"))) (state evaluated) (value (kind string) (value "ocl")))
    (evaluated (declaration (node (document "memory://snapshot/textual_representation_test.md") (qualified-name "TextualRepresentationTest::C::x_constraint"))) (state evaluated) (value (kind string) (value "ocl")))
    (evaluated (declaration (node (document "memory://snapshot/textual_representation_test.md") (qualified-name "TextualRepresentationTest::C::x_constraint"))) (state literal) (value (kind string) (value "ocl")))
  )
)
~~~
# TYPES
