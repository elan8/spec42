...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/analysis_test.md") (path (name "AnalysisTest") (name "AnalysisCase") (name "obj") (anonymous (kind subject) (ordinal 0)))))) (kind subject) (membership (kind feature) (visibility default)))
