  ...
  (document "memory://snapshot/requirement_derivation_example.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 5 1) (end 5 24))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 6 1) (end 6 24))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_package_member")
...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/requirement_derivation_example.md") (anonymous (kind import) (ordinal 0))))) (kind import) (membership (kind import) (visibility private)) (authored (membership (kind import) (visibility private)) (relationships (namespaceImport (reference "RequirementDerivation") (import (shape namespace) (recursive false)))))
  ...
  (references
    (reference (id (source (node (document "memory://snapshot/requirement_derivation_example.md") (anonymous (kind import) (ordinal 0))))) (kind namespaceImport) (ordinal 0))
...
(navigation
  (query (document "memory://snapshot/requirement_derivation_example.md") (range (start 1 16) (end 1 40)) (probe (position 1 16))
    (reference (id (source (node (document "memory://snapshot/requirement_derivation_example.md") (anonymous (kind import) (ordinal 0))))) (kind namespaceImport) (ordinal 0) (authored-target "RequirementDerivation")
      (outcome (status unresolved)))
  )
