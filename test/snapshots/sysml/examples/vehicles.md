...
(semantic-model
  ...
  (evaluation
    ...
    (unit (declaration (node (document "memory://snapshot/vehicles.md") (path (named (kind package) (name "VehicleMasses")) (named (kind part) (name "c")) (anonymous (kind attribute) (ordinal 0))))) (ordinal 0) (authored "kg") (start 25 25) (end 25 27) (outcome (status catalog-unavailable)))
    (unit (declaration (node (document "memory://snapshot/vehicles.md") (path (named (kind package) (name "VehicleMasses")) (named (kind part) (name "c")) (anonymous (kind part) (ordinal 0)) (anonymous (kind attribute) (ordinal 0))))) (ordinal 0) (authored "kg") (start 27 25) (end 27 27) (outcome (status catalog-unavailable)))
    (unit (declaration (node (document "memory://snapshot/vehicles.md") (path (named (kind package) (name "VehicleMasses")) (named (kind part) (name "c")) (anonymous (kind part) (ordinal 1)) (anonymous (kind attribute) (ordinal 0))))) (ordinal 0) (authored "kg") (start 31 24) (end 31 26) (outcome (status catalog-unavailable)))
  )
)
~~~
# TYPES
~~~sexpr
(types
    (declaration (id (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::CarPart")))
      (subtype (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::car")) (scopes any))
      (subtype (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::car::carParts")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::CarPart::serialNumber")))
      (featured-by (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::CarPart")))
      (subtype (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::car::vin")) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::c")))
      (effective-type (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::CarPart")) (source inherited) (from (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::car"))))
      (supertype (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::CarPart")) (scopes any))
      (supertype (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::car")) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/vehicles.md") (path (named (kind package) (name "VehicleMasses")) (named (kind part) (name "c")) (anonymous (kind attribute) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::c")))
    )
    (declaration (id (node (document "memory://snapshot/vehicles.md") (path (named (kind package) (name "VehicleMasses")) (named (kind part) (name "c")) (anonymous (kind part) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::c")))
    )
    (declaration (id (node (document "memory://snapshot/vehicles.md") (path (named (kind package) (name "VehicleMasses")) (named (kind part) (name "c")) (anonymous (kind part) (ordinal 1)))))
      (featured-by (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::c")))
    )
    (declaration (id (node (document "memory://snapshot/vehicles.md") (path (named (kind package) (name "VehicleMasses")) (named (kind part) (name "c")) (anonymous (kind part) (ordinal 0)) (anonymous (kind attribute) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/vehicles.md") (path (named (kind package) (name "VehicleMasses")) (named (kind part) (name "c")) (anonymous (kind part) (ordinal 0)))))
    )
    (declaration (id (node (document "memory://snapshot/vehicles.md") (path (named (kind package) (name "VehicleMasses")) (named (kind part) (name "c")) (anonymous (kind part) (ordinal 1)) (anonymous (kind attribute) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/vehicles.md") (path (named (kind package) (name "VehicleMasses")) (named (kind part) (name "c")) (anonymous (kind part) (ordinal 1)))))
    )
    (declaration (id (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::car")))
      (type (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::CarPart")) (provenance authored))
      (effective-type (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::CarPart")) (source direct))
      (supertype (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::CarPart")) (scopes any))
      (subtype (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::c")) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::car::carParts")))
      (featured-by (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::car")))
      (type (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::CarPart")) (provenance authored))
      (effective-type (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::CarPart")) (source direct))
      (supertype (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::CarPart")) (scopes any))
      (subtype (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::car::engine")) (scopes any feature))
      (subtype (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::car::transmission")) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::car::engine")))
      (featured-by (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::car")))
      (effective-type (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::CarPart")) (source inherited) (from (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::car::carParts"))))
      (supertype (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::CarPart")) (scopes any))
      (supertype (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::car::carParts")) (scopes any feature))
    )
    ...
    (declaration (id (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::car::vin")))
      (featured-by (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::car")))
      (supertype (node (document "memory://snapshot/vehicles.md") (qualified-name "VehicleMasses::CarPart::serialNumber")) (scopes any feature))
    )
)
~~~
# NAVIGATION
