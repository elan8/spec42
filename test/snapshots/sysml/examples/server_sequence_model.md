  ...
  (document "memory://snapshot/server_sequence_model.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (code "unsupported_part_usage_member")
        (source "semantic")
        (range (start 28 3) (end 28 43))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_part_usage_member")
        (source "semantic")
        (range (start 29 3) (end 29 46))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_part_usage_member")
        (source "semantic")
        (range (start 30 3) (end 30 46))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_part_definition_member")
      ...
      (diagnostic
        ...
        (code "unsupported_part_usage_member")
        (source "semantic")
        (range (start 37 3) (end 37 43))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_part_usage_member")
        (source "semantic")
        (range (start 38 3) (end 38 46))
      )
    )
  )
)
