...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/calculation_test.md") (anonymous (kind attribute) (ordinal 0))))) (kind attribute) (membership (kind feature) (visibility default)) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (referenceSubsetting (reference "m")) (memberAccessOperand (reference "ms::totalMass"))))
