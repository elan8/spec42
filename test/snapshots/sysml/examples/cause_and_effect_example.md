...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/cause_and_effect_example.md") (anonymous (kind connection-def) (ordinal 0))))) (kind connection-def) (membership (kind owning) (visibility default)))
    (declaration (id (node (document "memory://snapshot/cause_and_effect_example.md") (anonymous (kind bare-connect) (ordinal 0))))) (kind bare-connect) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (connectorEnd (reference "a")) (connectorEnd (reference "c"))))
    (declaration (id (node (document "memory://snapshot/cause_and_effect_example.md") (anonymous (kind bare-connect) (ordinal 1))))) (kind bare-connect) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (connectorEnd (reference "b")) (connectorEnd (reference "d"))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/cause_and_effect_example.md") (anonymous (kind bare-connect) (ordinal 0))))) (kind connectorEnd) (ordinal 0))
      (authored-target "a")
    ...
    (reference (id (source (node (document "memory://snapshot/cause_and_effect_example.md") (anonymous (kind bare-connect) (ordinal 1))))) (kind connectorEnd) (ordinal 0))
      (authored-target "b")
    ...
    (reference (id (source (node (document "memory://snapshot/cause_and_effect_example.md") (anonymous (kind bare-connect) (ordinal 0))))) (kind connectorEnd) (ordinal 1))
      (authored-target "c")
    ...
    (reference (id (source (node (document "memory://snapshot/cause_and_effect_example.md") (anonymous (kind bare-connect) (ordinal 1))))) (kind connectorEnd) (ordinal 1))
      (authored-target "d")
...
(navigation
  ...
  (query (document "memory://snapshot/cause_and_effect_example.md") (range (start 47 20) (end 47 21)) (probe (position 47 20))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect_example.md") (anonymous (kind bare-connect) (ordinal 0))))) (kind connectorEnd) (ordinal 0) (authored-target "a")
      (outcome (status resolved) (target (node (document "memory://snapshot/cause_and_effect_example.md") (qualified-name "CauseAndEffectExample::a")))))
  )
  (query (document "memory://snapshot/cause_and_effect_example.md") (range (start 48 20) (end 48 21)) (probe (position 48 20))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect_example.md") (anonymous (kind bare-connect) (ordinal 1))))) (kind connectorEnd) (ordinal 0) (authored-target "b")
      (outcome (status resolved) (target (node (document "memory://snapshot/cause_and_effect_example.md") (qualified-name "CauseAndEffectExample::b")))))
  )
  (query (document "memory://snapshot/cause_and_effect_example.md") (range (start 47 25) (end 47 26)) (probe (position 47 25))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect_example.md") (anonymous (kind bare-connect) (ordinal 0))))) (kind connectorEnd) (ordinal 1) (authored-target "c")
      (outcome (status resolved) (target (node (document "memory://snapshot/cause_and_effect_example.md") (qualified-name "CauseAndEffectExample::c")))))
  )
  (query (document "memory://snapshot/cause_and_effect_example.md") (range (start 48 25) (end 48 26)) (probe (position 48 25))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect_example.md") (anonymous (kind bare-connect) (ordinal 1))))) (kind connectorEnd) (ordinal 1) (authored-target "d")
      (outcome (status resolved) (target (node (document "memory://snapshot/cause_and_effect_example.md") (qualified-name "CauseAndEffectExample::d")))))
  )
