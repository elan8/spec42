...
(semantic-model
  ...
  (evaluation
    (evaluated (declaration (node (document "memory://snapshot/ahfprofile_lib.md") (qualified-name "AHFProfileMetadata::IDDMetadata::baseType"))) (state non-constant))
    (evaluated (declaration (node (document "memory://snapshot/ahfprofile_lib.md") (qualified-name "AHFProfileMetadata::LocalCloudsDDMetadata::baseType"))) (state non-constant))
    (evaluated (declaration (node (document "memory://snapshot/ahfprofile_lib.md") (qualified-name "AHFProfileMetadata::LocalCloudsMetadata::baseType"))) (state non-constant))
    (evaluated (declaration (node (document "memory://snapshot/ahfprofile_lib.md") (qualified-name "AHFProfileMetadata::SDDDMetadata::baseType"))) (state non-constant))
    (evaluated (declaration (node (document "memory://snapshot/ahfprofile_lib.md") (qualified-name "AHFProfileMetadata::SDMetadata::baseType"))) (state non-constant))
    (evaluated (declaration (node (document "memory://snapshot/ahfprofile_lib.md") (qualified-name "AHFProfileMetadata::SysDDMetadata::baseType"))) (state non-constant))
    (evaluated (declaration (node (document "memory://snapshot/ahfprofile_lib.md") (qualified-name "AHFProfileMetadata::SysDMetadata::baseType"))) (state non-constant))
    (evaluated (declaration (node (document "memory://snapshot/ahfprofile_lib.md") (qualified-name "AHFProfileMetadata::SysLocalCloudsMetadata::baseType"))) (state non-constant))
  )
)
~~~
# NAVIGATION
