  ...
  (document "memory://snapshot/metadata_test.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (source "parser")
        (range (start 6 3) (end 7 3))
      )
      (diagnostic
        (severity error)
        (code "unrecognized_declaration_in_scope")
        (source "parser")
        (range (start 7 3) (end 8 3))
      )
      (diagnostic
        (severity warning)
      ...
      (diagnostic
        ...
        (code "unresolved_reference")
        (source "semantic")
        (range (start 21 25) (end 21 50))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_reference")
        (source "semantic")
        (range (start 27 25) (end 27 50))
      )
      (diagnostic
        (severity error)
...
(semantic-model
  ...
  (evaluation
    (evaluated (declaration (node (document "memory://snapshot/metadata_test.md") (qualified-name "MetadataTest::x::Classified::classificationLevel"))) (state unresolved-operand))
    (evaluated (declaration (node (document "memory://snapshot/metadata_test.md") (path (named (kind package) (name "MetadataTest")) (named (kind ref) (name "y")) (anonymous (kind metadata) (ordinal 0)) (named (kind attribute) (name "classificationLevel"))))) (state unresolved-operand))
...
(types
    ...
    (declaration (id (node (document "memory://snapshot/metadata_test.md") (qualified-name "MetadataTest::User Defined Extensions::Classified::annotatedElement")))
