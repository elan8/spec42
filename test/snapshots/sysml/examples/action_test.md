...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/action_test.md") (qualified-name "ActionTest::c::c1"))) (kind action) (membership (kind feature) (visibility default)))
  )
  (references
