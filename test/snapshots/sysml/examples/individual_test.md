...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/individual_test.md") (anonymous (kind item) (ordinal 0))))) (kind item) (membership (kind feature) (visibility default)) (facts (modifiers individual)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "II2")) (redefinition (reference "i"))))
    ...
    (declaration (id (node (document "memory://snapshot/individual_test.md") (anonymous (kind part) (ordinal 0))))) (kind part) (membership (kind feature) (visibility default)) (facts (modifiers individual)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "IP2")) (redefinition (reference "p"))))
