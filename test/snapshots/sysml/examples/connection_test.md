...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/connection_test.md") (anonymous (kind bare-connect) (ordinal 0))))) (kind bare-connect) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (connectorEnd (reference "p")) (connectorEnd (reference "y"))))
    (declaration (id (node (document "memory://snapshot/connection_test.md") (anonymous (kind bare-connect) (ordinal 1))))) (kind bare-connect) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (connectorEnd (reference "y")) (memberAccessOperand (reference "p1::x"))))
    (declaration (id (node (document "memory://snapshot/connection_test.md") (anonymous (kind bare-connect) (ordinal 2))))) (kind bare-connect) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (connectorEnd (reference "y")) (memberAccessOperand (reference "p1::x::x1"))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/connection_test.md") (qualified-name "ConnectionTest::AB::b"))) (kind featureTyping) (ordinal 0))
      (authored-target "B")
      (outcome (status resolved) (target (node (document "memory://snapshot/connection_test.md") (qualified-name "ConnectionTest::B")))))
    (reference (id (source (node (document "memory://snapshot/connection_test.md") (anonymous (kind bare-connect) (ordinal 0))))) (kind connectorEnd) (ordinal 0))
      (authored-target "p")
      (outcome (status resolved) (target (node (document "memory://snapshot/connection_test.md") (qualified-name "ConnectionTest::p")))))
    (reference (id (source (node (document "memory://snapshot/connection_test.md") (anonymous (kind bare-connect) (ordinal 1))))) (kind connectorEnd) (ordinal 0))
      (authored-target "y")
      (outcome (status resolved) (target (node (document "memory://snapshot/connection_test.md") (qualified-name "ConnectionTest::P::y")))))
    (reference (id (source (node (document "memory://snapshot/connection_test.md") (anonymous (kind bare-connect) (ordinal 2))))) (kind connectorEnd) (ordinal 0))
      (authored-target "y")
      (outcome (status resolved) (target (node (document "memory://snapshot/connection_test.md") (qualified-name "ConnectionTest::P::y")))))
    (reference (id (source (node (document "memory://snapshot/connection_test.md") (anonymous (kind bare-connect) (ordinal 0))))) (kind connectorEnd) (ordinal 1))
      (authored-target "y")
      (outcome (status resolved) (target (node (document "memory://snapshot/connection_test.md") (qualified-name "ConnectionTest::P::y")))))
    (reference (id (source (node (document "memory://snapshot/connection_test.md") (anonymous (kind bare-connect) (ordinal 1))))) (kind memberAccessOperand) (ordinal 0))
      (authored-target "p1::x")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/connection_test.md") (anonymous (kind bare-connect) (ordinal 2))))) (kind memberAccessOperand) (ordinal 0))
  ...
  (relationships
    ...
    (relationship (kind connectorEnd) (source (node (document "memory://snapshot/connection_test.md") (anonymous (kind bare-connect) (ordinal 0))))) (target (node (document "memory://snapshot/connection_test.md") (qualified-name "ConnectionTest::p"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/connection_test.md") (anonymous (kind bare-connect) (ordinal 0))))) (kind connectorEnd) (ordinal 0)))
    (relationship (kind connectorEnd) (source (node (document "memory://snapshot/connection_test.md") (anonymous (kind bare-connect) (ordinal 1))))) (target (node (document "memory://snapshot/connection_test.md") (qualified-name "ConnectionTest::P::y"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/connection_test.md") (anonymous (kind bare-connect) (ordinal 1))))) (kind connectorEnd) (ordinal 0)))
    (relationship (kind connectorEnd) (source (node (document "memory://snapshot/connection_test.md") (anonymous (kind bare-connect) (ordinal 2))))) (target (node (document "memory://snapshot/connection_test.md") (qualified-name "ConnectionTest::P::y"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/connection_test.md") (anonymous (kind bare-connect) (ordinal 2))))) (kind connectorEnd) (ordinal 0)))
    (relationship (kind connectorEnd) (source (node (document "memory://snapshot/connection_test.md") (anonymous (kind bare-connect) (ordinal 0))))) (target (node (document "memory://snapshot/connection_test.md") (qualified-name "ConnectionTest::P::y"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/connection_test.md") (anonymous (kind bare-connect) (ordinal 0))))) (kind connectorEnd) (ordinal 1)))
...
(navigation
  ...
  (query (document "memory://snapshot/connection_test.md") (range (start 11 10) (end 11 11)) (probe (position 11 10))
    (reference (id (source (node (document "memory://snapshot/connection_test.md") (anonymous (kind bare-connect) (ordinal 0))))) (kind connectorEnd) (ordinal 0) (authored-target "p")
      (outcome (status resolved) (target (node (document "memory://snapshot/connection_test.md") (qualified-name "ConnectionTest::p")))))
  )
  (query (document "memory://snapshot/connection_test.md") (range (start 15 18) (end 15 19)) (probe (position 15 18))
    (reference (id (source (node (document "memory://snapshot/connection_test.md") (anonymous (kind bare-connect) (ordinal 1))))) (kind connectorEnd) (ordinal 0) (authored-target "y")
      (outcome (status resolved) (target (node (document "memory://snapshot/connection_test.md") (qualified-name "ConnectionTest::P::y")))))
  )
  (query (document "memory://snapshot/connection_test.md") (range (start 16 21) (end 16 22)) (probe (position 16 21))
    (reference (id (source (node (document "memory://snapshot/connection_test.md") (anonymous (kind bare-connect) (ordinal 2))))) (kind connectorEnd) (ordinal 0) (authored-target "y")
      (outcome (status resolved) (target (node (document "memory://snapshot/connection_test.md") (qualified-name "ConnectionTest::P::y")))))
  )
  (query (document "memory://snapshot/connection_test.md") (range (start 11 15) (end 11 16)) (probe (position 11 15))
    (reference (id (source (node (document "memory://snapshot/connection_test.md") (anonymous (kind bare-connect) (ordinal 0))))) (kind connectorEnd) (ordinal 1) (authored-target "y")
      (outcome (status resolved) (target (node (document "memory://snapshot/connection_test.md") (qualified-name "ConnectionTest::P::y")))))
  )
  (query (document "memory://snapshot/connection_test.md") (range (start 15 10) (end 15 14)) (probe (position 15 10))
    (reference (id (source (node (document "memory://snapshot/connection_test.md") (anonymous (kind bare-connect) (ordinal 1))))) (kind memberAccessOperand) (ordinal 0) (authored-target "p1::x")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/connection_test.md") (range (start 16 10) (end 16 17)) (probe (position 16 10))
    (reference (id (source (node (document "memory://snapshot/connection_test.md") (anonymous (kind bare-connect) (ordinal 2))))) (kind memberAccessOperand) (ordinal 0) (authored-target "p1::x::x1")
      (outcome (status unresolved)))
  )
