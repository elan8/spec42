...
~~~sexpr
(types
    (declaration (id (node (document "memory://snapshot/decision_test.md") (path (named (kind action-def) (name "DecisionTest")) (anonymous (kind decide) (ordinal 0)))))
    ...
    (declaration (id (node (document "memory://snapshot/decision_test.md") (path (named (kind action-def) (name "DecisionTest")) (anonymous (kind decide) (ordinal 1)))))
      (featured-by (node (document "memory://snapshot/decision_test.md") (qualified-name "DecisionTest")))
    )
