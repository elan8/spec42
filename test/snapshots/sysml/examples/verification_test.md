...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/verification_test.md") (anonymous (kind verify-requirement) (ordinal 0))))) (kind verify-requirement) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (verifyRequirementTarget (reference "r"))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/verification_test.md") (qualified-name "VerificationTest::VerificationPlan"))) (kind expressionOperand) (ordinal 0))
      (authored-target "verification")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/verification_test.md") (qualified-name "VerificationTest::VerificationPlan"))) (kind expressionOperand) (ordinal 1))
      (authored-target "verificationCase")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/verification_test.md") (anonymous (kind verify-requirement) (ordinal 0))))) (kind verifyRequirementTarget) (ordinal 0))
      (authored-target "r")
  ...
  (relationships
    ...
    (relationship (kind verifyRequirementTarget) (source (node (document "memory://snapshot/verification_test.md") (anonymous (kind verify-requirement) (ordinal 0))))) (target (node (document "memory://snapshot/verification_test.md") (qualified-name "VerificationTest::r"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/verification_test.md") (anonymous (kind verify-requirement) (ordinal 0))))) (kind verifyRequirementTarget) (ordinal 0)))
  ...
  (evaluation
    (evaluated (declaration (node (document "memory://snapshot/verification_test.md") (qualified-name "VerificationTest::VerificationPlan"))) (value (kind unresolved-operand)))
    (evaluated (declaration (node (document "memory://snapshot/verification_test.md") (qualified-name "VerificationTest::VerificationPlan"))) (value (kind unresolved-operand)))
  )
)
~~~
...
(navigation
  ...
  (query (document "memory://snapshot/verification_test.md") (range (start 30 2) (end 30 14)) (probe (position 30 2))
    (reference (id (source (node (document "memory://snapshot/verification_test.md") (qualified-name "VerificationTest::VerificationPlan"))) (kind expressionOperand) (ordinal 0) (authored-target "verification")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/verification_test.md") (range (start 30 15) (end 30 31)) (probe (position 30 15))
    (reference (id (source (node (document "memory://snapshot/verification_test.md") (qualified-name "VerificationTest::VerificationPlan"))) (kind expressionOperand) (ordinal 1) (authored-target "verificationCase")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/verification_test.md") (range (start 27 10) (end 27 11)) (probe (position 27 10))
    (reference (id (source (node (document "memory://snapshot/verification_test.md") (anonymous (kind verify-requirement) (ordinal 0))))) (kind verifyRequirementTarget) (ordinal 0) (authored-target "r")
      (outcome (status resolved) (target (node (document "memory://snapshot/verification_test.md") (qualified-name "VerificationTest::r")))))
  )
