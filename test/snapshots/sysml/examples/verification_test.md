...
(semantic-model
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/verification_test.md") (qualified-name "VerificationTest::VerificationPlan"))) (kind expressionOperand) (ordinal 1))
      ...
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/verification_test.md") (path (name "VerificationTest") (name "VerificationPlan") (name "objective") (anonymous (kind verify-requirement) (ordinal 0)))))) (kind verifyRequirementTarget) (ordinal 0))
      (authored-target "r")
  ...
  (relationships
    ...
    (relationship (kind verifyRequirementTarget) (source (node (document "memory://snapshot/verification_test.md") (path (name "VerificationTest") (name "VerificationPlan") (name "objective") (anonymous (kind verify-requirement) (ordinal 0)))))) (target (node (document "memory://snapshot/verification_test.md") (qualified-name "VerificationTest::r"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/verification_test.md") (path (name "VerificationTest") (name "VerificationPlan") (name "objective") (anonymous (kind verify-requirement) (ordinal 0)))))) (kind verifyRequirementTarget) (ordinal 0)))
...
(navigation
  ...
  (query (document "memory://snapshot/verification_test.md") (range (start 27 10) (end 27 11)) (probe (position 27 10))
    (reference (id (source (node (document "memory://snapshot/verification_test.md") (path (name "VerificationTest") (name "VerificationPlan") (name "objective") (anonymous (kind verify-requirement) (ordinal 0)))))) (kind verifyRequirementTarget) (ordinal 0) (authored-target "r")
      (outcome (status resolved) (target (node (document "memory://snapshot/verification_test.md") (qualified-name "VerificationTest::r")))))
  )
