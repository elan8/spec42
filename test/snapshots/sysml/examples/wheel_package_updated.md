...
~~~sexpr
(types
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::BalanceWeight")))
      (subtype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::wheel::w::weight")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::Hub")))
      (subtype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::hub")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::InflationValve")))
      (subtype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::wheel::w::v")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::LugBoltJoint")))
      (subtype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::lugBoltJoints")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::LugBoltMountingHole")))
      (subtype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::lugBoltJoints::mountingHole")) (scopes any))
      (subtype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::wheel::w::mountingHoles")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::LugBoltThreadableHole")))
      (subtype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::hub::h")) (scopes any))
      (subtype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::lugBoltJoints::threadedHole")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::PressureSeat")))
      (subtype (node (document "memory://snapshot/wheel_package_updated.md") (path (named (kind package) (name "Wheel Package - Updated")) (named (kind part) (name "wheelHubAssembly")) (named (kind part) (name "wheel")) (anonymous (kind connection) (ordinal 0)))) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::Tire")))
      (subtype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::wheel::t")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::TireBead")))
      (subtype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::wheel::t::bead")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::TireMountingRim")))
      (subtype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::wheel::w::rim")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::Wheel")))
      (subtype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::wheel::w")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::WheelAssembly")))
      (subtype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::wheel")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::WheelAssembly::inflationPressure")))
      (supertype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::pressure")) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::WheelHubAssembly")))
      (subtype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::pressure")))
      (subtype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::WheelAssembly::inflationPressure")) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly")))
      (type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::WheelHubAssembly")) (provenance authored))
      (effective-type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::WheelHubAssembly")) (source direct))
      (supertype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::WheelHubAssembly")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::hub")))
      (type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::Hub")) (provenance authored))
      (effective-type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::Hub")) (source direct))
      (supertype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::Hub")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::hub::h")))
      (type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::LugBoltThreadableHole")) (provenance authored))
      (effective-type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::LugBoltThreadableHole")) (source direct))
      (supertype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::LugBoltThreadableHole")) (scopes any))
      (subtype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::lugBoltJoints::threadedHole")) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::lugBoltJoints")))
      (type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::LugBoltJoint")) (provenance authored))
      (effective-type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::LugBoltJoint")) (source direct))
      (supertype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::LugBoltJoint")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::lugBoltJoints::mountingHole")))
      (type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::LugBoltMountingHole")) (provenance authored))
      (effective-type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::LugBoltMountingHole")) (source direct))
      (effective-type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::LugBoltMountingHole")) (source inherited) (from (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::wheel::w::mountingHoles"))))
      (supertype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::LugBoltMountingHole")) (scopes any))
      (supertype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::wheel::w::mountingHoles")) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::lugBoltJoints::threadedHole")))
      (type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::LugBoltThreadableHole")) (provenance authored))
      (effective-type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::LugBoltThreadableHole")) (source direct))
      (effective-type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::LugBoltThreadableHole")) (source inherited) (from (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::hub::h"))))
      (supertype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::LugBoltThreadableHole")) (scopes any))
      (supertype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::hub::h")) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::wheel")))
      (type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::WheelAssembly")) (provenance authored))
      (effective-type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::WheelAssembly")) (source direct))
      (supertype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::WheelAssembly")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (path (named (kind package) (name "Wheel Package - Updated")) (named (kind part) (name "wheelHubAssembly")) (named (kind part) (name "wheel")) (anonymous (kind connection) (ordinal 0)))))
      (type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::PressureSeat")) (provenance authored))
      (effective-type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::PressureSeat")) (source direct))
      (supertype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::PressureSeat")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::wheel::t")))
      (type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::Tire")) (provenance authored))
      (effective-type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::Tire")) (source direct))
      (supertype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::Tire")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::wheel::t::bead")))
      (type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::TireBead")) (provenance authored))
      (effective-type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::TireBead")) (source direct))
      (supertype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::TireBead")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::wheel::w")))
      (type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::Wheel")) (provenance authored))
      (effective-type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::Wheel")) (source direct))
      (supertype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::Wheel")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::wheel::w::mountingHoles")))
      (type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::LugBoltMountingHole")) (provenance authored))
      (effective-type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::LugBoltMountingHole")) (source direct))
      (supertype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::LugBoltMountingHole")) (scopes any))
      (subtype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::lugBoltJoints::mountingHole")) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::wheel::w::rim")))
      (type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::TireMountingRim")) (provenance authored))
      (effective-type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::TireMountingRim")) (source direct))
      (supertype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::TireMountingRim")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::wheel::w::v")))
      (type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::InflationValve")) (provenance authored))
      (effective-type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::InflationValve")) (source direct))
      (supertype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::InflationValve")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::wheel::w::weight")))
      (type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::BalanceWeight")) (provenance authored))
      (effective-type (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::BalanceWeight")) (source direct))
      (supertype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::BalanceWeight")) (scopes any))
    )
)
~~~
# NAVIGATION
