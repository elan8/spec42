...
(types
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::WheelAssembly::inflationPressure")))
      (supertype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::pressure")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly")))
    ...
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::lugBoltJoints::mountingHole")))
      ...
      (supertype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::wheel::w::mountingHoles")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::lugBoltJoints::threadedHole")))
      (supertype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::LugBoltThreadableHole")) (scopes any))
      (supertype (node (document "memory://snapshot/wheel_package_updated.md") (qualified-name "Wheel Package - Updated::wheelHubAssembly::hub::h")) (scopes any))
    )
