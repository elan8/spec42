...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/constraint_test.md") (anonymous (kind constraint) (ordinal 0))))) (kind constraint) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "mass"))))
