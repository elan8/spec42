...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/constraint_test.md") (qualified-name "ConstraintTest::vehicle2b::massAnalysis2::componentMasses"))) (kind parameter) (membership (kind feature) (visibility default)))
