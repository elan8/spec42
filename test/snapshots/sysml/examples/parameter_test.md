...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/parameter_test.md") (path (name "ParameterTest") (name "F") (anonymous (kind parameter) (ordinal 0)))))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "ScalarValues::Integer"))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/parameter_test.md") (path (name "ParameterTest") (name "F") (anonymous (kind parameter) (ordinal 0)))))) (kind featureTyping) (ordinal 0))
...
(navigation
  ...
  (query (document "memory://snapshot/parameter_test.md") (range (start 8 64) (end 8 85)) (probe (position 8 64))
    (reference (id (source (node (document "memory://snapshot/parameter_test.md") (path (name "ParameterTest") (name "F") (anonymous (kind parameter) (ordinal 0)))))) (kind featureTyping) (ordinal 0) (authored-target "ScalarValues::Integer")
      (outcome (status unresolved)))
  )
