  ...
  (document "memory://snapshot/server_sequence_outside_realization_3.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (code "unsupported_part_usage_member")
        (source "semantic")
        (range (start 130 3) (end 130 66))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_part_usage_member")
        (source "semantic")
        (range (start 131 3) (end 131 63))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_part_usage_member")
        (source "semantic")
        (range (start 132 3) (end 132 63))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_reference")
      ...
      (diagnostic
        ...
        (code "unsupported_part_usage_member")
        (source "semantic")
        (range (start 136 3) (end 136 66))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_part_usage_member")
        (source "semantic")
        (range (start 137 3) (end 137 63))
      )
    )
  )
)
