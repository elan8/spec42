...
(types
    ...
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CartesianCurrentDisplacementOf::clock")))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CurrentDisplacementOf::clock")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CartesianCurrentDisplacementOf::displacementVector")))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CurrentDisplacementOf::displacementVector")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CartesianCurrentDisplacementOf::frame")))
      ...
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CurrentDisplacementOf::frame")) (scopes any))
    ...
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CartesianCurrentDisplacementOf::point1")))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CurrentDisplacementOf::point1")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CartesianCurrentDisplacementOf::point2")))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CurrentDisplacementOf::point2")) (scopes any))
    )
    ...
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CartesianCurrentPositionOf::clock")))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CurrentPositionOf::clock")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CartesianCurrentPositionOf::frame")))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CartesianSpatialFrame")) (scopes any))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CurrentPositionOf::frame")) (scopes any))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::SpatialFrame")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CartesianCurrentPositionOf::point")))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CurrentPositionOf::point")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CartesianCurrentPositionOf::positionVector")))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CurrentPositionOf::positionVector")) (scopes any))
    )
    ...
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CartesianDisplacementOf::clock")))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::DisplacementOf::clock")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CartesianDisplacementOf::displacementVector")))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::DisplacementOf::displacementVector")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CartesianDisplacementOf::frame")))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CartesianSpatialFrame")) (scopes any))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::DisplacementOf::frame")) (scopes any))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::SpatialFrame")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CartesianDisplacementOf::point1")))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::DisplacementOf::point1")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CartesianDisplacementOf::point2")))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::DisplacementOf::point2")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CartesianDisplacementOf::time")))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::DisplacementOf::time")) (scopes any))
    )
    ...
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CartesianPositionOf::clock")))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::PositionOf::clock")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CartesianPositionOf::frame")))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CartesianSpatialFrame")) (scopes any))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::PositionOf::frame")) (scopes any))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::SpatialFrame")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CartesianPositionOf::point")))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::PositionOf::point")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CartesianPositionOf::positionVector")))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::PositionOf::positionVector")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::CartesianPositionOf::time")))
      (supertype (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::PositionOf::time")) (scopes any))
    )
