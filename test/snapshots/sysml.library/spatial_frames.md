...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::DisplacementOf::zeroDisplacementConstraint"))) (kind kerml-invariant) (membership (kind feature) (visibility default)))
    ...
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::PositionOf::positionTimePrecondition"))) (kind kerml-invariant) (membership (kind feature) (visibility default)))
    ...
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::PositionOf::spacePositionConstraint"))) (kind kerml-invariant) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (memberAccessOperand (reference "frame::spaceShots")) (typeCheckTarget (reference "Point"))))
