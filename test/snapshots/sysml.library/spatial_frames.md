...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::PositionOf::spacePositionConstraint"))) (kind kerml-invariant) (membership (kind feature) (visibility default)))
