...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::DisplacementOf::zeroDisplacementConstraint"))) (kind kerml-invariant) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "point2")) (expressionOperand (reference "point1")) (expressionOperand (reference "displacementVector")) (memberAccessOperand (reference "point1::spaceTimeEnclosedOccurrences")) (memberAccessOperand (reference "point2::spaceTimeEnclosedOccurrences")) (invocationCallee (reference "isZeroVector"))))
    ...
    (declaration (id (node (document "memory://snapshot/spatial_frames.md") (qualified-name "SpatialFrames::PositionOf::positionTimePrecondition"))) (kind kerml-invariant) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "time")) (expressionOperand (reference "time")) (memberAccessOperand (reference "point::startShot")) (memberAccessOperand (reference "point::endShot")) (invocationCallee (reference "TimeOf")) (invocationCallee (reference "TimeOf"))))
