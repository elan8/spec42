...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerAfter::clock"))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction in) (multiplicity (lower 1) (upper 1))) (documentation (doc (text "\n\t\t\t * The Clock to be used as the reference for the time delay. The default is\n\t\t\t * the localClock, which will be bound when the function is invoked. \n\t\t\t "))) (feature-value (kind bind) (default true) (operator false)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Clock") (direction in)) (expressionOperand (reference "localClock")))))
    (declaration (id (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerAfter::delay"))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction in) (multiplicity (lower 1) (upper 1))) (documentation (doc (text "\n\t\t\t * The time duration, relative to the clock, after which the TimeSignal is sent.\n\t\t\t "))) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "NumericalValue") (direction in)))))
    (declaration (id (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerAfter::monitor"))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction in) (multiplicity (lower 1) (upper 1))) (documentation (doc (text "\n\t\t\t * The ChangeMonitor to be used to monitor the TimeSignal condition.\n\t\t\t * The default is the Observation::defaultMonitor.\n\t\t\t "))) (feature-value (kind bind) (default true) (operator false)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "ChangeMonitor") (direction in)) (expressionOperand (reference "defaultMonitor")))))
    (declaration (id (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerAfter::receiver"))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction in) (multiplicity (lower 1) (upper 1))) (documentation (doc (text "\n\t\t\t * The Occurrence to which the TimeSignal is to be sent.\n\t\t\t "))) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Occurrence") (direction in)))))
    ...
    (declaration (id (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerAt::clock"))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction in) (multiplicity (lower 1) (upper 1))) (documentation (doc (text "\n\t\t\t * The Clock to be used as the reference for the timeInstant. The default is\n\t\t\t * the localClock, which will be bound when the function is invoked. \n\t\t\t "))) (feature-value (kind bind) (default true) (operator false)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Clock") (direction in)) (expressionOperand (reference "localClock")))))
    (declaration (id (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerAt::monitor"))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction in) (multiplicity (lower 1) (upper 1))) (documentation (doc (text "\n\t\t\t * The ChangeMonitor to be used to monitor the TimeSignal condition.\n\t\t\t * The default is the Observation::defaultMonitor.\n\t\t\t "))) (feature-value (kind bind) (default true) (operator false)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "ChangeMonitor") (direction in)) (expressionOperand (reference "defaultMonitor")))))
    (declaration (id (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerAt::receiver"))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction in) (multiplicity (lower 1) (upper 1))) (documentation (doc (text "\n\t\t\t * The Occurrence to which the TimeSignal is to be sent.\n\t\t\t "))) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Occurrence") (direction in)))))
    (declaration (id (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerAt::timeInstant"))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction in) (multiplicity (lower 1) (upper 1))) (documentation (doc (text "\n\t\t\t * The time instant, relative to the clock, at which the TimeSignal should be sent. \n\t\t\t "))) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "NumericalValue") (direction in)))))
    ...
    (declaration (id (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerWhen::condition"))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction in) (multiplicity (lower 1) (upper 1))) (documentation (doc (text "\n\t\t\t * The BooleanExpression to be monitored for changing from \n\t\t\t * false to true.\n\t\t "))))
    (declaration (id (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerWhen::monitor"))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction in) (multiplicity (lower 1) (upper 1))) (documentation (doc (text "\n\t\t\t * The ChangeMonitor to be used to monitor the ChangeSignal condition.\n\t\t\t * The default is the Observation::defaultMonitor.\n\t\t\t "))) (feature-value (kind bind) (default true) (operator false)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "ChangeMonitor") (direction in)) (expressionOperand (reference "defaultMonitor")))))
    (declaration (id (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerWhen::receiver"))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction in) (multiplicity (lower 1) (upper 1))) (documentation (doc (text "\n\t\t\t * The Occurrence to which the ChangeSignal is to be sent.\n\t\t\t "))) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Occurrence") (direction in)))))
  )
  (references
