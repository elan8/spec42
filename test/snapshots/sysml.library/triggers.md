...
(semantic-model
  ...
  (evaluation
    ...
    (evaluated (declaration (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-function) (name "TriggerAt")) (anonymous (kind kerml-step) (ordinal 0)) (named (kind parameter) (name "observer")))))) (value (kind non-constant)))
    (evaluated (declaration (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-function) (name "TriggerAt")) (anonymous (kind kerml-step) (ordinal 0)) (named (kind parameter) (name "signal")))))) (value (kind non-constant)))
    ...
    (evaluated (declaration (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-function) (name "TriggerWhen")) (anonymous (kind kerml-step) (ordinal 0)) (named (kind parameter) (name "observer")))))) (value (kind non-constant)))
    (evaluated (declaration (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-function) (name "TriggerWhen")) (anonymous (kind kerml-step) (ordinal 0)) (named (kind parameter) (name "signal")))))) (value (kind non-constant)))
