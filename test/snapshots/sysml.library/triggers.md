...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TimeSignal"))) (kind kerml-classifier) (membership (kind owning) (visibility default)) (documentation (doc (text "\n\t\t * A TimeSignal is a ChangeSignal whose condition is the currentTime\n\t\t * of a given Clock reaching a specific signalTime.\n\t\t "))) (authored (membership (kind owning) (visibility default)) (relationships (specialization (reference "ChangeSignal"))))
    (declaration (id (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TimeSignal")) (anonymous (kind kerml-feature) (ordinal 0)))))) (kind kerml-feature) (membership (kind feature) (visibility private)) (documentation (doc (text "\n\t\t\t * The Boolean condition of the currentTime of the signalClock being\n\t\t\t * equal to the signalTime.\n\t\t\t "))) (authored (membership (kind feature) (visibility private)) (relationships (redefinition (reference "signalCondition")) (expressionOperand (reference "signalTime")) (memberAccessOperand (reference "signalClock::currentTime"))))
    ...
    (declaration (id (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerAfter"))) (kind kerml-classifier) (membership (kind owning) (visibility default)) (documentation (doc (text "\n\t\t * TriggerAfter returns a monitored TimeSignal to be sent to a receiver after\n\t\t * a certain time delay relative to a given Clock.\n\t\t "))))
    ...
    (declaration (id (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerAt"))) (kind kerml-classifier) (membership (kind owning) (visibility default)) (documentation (doc (text "\n\t\t * TriggerAt returns a monitored TimeSignal to be sent to a receiver when\n\t\t * the currentTime of a given Clock reaches a specific timeInstant. \n\t\t "))))
    (declaration (id (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerAt")) (anonymous (kind kerml-feature) (ordinal 0)))))) (kind kerml-feature) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (subsetting (reference "monitor::startObservation"))))
    (declaration (id (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerAt")) (anonymous (kind kerml-feature) (ordinal 0)) (named (kind parameter) (name "observer")))))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction in)) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "receiver"))))
    (declaration (id (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerAt")) (anonymous (kind kerml-feature) (ordinal 0)) (named (kind parameter) (name "signal")))))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction in)) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "timeSignal"))))
    ...
    (declaration (id (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerWhen"))) (kind kerml-classifier) (membership (kind owning) (visibility default)) (documentation (doc (text "\n\t\t * TriggerWhen returns a monitored ChangeSignal for a given condition,\n\t\t * to be sent to a given receiver when the condition occurs.\n\t\t "))))
    (declaration (id (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerWhen")) (anonymous (kind kerml-feature) (ordinal 0)))))) (kind kerml-feature) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (subsetting (reference "monitor::startObservation"))))
    (declaration (id (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerWhen")) (anonymous (kind kerml-feature) (ordinal 0)) (named (kind parameter) (name "observer")))))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction in)) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "receiver"))))
    (declaration (id (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerWhen")) (anonymous (kind kerml-feature) (ordinal 0)) (named (kind parameter) (name "signal")))))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction in)) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "changeSignal"))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TimeSignal"))) (kind specialization) (ordinal 0))
      ...
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TimeSignal")) (anonymous (kind kerml-feature) (ordinal 0)))))) (kind redefinition) (ordinal 0))
      (authored-target "signalCondition")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TimeSignal")) (anonymous (kind kerml-feature) (ordinal 0)))))) (kind expressionOperand) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TimeSignal")) (anonymous (kind kerml-feature) (ordinal 0)))))) (kind memberAccessOperand) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerAt")) (anonymous (kind kerml-feature) (ordinal 0)))))) (kind subsetting) (ordinal 0))
      (authored-target "monitor::startObservation")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerAt")) (anonymous (kind kerml-feature) (ordinal 0)) (named (kind parameter) (name "observer")))))) (kind expressionOperand) (ordinal 0))
      (authored-target "receiver")
      (outcome (status resolved) (target (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerAt::receiver")))))
    (reference (id (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerAt")) (anonymous (kind kerml-feature) (ordinal 0)) (named (kind parameter) (name "signal")))))) (kind expressionOperand) (ordinal 0))
      (authored-target "timeSignal")
    ...
    (reference (id (source (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerAt::timeSignal"))) (kind invocationCallee) (ordinal 0))
      (authored-target "TimeSignal")
      (outcome (status resolved) (target (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TimeSignal")))))
    (reference (id (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerWhen")) (anonymous (kind kerml-feature) (ordinal 0)))))) (kind subsetting) (ordinal 0))
      (authored-target "monitor::startObservation")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerWhen")) (anonymous (kind kerml-feature) (ordinal 0)) (named (kind parameter) (name "observer")))))) (kind expressionOperand) (ordinal 0))
      (authored-target "receiver")
      (outcome (status resolved) (target (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerWhen::receiver")))))
    (reference (id (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerWhen")) (anonymous (kind kerml-feature) (ordinal 0)) (named (kind parameter) (name "signal")))))) (kind expressionOperand) (ordinal 0))
      (authored-target "changeSignal")
  ...
  (relationships
    (relationship (kind expressionOperand) (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TimeSignal")) (anonymous (kind kerml-feature) (ordinal 0)))))) (target (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TimeSignal::signalTime"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TimeSignal")) (anonymous (kind kerml-feature) (ordinal 0)))))) (kind expressionOperand) (ordinal 0)))
    ...
    (relationship (kind expressionOperand) (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerAt")) (anonymous (kind kerml-feature) (ordinal 0)) (named (kind parameter) (name "observer")))))) (target (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerAt::receiver"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerAt")) (anonymous (kind kerml-feature) (ordinal 0)) (named (kind parameter) (name "observer")))))) (kind expressionOperand) (ordinal 0)))
    (relationship (kind expressionOperand) (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerAt")) (anonymous (kind kerml-feature) (ordinal 0)) (named (kind parameter) (name "signal")))))) (target (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerAt::timeSignal"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerAt")) (anonymous (kind kerml-feature) (ordinal 0)) (named (kind parameter) (name "signal")))))) (kind expressionOperand) (ordinal 0)))
    ...
    (relationship (kind expressionOperand) (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerWhen")) (anonymous (kind kerml-feature) (ordinal 0)) (named (kind parameter) (name "observer")))))) (target (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerWhen::receiver"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerWhen")) (anonymous (kind kerml-feature) (ordinal 0)) (named (kind parameter) (name "observer")))))) (kind expressionOperand) (ordinal 0)))
    (relationship (kind expressionOperand) (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerWhen")) (anonymous (kind kerml-feature) (ordinal 0)) (named (kind parameter) (name "signal")))))) (target (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerWhen::changeSignal"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerWhen")) (anonymous (kind kerml-feature) (ordinal 0)) (named (kind parameter) (name "signal")))))) (kind expressionOperand) (ordinal 0)))
  ...
  (evaluation
    ...
    (evaluated (declaration (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerAt")) (anonymous (kind kerml-feature) (ordinal 0)) (named (kind parameter) (name "observer")))))) (value (kind non-constant)))
    (evaluated (declaration (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerAt")) (anonymous (kind kerml-feature) (ordinal 0)) (named (kind parameter) (name "signal")))))) (value (kind non-constant)))
    ...
    (evaluated (declaration (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerWhen")) (anonymous (kind kerml-feature) (ordinal 0)) (named (kind parameter) (name "observer")))))) (value (kind non-constant)))
    (evaluated (declaration (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerWhen")) (anonymous (kind kerml-feature) (ordinal 0)) (named (kind parameter) (name "signal")))))) (value (kind non-constant)))
...
(navigation
  ...
  (query (document "memory://snapshot/triggers.md") (range (start 36 19) (end 36 34)) (probe (position 36 19))
    (reference (id (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TimeSignal")) (anonymous (kind kerml-feature) (ordinal 0)))))) (kind redefinition) (ordinal 0) (authored-target "signalCondition")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/triggers.md") (range (start 43 30) (end 43 40)) (probe (position 43 30))
    (reference (id (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TimeSignal")) (anonymous (kind kerml-feature) (ordinal 0)))))) (kind expressionOperand) (ordinal 0) (authored-target "signalTime")
      (outcome (status resolved) (target (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TimeSignal::signalTime")))))
  )
  (query (document "memory://snapshot/triggers.md") (range (start 43 3) (end 43 26)) (probe (position 43 3))
    (reference (id (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TimeSignal")) (anonymous (kind kerml-feature) (ordinal 0)))))) (kind memberAccessOperand) (ordinal 0) (authored-target "signalClock::currentTime")
      (outcome (status unresolved)))
  )
  ...
  (query (document "memory://snapshot/triggers.md") (range (start 134 10) (end 134 34)) (probe (position 134 10))
    (reference (id (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerAt")) (anonymous (kind kerml-feature) (ordinal 0)))))) (kind subsetting) (ordinal 0) (authored-target "monitor::startObservation")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/triggers.md") (range (start 135 17) (end 135 25)) (probe (position 135 17))
    (reference (id (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerAt")) (anonymous (kind kerml-feature) (ordinal 0)) (named (kind parameter) (name "observer")))))) (kind expressionOperand) (ordinal 0) (authored-target "receiver")
      (outcome (status resolved) (target (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerAt::receiver")))))
  )
  (query (document "memory://snapshot/triggers.md") (range (start 136 15) (end 136 25)) (probe (position 136 15))
    (reference (id (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerAt")) (anonymous (kind kerml-feature) (ordinal 0)) (named (kind parameter) (name "signal")))))) (kind expressionOperand) (ordinal 0) (authored-target "timeSignal")
      (outcome (status resolved) (target (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerAt::timeSignal")))))
  )
  ...
  (query (document "memory://snapshot/triggers.md") (range (start 84 10) (end 84 34)) (probe (position 84 10))
    (reference (id (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerWhen")) (anonymous (kind kerml-feature) (ordinal 0)))))) (kind subsetting) (ordinal 0) (authored-target "monitor::startObservation")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/triggers.md") (range (start 85 17) (end 85 25)) (probe (position 85 17))
    (reference (id (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerWhen")) (anonymous (kind kerml-feature) (ordinal 0)) (named (kind parameter) (name "observer")))))) (kind expressionOperand) (ordinal 0) (authored-target "receiver")
      (outcome (status resolved) (target (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerWhen::receiver")))))
  )
  (query (document "memory://snapshot/triggers.md") (range (start 86 15) (end 86 27)) (probe (position 86 15))
    (reference (id (source (node (document "memory://snapshot/triggers.md") (path (named (kind library-package) (name "Triggers")) (named (kind kerml-classifier) (name "TriggerWhen")) (anonymous (kind kerml-feature) (ordinal 0)) (named (kind parameter) (name "signal")))))) (kind expressionOperand) (ordinal 0) (authored-target "changeSignal")
      (outcome (status resolved) (target (node (document "memory://snapshot/triggers.md") (qualified-name "Triggers::TriggerWhen::changeSignal")))))
  )
