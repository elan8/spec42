...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/actions.md") (anonymous (kind ref) (ordinal 0))))) (kind ref) (membership (kind feature) (visibility default)) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "acceptedMessage"))))
    ...
    (declaration (id (node (document "memory://snapshot/actions.md") (anonymous (kind parameter) (ordinal 0))))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction inout)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "payload"))))
    ...
    (declaration (id (node (document "memory://snapshot/actions.md") (anonymous (kind bind) (ordinal 0))))) (kind bind) (membership (kind feature) (visibility default)) (documentation (doc (text "\n\t\t\t * A ControlAction is instantaneous.\n\t\t\t "))) (authored (membership (kind feature) (visibility default)) (relationships (bindSource (reference "start")) (bindTarget (reference "done"))))
    ...
    (declaration (id (node (document "memory://snapshot/actions.md") (anonymous (kind parameter) (ordinal 0))))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction in) (multiplicity (lower 0) (upper unbounded))) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "payload"))))
