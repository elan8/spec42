...
(types
    ...
    (declaration (id (node (document "memory://snapshot/actions.md") (path (named (kind library-package) (name "Actions")) (named (kind action-def) (name "AcceptAction")) (anonymous (kind ref) (ordinal 0))))))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::AcceptMessageAction::acceptedMessage")) (scopes any))
    )
    ...
    (declaration (id (node (document "memory://snapshot/actions.md") (qualified-name "Actions::Action::acceptSubactions")))
      ...
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::Action::subactions")) (scopes any))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::acceptActions")) (scopes any))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::actions")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/actions.md") (qualified-name "Actions::Action::assignments")))
      ...
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::actions")) (scopes any))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::assignmentActions")) (scopes any))
    )
    ...
    (declaration (id (node (document "memory://snapshot/actions.md") (qualified-name "Actions::Action::decisionTransitions")))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::Action")) (scopes any))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::Action::subactions")) (scopes any))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::Action::transitions")) (scopes any))
      ...
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::actions")) (scopes any))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::transitionActions")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/actions.md") (qualified-name "Actions::Action::decisions")))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::Action")) (scopes any))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::Action::controls")) (scopes any))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::Action::subactions")) (scopes any))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::ControlAction")) (scopes any))
    ...
    (declaration (id (node (document "memory://snapshot/actions.md") (qualified-name "Actions::Action::forLoops")))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::Action")) (scopes any))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::Action::loops")) (scopes any))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::Action::subactions")) (scopes any))
      ...
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::actions")) (scopes any))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::forLoopActions")) (scopes any))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::loopActions")) (scopes any))
    )
    ...
    (declaration (id (node (document "memory://snapshot/actions.md") (qualified-name "Actions::Action::ifSubactions")))
      ...
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::actions")) (scopes any))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::ifThenActions")) (scopes any))
    )
    ...
    (declaration (id (node (document "memory://snapshot/actions.md") (qualified-name "Actions::Action::sendSubactions")))
      ...
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::actions")) (scopes any))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::sendActions")) (scopes any))
    )
    ...
    (declaration (id (node (document "memory://snapshot/actions.md") (qualified-name "Actions::Action::terminateSubactions")))
      ...
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::actions")) (scopes any))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::terminateActions")) (scopes any))
    )
    ...
    (declaration (id (node (document "memory://snapshot/actions.md") (qualified-name "Actions::Action::whileLoops")))
      ...
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::actions")) (scopes any))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::loopActions")) (scopes any))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::whileLoopActions")) (scopes any))
    )
    ...
    (declaration (id (node (document "memory://snapshot/actions.md") (path (named (kind library-package) (name "Actions")) (named (kind action-def) (name "DecisionTransitionAction")) (anonymous (kind ref) (ordinal 0))))))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::AcceptMessageAction")) (scopes any))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::Action")) (scopes any))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::TransitionAction::accepter")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/actions.md") (path (named (kind library-package) (name "Actions")) (named (kind action-def) (name "DecisionTransitionAction")) (anonymous (kind ref) (ordinal 1))))))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::Action")) (scopes any))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::TransitionAction::effect")) (scopes any))
    )
    ...
    (declaration (id (node (document "memory://snapshot/actions.md") (qualified-name "Actions::ForLoopAction::body")))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::LoopAction::body")) (scopes any))
    )
    ...
    (declaration (id (node (document "memory://snapshot/actions.md") (qualified-name "Actions::IfThenElseAction::ifTest")))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::IfThenAction::ifTest")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/actions.md") (qualified-name "Actions::IfThenElseAction::thenClause")))
      (supertype (node (document "memory://snapshot/actions.md") (qualified-name "Actions::IfThenAction::thenClause")) (scopes any))
    )
