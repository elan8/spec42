...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/actions.md") (qualified-name "Actions::ForLoopAction::var"))) (kind ref) (membership (kind feature) (visibility default)) (documentation (doc (text "\n\t\t\t * The loop variable that is assigned successive elements of seq on each\n\t\t\t * iteration of the loop.\n\t\t\t "))) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "seq")))))
