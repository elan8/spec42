...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/states.md") (anonymous (kind parameter) (ordinal 0))))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction in)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "receiver"))))
