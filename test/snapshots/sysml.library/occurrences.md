...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/occurrences.md") (anonymous (kind kerml-invariant) (ordinal 3))))) (kind kerml-invariant) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (invocationCallee (reference "isEmpty"))))
    ...
    (declaration (id (node (document "memory://snapshot/occurrences.md") (anonymous (kind kerml-invariant) (ordinal 5))))) (kind kerml-invariant) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "isClosed")) (expressionOperand (reference "spaceBoundary")) (expressionOperand (reference "spaceInterior")) (invocationCallee (reference "contains")) (invocationCallee (reference "union"))))
    ...
    (declaration (id (node (document "memory://snapshot/occurrences.md") (anonymous (kind kerml-invariant) (ordinal 7))))) (kind kerml-invariant) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "isClosed")) (invocationCallee (reference "isEmpty"))))
