...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/interfaces.md") (anonymous (kind ref) (ordinal 0))))) (kind ref) (membership (kind feature) (visibility default)) (facts (modifiers ordered nonunique) (multiplicity (lower 2) (upper 2))) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "Interface::participant")) (redefinition (reference "BinaryConnection::participant"))))
