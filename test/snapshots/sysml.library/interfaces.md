  ...
  (document "memory://snapshot/interfaces.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (source "semantic")
        (range (start 44 8) (end 54 9))
      )
      (diagnostic
        (severity error)
        (code "unexpected_keyword_in_scope")
        (source "parser")
        (range (start 51 12) (end 52 12))
      )
      (diagnostic
        (severity error)
        (code "unexpected_keyword_in_scope")
        (source "parser")
        (range (start 52 12) (end 54 8))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_specializes_reference")
...
(semantic-model
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/interfaces.md") (qualified-name "Interfaces::excludingOnce"))) (kind expressionOperand) (ordinal 1))
      ...
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/interfaces.md") (qualified-name "Interfaces::excludingOnce"))) (kind expressionOperand) (ordinal 2))
...
(navigation
  ...
  (query (document "memory://snapshot/interfaces.md") (range (start 28 8) (end 28 15)) (probe (position 28 8))
    (reference (id (source (node (document "memory://snapshot/interfaces.md") (qualified-name "Interfaces::excludingOnce"))) (kind expressionOperand) (ordinal 0) (authored-target "private")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/interfaces.md") (range (start 28 16) (end 28 25)) (probe (position 28 16))
    (reference (id (source (node (document "memory://snapshot/interfaces.md") (qualified-name "Interfaces::excludingOnce"))) (kind expressionOperand) (ordinal 1) (authored-target "attribute")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/interfaces.md") (range (start 28 26) (end 28 34)) (probe (position 28 26))
    (reference (id (source (node (document "memory://snapshot/interfaces.md") (qualified-name "Interfaces::excludingOnce"))) (kind expressionOperand) (ordinal 2) (authored-target "position")
      (outcome (status unresolved)))
  )
