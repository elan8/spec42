...
(semantic-model
  ...
  (evaluation
    ...
    (evaluated (declaration (node (document "memory://snapshot/measurement_references.md") (qualified-name "MeasurementReferences::MeasurementUnit::hasValidUnitPowerFactors::unitPowerFactors"))) (value (kind unresolved-operand)))
