...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/measurement_references.md") (anonymous (kind constraint) (ordinal 0))))) (kind constraint) (membership (kind feature) (visibility default)))
