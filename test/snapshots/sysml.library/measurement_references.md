...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/measurement_references.md") (qualified-name "MeasurementReferences::MeasurementUnit::hasValidUnitPowerFactors::quantityDimension"))) (kind parameter) (membership (kind feature) (visibility default)))
    (declaration (id (node (document "memory://snapshot/measurement_references.md") (qualified-name "MeasurementReferences::MeasurementUnit::hasValidUnitPowerFactors::unitPowerFactors"))) (kind parameter) (membership (kind feature) (visibility default)))
