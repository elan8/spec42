...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/measurement_references.md") (qualified-name "MeasurementReferences::CoordinateFramePlacement::validateBasisDirections"))) (kind constraint) (membership (kind feature) (visibility default)))
