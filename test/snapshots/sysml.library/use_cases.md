...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/use_cases.md") (qualified-name "UseCases::UseCase::subUseCases"))) (kind use-case) (membership (kind feature) (visibility default)) (facts (modifiers abstract)) (documentation (doc (text "\n\t\t\t * Other UseCases carried out as part of the performance of this UseCase.\n\t\t\t "))) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "UseCase")))))
