  ...
  (document "memory://snapshot/isq_chemistry_molecular.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (source "semantic")
        (range (start 42 4) (end 42 54))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 43 4) (end 43 56))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 44 4) (end 44 46))
      )
      (diagnostic
        (severity warning)
      ...
      (diagnostic
        ...
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 1028 4) (end 1028 38))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_specializes_reference")
      ...
      (diagnostic
        ...
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 1207 4) (end 1207 56))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_specializes_reference")
      ...
      (diagnostic
        ...
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 1282 4) (end 1282 64))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_type_reference")
...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness unsupported-syntax) (has-evaluation false) (source-digest "blake3:1b76a845b58c298bff89a5b6d72efefad50ebee987087f13acb3359c94d98132") (contract-version "parser-owned-resolution-v1"))
  (declarations
