  ...
  (document "memory://snapshot/items.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (code "unsupported_attribute_member")
        (source "semantic")
        (range (start 85 4) (end 85 27))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_constraint_definition_member")
        (source "semantic")
        (range (start 87 24) (end 87 83))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_reference")
      ...
      (diagnostic
        ...
        (code "unsupported_attribute_member")
        (source "semantic")
        (range (start 90 4) (end 90 27))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_constraint_definition_member")
        (source "semantic")
        (range (start 92 24) (end 93 66))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_reference")
...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 0))))) (kind constraint) (membership (kind feature) (visibility default)))
    (declaration (id (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 0))))) (kind constraint) (membership (kind feature) (visibility default)))
    ...
    (declaration (id (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 1))))) (kind constraint) (membership (kind feature) (visibility default)))
