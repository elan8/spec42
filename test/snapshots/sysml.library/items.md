...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/items.md") (qualified-name "Items::Item::boundingShapes::::inter"))) (kind item) (membership (kind feature) (visibility default)) (facts (multiplicity (lower 1) (upper 1))))
    (declaration (id (node (document "memory://snapshot/items.md") (qualified-name "Items::Item::boundingShapes::::inter"))) (kind item) (membership (kind feature) (visibility default)) (facts (multiplicity (lower 1) (upper 1))))
    ...
    (declaration (id (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 0))))) (kind constraint) (membership (kind feature) (visibility default)) (documentation (doc (text " \n                 * Enables two dimensional items to be enveloped by two or three dimensional shapes.\n                 "))) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "innerSpaceDimension")) (memberAccessOperand (reference "envelopedItem::innerSpaceDimension")) (memberAccessOperand (reference "envelopedItem::outerSpaceDimension")) (memberAccessOperand (reference "envelopedItem::outerSpaceDimension"))))
    (declaration (id (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 1))))) (kind constraint) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "outerSpaceDimension")) (memberAccessOperand (reference "that::innerSpaceDimension")) (invocationCallee (reference "notEmpty"))))
    (declaration (id (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 2))))) (kind constraint) (membership (kind feature) (visibility default)) (documentation (doc (text " \n\t\t\t\t * This constraint prevents an envelopingShape from being a portion.\n\t\t\t\t "))) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "that")) (memberAccessOperand (reference "envelopingItem::shape::spaceTimeCoincidentOccurrences")) (memberAccessOperand (reference "envelopingItem::spaceTimeEnclosedOccurrences")) (memberAccessOperand (reference "that::that"))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 1))))) (kind expressionOperand) (ordinal 0))
      ...
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 2))))) (kind expressionOperand) (ordinal 0))
      (authored-target "that")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 0))))) (kind memberAccessOperand) (ordinal 0))
      (authored-target "envelopedItem::innerSpaceDimension")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 1))))) (kind memberAccessOperand) (ordinal 0))
      (authored-target "that::innerSpaceDimension")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 2))))) (kind memberAccessOperand) (ordinal 0))
      (authored-target "envelopingItem::shape::spaceTimeCoincidentOccurrences")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 0))))) (kind memberAccessOperand) (ordinal 1))
      (authored-target "envelopedItem::outerSpaceDimension")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 2))))) (kind memberAccessOperand) (ordinal 1))
      (authored-target "envelopingItem::spaceTimeEnclosedOccurrences")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 0))))) (kind memberAccessOperand) (ordinal 2))
      (authored-target "envelopedItem::outerSpaceDimension")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 2))))) (kind memberAccessOperand) (ordinal 2))
...
(navigation
  ...
  (query (document "memory://snapshot/items.md") (range (start 70 66) (end 70 70)) (probe (position 70 66))
    (reference (id (source (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 2))))) (kind expressionOperand) (ordinal 0) (authored-target "that")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/items.md") (range (start 57 12) (end 57 45)) (probe (position 57 12))
    (reference (id (source (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 0))))) (kind memberAccessOperand) (ordinal 0) (authored-target "envelopedItem::innerSpaceDimension")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/items.md") (range (start 60 23) (end 60 57)) (probe (position 60 23))
    (reference (id (source (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 1))))) (kind memberAccessOperand) (ordinal 0) (authored-target "that::innerSpaceDimension")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/items.md") (range (start 70 4) (end 70 55)) (probe (position 70 4))
    (reference (id (source (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 2))))) (kind memberAccessOperand) (ordinal 0) (authored-target "envelopingItem::shape::spaceTimeCoincidentOccurrences")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/items.md") (range (start 57 54) (end 57 87)) (probe (position 57 54))
    (reference (id (source (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 0))))) (kind memberAccessOperand) (ordinal 1) (authored-target "envelopedItem::outerSpaceDimension")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/items.md") (range (start 71 4) (end 71 47)) (probe (position 71 4))
    (reference (id (source (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 2))))) (kind memberAccessOperand) (ordinal 1) (authored-target "envelopingItem::spaceTimeEnclosedOccurrences")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/items.md") (range (start 58 13) (end 58 46)) (probe (position 58 13))
    (reference (id (source (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 0))))) (kind memberAccessOperand) (ordinal 2) (authored-target "envelopedItem::outerSpaceDimension")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/items.md") (range (start 71 58) (end 71 67)) (probe (position 71 58))
    (reference (id (source (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 2))))) (kind memberAccessOperand) (ordinal 2) (authored-target "that::that")
      (outcome (status unresolved)))
  )
