...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 0))))) (kind constraint) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "innerSpaceDimension")) (memberAccessOperand (reference "envelopedItem::innerSpaceDimension")) (memberAccessOperand (reference "envelopedItem::outerSpaceDimension")) (memberAccessOperand (reference "envelopedItem::outerSpaceDimension"))))
    ...
    (declaration (id (node (document "memory://snapshot/items.md") (anonymous (kind constraint) (ordinal 2))))) (kind constraint) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "that")) (memberAccessOperand (reference "envelopingItem::shape::spaceTimeCoincidentOccurrences")) (memberAccessOperand (reference "envelopingItem::spaceTimeEnclosedOccurrences")) (memberAccessOperand (reference "that::that"))))
    ...
    (declaration (id (node (document "memory://snapshot/items.md") (qualified-name "Items::Item::subitems"))) (kind item) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Item"))))
    ...
    (declaration (id (node (document "memory://snapshot/items.md") (qualified-name "Items::items"))) (kind item) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Item"))))
  )
  (references
