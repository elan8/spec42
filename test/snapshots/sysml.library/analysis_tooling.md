...
(semantic-model
  ...
  (declarations
    (declaration (id (node (document "memory://snapshot/analysis_tooling.md") (qualified-name "AnalysisTooling"))) (kind library-package) (membership (kind owning) (visibility default)))
    ...
    (declaration (id (node (document "memory://snapshot/analysis_tooling.md") (qualified-name "AnalysisTooling::ToolExecution"))) (kind metadata-def) (membership (kind owning) (visibility default)))
    ...
    (declaration (id (node (document "memory://snapshot/analysis_tooling.md") (qualified-name "AnalysisTooling::ToolVariable"))) (kind metadata-def) (membership (kind owning) (visibility default)))
