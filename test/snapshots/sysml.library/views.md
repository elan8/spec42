  ...
  (document "memory://snapshot/views.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (source "semantic")
        (range (start 12 1) (end 50 2))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 52 1) (end 61 2))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 63 1) (end 77 2))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_package_member")
      ...
      (diagnostic
        ...
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 86 1) (end 91 2))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 93 1) (end 98 2))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 100 1) (end 105 2))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_package_member")
