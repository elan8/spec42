...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/views.md") (anonymous (kind rendering) (ordinal 0))))) (kind rendering) (membership (kind feature) (visibility default)) (facts (multiplicity (lower 0) (upper unbounded))) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "subrenderings"))))
