...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/spatial_items.md") (anonymous (kind attribute) (ordinal 0))))) (kind attribute) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "mRefs")) (memberAccessOperand (reference "that::that::coordinateFrame::mRefs"))))
    ...
    (declaration (id (node (document "memory://snapshot/spatial_items.md") (anonymous (kind attribute) (ordinal 0))))) (kind attribute) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "source")) (memberAccessOperand (reference "that::that::that::coordinateFrame"))))
