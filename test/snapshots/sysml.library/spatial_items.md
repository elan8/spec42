  ...
  (document "memory://snapshot/spatial_items.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (code "unresolved_reference")
        (source "semantic")
        (range (start 113 9) (end 113 23))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_calc_definition_member")
        (source "semantic")
        (range (start 113 24) (end 116 1))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_specializes_reference")
      ...
      (diagnostic
        ...
        (code "unresolved_reference")
        (source "semantic")
        (range (start 128 9) (end 128 23))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_calc_definition_member")
        (source "semantic")
        (range (start 128 24) (end 131 1))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_specializes_reference")
      ...
      (diagnostic
        ...
        (code "unresolved_reference")
        (source "semantic")
        (range (start 146 9) (end 146 27))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_calc_definition_member")
        (source "semantic")
        (range (start 146 28) (end 149 1))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_specializes_reference")
      ...
      (diagnostic
        ...
        (code "unresolved_reference")
        (source "semantic")
        (range (start 162 9) (end 162 27))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_calc_definition_member")
        (source "semantic")
        (range (start 162 28) (end 165 1))
      )
    )
  )
)
...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/spatial_items.md") (qualified-name "SpatialItems::CurrentDisplacementOf"))) (kind calc-def) (membership (kind owning) (visibility default)) (authored (membership (kind owning) (visibility default)) (relationships (specialization (reference "SpatialFrames::CurrentDisplacementOf")) (expressionOperand (reference "displacementVector"))))
    ...
    (declaration (id (node (document "memory://snapshot/spatial_items.md") (qualified-name "SpatialItems::CurrentPositionOf"))) (kind calc-def) (membership (kind owning) (visibility default)) (authored (membership (kind owning) (visibility default)) (relationships (specialization (reference "SpatialFrames::CurrentPositionOf")) (expressionOperand (reference "positionVector"))))
    ...
    (declaration (id (node (document "memory://snapshot/spatial_items.md") (qualified-name "SpatialItems::DisplacementOf"))) (kind calc-def) (membership (kind owning) (visibility default)) (authored (membership (kind owning) (visibility default)) (relationships (specialization (reference "SpatialFrames::DisplacementOf")) (expressionOperand (reference "displacementVector"))))
    ...
    (declaration (id (node (document "memory://snapshot/spatial_items.md") (qualified-name "SpatialItems::PositionOf"))) (kind calc-def) (membership (kind owning) (visibility default)) (authored (membership (kind owning) (visibility default)) (relationships (specialization (reference "SpatialFrames::PositionOf")) (expressionOperand (reference "positionVector"))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/spatial_items.md") (qualified-name "SpatialItems::CurrentDisplacementOf"))) (kind specialization) (ordinal 0))
      ...
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/spatial_items.md") (qualified-name "SpatialItems::CurrentDisplacementOf"))) (kind expressionOperand) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/spatial_items.md") (qualified-name "SpatialItems::CurrentPositionOf"))) (kind specialization) (ordinal 0))
      ...
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/spatial_items.md") (qualified-name "SpatialItems::CurrentPositionOf"))) (kind expressionOperand) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/spatial_items.md") (qualified-name "SpatialItems::DisplacementOf"))) (kind specialization) (ordinal 0))
      ...
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/spatial_items.md") (qualified-name "SpatialItems::DisplacementOf"))) (kind expressionOperand) (ordinal 0))
      (authored-target "displacementVector")
      (outcome (status unresolved)))
    ...
    (reference (id (source (node (document "memory://snapshot/spatial_items.md") (qualified-name "SpatialItems::PositionOf"))) (kind specialization) (ordinal 0))
      ...
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/spatial_items.md") (qualified-name "SpatialItems::PositionOf"))) (kind expressionOperand) (ordinal 0))
      (authored-target "positionVector")
      (outcome (status unresolved)))
...
(navigation
  ...
  (query (document "memory://snapshot/spatial_items.md") (range (start 162 9) (end 162 27)) (probe (position 162 9))
    (reference (id (source (node (document "memory://snapshot/spatial_items.md") (qualified-name "SpatialItems::CurrentDisplacementOf"))) (kind expressionOperand) (ordinal 0) (authored-target "displacementVector")
      (outcome (status unresolved)))
  )
  ...
  (query (document "memory://snapshot/spatial_items.md") (range (start 128 9) (end 128 23)) (probe (position 128 9))
    (reference (id (source (node (document "memory://snapshot/spatial_items.md") (qualified-name "SpatialItems::CurrentPositionOf"))) (kind expressionOperand) (ordinal 0) (authored-target "positionVector")
      (outcome (status unresolved)))
  )
  ...
  (query (document "memory://snapshot/spatial_items.md") (range (start 146 9) (end 146 27)) (probe (position 146 9))
    (reference (id (source (node (document "memory://snapshot/spatial_items.md") (qualified-name "SpatialItems::DisplacementOf"))) (kind expressionOperand) (ordinal 0) (authored-target "displacementVector")
      (outcome (status unresolved)))
  )
  ...
  (query (document "memory://snapshot/spatial_items.md") (range (start 113 9) (end 113 23)) (probe (position 113 9))
    (reference (id (source (node (document "memory://snapshot/spatial_items.md") (qualified-name "SpatialItems::PositionOf"))) (kind expressionOperand) (ordinal 0) (authored-target "positionVector")
      (outcome (status unresolved)))
  )
