...
(semantic-model
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/spatial_items.md") (qualified-name "SpatialItems::SpatialItem::cunionNum"))) (kind featureTyping) (ordinal 0))
      ...
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/spatial_items.md") (qualified-name "SpatialItems::SpatialItem::cunionNum"))) (kind expressionOperand) (ordinal 0))
      (authored-target "componentItems")
      (outcome (status resolved) (target (node (document "memory://snapshot/spatial_items.md") (qualified-name "SpatialItems::SpatialItem::componentItems")))))
    (reference (id (source (node (document "memory://snapshot/spatial_items.md") (qualified-name "SpatialItems::SpatialItem::cunionNum"))) (kind invocationCallee) (ordinal 0))
...
(navigation
  ...
  (query (document "memory://snapshot/spatial_items.md") (range (start 86 56) (end 86 70)) (probe (position 86 56))
    (reference (id (source (node (document "memory://snapshot/spatial_items.md") (qualified-name "SpatialItems::SpatialItem::cunionNum"))) (kind expressionOperand) (ordinal 0) (authored-target "componentItems")
      (outcome (status resolved) (target (node (document "memory://snapshot/spatial_items.md") (qualified-name "SpatialItems::SpatialItem::componentItems")))))
  )
  (query (document "memory://snapshot/spatial_items.md") (range (start 86 48) (end 86 55)) (probe (position 86 48))
    (reference (id (source (node (document "memory://snapshot/spatial_items.md") (qualified-name "SpatialItems::SpatialItem::cunionNum"))) (kind invocationCallee) (ordinal 0) (authored-target "isEmpty")
      (outcome (status unresolved)))
  )
