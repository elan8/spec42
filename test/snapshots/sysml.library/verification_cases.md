...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/verification_cases.md") (qualified-name "VerificationCases::VerificationCase::subVerificationCases"))) (kind verification) (membership (kind feature) (visibility default)) (facts (modifiers abstract)) (documentation (doc (text "\n\t\t\t * The subcases of this VerificationCase that are VerificationCaseUsages.\n\t\t\t "))) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "VerificationCase")))))
