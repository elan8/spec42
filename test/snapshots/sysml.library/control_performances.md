  ...
  (document "memory://snapshot/control_performances.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (code "unsupported_calc_definition_member")
        (source "semantic")
        (range (start 124 2) (end 124 51))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_calc_definition_member")
        (source "semantic")
        (range (start 125 2) (end 125 50))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_calc_definition_member")
      ...
      (diagnostic
        ...
        (code "unsupported_calc_definition_member")
        (source "semantic")
        (range (start 129 2) (end 129 51))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_calc_definition_member")
        (source "semantic")
        (range (start 130 2) (end 130 74))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_calc_definition_member")
        (source "semantic")
        (range (start 132 2) (end 132 55))
      )
    )
  )
)
