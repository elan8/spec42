...
(semantic-model
  ...
  (evaluation
    ...
    (evaluated (declaration (node (document "memory://snapshot/transfers.md") (path (named (kind library-package) (name "Transfers")) (named (kind kerml-behavior) (name "SendPerformance")) (named (kind kerml-feature) (name "sentTransfer")) (anonymous (kind kerml-feature) (ordinal 0)))))) (value (kind non-constant)))
