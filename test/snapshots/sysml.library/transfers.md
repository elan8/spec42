...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/transfers.md") (qualified-name "Transfers::AcceptPerformance::payload"))) (kind parameter) (membership (kind feature) (visibility default)))
    (declaration (id (node (document "memory://snapshot/transfers.md") (qualified-name "Transfers::AcceptPerformance::receiver"))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Occurrence") (direction in)) (expressionOperand (reference "this"))))
    ...
    (declaration (id (node (document "memory://snapshot/transfers.md") (anonymous (kind kerml-end) (ordinal 0))))) (kind kerml-end) (membership (kind feature) (visibility default)))
    (declaration (id (node (document "memory://snapshot/transfers.md") (anonymous (kind kerml-end) (ordinal 1))))) (kind kerml-end) (membership (kind feature) (visibility default)))
    ...
    (declaration (id (node (document "memory://snapshot/transfers.md") (qualified-name "Transfers::SendPerformance::payload"))) (kind parameter) (membership (kind feature) (visibility default)))
    (declaration (id (node (document "memory://snapshot/transfers.md") (qualified-name "Transfers::SendPerformance::receiver"))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Occurrence") (direction in))))
    (declaration (id (node (document "memory://snapshot/transfers.md") (qualified-name "Transfers::SendPerformance::sender"))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Occurrence") (direction in)) (expressionOperand (reference "this"))))
