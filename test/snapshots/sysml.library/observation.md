...
(semantic-model
  ...
  (evaluation
    ...
    (evaluated (declaration (node (document "memory://snapshot/observation.md") (path (named (kind library-package) (name "Observation")) (named (kind kerml-behavior) (name "ObserveChange")) (named (kind kerml-step) (name "transfer")) (named (kind kerml-feature) (name "source")) (anonymous (kind kerml-feature) (ordinal 0)))))) (value (kind non-constant)))
    (evaluated (declaration (node (document "memory://snapshot/observation.md") (path (named (kind library-package) (name "Observation")) (named (kind kerml-behavior) (name "ObserveChange")) (named (kind kerml-step) (name "wait")) (anonymous (kind parameter) (ordinal 0)))))) (value (kind non-constant)))
  )
)
~~~
# NAVIGATION
