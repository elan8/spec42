...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/transition_performances.md") (anonymous (kind kerml-invariant) (ordinal 0))))) (kind kerml-invariant) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (invocationCallee (reference "allTrue")) (invocationCallee (reference "constrainedGuard"))))
    ...
    (declaration (id (node (document "memory://snapshot/transition_performances.md") (anonymous (kind kerml-binding) (ordinal 0))))) (kind kerml-binding) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (bindSource (reference "transitionLink::earlierOccurrence")) (bindTarget (reference "transitionLinkSource"))))
    (declaration (id (node (document "memory://snapshot/transition_performances.md") (anonymous (kind kerml-connector) (ordinal 0))))) (kind kerml-connector) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (connectorEnd (reference "transitionLink")) (connectorEnd (reference "trigger"))))
    (declaration (id (node (document "memory://snapshot/transition_performances.md") (anonymous (kind kerml-binding) (ordinal 1))))) (kind kerml-binding) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (bindSource (reference "accept::receiver")) (bindTarget (reference "triggerTarget"))))
    ...
    (declaration (id (node (document "memory://snapshot/transition_performances.md") (qualified-name "TransitionPerformances::TransitionPerformance::guardConstraint"))) (kind kerml-connector) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "TPCGuardConstraint")) (connectorEnd (reference "transitionLink")) (connectorEnd (reference "guard"))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/transition_performances.md") (qualified-name "TransitionPerformances::TPCGuardConstraint"))) (kind expressionOperand) (ordinal 0))
      ...
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/transition_performances.md") (anonymous (kind kerml-invariant) (ordinal 0))))) (kind invocationCallee) (ordinal 0))
      (authored-target "allTrue")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/transition_performances.md") (anonymous (kind kerml-invariant) (ordinal 0))))) (kind invocationCallee) (ordinal 1))
      (authored-target "constrainedGuard")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/transition_performances.md") (anonymous (kind kerml-connector) (ordinal 0))))) (kind connectorEnd) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/transition_performances.md") (anonymous (kind kerml-connector) (ordinal 0))))) (kind connectorEnd) (ordinal 1))
    ...
    (reference (id (source (node (document "memory://snapshot/transition_performances.md") (anonymous (kind kerml-binding) (ordinal 0))))) (kind bindSource) (ordinal 0))
      (authored-target "transitionLink::earlierOccurrence")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/transition_performances.md") (anonymous (kind kerml-binding) (ordinal 1))))) (kind bindSource) (ordinal 0))
      (authored-target "accept::receiver")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/transition_performances.md") (anonymous (kind kerml-binding) (ordinal 0))))) (kind bindTarget) (ordinal 0))
      (authored-target "transitionLinkSource")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/transition_performances.md") (anonymous (kind kerml-binding) (ordinal 1))))) (kind bindTarget) (ordinal 0))
  ...
  (evaluation
    ...
    (evaluated (declaration (node (document "memory://snapshot/transition_performances.md") (anonymous (kind kerml-invariant) (ordinal 0))))) (value (kind non-constant)))
...
(navigation
  ...
  (query (document "memory://snapshot/transition_performances.md") (range (start 63 16) (end 63 23)) (probe (position 63 16))
    (reference (id (source (node (document "memory://snapshot/transition_performances.md") (anonymous (kind kerml-invariant) (ordinal 0))))) (kind invocationCallee) (ordinal 0) (authored-target "allTrue")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/transition_performances.md") (range (start 63 24) (end 63 40)) (probe (position 63 24))
    (reference (id (source (node (document "memory://snapshot/transition_performances.md") (anonymous (kind kerml-invariant) (ordinal 0))))) (kind invocationCallee) (ordinal 1) (authored-target "constrainedGuard")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/transition_performances.md") (range (start 34 27) (end 34 41)) (probe (position 34 27))
    (reference (id (source (node (document "memory://snapshot/transition_performances.md") (anonymous (kind kerml-connector) (ordinal 0))))) (kind connectorEnd) (ordinal 0) (authored-target "transitionLink")
      (outcome (status resolved) (target (node (document "memory://snapshot/transition_performances.md") (qualified-name "TransitionPerformances::TransitionPerformance::transitionLink")))))
  )
  (query (document "memory://snapshot/transition_performances.md") (range (start 34 52) (end 34 59)) (probe (position 34 52))
    (reference (id (source (node (document "memory://snapshot/transition_performances.md") (anonymous (kind kerml-connector) (ordinal 0))))) (kind connectorEnd) (ordinal 1) (authored-target "trigger")
      (outcome (status resolved) (target (node (document "memory://snapshot/transition_performances.md") (qualified-name "TransitionPerformances::TransitionPerformance::trigger")))))
  )
  (query (document "memory://snapshot/transition_performances.md") (range (start 30 25) (end 30 57)) (probe (position 30 25))
    (reference (id (source (node (document "memory://snapshot/transition_performances.md") (anonymous (kind kerml-binding) (ordinal 0))))) (kind bindSource) (ordinal 0) (authored-target "transitionLink::earlierOccurrence")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/transition_performances.md") (range (start 45 16) (end 45 33)) (probe (position 45 16))
    (reference (id (source (node (document "memory://snapshot/transition_performances.md") (anonymous (kind kerml-binding) (ordinal 1))))) (kind bindSource) (ordinal 0) (authored-target "accept::receiver")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/transition_performances.md") (range (start 30 64) (end 30 84)) (probe (position 30 64))
    (reference (id (source (node (document "memory://snapshot/transition_performances.md") (anonymous (kind kerml-binding) (ordinal 0))))) (kind bindTarget) (ordinal 0) (authored-target "transitionLinkSource")
      (outcome (status unresolved)))
  )
  (query (document "memory://snapshot/transition_performances.md") (range (start 45 36) (end 45 49)) (probe (position 45 36))
    (reference (id (source (node (document "memory://snapshot/transition_performances.md") (anonymous (kind kerml-binding) (ordinal 1))))) (kind bindTarget) (ordinal 0) (authored-target "triggerTarget")
      (outcome (status resolved) (target (node (document "memory://snapshot/transition_performances.md") (qualified-name "TransitionPerformances::TransitionPerformance::triggerTarget")))))
  )
