...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/clocks.md") (qualified-name "Clocks::TimeOf::startTimeConstraint"))) (kind kerml-invariant) (membership (kind feature) (visibility default)))
