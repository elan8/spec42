  ...
  (document "memory://snapshot/clocks.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (code "unsupported_calc_definition_member")
        (source "semantic")
        (range (start 89 3) (end 91 4))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_calc_definition_member")
        (source "semantic")
        (range (start 102 3) (end 104 4))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_type_reference")
...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/clocks.md") (qualified-name "Clocks::Clock::timeFlowConstraint"))) (kind kerml-invariant) (membership (kind feature) (visibility default)))
    ...
    (declaration (id (node (document "memory://snapshot/clocks.md") (qualified-name "Clocks::TimeOf::timeContinuityConstraint"))) (kind kerml-invariant) (membership (kind feature) (visibility default)))
    ...
    (declaration (id (node (document "memory://snapshot/clocks.md") (qualified-name "Clocks::TimeOf::timeOrderingConstraint"))) (kind kerml-invariant) (membership (kind feature) (visibility default)))
