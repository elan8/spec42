...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesian+::u"))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "CartesianVectorValue")) (expressionOperand (reference "w")) (expressionOperand (reference "v")) (memberAccessOperand (reference "w::dimension")) (invocationCallee (reference "CartesianVectorOf"))))
    ...
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesian-"))) (kind kerml-classifier) (membership (kind owning) (visibility default)) (authored (membership (kind owning) (visibility default)) (relationships (specialization (reference "-"))))
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesian-::precondition"))) (kind kerml-invariant) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "w")) (memberAccessOperand (reference "v::dimension")) (memberAccessOperand (reference "w::dimension"))))
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesian-::u"))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "CartesianVectorValue")) (expressionOperand (reference "w")) (memberAccessOperand (reference "v::elements")) (memberAccessOperand (reference "v::dimension")) (invocationCallee (reference "CartesianVectorOf")) (invocationCallee (reference "CartesianVectorOf")) (invocationCallee (reference "CartesianVectorOf"))))
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesian-::v"))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "CartesianVectorValue") (direction in))))
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesian-::w"))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "CartesianVectorValue") (direction in))))
    ...
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesianInner::x"))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Real")) (expressionOperand (reference "RealFunctions::+")) (memberAccessOperand (reference "v::dimension"))))
    ...
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::sum0::s"))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "VectorValue")) (expressionOperand (reference "coll")) (expressionOperand (reference "+")) (expressionOperand (reference "zero"))))
