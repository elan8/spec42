  ...
  (document "memory://snapshot/vector_functions.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (source "semantic")
        (range (start 41 21) (end 41 64))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_calc_definition_member")
        (source "semantic")
        (range (start 42 20) (end 42 48))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_specializes_reference")
      ...
      (diagnostic
        ...
        (code "unsupported_calc_definition_member")
        (source "semantic")
        (range (start 56 17) (end 56 54))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_calc_definition_member")
        (source "semantic")
        (range (start 57 19) (end 57 47))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_type_reference")
      ...
      (diagnostic
        ...
        (code "unsupported_calc_definition_member")
        (source "semantic")
        (range (start 97 16) (end 97 38))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_calc_definition_member")
        (source "semantic")
        (range (start 98 19) (end 98 58))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_specializes_reference")
      ...
      (diagnostic
        ...
        (code "unsupported_calc_definition_member")
        (source "semantic")
        (range (start 135 21) (end 135 37))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_calc_definition_member")
        (source "semantic")
        (range (start 136 18) (end 136 70))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_type_reference")
      ...
      (diagnostic
        ...
        (code "unsupported_calc_definition_member")
        (source "semantic")
        (range (start 147 19) (end 147 38))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_calc_definition_member")
        (source "semantic")
        (range (start 148 19) (end 148 47))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_type_reference")
      ...
      (diagnostic
        ...
        (code "unsupported_calc_definition_member")
        (source "semantic")
        (range (start 160 20) (end 160 40))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_calc_definition_member")
        (source "semantic")
        (range (start 161 26) (end 161 66))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_type_reference")
...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::+::commutivity"))) (kind kerml-invariant) (membership (kind feature) (visibility default)))
    ...
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::+::zeroAddition"))) (kind kerml-invariant) (membership (kind feature) (visibility default)))
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::-"))) (kind kerml-classifier) (membership (kind owning) (visibility default)) (authored (membership (kind owning) (visibility default)) (relationships (specialization (reference "DataFunctions::-"))))
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::-::difference"))) (kind kerml-invariant) (membership (kind feature) (visibility default)))
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::-::negation"))) (kind kerml-invariant) (membership (kind feature) (visibility default)))
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::-::u"))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "VectorValue"))))
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::-::v"))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "VectorValue") (direction in))))
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::-::w"))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "VectorValue") (direction in))))
    ...
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::angle::commutivity"))) (kind kerml-invariant) (membership (kind feature) (visibility default)))
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::angle::lengthInsensitive"))) (kind kerml-invariant) (membership (kind feature) (visibility default)))
    ...
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesian+::precondition"))) (kind kerml-invariant) (membership (kind feature) (visibility default)))
    ...
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesian-::v"))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "CartesianVectorValue") (direction in))))
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesian-::w"))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "CartesianVectorValue") (direction in))))
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesian3DZeroVector"))) (kind kerml-feature) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "CartesianThreeVectorValue")) (expressionOperand (reference "cartesianZeroVector"))))
    ...
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesianAngle::precondition"))) (kind kerml-invariant) (membership (kind feature) (visibility default)))
    ...
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesianInner::precondition"))) (kind kerml-invariant) (membership (kind feature) (visibility default)))
    ...
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesianInner::x"))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Real")) (expressionOperand (reference "RealFunctions::+"))))
    ...
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesianScalarVectorMult::w"))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "CartesianVectorValue")) (memberAccessOperand (reference "v::elements")) (invocationCallee (reference "CartesianVectorOf"))))
    ...
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::inner::commmutivity"))) (kind kerml-invariant) (membership (kind feature) (visibility default)))
    ...
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::inner::zeroInner"))) (kind kerml-invariant) (membership (kind feature) (visibility default)))
    ...
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (anonymous (kind parameter) (ordinal 0))))) (kind parameter) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Boolean")) (memberAccessOperand (reference "v::elements"))))
    ...
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::norm::lengthZero"))) (kind kerml-invariant) (membership (kind feature) (visibility default)))
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::norm::squareNorm"))) (kind kerml-invariant) (membership (kind feature) (visibility default)))
    ...
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::scalarVectorMult::scaling"))) (kind kerml-invariant) (membership (kind feature) (visibility default)))
    ...
    (declaration (id (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::scalarVectorMult::zeroLength"))) (kind kerml-invariant) (membership (kind feature) (visibility default)))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesian3DZeroVector"))) (kind featureTyping) (ordinal 0))
      (authored-target "CartesianThreeVectorValue")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesian3DZeroVector"))) (kind expressionOperand) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesianInner::x"))) (kind featureTyping) (ordinal 0))
      (authored-target "Real")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesianInner::x"))) (kind expressionOperand) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesianScalarVectorMult::w"))) (kind featureTyping) (ordinal 0))
      (authored-target "CartesianVectorValue")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesianScalarVectorMult::w"))) (kind memberAccessOperand) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/vector_functions.md") (anonymous (kind parameter) (ordinal 0))))) (kind featureTyping) (ordinal 0))
      ...
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/vector_functions.md") (anonymous (kind parameter) (ordinal 0))))) (kind memberAccessOperand) (ordinal 0))
      (authored-target "v::elements")
      (outcome (status unresolved)))
  ...
  (relationships
    ...
    (relationship (kind expressionOperand) (source (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesian3DZeroVector"))) (target (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesianZeroVector"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesian3DZeroVector"))) (kind expressionOperand) (ordinal 0)))
  ...
  (evaluation
    ...
    (evaluated (declaration (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::sum0::precondition"))) (value (kind non-constant)))
...
(navigation
  ...
  (query (document "memory://snapshot/vector_functions.md") (range (start 198 2) (end 198 21)) (probe (position 198 2))
    (reference (id (source (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesian3DZeroVector"))) (kind expressionOperand) (ordinal 0) (authored-target "cartesianZeroVector")
      (outcome (status resolved) (target (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesianZeroVector")))))
  )
  ...
  (query (document "memory://snapshot/vector_functions.md") (range (start 253 69) (end 253 87)) (probe (position 253 69))
    (reference (id (source (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesianInner::x"))) (kind expressionOperand) (ordinal 0) (authored-target "RealFunctions::+")
      (outcome (status unresolved)))
  )
  ...
  (query (document "memory://snapshot/vector_functions.md") (range (start 239 4) (end 239 14)) (probe (position 239 4))
    (reference (id (source (node (document "memory://snapshot/vector_functions.md") (qualified-name "VectorFunctions::cartesianScalarVectorMult::w"))) (kind memberAccessOperand) (ordinal 0) (authored-target "v::elements")
      (outcome (status unresolved)))
  )
  ...
  (query (document "memory://snapshot/vector_functions.md") (range (start 207 24) (end 207 34)) (probe (position 207 24))
    (reference (id (source (node (document "memory://snapshot/vector_functions.md") (anonymous (kind parameter) (ordinal 0))))) (kind memberAccessOperand) (ordinal 0) (authored-target "v::elements")
      (outcome (status unresolved)))
  )
