...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::CausationSemanticMetadadata::baseType"))) (kind attribute) (membership (kind feature) (visibility default)) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "baseType")) (expressionOperand (reference "causations")) (metaCastTarget (reference "SysML::Usage")))))
    ...
    (declaration (id (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::CauseMetadata::baseType"))) (kind attribute) (membership (kind feature) (visibility default)) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "baseType")) (expressionOperand (reference "causes")) (typeCheckTarget (reference "SysML::Usage")))))
    ...
    (declaration (id (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::EffectMetadata::baseType"))) (kind attribute) (membership (kind feature) (visibility default)) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "baseType")) (expressionOperand (reference "effects")) (typeCheckTarget (reference "SysML::Usage")))))
    ...
    (declaration (id (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::MulticausationSemanticMetadata::baseType"))) (kind attribute) (membership (kind feature) (visibility default)) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "baseType")) (expressionOperand (reference "multicausations")) (metaCastTarget (reference "SysML::Usage")))))
  )
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (path (named (kind library-package) (name "CauseAndEffect")) (anonymous (kind import) (ordinal 2))))) (kind membershipImport) (ordinal 0))
      ...
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (path (named (kind library-package) (name "CauseAndEffect")) (named (kind metadata-def) (name "CausationMetadata")) (named (kind attribute) (name "annotatedElement"))))) (kind featureTyping) (ordinal 0))
      (authored-target "SysML::ConnectionDefinition")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (path (named (kind library-package) (name "CauseAndEffect")) (named (kind metadata-def) (name "CausationMetadata")) (named (kind attribute) (name "annotatedElement") (occurrence 1))))) (kind featureTyping) (ordinal 0))
      (authored-target "SysML::ConnectionUsage")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (path (named (kind library-package) (name "CauseAndEffect")) (named (kind metadata-def) (name "CausationMetadata")) (named (kind attribute) (name "annotatedElement"))))) (kind subsetting) (ordinal 0))
      (authored-target "annotatedElement")
      (outcome (status ambiguous) (candidates (node (document "memory://snapshot/cause_and_effect.md") (path (named (kind library-package) (name "CauseAndEffect")) (named (kind metadata-def) (name "CausationMetadata")) (named (kind attribute) (name "annotatedElement")))) (node (document "memory://snapshot/cause_and_effect.md") (path (named (kind library-package) (name "CauseAndEffect")) (named (kind metadata-def) (name "CausationMetadata")) (named (kind attribute) (name "annotatedElement") (occurrence 1)))))))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (path (named (kind library-package) (name "CauseAndEffect")) (named (kind metadata-def) (name "CausationMetadata")) (named (kind attribute) (name "annotatedElement") (occurrence 1))))) (kind subsetting) (ordinal 0))
      (authored-target "annotatedElement")
      (outcome (status ambiguous) (candidates (node (document "memory://snapshot/cause_and_effect.md") (path (named (kind library-package) (name "CauseAndEffect")) (named (kind metadata-def) (name "CausationMetadata")) (named (kind attribute) (name "annotatedElement")))) (node (document "memory://snapshot/cause_and_effect.md") (path (named (kind library-package) (name "CauseAndEffect")) (named (kind metadata-def) (name "CausationMetadata")) (named (kind attribute) (name "annotatedElement") (occurrence 1)))))))
    ...
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::CausationSemanticMetadadata::baseType"))) (kind expressionOperand) (ordinal 0))
      (authored-target "causations")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::CausationSemanticMetadadata::baseType"))) (kind metaCastTarget) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::CauseMetadata::baseType"))) (kind expressionOperand) (ordinal 0))
      (authored-target "causes")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::CauseMetadata::baseType"))) (kind typeCheckTarget) (ordinal 0))
      (authored-target "SysML::Usage")
      (outcome (status unresolved)))
    ...
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::EffectMetadata::baseType"))) (kind expressionOperand) (ordinal 0))
      (authored-target "effects")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::EffectMetadata::baseType"))) (kind typeCheckTarget) (ordinal 0))
      (authored-target "SysML::Usage")
      (outcome (status unresolved)))
    ...
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::MulticausationSemanticMetadata::baseType"))) (kind expressionOperand) (ordinal 0))
      (authored-target "multicausations")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::MulticausationSemanticMetadata::baseType"))) (kind metaCastTarget) (ordinal 0))
      (authored-target "SysML::Usage")
      (outcome (status unresolved)))
  )
  (relationships
...
(types
    ...
    (declaration (id (node (document "memory://snapshot/cause_and_effect.md") (path (named (kind library-package) (name "CauseAndEffect")) (named (kind metadata-def) (name "CausationMetadata")) (named (kind attribute) (name "annotatedElement") (occurrence 1)))))
      (featured-by (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::CausationMetadata")))
    )
    ...
    (declaration (id (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::CausationSemanticMetadadata::baseType"))) (cyclic true)
      ...
      (subtype (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::CausationSemanticMetadadata::baseType")) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::CauseMetadata::annotatedElement"))) (cyclic true)
      ...
      (subtype (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::CauseMetadata::annotatedElement")) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::CauseMetadata::baseType"))) (cyclic true)
      (featured-by (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::CauseMetadata")))
      (subtype (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::CauseMetadata::baseType")) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::EffectMetadata::annotatedElement"))) (cyclic true)
      ...
      (subtype (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::EffectMetadata::annotatedElement")) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::EffectMetadata::baseType"))) (cyclic true)
      (featured-by (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::EffectMetadata")))
      (subtype (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::EffectMetadata::baseType")) (scopes any feature))
    )
    ...
    (declaration (id (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::MulticausationSemanticMetadata::baseType"))) (cyclic true)
      ...
      (subtype (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::MulticausationSemanticMetadata::baseType")) (scopes any feature))
    )
)
~~~
# NAVIGATION
...
(navigation
  ...
  (query (document "memory://snapshot/cause_and_effect.md") (range (start 36 28) (end 36 55)) (probe (position 36 28))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (path (named (kind library-package) (name "CauseAndEffect")) (named (kind metadata-def) (name "CausationMetadata")) (named (kind attribute) (name "annotatedElement"))))) (kind featureTyping) (ordinal 0) (authored-target "SysML::ConnectionDefinition")
      (outcome (status unresolved)))
    )
  )
  (query (document "memory://snapshot/cause_and_effect.md") (range (start 37 28) (end 37 50)) (probe (position 37 28))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (path (named (kind library-package) (name "CauseAndEffect")) (named (kind metadata-def) (name "CausationMetadata")) (named (kind attribute) (name "annotatedElement") (occurrence 1))))) (kind featureTyping) (ordinal 0) (authored-target "SysML::ConnectionUsage")
      (outcome (status unresolved)))
    )
  )
  (query (document "memory://snapshot/cause_and_effect.md") (range (start 36 9) (end 36 25)) (probe (position 36 9))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (path (named (kind library-package) (name "CauseAndEffect")) (named (kind metadata-def) (name "CausationMetadata")) (named (kind attribute) (name "annotatedElement"))))) (kind subsetting) (ordinal 0) (authored-target "annotatedElement")
      (outcome (status ambiguous) (candidates (node (document "memory://snapshot/cause_and_effect.md") (path (named (kind library-package) (name "CauseAndEffect")) (named (kind metadata-def) (name "CausationMetadata")) (named (kind attribute) (name "annotatedElement")))) (node (document "memory://snapshot/cause_and_effect.md") (path (named (kind library-package) (name "CauseAndEffect")) (named (kind metadata-def) (name "CausationMetadata")) (named (kind attribute) (name "annotatedElement") (occurrence 1)))))))
    )
  )
  (query (document "memory://snapshot/cause_and_effect.md") (range (start 37 9) (end 37 25)) (probe (position 37 9))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (path (named (kind library-package) (name "CauseAndEffect")) (named (kind metadata-def) (name "CausationMetadata")) (named (kind attribute) (name "annotatedElement") (occurrence 1))))) (kind subsetting) (ordinal 0) (authored-target "annotatedElement")
      (outcome (status ambiguous) (candidates (node (document "memory://snapshot/cause_and_effect.md") (path (named (kind library-package) (name "CauseAndEffect")) (named (kind metadata-def) (name "CausationMetadata")) (named (kind attribute) (name "annotatedElement")))) (node (document "memory://snapshot/cause_and_effect.md") (path (named (kind library-package) (name "CauseAndEffect")) (named (kind metadata-def) (name "CausationMetadata")) (named (kind attribute) (name "annotatedElement") (occurrence 1)))))))
    )
  )
  ...
  (query (document "memory://snapshot/cause_and_effect.md") (range (start 78 21) (end 78 31)) (probe (position 78 21))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::CausationSemanticMetadadata::baseType"))) (kind expressionOperand) (ordinal 0) (authored-target "causations")
      (outcome (status unresolved)))
    )
  )
  (query (document "memory://snapshot/cause_and_effect.md") (range (start 78 37) (end 78 49)) (probe (position 78 37))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::CausationSemanticMetadadata::baseType"))) (kind metaCastTarget) (ordinal 0) (authored-target "SysML::Usage")
      (outcome (status unresolved)))
    )
  )
  ...
  (query (document "memory://snapshot/cause_and_effect.md") (range (start 15 21) (end 15 27)) (probe (position 15 21))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::CauseMetadata::baseType"))) (kind expressionOperand) (ordinal 0) (authored-target "causes")
      (outcome (status unresolved)))
    )
  )
  (query (document "memory://snapshot/cause_and_effect.md") (range (start 15 31) (end 15 43)) (probe (position 15 31))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::CauseMetadata::baseType"))) (kind typeCheckTarget) (ordinal 0) (authored-target "SysML::Usage")
      (outcome (status unresolved)))
    )
  )
  ...
  (query (document "memory://snapshot/cause_and_effect.md") (range (start 26 21) (end 26 28)) (probe (position 26 21))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::EffectMetadata::baseType"))) (kind expressionOperand) (ordinal 0) (authored-target "effects")
      (outcome (status unresolved)))
    )
  )
  (query (document "memory://snapshot/cause_and_effect.md") (range (start 26 32) (end 26 44)) (probe (position 26 32))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::EffectMetadata::baseType"))) (kind typeCheckTarget) (ordinal 0) (authored-target "SysML::Usage")
      (outcome (status unresolved)))
    )
  )
  ...
  (query (document "memory://snapshot/cause_and_effect.md") (range (start 69 21) (end 69 36)) (probe (position 69 21))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::MulticausationSemanticMetadata::baseType"))) (kind expressionOperand) (ordinal 0) (authored-target "multicausations")
      (outcome (status unresolved)))
    )
  )
  (query (document "memory://snapshot/cause_and_effect.md") (range (start 69 42) (end 69 54)) (probe (position 69 42))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect.md") (qualified-name "CauseAndEffect::MulticausationSemanticMetadata::baseType"))) (kind metaCastTarget) (ordinal 0) (authored-target "SysML::Usage")
      (outcome (status unresolved)))
    )
  )
)
