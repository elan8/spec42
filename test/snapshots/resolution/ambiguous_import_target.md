...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation false) (source-digest "blake3:d49916dfa251a36d6a71e7b1ef1dc0d6df60d3d29fd0860ff0e2ec7e84929b98") (contract-version "parser-owned-resolution-v1"))
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/Use.sysml") (path (name "Use") (anonymous (kind import) (ordinal 0)))))) (kind import) (membership (kind import) (visibility default)) (authored (membership (kind import) (visibility default)) (relationships (namespaceImport (reference "Shared") (import (shape namespace) (recursive false)))))
  ...
  (references
    (reference (id (source (node (document "memory://snapshot/Use.sysml") (path (name "Use") (anonymous (kind import) (ordinal 0)))))) (kind namespaceImport) (ordinal 0))
...
(navigation
  (query (document "memory://snapshot/Use.sysml") (range (start 1 11) (end 1 20)) (probe (position 1 11))
    (reference (id (source (node (document "memory://snapshot/Use.sysml") (path (name "Use") (anonymous (kind import) (ordinal 0)))))) (kind namespaceImport) (ordinal 0) (authored-target "Shared")
      (outcome (status ambiguous) (candidates (node (document "memory://snapshot/A.sysml") (qualified-name "Shared")) (node (document "memory://snapshot/B.sysml") (qualified-name "Shared")))))
  )
