...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/Use.sysml") (anonymous (kind import) (ordinal 0))))) (kind import) (membership (kind import) (visibility default)) (authored (membership (kind import) (visibility default)) (relationships (namespaceImport (reference "Shared") (import (shape namespace) (recursive false)))))
  ...
  (references
    (reference (id (source (node (document "memory://snapshot/Use.sysml") (anonymous (kind import) (ordinal 0))))) (kind namespaceImport) (ordinal 0))
...
(navigation
  (query (document "memory://snapshot/Use.sysml") (range (start 1 11) (end 1 20)) (probe (position 1 11))
    (reference (id (source (node (document "memory://snapshot/Use.sysml") (anonymous (kind import) (ordinal 0))))) (kind namespaceImport) (ordinal 0) (authored-target "Shared")
      (outcome (status ambiguous) (candidates (node (document "memory://snapshot/A.sysml") (qualified-name "Shared")) (node (document "memory://snapshot/B.sysml") (qualified-name "Shared")))))
  )
