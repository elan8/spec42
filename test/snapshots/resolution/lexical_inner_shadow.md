...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/lexical_inner_shadow.md") (anonymous (kind import) (ordinal 0))))) (kind import) (membership (kind import) (visibility default)) (authored (membership (kind import) (visibility default)) (relationships (namespaceImport (reference "A") (import (shape namespace) (recursive false)))))
  ...
  (references
    (reference (id (source (node (document "memory://snapshot/lexical_inner_shadow.md") (anonymous (kind import) (ordinal 0))))) (kind namespaceImport) (ordinal 0))
      (authored-target "A")
...
(navigation
  (query (document "memory://snapshot/lexical_inner_shadow.md") (range (start 4 11) (end 4 15)) (probe (position 4 11))
    (reference (id (source (node (document "memory://snapshot/lexical_inner_shadow.md") (anonymous (kind import) (ordinal 0))))) (kind namespaceImport) (ordinal 0) (authored-target "A")
      (outcome (status resolved) (target (node (document "memory://snapshot/lexical_inner_shadow.md") (qualified-name "A")))))
  )
