...
pub use sysml_resolution::{
    ...
    DiagramScene, DiagramSemanticReference, DiagramStateTransition, DiagramStateTransitionScene,
    DiagramStateVertex, DiagramStateVertexKind, DiagramTransitionFeature, DiagramViewCatalogEntry,
    DiagramViewKind, DiagramViewProjection, Documentation, EffectiveType, EffectiveTypeEntry,
    EffectiveTypeOrigin, EffectiveTyping, ElementDetails, ElementDetailsAt, ElementEvaluation,
    ...
    ExpectedMeasurement, FeatureDirection, InheritedFeature, MembershipFacts, MembershipKind,
    MembershipRole, MultiplicityBound, MultiplicityFacts, NavigationTarget, OccurrenceRole,
    PortionKind, PublicationCompleteness, PublicationIdentity, PublishedDiagnostics,
