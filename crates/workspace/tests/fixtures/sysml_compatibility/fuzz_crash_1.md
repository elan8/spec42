...
(model
  (namespace
    (package 'MassRkllup2'
      ...
      (part_usage 'composicomackagteThing' : 'MassRkllup2::MassedThing'[part_def]
        (not_implemented 'malformed')
        (reference_usage reference 'arValuete' :>> 'MassRkllup2::MassedThing::totalMass'[attribute_usage]
          (feature_value (default =))))
      (not_implemented 'malformed'))))
~~~
