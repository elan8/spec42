  ...
  (document "kerml/a_3_5_timing_for_structures.md"
    (diagnostics
      (diagnostic
        ...
        (source "semantic")
        (range (start 6 1) (end 6 58))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 7 1) (end 7 61))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
      ...
      (diagnostic
        ...
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 21 1) (end 21 25))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 23 1) (end 23 53))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 24 1) (end 24 56))
      )
      (diagnostic
        (severity warning)
