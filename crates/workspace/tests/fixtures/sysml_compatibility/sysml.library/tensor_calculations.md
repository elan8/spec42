  ...
  (document "sysml.library/tensor_calculations.md"
    (diagnostics
      (diagnostic
        ...
        (source "semantic")
        (range (start 6 4) (end 6 41))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 7 4) (end 7 40))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
      ...
      (diagnostic
        ...
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 9 4) (end 9 51))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 10 4) (end 10 51))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 11 4) (end 11 69))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 12 4) (end 12 67))
      )
      (diagnostic
        (severity warning)
