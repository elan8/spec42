...
(semantic-graph
  ...
  (relationships
    ...
    (subsetting (status resolved) (from (node (document "d0") (qualified-name "SpatialItems::SpatialItem::componentParts"))) (to (node (document "d0") (qualified-name "SpatialItems::SpatialItem::subSpatialParts"))))
  ...
  (document "sysml.library/spatial_items.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 13 1) (end 13 39))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 14 1) (end 14 38))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 15 1) (end 15 64))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 16 1) (end 16 38))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
      ...
      (diagnostic
        ...
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 18 1) (end 18 46))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 19 1) (end 19 43))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
