...
~~~sexpr
(fixture-diagnostics
  (document "sysml.library/spatial_frames.md"
    (diagnostics
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 7 4) (end 7 29))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 8 4) (end 8 48))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
      ...
      (diagnostic
        ...
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 10 4) (end 10 59))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 11 4) (end 11 49))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 12 4) (end 12 37))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 13 4) (end 13 33))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
