  ...
  (document "sysml.library/vector_functions.md"
    (diagnostics
      (diagnostic
        ...
        (source "semantic")
        (range (start 8 1) (end 8 45))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 9 1) (end 9 39))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 10 1) (end 10 35))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
      ...
      (diagnostic
        ...
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 12 1) (end 12 38))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 13 1) (end 13 36))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
      ...
      (diagnostic
        ...
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 16 1) (end 16 36))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 18 1) (end 18 31))
      )
      (diagnostic
        (severity warning)
