...
(semantic-graph
  ...
  (relationships
    (annotation (status resolved) (from (node (document "d0") (qualified-name "Flows::Flow::_documentation"))) (to (node (document "d0") (qualified-name "Flows::Flow"))) (provenance authored))
    (annotation (status resolved) (from (node (document "d0") (qualified-name "Flows::Message::_documentation"))) (to (node (document "d0") (qualified-name "Flows::Message"))) (provenance authored))
    (annotation (status resolved) (from (node (document "d0") (qualified-name "Flows::MessageAction::_documentation"))) (to (node (document "d0") (qualified-name "Flows::MessageAction"))) (provenance authored))
    (annotation (status resolved) (from (node (document "d0") (qualified-name "Flows::SuccessionFlow::_documentation"))) (to (node (document "d0") (qualified-name "Flows::SuccessionFlow"))) (provenance authored))
    (annotation (status resolved) (from (node (document "d0") (qualified-name "Flows::_documentation"))) (to (node (document "d0") (qualified-name "Flows"))) (provenance authored))
    (annotation (status resolved) (from (node (document "d0") (qualified-name "Flows::flows::_documentation"))) (to (node (document "d0") (qualified-name "Flows::flows"))) (provenance authored))
    (annotation (status resolved) (from (node (document "d0") (qualified-name "Flows::messages::_documentation"))) (to (node (document "d0") (qualified-name "Flows::messages"))) (provenance authored))
    (annotation (status resolved) (from (node (document "d0") (qualified-name "Flows::successionFlows::_documentation"))) (to (node (document "d0") (qualified-name "Flows::successionFlows"))) (provenance authored))
    (redefinition (status resolved) (from (node (document "d0") (qualified-name "Flows::SuccessionFlow::source"))) (to (node (document "d0") (qualified-name "Flows::Flow::source"))) (provenance authored))
    (redefinition (status resolved) (from (node (document "d0") (qualified-name "Flows::SuccessionFlow::target"))) (to (node (document "d0") (qualified-name "Flows::Flow::target"))) (provenance authored))
    (redefinition (status resolved) (from (node (document "d0") (qualified-name "Flows::flows::source"))) (to (node (document "d0") (qualified-name "Flows::Flow::source"))) (provenance authored))
    (redefinition (status resolved) (from (node (document "d0") (qualified-name "Flows::flows::target"))) (to (node (document "d0") (qualified-name "Flows::Flow::target"))) (provenance authored))
    (redefinition (status resolved) (from (node (document "d0") (qualified-name "Flows::successionFlows::source"))) (to (node (document "d0") (qualified-name "Flows::SuccessionFlow::source"))) (provenance authored))
    (redefinition (status resolved) (from (node (document "d0") (qualified-name "Flows::successionFlows::target"))) (to (node (document "d0") (qualified-name "Flows::SuccessionFlow::target"))) (provenance authored))
    (specializes (status resolved) (from (node (document "d0") (qualified-name "Flows::Flow"))) (to (node (document "d0") (qualified-name "Flows::Message"))) (provenance authored))
    (specializes (status resolved) (from (node (document "d0") (qualified-name "Flows::Message"))) (to (node (document "d0") (qualified-name "Flows::MessageAction"))) (provenance authored))
    (specializes (status resolved) (from (node (document "d0") (qualified-name "Flows::SuccessionFlow"))) (to (node (document "d0") (qualified-name "Flows::Flow"))) (provenance authored))
    (typing (status resolved) (from (node (document "d0") (qualified-name "Flows::flows"))) (to (node (document "d0") (qualified-name "Flows::Flow"))) (provenance authored))
    (typing (status resolved) (from (node (document "d0") (qualified-name "Flows::messages"))) (to (node (document "d0") (qualified-name "Flows::Message"))) (provenance authored))
    (typing (status resolved) (from (node (document "d0") (qualified-name "Flows::successionFlows"))) (to (node (document "d0") (qualified-name "Flows::SuccessionFlow"))) (provenance authored))
  )
  ...
  (derived-relationship-resolutions
    (universal-standard-library-relationship (from (node (document "d0") (qualified-name "Flows::Flow"))) (status missing-prerequisite) (target "Flows::MessageAction"))
    (universal-standard-library-relationship (from (node (document "d0") (qualified-name "Flows::Message"))) (status missing-prerequisite) (target "Flows::MessageAction"))
    (universal-standard-library-relationship (from (node (document "d0") (qualified-name "Flows::MessageAction"))) (status missing-prerequisite) (target "Flows::MessageAction"))
    (universal-standard-library-relationship (from (node (document "d0") (qualified-name "Flows::SuccessionFlow"))) (status missing-prerequisite) (target "Flows::MessageAction"))
    (universal-standard-library-relationship (from (node (document "d0") (qualified-name "Flows::flows"))) (status missing-prerequisite) (target "Flows::messages"))
    (universal-standard-library-relationship (from (node (document "d0") (qualified-name "Flows::messages"))) (status missing-prerequisite) (target "Flows::messages"))
    (universal-standard-library-relationship (from (node (document "d0") (qualified-name "Flows::successionFlows"))) (status missing-prerequisite) (target "Flows::messages"))
  )
)
~~~
# DIAGNOSTICS
~~~sexpr
(fixture-diagnostics
  (document "sysml.library/flows.md"
    (diagnostics
      (diagnostic
        (severity warning)
      ...
      (diagnostic
        ...
        (code "unresolved_specializes_reference")
        (source "semantic")
        (range (start 37 4) (end 37 1504))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_specializes_reference")
        (source "semantic")
        (range (start 73 4) (end 73 455))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_redefines_target")
        (source "semantic")
        (range (start 81 8) (end 81 84))
      )
      (diagnostic
        (severity warning)
