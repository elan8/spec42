  ...
  (document "sysml.library/isq_atomic_nuclear.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 20 4) (end 20 67))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 21 4) (end 21 68))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 22 4) (end 22 63))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 23 4) (end 23 60))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
      ...
      (diagnostic
        ...
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 25 4) (end 25 43))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_import_target")
        (source "semantic")
        (range (start 26 4) (end 26 50))
      )
      (diagnostic
        (severity warning)
