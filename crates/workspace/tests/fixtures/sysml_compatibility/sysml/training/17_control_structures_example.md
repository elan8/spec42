  ...
  (containment
    (element (kind "package") (id (node (document "d0") (qualified-name "Control Structures Example"))) (name "Control Structures Example") (declared-name "Control Structures Example")
      (contains
        ...
        (element (kind "part") (id (node (document "d0") (qualified-name "Control Structures Example::powerSystem"))) (name "powerSystem") (declared-name "powerSystem") (declared (properties (ordered false))))
      )
    )
  )
  (relationships
