    ...
    (element (kind "package") (id (node (document "d0") (qualified-name "Conditional Succession Example-1"))) (name "Conditional Succession Example-1") (declared-name "Conditional Succession Example-1")
      (contains
        ...
        (element (kind "action") (id (node (document "d0") (qualified-name "Conditional Succession Example-1::takePicture"))) (name "takePicture") (declared-name "takePicture") (declared)
          (contains
            (element (kind "action") (id (node (document "d0") (qualified-name "Conditional Succession Example-1::takePicture::focus"))) (name "focus") (declared-name "focus") (declared) (effective (featuring-type (node (document "d0") (qualified-name "Conditional Succession Example-1::TakePicture"))))
              (contains
            ...
            (element (kind "action") (id (node (document "d0") (qualified-name "Conditional Succession Example-1::takePicture::shoot"))) (name "shoot") (declared-name "shoot") (declared) (effective (featuring-type (node (document "d0") (qualified-name "Conditional Succession Example-1::TakePicture"))))
              (contains
