...
(semantic-graph
  ...
  (relationships
    ...
    (subsetting (status resolved) (from (node (document "d0") (qualified-name "Car Mass Rollup Example 1::car::engine"))) (to (node (document "d0") (qualified-name "Car Mass Rollup Example 1::car::carParts"))))
    (subsetting (status resolved) (from (node (document "d0") (qualified-name "Car Mass Rollup Example 1::car::transmission"))) (to (node (document "d0") (qualified-name "Car Mass Rollup Example 1::car::carParts"))))
