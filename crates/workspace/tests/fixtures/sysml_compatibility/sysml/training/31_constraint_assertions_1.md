...
(model
  (namespace
    (package 'Constraint Assertions-1'
      ...
      (part_def 'Vehicle'
        (assert_constraint_usage 'massConstraint' : 'Constraint Assertions-1::MassConstraint'[constraint_def]
        ...
        (part_usage composite 'engine' : 'Constraint Assertions-1::Engine'[part_def]
          (attribute_usage composite 'mass' : 'MassValue'[unresolved]))
        (part_usage composite 'transmission' : 'Constraint Assertions-1::Engine'[part_def]
          (attribute_usage composite 'mass' : 'MassValue'[unresolved]))))))
~~~
