...
(model
  (namespace
    (package 'ServerSequenceRealization_3'
      ...
      (namespace_import private -> 'ServerSequenceModel'[unresolved])
      (namespace_import private -> 'ServerSequenceRealization_3::Configuration'[package])
      (package 'Configuration'
        (port_def 'PublicationPort'
        ...
        (interface_def 'PublicationInterface'
          (port_usage end 'source' : 'ServerSequenceRealization_3::Configuration::PublicationPort'[port_def])
          (port_usage end 'target' : 'ServerSequenceRealization_3::Configuration::PublicationPort'[port_def]))
        (interface_def 'SubscriptionInterface'
          (port_usage end 'source' : 'ServerSequenceRealization_3::Configuration::SubscriptionPort'[port_def])
          (port_usage end 'target' : 'ServerSequenceRealization_3::Configuration::SubscriptionPort'[port_def]))
        (part_usage 'producer_3'
          (multiplicity_range [1])
          (attribute_usage composite 'someTopic' : 'String'[unresolved])
          (item_usage composite 'somePublication')
          (port_usage composite 'publicationPort' : 'ServerSequenceRealization_3::Configuration::PublicationPort'[port_def] ~ 'ServerSequenceRealization_3::Configuration::PublicationPort'[port_def]
            (reference_usage out reference :>> 'ServerSequenceRealization_3::Configuration::PublicationPort::publish'[reference_usage]))
        ...
        (interface_usage 'publication_interface' : 'ServerSequenceRealization_3::Configuration::PublicationInterface'[interface_def]
        ...
        (part_usage 'server_3'
          (multiplicity_range [1])
          (port_usage composite 'publicationPort' : 'ServerSequenceRealization_3::Configuration::PublicationPort'[port_def]
            (reference_usage in reference :>> 'ServerSequenceRealization_3::Configuration::PublicationPort::publish'[reference_usage]))
          (port_usage composite 'subscriptionPort' : 'ServerSequenceRealization_3::Configuration::SubscriptionPort'[port_def]
            (reference_usage in reference :>> 'ServerSequenceRealization_3::Configuration::SubscriptionPort::subscribe'[reference_usage])
            (reference_usage out reference :>> 'ServerSequenceRealization_3::Configuration::SubscriptionPort::deliver'[reference_usage]))
          ...
          (perform_action_usage 'serverBehavior'
            ...
            (source_succession
              (reference_usage reference 'continuePublishing'))))
        (interface_usage 'subscription_interface' : 'ServerSequenceRealization_3::Configuration::SubscriptionInterface'[interface_def]
        ...
        (part_usage 'consumer_3'
          ...
          (port_usage composite 'subscriptionPort' : 'ServerSequenceRealization_3::Configuration::SubscriptionPort'[port_def] ~ 'ServerSequenceRealization_3::Configuration::SubscriptionPort'[port_def]
            (reference_usage out reference :>> 'ServerSequenceRealization_3::Configuration::SubscriptionPort::subscribe'[reference_usage])
            (reference_usage in reference :>> 'ServerSequenceRealization_3::Configuration::SubscriptionPort::deliver'[reference_usage]))
          (flow_usage composite 'subscribe_request'
      ...
      (part_usage 'realization_2' : 'PubSubSequence'[unresolved]
        (part_usage composite :>> 'producer'[unresolved] :> 'ServerSequenceRealization_3::Configuration::producer_3'[part_usage]
          (not_implemented 'malformed'))
        (part_usage composite :>> 'server'[unresolved] :> 'ServerSequenceRealization_3::Configuration::server_3'[part_usage]
          (not_implemented 'malformed')
          (not_implemented 'malformed')
          (not_implemented 'malformed'))
        (part_usage composite :>> 'consumer'[unresolved] :> 'ServerSequenceRealization_3::Configuration::consumer_3'[part_usage]
          (not_implemented 'malformed')
          (not_implemented 'malformed'))
