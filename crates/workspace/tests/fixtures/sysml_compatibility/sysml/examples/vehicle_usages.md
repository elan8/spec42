  ...
  (document "sysml/examples/vehicle_usages.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (code "unresolved_type_reference")
        (source "semantic")
        (range (start 23 1) (end 23 126))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_type_reference")
        (source "semantic")
        (range (start 26 2) (end 26 30))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_type_reference")
        (source "semantic")
        (range (start 29 1) (end 29 513))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_type_reference")
        (source "semantic")
        (range (start 32 2) (end 32 207))
      )
      (diagnostic
        (severity warning)
      ...
      (diagnostic
        ...
        (code "unresolved_type_reference")
        (source "semantic")
        (range (start 38 3) (end 38 24))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_type_reference")
        (source "semantic")
        (range (start 40 2) (end 40 205))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_redefines_target")
