...
(model
  (namespace
    (package 'ServerSequenceRealization_2'
      ...
      (namespace_import private -> 'ServerSequenceRealization_2::Configuration'[package])
      (package 'Configuration'
        (port_def 'PublicationPort')
        (port_def 'SubscriptionPort')
        (part_usage 'producer_2'
          ...
          (port_usage composite 'publicationPort' : 'ServerSequenceRealization_2::Configuration::PublicationPort'[port_def] ~ 'ServerSequenceRealization_2::Configuration::PublicationPort'[port_def])
        ...
        (part_usage 'server_2'
          (multiplicity_range [1])
          (port_usage composite 'publicationPort' : 'ServerSequenceRealization_2::Configuration::PublicationPort'[port_def])
          (port_usage composite 'subscriptionPort' : 'ServerSequenceRealization_2::Configuration::SubscriptionPort'[port_def])
        ...
        (part_usage 'consumer_2'
          ...
          (port_usage composite 'subscriptionPort' : 'ServerSequenceRealization_2::Configuration::SubscriptionPort'[port_def] ~ 'ServerSequenceRealization_2::Configuration::SubscriptionPort'[port_def])
      ...
      (part_usage 'realization_2' : 'PubSubSequence'[unresolved]
        (part_usage composite :>> 'producer'[unresolved] :> 'ServerSequenceRealization_2::Configuration::producer_2'[part_usage]
          (not_implemented 'malformed'))
        (part_usage composite :>> 'server'[unresolved] :> 'ServerSequenceRealization_2::Configuration::server_2'[part_usage]
          (not_implemented 'malformed')
          (not_implemented 'malformed')
          (not_implemented 'malformed'))
        (part_usage composite :>> 'consumer'[unresolved] :> 'ServerSequenceRealization_2::Configuration::consumer_2'[part_usage]
          (not_implemented 'malformed')
          (not_implemented 'malformed'))
