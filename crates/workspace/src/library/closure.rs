// Import- and typing-scoped admission of SysML/KerML library files from configured roots.
//
// Library files are never admitted by default. Imports and typing references seed a transitive
// closure, with workspace declarations taking precedence over configured library roots.
