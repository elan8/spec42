...
pub fn resolve_library_catalog(request: &HostLibraryRequest) -> HostResult<LibraryCatalog> {
    ...
    let content_hash = hash_package_roots(&package_roots, &request.standard_library, &request.domain_libraries);
...
fn resolve_stdlib_component(
        ...
        .map_err(Spec42HostError::unresolved_library_environment)?
    {
        ...
        let expected_path =
            crate::library::stdlib::managed_install_path(standard_library_paths, &request.standard_library);
