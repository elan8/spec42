...
const CATALOG: &[DiagnosticCatalogEntry] = &[
    ...
    DiagnosticCatalogEntry {
        ...
        severity: "warning",
        meaning: "An import declaration lacks a complete typed target-resolution shape.",
        typical_fix: "Repair the import declaration so it has a valid target and import shape.",
        editor_quick_fixes: None,
    },
    DiagnosticCatalogEntry {
    ...
    DiagnosticCatalogEntry {
        ...
        typical_fix: "Remove the direction modifier from the end feature.",
        editor_quick_fixes: None,
    },
    DiagnosticCatalogEntry {
    ...
    DiagnosticCatalogEntry {
        ...
        severity: "warning",
        meaning: "A metadata usage `about` target does not resolve to a model element.",
        typical_fix: "Use a visible qualified name for the annotated element or import its package.",
        editor_quick_fixes: None,
    },
    DiagnosticCatalogEntry {
        code: "metadata_binding_missing",
        severity: "warning",
        meaning: "A metadata usage is missing a required attribute binding from its metadata definition.",
        typical_fix: "Add attribute bindings in the metadata usage body for each feature of the metadata definition.",
        editor_quick_fixes: None,
    },
    DiagnosticCatalogEntry {
        code: "metadata_binding_unknown",
        severity: "warning",
        meaning: "A metadata usage binds an attribute that is not declared on its metadata definition.",
        typical_fix: "Remove the unknown binding or add the feature to the metadata definition.",
        editor_quick_fixes: None,
    },
    DiagnosticCatalogEntry {
        code: "metadata_annotated_element_incompatible",
        severity: "warning",
        meaning: "A SemanticMetadata usage annotates an element that does not conform to its annotatedElement restriction.",
        typical_fix: "Annotate a compatible element kind or adjust the SemanticMetadata annotatedElement type.",
        editor_quick_fixes: None,
    },
    DiagnosticCatalogEntry {
    ...
    DiagnosticCatalogEntry {
        code: "verification_membership_outside_objective",
        severity: "error",
        meaning: "A verification membership is not nested in an objective of a verification case.",
        typical_fix: "Move the verify membership into an objective in a verification definition or usage.",
        editor_quick_fixes: None,
    },
    DiagnosticCatalogEntry {
...
mod tests {
    ...
    const EMITTED_DIAGNOSTIC_CODES: &[(&str, &str)] = &[
        ...
        ("ambiguous_import_target", "warning"),
        ...
        ("flow_payload_type_not_occurrence", "error"),
        ...
        ("metadata_about_unresolved", "warning"),
        ("metadata_binding_missing", "warning"),
        ("metadata_binding_unknown", "warning"),
        ("metadata_annotated_element_incompatible", "warning"),
        ...
        ("redefinition_featuring_type_incompatible", "error"),
        ...
        ("subject_member_not_first", "warning"),
        ...
        ("duplicate_role_member", "warning"),
        ("verification_case_invalid_shape", "warning"),
        ("verification_membership_outside_objective", "error"),
        ...
        ("end_feature_has_direction", "warning"),
        ("end_feature_invalid_restrictions", "warning"),
        ("invalid_variation_member_kind", "warning"),
        ("subsetting_uniqueness_mismatch", "warning"),
        ...
        ("unsupported_filtered_import", "warning"),
