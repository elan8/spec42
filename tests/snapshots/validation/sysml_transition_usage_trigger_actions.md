...
blocked_by=semantic-transition-trigger-source
type=file
~~~
# SOURCE
~~~sysml
  ...
  (document "memory://snapshot/sysml_transition_usage_trigger_actions.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (related-information
          (related
            (uri "memory://snapshot/sysml_transition_usage_trigger_actions.md")
            (range (start 9 8) (end 9 20))
          )
          (related
            (uri "memory://snapshot/sysml_transition_usage_trigger_actions.md")
            (range (start 10 8) (end 10 20))
          )
        )
      )
    )
...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation false) (source-digest "blake3:bea0d7d1f990b27981eccc85642bde1f92794e24b7af4d89bdc8ace930cabfc2"))
  (declarations
...
~~~sexpr
(navigation
  (query (document "memory://snapshot/sysml_transition_usage_trigger_actions.md") (range (start 13 25) (end 13 29)) (probe (position 13 25))
  ...
  (query (document "memory://snapshot/sysml_transition_usage_trigger_actions.md") (range (start 13 52) (end 13 56)) (probe (position 13 52))
