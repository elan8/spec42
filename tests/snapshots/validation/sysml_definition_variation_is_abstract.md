...
type=file
skip_validation=no semantic rule pairs the variation and abstract modifiers of a definition; the canonical code variation_not_abstract does not exist yet
~~~
# SOURCE
~~~sysml
package Variations {
...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness parse-recovery) (has-evaluation false) (source-digest "blake3:339ed252a4fc80dda78aeb5615047122ab1f1d4582be1ed829ca961ec36cbce9") (contract-version "parser-owned-resolution-v1"))
  (declarations
