...
type=file
skip_validation=no semantic rule checks that a metadata feature type is a Metaclass; the canonical code metadata_type_not_metaclass does not exist yet
~~~
# SOURCE
~~~kerml
package Metadata {
...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation false) (source-digest "blake3:7ed33eb772185577294e50d6621a7443f090c7021b701d0f81120e7b51d63438") (contract-version "parser-owned-resolution-v1"))
  (declarations
