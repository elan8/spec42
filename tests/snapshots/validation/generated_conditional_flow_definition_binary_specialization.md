...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation true) (source-digest "blake3:6ad14ddbdaf377e61a1fabd167d52419bfed3d7e2ef2787e1b3123e4381c5e91") (admitted (standard-library 94)))
  (declarations
  ...
  (relationships
    ...
    (relationship (kind typing) (source (node (document "memory://snapshot/generated_conditional_flow_definition_binary_specialization.md") (qualified-name "FlowDefinitionBinarySpecialization::Binary::source"))) (target (node (document "memory://snapshot/sysml.library/connections.md") (qualified-name "Connections::connections"))) (provenance implied))
