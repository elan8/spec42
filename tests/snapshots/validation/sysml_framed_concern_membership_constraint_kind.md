...
type=file
skip_validation=the pinned parser has no production for a `frame concern` member, so the accepted side is reported as parser recovery rather than a FramedConcernMembership
~~~
# SOURCE
~~~sysml
...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness parse-recovery) (has-evaluation false) (source-digest "blake3:c9bf1f654f668d67379a4098d3da2875450e8ee4ad559a108afec92465e02325") (contract-version "parser-owned-resolution-v1"))
  (declarations
...
~~~sexpr
(navigation
  (query (document "memory://snapshot/sysml_framed_concern_membership_constraint_kind.md") (range (start 9 23) (end 9 32)) (probe (position 9 23))
