...
type=file
skip_validation=the pinned parser drops the `crosses` clause, so no CrossSubsetting relationship is published and the rule has nothing to check
~~~
# SOURCE
~~~kerml
package Crossings {
...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation false) (source-digest "blake3:6bc84072f2c3ac4e93f3ce2526cef7122a8d64bbaea4c15c46a730488a68c82c") (contract-version "parser-owned-resolution-v1"))
  (declarations
