...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/sysml_occurrence_usage_individual_definition.md") (path (named (kind package) (name "Occurrences")) (named (kind occurrence-def) (name "First")) (anonymous (kind kerml-multiplicity) (ordinal 0))))) (kind kerml-multiplicity) (membership (kind owning) (visibility default)) (facts (multiplicity (lower 0) (upper 1))))
    ...
    (declaration (id (node (document "memory://snapshot/sysml_occurrence_usage_individual_definition.md") (path (named (kind package) (name "Occurrences")) (named (kind occurrence-def) (name "Second")) (anonymous (kind kerml-multiplicity) (ordinal 0))))) (kind kerml-multiplicity) (membership (kind owning) (visibility default)) (facts (multiplicity (lower 0) (upper 1))))
  )
  (references
