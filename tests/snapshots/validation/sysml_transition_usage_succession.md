...
type=file
skip_validation=the succession owned by a transition usage is not published as a member, so the accepted side cannot be observed in SMG either
~~~
# SOURCE
~~~sysml
...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation false) (source-digest "blake3:2e47de9889b2518cb44c14408ca2c82775055014dceec02146fffec05abb01a5") (contract-version "parser-owned-resolution-v1"))
  (declarations
