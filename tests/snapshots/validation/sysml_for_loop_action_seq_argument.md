...
# EXPECTED SEMANTICS
~~~sexpr
(fixture-semantics (action-derived-fact (rule_id "sysml-2.0:8.3.17.9:deriveForLoopActionUsageSeqArgument") (source "Actions::Procedure") (outcome resolved)))
~~~
# DIAGNOSTICS
~~~sexpr
(fixture-diagnostics
...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation true) (source-digest "blake3:680b4ad039fe94f220cd6d54eaeea00d3c9cc68bec0d68d7bd129b81058feb86") (contract-version "parser-owned-resolution-v2"))
  (declarations
