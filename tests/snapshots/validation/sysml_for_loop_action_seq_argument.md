...
~~~sexpr
(expressions
  (declaration (id (node (document "memory://snapshot/sysml_for_loop_action_seq_argument.md") (path (named (kind package) (name "Actions")) (named (kind action-def) (name "Procedure")) (anonymous (kind for-loop) (ordinal 0))))) (outcome resolved) (literal (value (kind integer) (integer 1))))
)
~~~
# NAVIGATION
~~~sexpr
