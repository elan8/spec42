...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/generated_conditional_library_specializations.md") (path (named (kind package) (name "ConditionalSpecializations")) (named (kind occurrence-def) (name "Explicit")) (anonymous (kind kerml-multiplicity) (ordinal 0))))) (kind kerml-multiplicity) (membership (kind owning) (visibility default)) (facts (multiplicity (lower 0) (upper 1))))
    ...
    (declaration (id (node (document "memory://snapshot/generated_conditional_library_specializations.md") (path (named (kind package) (name "ConditionalSpecializations")) (named (kind occurrence-def) (name "Individual")) (anonymous (kind kerml-multiplicity) (ordinal 0))))) (kind kerml-multiplicity) (membership (kind owning) (visibility default)) (facts (multiplicity (lower 0) (upper 1))))
