...
type=file
skip_validation=no semantic rule rejects a variation usage specializing a variation; the canonical code variation_specializes_variation does not exist yet
~~~
# SOURCE
~~~sysml
package Variations {
...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness parse-recovery) (has-evaluation false) (source-digest "blake3:b645c709610c84f618dce63bce1132a7a7e8adef9a98c73bd236f1f1a4af966b") (contract-version "parser-owned-resolution-v1"))
  (declarations
