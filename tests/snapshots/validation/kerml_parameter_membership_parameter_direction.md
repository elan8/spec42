...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/kerml_parameter_membership_parameter_direction.md") (qualified-name "Parameters::Computing::both"))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction inout)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Thing") (direction inout)))))
    (declaration (id (node (document "memory://snapshot/kerml_parameter_membership_parameter_direction.md") (qualified-name "Parameters::Computing::input"))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction in)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Thing") (direction in)))))
    (declaration (id (node (document "memory://snapshot/kerml_parameter_membership_parameter_direction.md") (qualified-name "Parameters::Computing::output"))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction out)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Thing") (direction out)))))
