...
type=file
skip_validation=no semantic rule pairs a usage direction with its referential status; the canonical code directed_usage_not_referential does not exist yet
~~~
# SOURCE
~~~sysml
package References {
...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation false) (source-digest "blake3:5357ff7c0849aed983304050894df8156db2d3cd1d38242d0158a2f82cd7a46a") (contract-version "parser-owned-resolution-v1"))
  (declarations
