...
type=file
skip_validation=the pinned parser reports a satisfy requirement member as unsupported_part_definition_member, so no SatisfyRequirementUsage reaches semantics
~~~
# SOURCE
~~~sysml
...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation false) (source-digest "blake3:d31b68e8c76c8f6e57f30f215929a28e1d66bc57282bf41a3ad43a527a2320f8") (contract-version "parser-owned-resolution-v1"))
  (declarations
