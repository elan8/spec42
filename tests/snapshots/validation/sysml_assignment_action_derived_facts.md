...
~~~sexpr
(fixture-semantics
  (action-derived-fact (rule_id "sysml-2.0:8.3.17.5:deriveAssignmentActionUsageValueExpression") (source "Actions::Procedure::") (position 2) (outcome resolved))
  (action-derived-fact (rule_id "sysml-2.0:8.3.17.5:deriveAssignmentUsageTargetArgument") (source "Actions::Procedure::") (position 1) (outcome resolved)))
~~~
# DIAGNOSTICS
~~~sexpr
(fixture-diagnostics
...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation true) (source-digest "blake3:471ed72f0e7e9e1b007dd4096affbf7c95f008d4f6c5f7095cfebdce039a3bd7") (contract-version "constructor-expression-specialization-v9"))
  (declarations
