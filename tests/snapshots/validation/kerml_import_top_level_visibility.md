...
type=file
skip_validation=no semantic rule checks the visibility of a root-namespace import; the canonical code top_level_import_not_private does not exist yet
~~~
# SOURCE
~~~kerml
package Lib {
...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation false) (source-digest "blake3:4d5a46e89519176de150fffde30edf02335e6560a15b1c57b324a9b12e8275d5") (contract-version "parser-owned-resolution-v1"))
  (declarations
