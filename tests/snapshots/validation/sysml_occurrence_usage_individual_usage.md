...
type=file
skip_validation=no semantic rule requires an individual occurrence usage to have an individual definition; the canonical code individual_usage_without_individual_definition does not exist yet
~~~
# SOURCE
~~~sysml
package Occurrences {
...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation false) (source-digest "blake3:c16fe6bdb1ad6e97fd19940590352e24d07b4669e5d7cf33c0faa11d24f293ba") (contract-version "parser-owned-resolution-v1"))
  (declarations
