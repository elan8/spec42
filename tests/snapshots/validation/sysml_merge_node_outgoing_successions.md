...
type=file
skip_validation=control nodes now publish as named declarations, but no semantic rule inspects the successions attached to one, so the canonical code merge_node_multiple_outgoing does not exist yet
~~~
# SOURCE
~~~sysml
package Actions {
