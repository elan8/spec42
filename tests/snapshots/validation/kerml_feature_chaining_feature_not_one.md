...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/kerml_feature_chaining_feature_not_one.md") (qualified-name "Chains::Holder::pair"))) (kind kerml-feature) (membership (kind feature) (visibility default)))
    (declaration (id (node (document "memory://snapshot/kerml_feature_chaining_feature_not_one.md") (qualified-name "Chains::Holder::single"))) (kind kerml-feature) (membership (kind feature) (visibility default)))
