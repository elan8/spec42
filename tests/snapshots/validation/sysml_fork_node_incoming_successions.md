...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/sysml_fork_node_incoming_successions.md") (path (named (kind package) (name "Actions")) (named (kind action-def) (name "Act")) (anonymous (kind fork) (ordinal 0))))) (kind fork) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (forkInput (reference "good")))))
    ...
    (declaration (id (node (document "memory://snapshot/sysml_fork_node_incoming_successions.md") (path (named (kind package) (name "Actions")) (named (kind action-def) (name "Act")) (anonymous (kind fork) (ordinal 1))))) (kind fork) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (forkInput (reference "bad")))))
    ...
    (declaration (id (node (document "memory://snapshot/sysml_fork_node_incoming_successions.md") (qualified-name "Actions::Act::a1"))) (kind action) (membership (kind feature) (visibility default)))
    (declaration (id (node (document "memory://snapshot/sysml_fork_node_incoming_successions.md") (qualified-name "Actions::Act::a2"))) (kind action) (membership (kind feature) (visibility default)))
  )
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/sysml_fork_node_incoming_successions.md") (path (named (kind package) (name "Actions")) (named (kind action-def) (name "Act")) (anonymous (kind succession) (ordinal 2))))) (kind succession) (ordinal 1))
      (authored-target "bad")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/sysml_fork_node_incoming_successions.md") (path (named (kind package) (name "Actions")) (named (kind action-def) (name "Act")) (anonymous (kind fork) (ordinal 0))))) (kind forkInput) (ordinal 0))
      (authored-target "good")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/sysml_fork_node_incoming_successions.md") (path (named (kind package) (name "Actions")) (named (kind action-def) (name "Act")) (anonymous (kind fork) (ordinal 1))))) (kind forkInput) (ordinal 0))
      (authored-target "bad")
      (outcome (status unresolved)))
  )
  (relationships
...
~~~sexpr
(types
    (declaration (id (node (document "memory://snapshot/sysml_fork_node_incoming_successions.md") (path (named (kind package) (name "Actions")) (named (kind action-def) (name "Act")) (anonymous (kind fork) (ordinal 0)))))
    ...
    (declaration (id (node (document "memory://snapshot/sysml_fork_node_incoming_successions.md") (path (named (kind package) (name "Actions")) (named (kind action-def) (name "Act")) (anonymous (kind fork) (ordinal 1)))))
      (featured-by (node (document "memory://snapshot/sysml_fork_node_incoming_successions.md") (qualified-name "Actions::Act")))
    )
...
(navigation
  ...
  (query (document "memory://snapshot/sysml_fork_node_incoming_successions.md") (range (start 6 13) (end 6 17)) (probe (position 6 13))
    (reference (id (source (node (document "memory://snapshot/sysml_fork_node_incoming_successions.md") (path (named (kind package) (name "Actions")) (named (kind action-def) (name "Act")) (anonymous (kind fork) (ordinal 0))))) (kind forkInput) (ordinal 0) (authored-target "good")
      (outcome (status unresolved)))
    )
  )
  (query (document "memory://snapshot/sysml_fork_node_incoming_successions.md") (range (start 10 13) (end 10 16)) (probe (position 10 13))
    (reference (id (source (node (document "memory://snapshot/sysml_fork_node_incoming_successions.md") (path (named (kind package) (name "Actions")) (named (kind action-def) (name "Act")) (anonymous (kind fork) (ordinal 1))))) (kind forkInput) (ordinal 0) (authored-target "bad")
      (outcome (status unresolved)))
    )
  )
)
