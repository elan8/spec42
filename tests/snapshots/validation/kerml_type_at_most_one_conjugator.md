...
type=file
skip_validation=the pinned parser has no conjugation production, so `classifier Two conjugates A conjugates B;` never reaches semantics and is reported as unsupported_grammar_form
~~~
# SOURCE
~~~kerml
