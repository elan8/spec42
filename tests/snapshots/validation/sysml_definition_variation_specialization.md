...
type=file
skip_validation=no semantic rule rejects a variation specializing another variation; the canonical code variation_specializes_variation does not exist yet
~~~
# SOURCE
~~~sysml
package Variations {
...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness parse-recovery) (has-evaluation false) (source-digest "blake3:0976a8e5dd4ea91cd3f5417cb5f21da81f2a5e4b22344ee884a5151e7c539d20") (contract-version "parser-owned-resolution-v1"))
  (declarations
