  ...
  (document "memory://snapshot/behaviors.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (code "unresolved_reference")
        (source "semantic")
        (range (start 17 8) (end 17 12))
      )
      (diagnostic
        (severity warning)
        (code "unresolved_reference")
        (source "semantic")
        (range (start 17 17) (end 17 19))
      )
      (diagnostic
        (severity warning)
...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::C"))) (kind class-def) (membership (kind owning) (visibility default)) (authored (membership (kind owning) (visibility default)) (relationships (expressionOperand (reference "flow")) (expressionOperand (reference "to")) (memberAccessOperand (reference "a::y")) (memberAccessOperand (reference "b::x1")))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::C"))) (kind expressionOperand) (ordinal 0))
      (authored-target "flow")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::C"))) (kind expressionOperand) (ordinal 1))
      (authored-target "to")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::C"))) (kind memberAccessOperand) (ordinal 0))
      (authored-target "a::y")
      (outcome (status resolved) (target (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::A::y")))))
    (reference (id (source (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::C"))) (kind memberAccessOperand) (ordinal 1))
      (authored-target "b::x1")
      (outcome (status resolved) (target (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::B::x1")))))
  ...
  (relationships
    ...
    (relationship (kind memberAccessOperand) (source (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::C"))) (target (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::A::y"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::C"))) (kind memberAccessOperand) (ordinal 0)))
    (relationship (kind memberAccessOperand) (source (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::C"))) (target (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::B::x1"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::C"))) (kind memberAccessOperand) (ordinal 1)))
  ...
  (evaluation
    ...
    (evaluated (declaration (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::C"))) (state unresolved-operand))
    (evaluated (declaration (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::C"))) (state unsupported))
    (evaluated (declaration (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::C"))) (state unresolved-operand))
    (evaluated (declaration (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::C"))) (state unsupported))
...
(navigation
  ...
  (query (document "memory://snapshot/behaviors.md") (range (start 17 8) (end 17 12)) (probe (position 17 8))
    (reference (id (source (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::C"))) (kind expressionOperand) (ordinal 0) (authored-target "flow")
      (outcome (status unresolved)))
    )
  )
  (query (document "memory://snapshot/behaviors.md") (range (start 17 17) (end 17 19)) (probe (position 17 17))
    (reference (id (source (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::C"))) (kind expressionOperand) (ordinal 1) (authored-target "to")
      (outcome (status unresolved)))
    )
  )
  (query (document "memory://snapshot/behaviors.md") (range (start 17 13) (end 17 16)) (probe (position 17 13))
    (reference (id (source (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::C"))) (kind memberAccessOperand) (ordinal 0) (authored-target "a::y")
      (outcome (status resolved) (target (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::A::y")))))
    )
  )
  (query (document "memory://snapshot/behaviors.md") (range (start 17 20) (end 17 24)) (probe (position 17 20))
    (reference (id (source (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::C"))) (kind memberAccessOperand) (ordinal 1) (authored-target "b::x1")
      (outcome (status resolved) (target (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::B::x1")))))
    )
  )
