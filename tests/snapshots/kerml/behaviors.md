...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness unsupported-syntax) (has-evaluation true) (source-digest "blake3:68865699f91e36a67d4f07c6f249bb6a3e1bcf946c5621a2750834b306b37d8e") (contract-version "lossless-publication-completeness-v3"))
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::msg"))) (kind flow) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (flowPayloadType (reference "C")))))
  )
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::C::b"))) (kind featureTyping) (ordinal 0))
      (authored-target "B")
      (outcome (status resolved) (target (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::B")))))
    (reference (id (source (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::msg"))) (kind flowPayloadType) (ordinal 0))
      (authored-target "C")
      (outcome (status resolved) (target (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::C")))))
  )
  (relationships
    ...
    (relationship (kind flowPayloadType) (source (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::msg"))) (target (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::C"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::msg"))) (kind flowPayloadType) (ordinal 0)))
...
(navigation
  ...
  (query (document "memory://snapshot/behaviors.md") (range (start 19 25) (end 19 26)) (probe (position 19 25))
    (reference (id (source (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::msg"))) (kind flowPayloadType) (ordinal 0) (authored-target "C")
      (outcome (status resolved) (target (node (document "memory://snapshot/behaviors.md") (qualified-name "Behaviors::C")))))
    )
  )
)
