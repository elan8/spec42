...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation false) (source-digest "blake3:949760c1f15c1ac357d2c6a1a56ad4841145fcab98e62ffffe81cfe2104554d8") (contract-version "parser-owned-resolution-v1"))
  (declarations
...
(types
    ...
    (declaration (id (node (document "memory://snapshot/camera.md") (path (named (kind class-def) (name "Camera")) (anonymous (kind import) (ordinal 0)))))
