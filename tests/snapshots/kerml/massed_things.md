...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation true) (source-digest "blake3:c17dc71096393b21aa06105c3c4fd813166bbf15ba87ecd48fb4f40c8788fca6") (contract-version "constructor-expression-specialization-v9"))
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/massed_things.md") (qualified-name "MassedThings::MassedThing::mass"))) (kind default-reference) (membership (kind feature) (visibility public)) (feature-value (kind bind) (value (node (document "memory://snapshot/massed_things.md") (path (named (kind package) (name "MassedThings")) (named (kind class-def) (name "MassedThing")) (named (kind default-reference) (name "mass")) (anonymous (kind kerml-expression) (ordinal 0))))) (result (node (document "memory://snapshot/massed_things.md") (path (named (kind package) (name "MassedThings")) (named (kind class-def) (name "MassedThing")) (named (kind default-reference) (name "mass")) (anonymous (kind kerml-expression) (ordinal 0)) (anonymous (kind kerml-feature) (ordinal 0)))))) (authored (membership (kind feature) (visibility public)) (relationships (featureTyping (reference "Real")))))
    (declaration (id (node (document "memory://snapshot/massed_things.md") (path (named (kind package) (name "MassedThings")) (named (kind class-def) (name "MassedThing")) (named (kind default-reference) (name "mass")) (anonymous (kind kerml-expression) (ordinal 0))))) (kind kerml-expression) (membership (kind owning) (visibility default)) (facts (expression-result (node (document "memory://snapshot/massed_things.md") (path (named (kind package) (name "MassedThings")) (named (kind class-def) (name "MassedThing")) (named (kind default-reference) (name "mass")) (anonymous (kind kerml-expression) (ordinal 0)) (anonymous (kind kerml-feature) (ordinal 0)))))))
    ...
    (declaration (id (node (document "memory://snapshot/massed_things.md") (qualified-name "MassedThings::MassedThingAssembly::assembly"))) (kind kerml-feature) (membership (kind feature) (visibility public)) (facts (modifiers end) (cross-feature-projection (cross-feature (node (document "memory://snapshot/massed_things.md") (path (named (kind package) (name "MassedThings")) (named (kind kerml-association) (name "MassedThingAssembly")) (named (kind kerml-feature) (name "assembly")) (anonymous (kind kerml-end) (ordinal 0))))) (owned-cross-feature (node (document "memory://snapshot/massed_things.md") (path (named (kind package) (name "MassedThings")) (named (kind kerml-association) (name "MassedThingAssembly")) (named (kind kerml-feature) (name "assembly")) (anonymous (kind kerml-end) (ordinal 0))))))) (authored (membership (kind feature) (visibility public)) (relationships (featureTyping (reference "MassedThing")))))
    ...
    (declaration (id (node (document "memory://snapshot/massed_things.md") (qualified-name "MassedThings::MassedThingAssembly::parts"))) (kind kerml-feature) (membership (kind feature) (visibility public)) (facts (modifiers end) (cross-feature-projection (cross-feature (node (document "memory://snapshot/massed_things.md") (path (named (kind package) (name "MassedThings")) (named (kind kerml-association) (name "MassedThingAssembly")) (named (kind kerml-feature) (name "parts")) (anonymous (kind kerml-end) (ordinal 0))))) (owned-cross-feature (node (document "memory://snapshot/massed_things.md") (path (named (kind package) (name "MassedThings")) (named (kind kerml-association) (name "MassedThingAssembly")) (named (kind kerml-feature) (name "parts")) (anonymous (kind kerml-end) (ordinal 0))))))) (authored (membership (kind feature) (visibility public)) (relationships (featureTyping (reference "MassedThing")))))
  ...
  (relationships
    ...
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/massed_things.md") (path (named (kind package) (name "MassedThings")) (named (kind class-def) (name "MassedThing")) (named (kind default-reference) (name "mass")) (anonymous (kind kerml-expression) (ordinal 0)) (anonymous (kind kerml-feature) (ordinal 0))))) (target (node (document "memory://snapshot/massed_things.md") (path (named (kind package) (name "MassedThings")) (named (kind class-def) (name "MassedThing")) (named (kind default-reference) (name "mass")) (anonymous (kind kerml-expression) (ordinal 0))))) (provenance implied))
  ...
  (evaluation
    (evaluated (declaration (node (document "memory://snapshot/massed_things.md") (path (named (kind package) (name "MassedThings")) (named (kind class-def) (name "MassedThing")) (named (kind default-reference) (name "mass")) (anonymous (kind kerml-expression) (ordinal 0))))) (state literal) (value (kind integer) (integer 0)))
  )
)
~~~
# TYPES
...
(types
    ...
    (declaration (id (node (document "memory://snapshot/massed_things.md") (path (named (kind package) (name "MassedThings")) (named (kind class-def) (name "MassedThing")) (named (kind default-reference) (name "mass")) (anonymous (kind kerml-expression) (ordinal 0)) (anonymous (kind kerml-feature) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/massed_things.md") (path (named (kind package) (name "MassedThings")) (named (kind class-def) (name "MassedThing")) (named (kind default-reference) (name "mass")) (anonymous (kind kerml-expression) (ordinal 0)))))
    )
