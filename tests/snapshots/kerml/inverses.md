...
(semantic-model
  ...
  (references
    (reference (id (source (node (document "memory://snapshot/inverses.md") (qualified-name "Inverses"))) (kind explicitRelationshipEndpoint) (ordinal 0))
      (authored-target "B::g")
      (outcome (status resolved) (target (node (document "memory://snapshot/inverses.md") (qualified-name "Inverses::B::g")))))
    (reference (id (source (node (document "memory://snapshot/inverses.md") (qualified-name "Inverses"))) (kind explicitRelationshipEndpoint) (ordinal 1))
      (authored-target "A::f")
      (outcome (status resolved) (target (node (document "memory://snapshot/inverses.md") (qualified-name "Inverses::A::f")))))
    (reference (id (source (node (document "memory://snapshot/inverses.md") (qualified-name "Inverses"))) (kind explicitRelationshipEndpoint) (ordinal 2))
      (authored-target "B::g::f")
      (outcome (status resolved) (target (node (document "memory://snapshot/inverses.md") (qualified-name "Inverses::A::f")))))
    (reference (id (source (node (document "memory://snapshot/inverses.md") (qualified-name "Inverses"))) (kind explicitRelationshipEndpoint) (ordinal 3))
      (authored-target "A::h")
  ...
  (relationships
    ...
    (relationship (kind featureInverting) (source (node (document "memory://snapshot/inverses.md") (qualified-name "Inverses::A::f"))) (target (node (document "memory://snapshot/inverses.md") (qualified-name "Inverses::A::h"))) (provenance authored))
    (relationship (kind featureInverting) (source (node (document "memory://snapshot/inverses.md") (qualified-name "Inverses::B::g"))) (target (node (document "memory://snapshot/inverses.md") (qualified-name "Inverses::A::f"))) (provenance authored))
...
~~~sexpr
(navigation
  (query (document "memory://snapshot/inverses.md") (range (start 10 9) (end 10 13)) (probe (position 10 9))
    (reference (id (source (node (document "memory://snapshot/inverses.md") (qualified-name "Inverses"))) (kind explicitRelationshipEndpoint) (ordinal 0) (authored-target "B::g")
      (outcome (status resolved) (target (node (document "memory://snapshot/inverses.md") (qualified-name "Inverses::B::g")))))
    )
  )
  (query (document "memory://snapshot/inverses.md") (range (start 10 17) (end 10 21)) (probe (position 10 17))
    (reference (id (source (node (document "memory://snapshot/inverses.md") (qualified-name "Inverses"))) (kind explicitRelationshipEndpoint) (ordinal 1) (authored-target "A::f")
      (outcome (status resolved) (target (node (document "memory://snapshot/inverses.md") (qualified-name "Inverses::A::f")))))
    )
  )
  (query (document "memory://snapshot/inverses.md") (range (start 11 26) (end 11 32)) (probe (position 11 26))
    (reference (id (source (node (document "memory://snapshot/inverses.md") (qualified-name "Inverses"))) (kind explicitRelationshipEndpoint) (ordinal 2) (authored-target "B::g::f")
      (outcome (status resolved) (target (node (document "memory://snapshot/inverses.md") (qualified-name "Inverses::A::f")))))
    )
  )
  (query (document "memory://snapshot/inverses.md") (range (start 11 36) (end 11 40)) (probe (position 11 36))
    (reference (id (source (node (document "memory://snapshot/inverses.md") (qualified-name "Inverses"))) (kind explicitRelationshipEndpoint) (ordinal 3) (authored-target "A::h")
      (outcome (status resolved) (target (node (document "memory://snapshot/inverses.md") (qualified-name "Inverses::A::h")))))
    )
  )
