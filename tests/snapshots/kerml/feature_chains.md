  ...
  (document "memory://snapshot/feature_chains.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 32 15) (end 32 23))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_package_member")
        (source "semantic")
        (range (start 32 24) (end 32 34))
      )
    )
  )
)
...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/feature_chains.md") (qualified-name "FeatureChains::b_f_a"))) (kind kerml-feature) (membership (kind feature) (visibility default)))
