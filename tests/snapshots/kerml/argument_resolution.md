...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation true) (source-digest "blake3:b753ec2a1688d588b7fc25704884c3a36dbeb6ed77aafa28f53b6a331363e5bc"))
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/argument_resolution.md") (path (named (kind package) (name "ArgumentResolutionBug")) (named (kind class-def) (name "C")) (anonymous (kind kerml-connector) (ordinal 0)) (named (kind kerml-feature) (name "a"))))) (kind kerml-feature) (membership (kind feature) (visibility default)) (facts (positional-end 0)) (authored (membership (kind feature) (visibility default)) (relationships (connectorEnd (reference "a::x")))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/argument_resolution.md") (path (named (kind package) (name "ArgumentResolutionBug")) (named (kind kerml-behavior) (name "B")) (anonymous (kind kerml-feature) (ordinal 0)) (anonymous (kind kerml-expression) (ordinal 0))))) (kind expressionOperand) (ordinal 0))
      (authored-target "x")
      (outcome (status resolved) (target (node (document "memory://snapshot/argument_resolution.md") (qualified-name "ArgumentResolutionBug::A::x")))))
    ...
    (reference (id (source (node (document "memory://snapshot/argument_resolution.md") (path (named (kind package) (name "ArgumentResolutionBug")) (named (kind class-def) (name "C")) (anonymous (kind kerml-connector) (ordinal 0)) (named (kind kerml-feature) (name "a"))))) (kind connectorEnd) (ordinal 0))
      (authored-target "a::x")
  ...
  (relationships
    ...
    (relationship (kind typing) (source (node (document "memory://snapshot/argument_resolution.md") (path (named (kind package) (name "ArgumentResolutionBug")) (named (kind kerml-behavior) (name "B")) (anonymous (kind kerml-feature) (ordinal 0)) (anonymous (kind kerml-expression) (ordinal 0)) (anonymous (kind kerml-feature) (ordinal 0))))) (target (node (document "memory://snapshot/argument_resolution.md") (qualified-name "ArgumentResolutionBug::A"))) (provenance implied))
    ...
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/argument_resolution.md") (path (named (kind package) (name "ArgumentResolutionBug")) (named (kind class-def) (name "C")) (anonymous (kind kerml-connector) (ordinal 0)) (named (kind kerml-feature) (name "a"))))) (target (node (document "memory://snapshot/argument_resolution.md") (path (named (kind package) (name "ArgumentResolutionBug")) (named (kind class-def) (name "C")) (anonymous (kind kerml-connector) (ordinal 0))))) (provenance implied))
...
(types
    (declaration (id (node (document "memory://snapshot/argument_resolution.md") (qualified-name "ArgumentResolutionBug::A")))
      ...
      (subtype (node (document "memory://snapshot/argument_resolution.md") (path (named (kind package) (name "ArgumentResolutionBug")) (named (kind kerml-behavior) (name "B")) (anonymous (kind kerml-feature) (ordinal 0)) (anonymous (kind kerml-expression) (ordinal 0)) (anonymous (kind kerml-feature) (ordinal 0)))) (scopes any))
    ...
    (declaration (id (node (document "memory://snapshot/argument_resolution.md") (path (named (kind package) (name "ArgumentResolutionBug")) (named (kind kerml-behavior) (name "B")) (anonymous (kind kerml-feature) (ordinal 0)) (anonymous (kind kerml-expression) (ordinal 0)) (anonymous (kind kerml-feature) (ordinal 0)))))
      ...
      (type (node (document "memory://snapshot/argument_resolution.md") (qualified-name "ArgumentResolutionBug::A")) (provenance implied))
      (effective-type (node (document "memory://snapshot/argument_resolution.md") (qualified-name "ArgumentResolutionBug::A")) (source direct))
      (supertype (node (document "memory://snapshot/argument_resolution.md") (qualified-name "ArgumentResolutionBug::A")) (scopes any))
    )
    ...
    (declaration (id (node (document "memory://snapshot/argument_resolution.md") (path (named (kind package) (name "ArgumentResolutionBug")) (named (kind class-def) (name "C")) (anonymous (kind kerml-connector) (ordinal 0)) (named (kind kerml-feature) (name "a")))))
      (featured-by (node (document "memory://snapshot/argument_resolution.md") (path (named (kind package) (name "ArgumentResolutionBug")) (named (kind class-def) (name "C")) (anonymous (kind kerml-connector) (ordinal 0)))))
    )
...
(navigation
  ...
  (query (document "memory://snapshot/argument_resolution.md") (range (start 14 25) (end 14 26)) (probe (position 14 25))
    (reference (id (source (node (document "memory://snapshot/argument_resolution.md") (path (named (kind package) (name "ArgumentResolutionBug")) (named (kind class-def) (name "C")) (anonymous (kind kerml-connector) (ordinal 0))))) (kind connectorEnd) (ordinal 0) (authored-target "b")
      (outcome (status resolved) (target (node (document "memory://snapshot/argument_resolution.md") (qualified-name "ArgumentResolutionBug::C::b")))))
    )
  )
  (query (document "memory://snapshot/argument_resolution.md") (range (start 14 18) (end 14 21)) (probe (position 14 18))
    (reference (id (source (node (document "memory://snapshot/argument_resolution.md") (path (named (kind package) (name "ArgumentResolutionBug")) (named (kind class-def) (name "C")) (anonymous (kind kerml-connector) (ordinal 0)) (named (kind kerml-feature) (name "a"))))) (kind connectorEnd) (ordinal 0) (authored-target "a::x")
      (outcome (status unresolved)))
    )
  )
