...
~~~sexpr
(metadata-annotations
  (annotation (element (node (document "memory://snapshot/metadata_annotation_body_references.md") (qualified-name "MetadataAnnotationBody::Annotated"))) (form annotating-member) (definition (resolved (node (document "memory://snapshot/metadata_annotation_body_references.md") (qualified-name "MetadataAnnotationBody::EngineeringConcern")))) (value (redefines (resolved (node (document "memory://snapshot/metadata_annotation_body_references.md") (qualified-name "MetadataAnnotationBody::EngineeringConcern::concern")))) (outcome resolved) (feature-reference "purpose" (target (node (document "memory://snapshot/metadata_annotation_body_references.md") (qualified-name "MetadataAnnotationBody::ConcernKind::purpose"))))))
  (annotation (element (node (document "memory://snapshot/metadata_annotation_body_references.md") (qualified-name "MetadataAnnotationBody::BadAnnotated"))) (form annotating-member) (definition (resolved (node (document "memory://snapshot/metadata_annotation_body_references.md") (qualified-name "MetadataAnnotationBody::EngineeringConcern")))) (value (redefines unresolved) (outcome resolved) (feature-reference "purpose" (target unresolved))))
  (annotation (element (node (document "memory://snapshot/metadata_annotation_body_references.md") (qualified-name "MetadataAnnotationBody::NestedAnnotated"))) (form annotating-member) (definition (resolved (node (document "memory://snapshot/metadata_annotation_body_references.md") (qualified-name "MetadataAnnotationBody::EngineeringConcern")))) (value (redefines (resolved (node (document "memory://snapshot/metadata_annotation_body_references.md") (qualified-name "MetadataAnnotationBody::EngineeringConcern::concern")))) (outcome resolved) (feature-reference "structure" (target (node (document "memory://snapshot/metadata_annotation_body_references.md") (qualified-name "MetadataAnnotationBody::ConcernKind::structure"))))) (value (redefines (resolved (node (document "memory://snapshot/metadata_annotation_body_references.md") (qualified-name "MetadataAnnotationBody::EngineeringConcern::score")))) (outcome not-applicable) (value (redefines (resolved (node (document "memory://snapshot/metadata_annotation_body_references.md") (qualified-name "MetadataAnnotationBody::Score::weight")))) (outcome resolved) (feature-reference "purpose" (target (node (document "memory://snapshot/metadata_annotation_body_references.md") (qualified-name "MetadataAnnotationBody::ConcernKind::purpose")))))))
)
~~~
# NAVIGATION
~~~sexpr
