...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation false) (source-digest "blake3:62eb545c688c3dc9349d84f36683c414050bca54e93ee67b87be17809075b115") (contract-version "constructor-expression-specialization-v9"))
  (declarations
  ...
  (relationships
    ...
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/view_body_satisfy.md") (path (named (kind package) (name "ViewCoverage")) (named (kind view) (name "architecture")) (anonymous (kind satisfy) (ordinal 0))))) (target (node (document "memory://snapshot/view_body_satisfy.md") (qualified-name "ViewCoverage::architecture"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/view_body_satisfy.md") (path (named (kind package) (name "ViewCoverage")) (named (kind view) (name "unresolvable")) (anonymous (kind satisfy) (ordinal 0))))) (target (node (document "memory://snapshot/view_body_satisfy.md") (qualified-name "ViewCoverage::unresolvable"))) (provenance implied))
  )
  (evaluation
  )
)
