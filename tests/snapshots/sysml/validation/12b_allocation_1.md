...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation true) (source-digest "blake3:ae82e7099dc27604c1368eaff5be48ff11690cd1b44014c410d0006167e757b7") (contract-version "parser-owned-resolution-v1"))
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::GenerateTorque::torque"))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction out)) (authored (membership (kind feature) (visibility default)) (relationships (subsetting (reference "ISQ::torque")))))
    ...
    (declaration (id (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalToPhysical::logical"))) (kind connection) (membership (kind feature) (visibility default)) (facts (positional-end 0)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "LogicalElement")))))
    (declaration (id (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalToPhysical::physical"))) (kind connection) (membership (kind feature) (visibility default)) (facts (positional-end 1)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "PhysicalElement")))))
    ...
    (declaration (id (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::torqueGenAlloc"))) (kind allocate) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "LogicalToPhysical")) (allocateSource (reference "logical")) (allocateTarget (reference "physical")))))
    (declaration (id (node (document "memory://snapshot/12b_allocation_1.md") (path (named (kind package) (name "12b-Allocation-1")) (named (kind allocate) (name "torqueGenAlloc")) (anonymous (kind allocate) (ordinal 0))))) (kind allocate) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (memberAccessOperand (reference "torqueGenerator::generateTorque")) (memberAccessOperand (reference "powerTrain::engine::generateTorque")))))
  )
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::GenerateTorque::torque"))) (kind subsetting) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/12b_allocation_1.md") (path (named (kind package) (name "12b-Allocation-1")) (named (kind package) (name "RequirementModel")) (named (kind requirement) (name "torqueGeneration")) (anonymous (kind require-constraint) (ordinal 0))))) (kind memberAccessOperand) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::RequirementModel::torqueGeneration::generator"))) (kind featureTyping) (ordinal 0))
      (authored-target "TorqueGenerator")
      (outcome (status resolved) (target (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::TorqueGenerator")))))
    (reference (id (source (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::torqueGenAlloc"))) (kind featureTyping) (ordinal 0))
      (authored-target "LogicalToPhysical")
      (outcome (status resolved) (target (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalToPhysical")))))
    (reference (id (source (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::torqueGenAlloc"))) (kind allocateSource) (ordinal 0))
      (authored-target "logical")
      (outcome (status resolved) (target (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalToPhysical::logical")))))
    (reference (id (source (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::torqueGenAlloc"))) (kind allocateTarget) (ordinal 0))
      (authored-target "physical")
      (outcome (status resolved) (target (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalToPhysical::physical")))))
    (reference (id (source (node (document "memory://snapshot/12b_allocation_1.md") (path (named (kind package) (name "12b-Allocation-1")) (named (kind allocate) (name "torqueGenAlloc")) (anonymous (kind allocate) (ordinal 0))))) (kind memberAccessOperand) (ordinal 0))
      (authored-target "torqueGenerator::generateTorque")
      (outcome (status resolved) (target (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::TorqueGenerator::generateTorque")))))
    (reference (id (source (node (document "memory://snapshot/12b_allocation_1.md") (path (named (kind package) (name "12b-Allocation-1")) (named (kind allocate) (name "torqueGenAlloc")) (anonymous (kind allocate) (ordinal 0))))) (kind memberAccessOperand) (ordinal 1))
  ...
  (relationships
    ...
    (relationship (kind memberAccessOperand) (source (node (document "memory://snapshot/12b_allocation_1.md") (path (named (kind package) (name "12b-Allocation-1")) (named (kind package) (name "RequirementModel")) (named (kind requirement) (name "torqueGeneration")) (anonymous (kind require-constraint) (ordinal 0))))) (target (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::GenerateTorque::torque"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/12b_allocation_1.md") (path (named (kind package) (name "12b-Allocation-1")) (named (kind package) (name "RequirementModel")) (named (kind requirement) (name "torqueGeneration")) (anonymous (kind require-constraint) (ordinal 0))))) (kind memberAccessOperand) (ordinal 0)))
    ...
    (relationship (kind typing) (source (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::torqueGenAlloc"))) (target (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalToPhysical"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::torqueGenAlloc"))) (kind featureTyping) (ordinal 0)))
    (relationship (kind allocateSource) (source (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::torqueGenAlloc"))) (target (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalToPhysical::logical"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::torqueGenAlloc"))) (kind allocateSource) (ordinal 0)))
    (relationship (kind allocateTarget) (source (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::torqueGenAlloc"))) (target (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalToPhysical::physical"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::torqueGenAlloc"))) (kind allocateTarget) (ordinal 0)))
    (relationship (kind memberAccessOperand) (source (node (document "memory://snapshot/12b_allocation_1.md") (path (named (kind package) (name "12b-Allocation-1")) (named (kind allocate) (name "torqueGenAlloc")) (anonymous (kind allocate) (ordinal 0))))) (target (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::TorqueGenerator::generateTorque"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/12b_allocation_1.md") (path (named (kind package) (name "12b-Allocation-1")) (named (kind allocate) (name "torqueGenAlloc")) (anonymous (kind allocate) (ordinal 0))))) (kind memberAccessOperand) (ordinal 0)))
  )
  (evaluation
...
~~~sexpr
(types
    (declaration (id (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::GenerateTorque")))
      (subtype (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::TorqueGenerator::generateTorque")) (scopes any))
      (subtype (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::providePower::generateTorque")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::GenerateTorque::torque")))
      (featured-by (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::GenerateTorque")))
    )
    (declaration (id (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::LogicalElement")))
      (subtype (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::TorqueGenerator")) (scopes any subclassification))
      (subtype (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalToPhysical::logical")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::TorqueGenerator")))
      ...
      (subtype (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::torqueGenerator")) (scopes any))
      (subtype (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::RequirementModel::torqueGeneration::generator")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::TorqueGenerator::generateTorque")))
      (featured-by (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::TorqueGenerator")))
      (type (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::GenerateTorque")) (provenance authored))
      (effective-type (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::GenerateTorque")) (source direct))
      ...
      (subtype (node (document "memory://snapshot/12b_allocation_1.md") (path (named (kind package) (name "12b-Allocation-1")) (named (kind package) (name "LogicalModel")) (named (kind part) (name "torqueGenerator")) (anonymous (kind perform-action) (ordinal 0)))) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::providePower::generateTorque")))
      (featured-by (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::providePower")))
      (type (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::GenerateTorque")) (provenance authored))
      (effective-type (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::GenerateTorque")) (source direct))
      (supertype (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::GenerateTorque")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::torqueGenerator")))
      (type (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::TorqueGenerator")) (provenance authored))
      (effective-type (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::TorqueGenerator")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/12b_allocation_1.md") (path (named (kind package) (name "12b-Allocation-1")) (named (kind package) (name "LogicalModel")) (named (kind part) (name "torqueGenerator")) (anonymous (kind perform-action) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::torqueGenerator")))
      (effective-type (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::GenerateTorque")) (source inherited) (from (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::TorqueGenerator::generateTorque"))))
      (supertype (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::GenerateTorque")) (scopes any))
      (supertype (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::TorqueGenerator::generateTorque")) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalToPhysical")))
      (positional-ends (authored 2) (effective 2))
      (subtype (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::torqueGenAlloc")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalToPhysical::logical")))
      (featured-by (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalToPhysical")))
      (type (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::LogicalElement")) (provenance authored))
      (effective-type (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::LogicalElement")) (source direct))
      (supertype (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::LogicalElement")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalToPhysical::physical")))
      (featured-by (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalToPhysical")))
      (type (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::PhysicalModel::PhysicalElement")) (provenance authored))
      (effective-type (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::PhysicalModel::PhysicalElement")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::PhysicalModel::PhysicalElement")))
      (subtype (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalToPhysical::physical")) (scopes any))
      (subtype (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::PhysicalModel::PowerTrain")) (scopes any subclassification))
    )
    (declaration (id (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::PhysicalModel::PowerTrain")))
      ...
      (subtype (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::PhysicalModel::powerTrain")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::PhysicalModel::powerTrain")))
      (type (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::PhysicalModel::PowerTrain")) (provenance authored))
      (effective-type (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::PhysicalModel::PowerTrain")) (source direct))
      (supertype (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::PhysicalModel::PhysicalElement")) (scopes any))
    ...
    (declaration (id (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::PhysicalModel::powerTrain::engine")))
      (featured-by (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::PhysicalModel::powerTrain")))
    )
    (declaration (id (node (document "memory://snapshot/12b_allocation_1.md") (path (named (kind package) (name "12b-Allocation-1")) (named (kind package) (name "PhysicalModel")) (named (kind part) (name "powerTrain")) (named (kind part) (name "engine")) (anonymous (kind perform-action) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::PhysicalModel::powerTrain::engine")))
    )
    (declaration (id (node (document "memory://snapshot/12b_allocation_1.md") (path (named (kind package) (name "12b-Allocation-1")) (named (kind package) (name "RequirementModel")) (named (kind requirement) (name "torqueGeneration")) (anonymous (kind require-constraint) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::RequirementModel::torqueGeneration")))
    )
    ...
    (declaration (id (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::torqueGenAlloc")))
      (positional-ends (authored 0) (effective 2))
      (type (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalToPhysical")) (provenance authored))
      (effective-type (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalToPhysical")) (source direct))
      (supertype (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalToPhysical")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/12b_allocation_1.md") (path (named (kind package) (name "12b-Allocation-1")) (named (kind allocate) (name "torqueGenAlloc")) (anonymous (kind allocate) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::torqueGenAlloc")))
    )
)
~~~
# NAVIGATION
...
(navigation
  ...
  (query (document "memory://snapshot/12b_allocation_1.md") (range (start 16 44) (end 16 55)) (probe (position 16 44))
    (reference (id (source (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::GenerateTorque::torque"))) (kind subsetting) (ordinal 0) (authored-target "ISQ::torque")
      (outcome (status unresolved)))
    )
  )
  ...
  (query (document "memory://snapshot/12b_allocation_1.md") (range (start 50 29) (end 50 46)) (probe (position 50 29))
    (reference (id (source (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::torqueGenAlloc"))) (kind featureTyping) (ordinal 0) (authored-target "LogicalToPhysical")
      (outcome (status resolved) (target (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalToPhysical")))))
    )
  )
  (query (document "memory://snapshot/12b_allocation_1.md") (range (start 51 11) (end 51 18)) (probe (position 51 11))
    (reference (id (source (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::torqueGenAlloc"))) (kind allocateSource) (ordinal 0) (authored-target "logical")
      (outcome (status resolved) (target (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalToPhysical::logical")))))
    )
  )
  (query (document "memory://snapshot/12b_allocation_1.md") (range (start 51 42) (end 51 50)) (probe (position 51 42))
    (reference (id (source (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::torqueGenAlloc"))) (kind allocateTarget) (ordinal 0) (authored-target "physical")
      (outcome (status resolved) (target (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalToPhysical::physical")))))
    )
  )
  (query (document "memory://snapshot/12b_allocation_1.md") (range (start 53 11) (end 53 41)) (probe (position 53 11))
    (reference (id (source (node (document "memory://snapshot/12b_allocation_1.md") (path (named (kind package) (name "12b-Allocation-1")) (named (kind allocate) (name "torqueGenAlloc")) (anonymous (kind allocate) (ordinal 0))))) (kind memberAccessOperand) (ordinal 0) (authored-target "torqueGenerator::generateTorque")
      (outcome (status resolved) (target (node (document "memory://snapshot/12b_allocation_1.md") (qualified-name "12b-Allocation-1::LogicalModel::TorqueGenerator::generateTorque")))))
    )
  )
  (query (document "memory://snapshot/12b_allocation_1.md") (range (start 53 45) (end 53 77)) (probe (position 53 45))
    (reference (id (source (node (document "memory://snapshot/12b_allocation_1.md") (path (named (kind package) (name "12b-Allocation-1")) (named (kind allocate) (name "torqueGenAlloc")) (anonymous (kind allocate) (ordinal 0))))) (kind memberAccessOperand) (ordinal 1) (authored-target "powerTrain::engine::generateTorque")
      (outcome (status unresolved)))
    )
  )
)
