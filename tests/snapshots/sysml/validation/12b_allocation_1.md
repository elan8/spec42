...
(semantic-model
  ...
  (relationships
    ...
    (relationship (kind memberAccessOperand) (source (node (document "memory://snapshot/12b_allocation_1.md") (path (named (kind package) (name "12b-Allocation-1")) (named (kind allocate) (name "torqueGenAlloc")) (anonymous (kind allocate) (ordinal 0))))) (target (node (document "memory://snapshot/12b_allocation_1.md") (path (named (kind package) (name "12b-Allocation-1")) (named (kind package) (name "LogicalModel")) (named (kind part) (name "torqueGenerator")) (anonymous (kind perform-action) (ordinal 0))))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/12b_allocation_1.md") (path (named (kind package) (name "12b-Allocation-1")) (named (kind allocate) (name "torqueGenAlloc")) (anonymous (kind allocate) (ordinal 0))))) (kind memberAccessOperand) (ordinal 0)))
