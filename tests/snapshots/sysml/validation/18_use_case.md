...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness unsupported-syntax) (has-evaluation false) (source-digest "blake3:39f8cb233733093cba3b33d7a329a437580e3ca1a386383354314d85f0d0b6d2"))
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/18_use_case.md") (qualified-name "18-Use Case::provide transportation::drive vehicle"))) (kind use-case) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (includeUseCase (reference "add fuel")))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/18_use_case.md") (path (named (kind package) (name "18-Use Case")) (named (kind use-case) (name "provide transportation")) (anonymous (kind succession) (ordinal 0))))) (kind succession) (ordinal 0))
      (authored-target "start")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/18_use_case.md") (path (named (kind package) (name "18-Use Case")) (named (kind use-case) (name "provide transportation")) (anonymous (kind then-continuation) (ordinal 0))))) (kind thenTarget) (ordinal 0))
      (authored-target "done")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/18_use_case.md") (qualified-name "18-Use Case::provide transportation::drive vehicle"))) (kind includeUseCase) (ordinal 0))
      (authored-target "add fuel")
      (outcome (status resolved) (target (node (document "memory://snapshot/18_use_case.md") (qualified-name "18-Use Case::add fuel")))))
  ...
  (relationships
    ...
    (relationship (kind includeUseCase) (source (node (document "memory://snapshot/18_use_case.md") (qualified-name "18-Use Case::provide transportation::drive vehicle"))) (target (node (document "memory://snapshot/18_use_case.md") (qualified-name "18-Use Case::add fuel"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/18_use_case.md") (qualified-name "18-Use Case::provide transportation::drive vehicle"))) (kind includeUseCase) (ordinal 0)))
    ...
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/18_use_case.md") (path (named (kind package) (name "18-Use Case")) (named (kind use-case) (name "provide transportation")) (anonymous (kind succession) (ordinal 0))))) (target (node (document "memory://snapshot/18_use_case.md") (qualified-name "18-Use Case::provide transportation"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/18_use_case.md") (path (named (kind package) (name "18-Use Case")) (named (kind use-case) (name "provide transportation")) (anonymous (kind then-continuation) (ordinal 0))))) (target (node (document "memory://snapshot/18_use_case.md") (qualified-name "18-Use Case::provide transportation"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/18_use_case.md") (qualified-name "18-Use Case::provide transportation::drive vehicle"))) (target (node (document "memory://snapshot/18_use_case.md") (qualified-name "18-Use Case::provide transportation"))) (provenance implied))
...
(types
    ...
    (declaration (id (node (document "memory://snapshot/18_use_case.md") (path (named (kind package) (name "18-Use Case")) (named (kind use-case) (name "provide transportation")) (anonymous (kind succession) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/18_use_case.md") (qualified-name "18-Use Case::provide transportation")))
    )
    (declaration (id (node (document "memory://snapshot/18_use_case.md") (path (named (kind package) (name "18-Use Case")) (named (kind use-case) (name "provide transportation")) (anonymous (kind then-continuation) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/18_use_case.md") (qualified-name "18-Use Case::provide transportation")))
    )
    (declaration (id (node (document "memory://snapshot/18_use_case.md") (qualified-name "18-Use Case::provide transportation::drive vehicle")))
      (featured-by (node (document "memory://snapshot/18_use_case.md") (qualified-name "18-Use Case::provide transportation")))
    )
...
(navigation
  ...
  (query (document "memory://snapshot/18_use_case.md") (range (start 30 8) (end 30 13)) (probe (position 30 8))
    (reference (id (source (node (document "memory://snapshot/18_use_case.md") (path (named (kind package) (name "18-Use Case")) (named (kind use-case) (name "provide transportation")) (anonymous (kind succession) (ordinal 0))))) (kind succession) (ordinal 0) (authored-target "start")
      (outcome (status unresolved)))
    )
  )
  (query (document "memory://snapshot/18_use_case.md") (range (start 60 7) (end 60 11)) (probe (position 60 7))
    (reference (id (source (node (document "memory://snapshot/18_use_case.md") (path (named (kind package) (name "18-Use Case")) (named (kind use-case) (name "provide transportation")) (anonymous (kind then-continuation) (ordinal 0))))) (kind thenTarget) (ordinal 0) (authored-target "done")
      (outcome (status unresolved)))
    )
  )
  (query (document "memory://snapshot/18_use_case.md") (range (start 39 11) (end 39 21)) (probe (position 39 11))
    (reference (id (source (node (document "memory://snapshot/18_use_case.md") (qualified-name "18-Use Case::provide transportation::drive vehicle"))) (kind includeUseCase) (ordinal 0) (authored-target "add fuel")
      (outcome (status resolved) (target (node (document "memory://snapshot/18_use_case.md") (qualified-name "18-Use Case::add fuel")))))
    )
  )
