...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation false) (source-digest "blake3:de391375b639f38b3a8497d1acd8a6b8857bb5449be38c0080832b75777657a2"))
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerHitch::coupler"))) (kind connection) (membership (kind feature) (visibility default)) (facts (positional-end 1)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "TrailerCoupler")))))
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerHitch::hitch"))) (kind connection) (membership (kind feature) (visibility default)) (facts (positional-end 0)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "HitchBall")))))
    ...
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (path (named (kind package) (name "3c-Function-based Behavior-structure mod-2")) (named (kind part) (name "vehicle-trailer system")) (anonymous (kind perform-action) (ordinal 0)) (named (kind action) (name "connect trailer to vehicle"))))) (kind action) (membership (kind feature) (visibility default)) (facts (modifiers composite)))
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (path (named (kind package) (name "3c-Function-based Behavior-structure mod-2")) (named (kind part) (name "vehicle-trailer system")) (anonymous (kind perform-action) (ordinal 0)) (named (kind action) (name "connect trailer to vehicle")) (anonymous (kind ref) (ordinal 0))))) (kind ref) (membership (kind feature) (visibility default)) (facts (modifiers abstract)) (effective-identification (name "trailerHitch") (short-name absent) (provenance first-redefinition)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "trailerHitch")))))
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (path (named (kind package) (name "3c-Function-based Behavior-structure mod-2")) (named (kind part) (name "vehicle-trailer system")) (anonymous (kind perform-action) (ordinal 0)) (named (kind action) (name "disconnect trailer from vehicle"))))) (kind action) (membership (kind feature) (visibility default)) (facts (modifiers composite)))
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (path (named (kind package) (name "3c-Function-based Behavior-structure mod-2")) (named (kind part) (name "vehicle-trailer system")) (anonymous (kind perform-action) (ordinal 0)) (named (kind action) (name "disconnect trailer from vehicle")) (anonymous (kind ref) (ordinal 0))))) (kind ref) (membership (kind feature) (visibility default)) (facts (modifiers abstract)) (effective-identification (name "trailerHitch") (short-name absent) (provenance first-redefinition)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "trailerHitch")))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailerHitch"))) (kind memberAccessOperand) (ordinal 0))
      ...
      (outcome (status resolved) (target (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::vehicle::vehicleFrame::hitch")))))
    (reference (id (source (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailerHitch"))) (kind memberAccessOperand) (ordinal 1))
      ...
      (outcome (status resolved) (target (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailer::trailerFrame::coupler")))))
  ...
  (relationships
    ...
    (relationship (kind memberAccessOperand) (source (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailerHitch"))) (target (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::vehicle::vehicleFrame::hitch"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailerHitch"))) (kind memberAccessOperand) (ordinal 0)))
    (relationship (kind memberAccessOperand) (source (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailerHitch"))) (target (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailer::trailerFrame::coupler"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailerHitch"))) (kind memberAccessOperand) (ordinal 1)))
    ...
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerHitch::coupler"))) (target (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerHitch"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerHitch::hitch"))) (target (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerHitch"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (path (named (kind package) (name "3c-Function-based Behavior-structure mod-2")) (named (kind part) (name "vehicle-trailer system")) (anonymous (kind perform-action) (ordinal 0))))) (target (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (path (named (kind package) (name "3c-Function-based Behavior-structure mod-2")) (named (kind part) (name "vehicle-trailer system")) (anonymous (kind perform-action) (ordinal 0)) (named (kind action) (name "connect trailer to vehicle"))))) (target (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (path (named (kind package) (name "3c-Function-based Behavior-structure mod-2")) (named (kind part) (name "vehicle-trailer system")) (anonymous (kind perform-action) (ordinal 0))))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (path (named (kind package) (name "3c-Function-based Behavior-structure mod-2")) (named (kind part) (name "vehicle-trailer system")) (anonymous (kind perform-action) (ordinal 0)) (named (kind action) (name "connect trailer to vehicle")) (anonymous (kind ref) (ordinal 0))))) (target (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (path (named (kind package) (name "3c-Function-based Behavior-structure mod-2")) (named (kind part) (name "vehicle-trailer system")) (anonymous (kind perform-action) (ordinal 0)) (named (kind action) (name "connect trailer to vehicle"))))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (path (named (kind package) (name "3c-Function-based Behavior-structure mod-2")) (named (kind part) (name "vehicle-trailer system")) (anonymous (kind perform-action) (ordinal 0)) (named (kind action) (name "disconnect trailer from vehicle"))))) (target (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (path (named (kind package) (name "3c-Function-based Behavior-structure mod-2")) (named (kind part) (name "vehicle-trailer system")) (anonymous (kind perform-action) (ordinal 0))))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (path (named (kind package) (name "3c-Function-based Behavior-structure mod-2")) (named (kind part) (name "vehicle-trailer system")) (anonymous (kind perform-action) (ordinal 0)) (named (kind action) (name "disconnect trailer from vehicle")) (anonymous (kind ref) (ordinal 0))))) (target (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (path (named (kind package) (name "3c-Function-based Behavior-structure mod-2")) (named (kind part) (name "vehicle-trailer system")) (anonymous (kind perform-action) (ordinal 0)) (named (kind action) (name "disconnect trailer from vehicle"))))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailer"))) (target (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailer::trailerFrame"))) (target (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailer"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailer::trailerFrame::coupler"))) (target (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailer::trailerFrame"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailerHitch"))) (target (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::vehicle"))) (target (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::vehicle::vehicleFrame"))) (target (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::vehicle"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::vehicle::vehicleFrame::hitch"))) (target (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::vehicle::vehicleFrame"))) (provenance implied))
  )
  (evaluation
  )
)
...
~~~sexpr
(types
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::HitchBall")))
      (subtype (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerHitch::hitch")) (scopes any))
      (subtype (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::vehicle::vehicleFrame::hitch")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::Trailer")))
      (subtype (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailer")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerCoupler")))
      (subtype (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerHitch::coupler")) (scopes any))
      (subtype (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailer::trailerFrame::coupler")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerFrame")))
      (subtype (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailer::trailerFrame")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerHitch")))
      (positional-ends (authored 2) (effective 2))
      (subtype (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailerHitch")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerHitch::coupler")))
      (featured-by (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerHitch")))
      (type (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerCoupler")) (provenance authored))
      (effective-type (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerCoupler")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerHitch::hitch")))
      (featured-by (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerHitch")))
      (type (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::HitchBall")) (provenance authored))
      (effective-type (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::HitchBall")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::Vehicle")))
      (subtype (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::vehicle")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::VehicleFrame")))
      (subtype (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::vehicle::vehicleFrame")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (path (named (kind package) (name "3c-Function-based Behavior-structure mod-2")) (named (kind part) (name "vehicle-trailer system")) (anonymous (kind perform-action) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system")))
    )
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (path (named (kind package) (name "3c-Function-based Behavior-structure mod-2")) (named (kind part) (name "vehicle-trailer system")) (anonymous (kind perform-action) (ordinal 0)) (named (kind action) (name "connect trailer to vehicle")))))
      (featured-by (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (path (named (kind package) (name "3c-Function-based Behavior-structure mod-2")) (named (kind part) (name "vehicle-trailer system")) (anonymous (kind perform-action) (ordinal 0)))))
    )
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (path (named (kind package) (name "3c-Function-based Behavior-structure mod-2")) (named (kind part) (name "vehicle-trailer system")) (anonymous (kind perform-action) (ordinal 0)) (named (kind action) (name "connect trailer to vehicle")) (anonymous (kind ref) (ordinal 0)))))
      ...
      (featured-by (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (path (named (kind package) (name "3c-Function-based Behavior-structure mod-2")) (named (kind part) (name "vehicle-trailer system")) (anonymous (kind perform-action) (ordinal 0)) (named (kind action) (name "connect trailer to vehicle")))))
      (effective-type (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerHitch")) (source inherited) (from (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailerHitch"))))
      ...
      (supertype (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailerHitch")) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (path (named (kind package) (name "3c-Function-based Behavior-structure mod-2")) (named (kind part) (name "vehicle-trailer system")) (anonymous (kind perform-action) (ordinal 0)) (named (kind action) (name "disconnect trailer from vehicle")))))
      (featured-by (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (path (named (kind package) (name "3c-Function-based Behavior-structure mod-2")) (named (kind part) (name "vehicle-trailer system")) (anonymous (kind perform-action) (ordinal 0)))))
    )
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (path (named (kind package) (name "3c-Function-based Behavior-structure mod-2")) (named (kind part) (name "vehicle-trailer system")) (anonymous (kind perform-action) (ordinal 0)) (named (kind action) (name "disconnect trailer from vehicle")) (anonymous (kind ref) (ordinal 0)))))
      (positional-ends (authored 0) (effective 2))
      (featured-by (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (path (named (kind package) (name "3c-Function-based Behavior-structure mod-2")) (named (kind part) (name "vehicle-trailer system")) (anonymous (kind perform-action) (ordinal 0)) (named (kind action) (name "disconnect trailer from vehicle")))))
      (effective-type (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerHitch")) (source inherited) (from (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailerHitch"))))
      (supertype (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerHitch")) (scopes any))
      (supertype (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailerHitch")) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailer")))
      (featured-by (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system")))
      (type (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::Trailer")) (provenance authored))
      (effective-type (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::Trailer")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailer::trailerFrame")))
      (featured-by (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailer")))
      (type (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerFrame")) (provenance authored))
      (effective-type (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerFrame")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailer::trailerFrame::coupler")))
      (featured-by (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailer::trailerFrame")))
      (type (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerCoupler")) (provenance authored))
      (effective-type (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerCoupler")) (source direct))
      (supertype (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerCoupler")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailerHitch")))
      (positional-ends (authored 0) (effective 2))
      (featured-by (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system")))
      (type (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerHitch")) (provenance authored))
      (effective-type (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerHitch")) (source direct))
      (supertype (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerHitch")) (scopes any))
      (subtype (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (path (named (kind package) (name "3c-Function-based Behavior-structure mod-2")) (named (kind part) (name "vehicle-trailer system")) (anonymous (kind perform-action) (ordinal 0)) (named (kind action) (name "connect trailer to vehicle")) (anonymous (kind ref) (ordinal 0)))) (scopes any feature))
      (subtype (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (path (named (kind package) (name "3c-Function-based Behavior-structure mod-2")) (named (kind part) (name "vehicle-trailer system")) (anonymous (kind perform-action) (ordinal 0)) (named (kind action) (name "disconnect trailer from vehicle")) (anonymous (kind ref) (ordinal 0)))) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::vehicle")))
      (featured-by (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system")))
      (type (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::Vehicle")) (provenance authored))
      (effective-type (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::Vehicle")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::vehicle::vehicleFrame")))
      (featured-by (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::vehicle")))
      (type (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::VehicleFrame")) (provenance authored))
      (effective-type (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::VehicleFrame")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::vehicle::vehicleFrame::hitch")))
      (featured-by (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::vehicle::vehicleFrame")))
      (type (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::HitchBall")) (provenance authored))
      (effective-type (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::HitchBall")) (source direct))
      (supertype (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::HitchBall")) (scopes any))
    )
...
(connections
  ...
  (connector (id (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailerHitch"))) (kind connection) (type (resolved (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::TrailerHitch")))) (end bare (feature-chain (root (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::vehicle"))) (terminal (resolved (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::vehicle::vehicleFrame::hitch")))) (path (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::vehicle")) (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::vehicle::vehicleFrame")) (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::vehicle::vehicleFrame::hitch"))) "vehicle::vehicleFrame::hitch")) (end bare (feature-chain (root (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailer"))) (terminal (resolved (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailer::trailerFrame::coupler")))) (path (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailer")) (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailer::trailerFrame")) (node (document "memory://snapshot/3c_function_based_behavior_structure_mod_2.md") (qualified-name "3c-Function-based Behavior-structure mod-2::vehicle-trailer system::trailer::trailerFrame::coupler"))) "trailer::trailerFrame::coupler")))
)
~~~
# NAVIGATION
~~~sexpr
