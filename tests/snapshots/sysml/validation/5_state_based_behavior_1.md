...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness unsupported-syntax) (has-evaluation true) (source-digest "blake3:bd4e70d8d29348added27f11a9dd4c31d219e92e5cf74856b03357d5ec1b1104"))
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (anonymous (kind import) (ordinal 0))))) (kind import) (membership (kind import) (visibility private)) (authored (membership (kind import) (visibility private)) (relationships (namespaceImport (reference "ScalarValues") (import (shape namespace) (recursive false))))))
    ...
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions"))) (kind package) (membership (kind owning) (visibility default)) (documentation (comment (text "\n\t\t * Black box specifications for state definitions may also have\n\t\t * input and output parameters, like activities, though none\n\t\t * are used here.\n\t\t "))))
    ...
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Sense Temperature::temp"))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction out)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "TemperatureValue") (direction out)))))
    ...
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA"))) (kind part-def) (membership (kind owning) (visibility default)) (documentation (comment (text "\n\t\t\t * The following declare that 'VehicleA' performs a\n\t\t\t * 'provide power' action and exhibits some 'vehicle states',\n\t\t\t * without giving details about these behaviors.\n\t\t\t "))))
    ...
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleController::controller states"))) (kind state) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Controller States")))))
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages"))) (kind package) (membership (kind owning) (visibility default)) (documentation (comment (text "\n\t\t * These actions are used enabled in the state usage \n\t\t * 'vehicle states', in addition to 'provide power'.\n\t\t "))))
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (anonymous (kind import) (ordinal 0))))) (kind import) (membership (kind import) (visibility private)) (authored (membership (kind import) (visibility private)) (relationships (namespaceImport (reference "Definitions") (import (shape namespace) (recursive false))))))
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::apply parking brake"))) (kind action) (membership (kind feature) (visibility default)) (facts (modifiers composite)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Apply Parking Brake")))))
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states"))) (kind state) (membership (kind feature) (visibility default)) (facts (modifiers parallel)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Controller States")))))
    ...
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::perform self test"))) (kind action) (membership (kind feature) (visibility default)) (facts (modifiers composite)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Perform Self Test")))))
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::sense temperature"))) (kind action) (membership (kind feature) (visibility default)) (facts (modifiers composite)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Sense Temperature")))))
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states"))) (kind state) (membership (kind feature) (visibility default)) (facts (modifiers parallel)) (documentation (comment (text "\n\t\t\t * This is a usage of the state definition 'Vehicle States'.\n\t\t\t * Note that it depends specifically on on the part 'vehicle1_c1'.\n\t\t\t "))) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Vehicle States")))))
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states"))) (kind state) (membership (kind feature) (visibility default)) (documentation (comment (text "\n\t\t\t\t * 'health states' is concurrent with 'operational states', because the\n\t\t\t\t * containing state usage is \"parallel\".\n\t\t\t\t "))))
    ...
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states"))) (kind state) (membership (kind feature) (visibility default)) (documentation (doc (text "\n\t\t\t * The state definition for this usage is implicit.\n\t\t\t "))))
    ...
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::on"))) (kind state) (membership (kind feature) (visibility default)) (documentation (comment (text "\n\t\t\t\t\t * A state may have a \"entry\" action that is performed on entry into\n\t\t\t\t\t * the state, a \"do\" action that is performed while in the state\n\t\t\t\t\t * and an \"exit\" action that is performed on exit from the state.\n\t\t\t\t\t "))))
    ...
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1"))) (kind part) (membership (kind feature) (visibility default)) (documentation (comment (text "\n\t\t\t * These attribute properties are used in the specification for\n\t\t\t * 'vehicle states'.\n\t\t\t "))) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "VehicleA")))))
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind perform-action) (ordinal 0))))) (kind perform-action) (membership (kind feature) (visibility default)) (effective-identification (name "provide power") (short-name absent) (provenance first-redefinition)) (documentation (comment (text "\n\t\t\t\t * In the context of the 'vehicle1_c1' part, the 'provide power' action\n\t\t\t\t * that is enabled in 'vehicle states' gets its input from the 'fuelCmdPort'.\n\t\t\t\t "))) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "VehicleA::provide power")) (referenceSubsetting (reference "provide power")))))
    ...
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::fuelCmdPort::fuelCmd"))) (kind parameter) (membership (kind feature) (visibility default)) (facts (direction in)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "FuelCmd") (direction in)))))
  ...
  (references
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (anonymous (kind import) (ordinal 0))))) (kind namespaceImport) (ordinal 0))
      (authored-target "ScalarValues")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (anonymous (kind import) (ordinal 1))))) (kind namespaceImport) (ordinal 0))
      (authored-target "ISQ")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (anonymous (kind import) (ordinal 2))))) (kind namespaceImport) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA::provide power"))) (kind featureTyping) (ordinal 0))
      ...
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA::vehicle states"))) (kind featureTyping) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleController::controller states"))) (kind featureTyping) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (anonymous (kind import) (ordinal 0))))) (kind namespaceImport) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states"))) (kind featureTyping) (ordinal 0))
      (authored-target "Controller States")
      (outcome (status resolved) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Controller States")))))
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "controller states")) (named (kind state) (name "operational controller states")) (anonymous (kind entry-action-binding) (ordinal 0))))) (kind entryActionBinding) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::normal-degraded"))) (kind memberAccessOperand) (ordinal 1))
      ...
      (outcome (status resolved) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::Tmax")))))
    ...
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::normal-maintenance"))) (kind memberAccessOperand) (ordinal 0))
      ...
      (outcome (status resolved) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::maintenanceTime")))))
    ...
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::off-starting"))) (kind memberAccessOperand) (ordinal 0))
      ...
      (outcome (status resolved) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::brake pedal depressed")))))
    ...
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1"))) (kind featureTyping) (ordinal 0))
      (authored-target "VehicleA")
      (outcome (status resolved) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA")))))
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind perform-action) (ordinal 0))))) (kind redefinition) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind state) (ordinal 0))))) (kind redefinition) (ordinal 0))
      (authored-target "VehicleA::vehicle states")
      (outcome (status resolved) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA::vehicle states")))))
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind perform-action) (ordinal 0))))) (kind referenceSubsetting) (ordinal 0))
      (authored-target "provide power")
      (outcome (status resolved) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind perform-action) (ordinal 0)))))))
    ...
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (named (kind part) (name "vehicleController")) (anonymous (kind state) (ordinal 0))))) (kind redefinition) (ordinal 0))
      (authored-target "VehicleController::controller states")
      (outcome (status resolved) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleController::controller states")))))
  )
  (relationships
    (relationship (kind typing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA::vehicle states"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Vehicle States"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA::vehicle states"))) (kind featureTyping) (ordinal 0)))
    (relationship (kind typing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleController::controller states"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Controller States"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleController::controller states"))) (kind featureTyping) (ordinal 0)))
    ...
    (relationship (kind entryActionBinding) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "controller states")) (named (kind state) (name "operational controller states")) (anonymous (kind entry-action-binding) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states::initial"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "controller states")) (named (kind state) (name "operational controller states")) (anonymous (kind entry-action-binding) (ordinal 0))))) (kind entryActionBinding) (ordinal 0)))
    ...
    (relationship (kind entryActionBinding) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "health states")) (anonymous (kind entry-action-binding) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::initial"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "health states")) (anonymous (kind entry-action-binding) (ordinal 0))))) (kind entryActionBinding) (ordinal 0)))
    (relationship (kind doActionBinding) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "health states")) (anonymous (kind do-action-binding) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::sense temperature"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "health states")) (anonymous (kind do-action-binding) (ordinal 0))))) (kind doActionBinding) (ordinal 0)))
    ...
    (relationship (kind memberAccessOperand) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::normal-degraded"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::Tmax"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::normal-degraded"))) (kind memberAccessOperand) (ordinal 1)))
    ...
    (relationship (kind memberAccessOperand) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::normal-maintenance"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::maintenanceTime"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::normal-maintenance"))) (kind memberAccessOperand) (ordinal 0)))
    (relationship (kind entryActionBinding) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "operational states")) (anonymous (kind entry-action-binding) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::initial"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "operational states")) (anonymous (kind entry-action-binding) (ordinal 0))))) (kind entryActionBinding) (ordinal 0)))
    ...
    (relationship (kind memberAccessOperand) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::off-starting"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::brake pedal depressed"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::off-starting"))) (kind memberAccessOperand) (ordinal 0)))
    ...
    (relationship (kind entryActionBinding) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "operational states")) (named (kind state) (name "on")) (anonymous (kind entry-action-binding) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::perform self test"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "operational states")) (named (kind state) (name "on")) (anonymous (kind entry-action-binding) (ordinal 0))))) (kind entryActionBinding) (ordinal 0)))
    (relationship (kind exitActionBinding) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "operational states")) (named (kind state) (name "on")) (anonymous (kind exit-action-binding) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::apply parking brake"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "operational states")) (named (kind state) (name "on")) (anonymous (kind exit-action-binding) (ordinal 0))))) (kind exitActionBinding) (ordinal 0)))
    ...
    (relationship (kind redefinition) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind perform-action) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA::provide power"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind perform-action) (ordinal 0))))) (kind redefinition) (ordinal 0)))
    (relationship (kind redefinition) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind state) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA::vehicle states"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind state) (ordinal 0))))) (kind redefinition) (ordinal 0)))
    (relationship (kind referenceSubsetting) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind perform-action) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind perform-action) (ordinal 0))))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind perform-action) (ordinal 0))))) (kind referenceSubsetting) (ordinal 0)))
    (relationship (kind expressionOperand) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind perform-action) (ordinal 0)) (anonymous (kind perform-parameter-binding) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::fuelCmdPort::fuelCmd"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind perform-action) (ordinal 0)) (anonymous (kind perform-parameter-binding) (ordinal 0))))) (kind expressionOperand) (ordinal 0)))
    ...
    (relationship (kind redefinition) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (named (kind part) (name "vehicleController")) (anonymous (kind state) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleController::controller states"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (named (kind part) (name "vehicleController")) (anonymous (kind state) (ordinal 0))))) (kind redefinition) (ordinal 0)))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Sense Temperature::temp"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Sense Temperature"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA::provide power"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA::vehicle states"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleController::controller states"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleController"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "controller states")) (named (kind state) (name "operational controller states")) (anonymous (kind entry-action-binding) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states::initial"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states::off"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states::off-on"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "controller states")) (named (kind state) (name "operational controller states")) (named (kind transition) (name "off-on")) (anonymous (kind accept-action) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states::off-on"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states::on"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states::on-off"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "controller states")) (named (kind state) (name "operational controller states")) (named (kind transition) (name "on-off")) (anonymous (kind accept-action) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states::on-off"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "health states")) (anonymous (kind entry-action-binding) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "health states")) (anonymous (kind do-action-binding) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::degraded"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::degraded-normal"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "health states")) (named (kind transition) (name "degraded-normal")) (anonymous (kind accept-action) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::degraded-normal"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::initial"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::maintenance"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::maintenance-normal"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "health states")) (named (kind transition) (name "maintenance-normal")) (anonymous (kind accept-action) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::maintenance-normal"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::normal"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::normal-degraded"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "health states")) (named (kind transition) (name "normal-degraded")) (anonymous (kind accept-action) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::normal-degraded"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::normal-maintenance"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "health states")) (named (kind transition) (name "normal-maintenance")) (anonymous (kind accept-action) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::normal-maintenance"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "operational states")) (anonymous (kind entry-action-binding) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::initial"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::off"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::off-starting"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "operational states")) (named (kind transition) (name "off-starting")) (anonymous (kind accept-action) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::off-starting"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::on"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::on-off"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "operational states")) (named (kind transition) (name "on-off")) (anonymous (kind accept-action) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::on-off"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "operational states")) (named (kind state) (name "on")) (anonymous (kind entry-action-binding) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::on"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "operational states")) (named (kind state) (name "on")) (anonymous (kind do-action-binding) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::on"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "operational states")) (named (kind state) (name "on")) (anonymous (kind exit-action-binding) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::on"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::starting"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::starting-on"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "operational states")) (named (kind transition) (name "starting-on")) (anonymous (kind accept-action) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::starting-on"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::vehicle"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind perform-action) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind state) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind perform-action) (ordinal 0)) (anonymous (kind perform-parameter-binding) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind perform-action) (ordinal 0))))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::Tmax"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::brake pedal depressed"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::fuelCmdPort"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::fuelCmdPort::fuelCmd"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::fuelCmdPort"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::maintenanceTime"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::vehicleController"))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (named (kind part) (name "vehicleController")) (anonymous (kind state) (ordinal 0))))) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::vehicleController"))) (provenance implied))
  )
  (evaluation
    (evaluated (declaration (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::off-starting"))) (state unsupported))
...
~~~sexpr
(types
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Apply Parking Brake")))
      (subtype (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::apply parking brake")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Controller States")))
      (subtype (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleController::controller states")) (scopes any))
      (subtype (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Perform Self Test")))
      (subtype (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::perform self test")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Sense Temperature")))
      (subtype (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::sense temperature")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Sense Temperature::temp")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Sense Temperature")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Vehicle States")))
      (subtype (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA::vehicle states")) (scopes any))
      (subtype (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA")))
      (subtype (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::vehicle")) (scopes any))
      (subtype (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA::provide power")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA")))
      (subtype (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind perform-action) (ordinal 0)))) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA::vehicle states")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA")))
      (type (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Vehicle States")) (provenance authored))
      (effective-type (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Vehicle States")) (source direct))
      ...
      (subtype (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind state) (ordinal 0)))) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleController")))
      (subtype (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::vehicleController")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleController::controller states")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleController")))
      (type (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Controller States")) (provenance authored))
      (effective-type (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Controller States")) (source direct))
      ...
      (subtype (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (named (kind part) (name "vehicleController")) (anonymous (kind state) (ordinal 0)))) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::apply parking brake")))
      (type (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Apply Parking Brake")) (provenance authored))
      (effective-type (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Apply Parking Brake")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "controller states")) (named (kind state) (name "operational controller states")) (anonymous (kind entry-action-binding) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states::initial")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states::off")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states::off-on")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "controller states")) (named (kind state) (name "operational controller states")) (named (kind transition) (name "off-on")) (anonymous (kind accept-action) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states::off-on")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states::on")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states::on-off")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "controller states")) (named (kind state) (name "operational controller states")) (named (kind transition) (name "on-off")) (anonymous (kind accept-action) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::controller states::operational controller states::on-off")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::perform self test")))
      (type (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Perform Self Test")) (provenance authored))
      (effective-type (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Perform Self Test")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::sense temperature")))
      (type (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Sense Temperature")) (provenance authored))
      (effective-type (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Sense Temperature")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "health states")) (anonymous (kind entry-action-binding) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "health states")) (anonymous (kind do-action-binding) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::degraded")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::degraded-normal")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "health states")) (named (kind transition) (name "degraded-normal")) (anonymous (kind accept-action) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::degraded-normal")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::initial")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::maintenance")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::maintenance-normal")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "health states")) (named (kind transition) (name "maintenance-normal")) (anonymous (kind accept-action) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::maintenance-normal")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::normal")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::normal-degraded")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "health states")) (named (kind transition) (name "normal-degraded")) (anonymous (kind accept-action) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::normal-degraded")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::normal-maintenance")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "health states")) (named (kind transition) (name "normal-maintenance")) (anonymous (kind accept-action) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::health states::normal-maintenance")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "operational states")) (anonymous (kind entry-action-binding) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::initial")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::off")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::off-starting")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "operational states")) (named (kind transition) (name "off-starting")) (anonymous (kind accept-action) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::off-starting")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::on")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::on-off")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "operational states")) (named (kind transition) (name "on-off")) (anonymous (kind accept-action) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::on-off")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "operational states")) (named (kind state) (name "on")) (anonymous (kind entry-action-binding) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::on")))
    )
    ...
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::starting")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::starting-on")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind state) (name "vehicle states")) (named (kind state) (name "operational states")) (named (kind transition) (name "starting-on")) (anonymous (kind accept-action) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::operational states::starting-on")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states::vehicle")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle states")))
      (type (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA")) (provenance authored))
      (effective-type (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind perform-action) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1")))
      (supertype (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA::provide power")) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind state) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1")))
      (effective-type (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Vehicle States")) (source inherited) (from (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA::vehicle states"))))
      (supertype (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Vehicle States")) (scopes any))
      (supertype (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA::vehicle states")) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind perform-action) (ordinal 0)) (anonymous (kind perform-parameter-binding) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind perform-action) (ordinal 0)))))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::Tmax")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::brake pedal depressed")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::fuelCmdPort")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::fuelCmdPort::fuelCmd")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::fuelCmdPort")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::maintenanceTime")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1")))
    )
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::vehicleController")))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1")))
      (type (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleController")) (provenance authored))
      (effective-type (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleController")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (named (kind part) (name "vehicleController")) (anonymous (kind state) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Usages::vehicle1_c1::vehicleController")))
      (effective-type (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Controller States")) (source inherited) (from (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleController::controller states"))))
      (supertype (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Controller States")) (scopes any))
      (supertype (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleController::controller states")) (scopes any feature))
    )
)
~~~
# NAVIGATION
...
(navigation
  (query (document "memory://snapshot/5_state_based_behavior_1.md") (range (start 1 16) (end 1 31)) (probe (position 1 16))
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (anonymous (kind import) (ordinal 0))))) (kind namespaceImport) (ordinal 0) (authored-target "ScalarValues")
      (outcome (status unresolved)))
    )
  )
  (query (document "memory://snapshot/5_state_based_behavior_1.md") (range (start 2 16) (end 2 22)) (probe (position 2 16))
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (anonymous (kind import) (ordinal 1))))) (kind namespaceImport) (ordinal 0) (authored-target "ISQ")
      (outcome (status unresolved)))
    )
  )
  (query (document "memory://snapshot/5_state_based_behavior_1.md") (range (start 3 16) (end 3 49)) (probe (position 3 16))
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (anonymous (kind import) (ordinal 2))))) (kind namespaceImport) (ordinal 0) (authored-target "3a-Function-based Behavior-1")
      (outcome (status unresolved)))
    )
  )
  ...
  (query (document "memory://snapshot/5_state_based_behavior_1.md") (range (start 13 35) (end 13 51)) (probe (position 13 35))
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA::vehicle states"))) (kind featureTyping) (ordinal 0) (authored-target "Vehicle States")
      (outcome (status resolved) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Vehicle States")))))
    )
  )
  (query (document "memory://snapshot/5_state_based_behavior_1.md") (range (start 17 38) (end 17 57)) (probe (position 17 38))
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleController::controller states"))) (kind featureTyping) (ordinal 0) (authored-target "Controller States")
      (outcome (status resolved) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::Controller States")))))
    )
  )
  (query (document "memory://snapshot/5_state_based_behavior_1.md") (range (start 44 17) (end 44 31)) (probe (position 44 17))
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (anonymous (kind import) (ordinal 0))))) (kind namespaceImport) (ordinal 0) (authored-target "Definitions")
      (outcome (status resolved) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions")))))
    )
  )
  ...
  (query (document "memory://snapshot/5_state_based_behavior_1.md") (range (start 210 32) (end 210 58)) (probe (position 210 32))
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind state) (ordinal 0))))) (kind redefinition) (ordinal 0) (authored-target "VehicleA::vehicle states")
      (outcome (status resolved) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (qualified-name "5-State-based Behavior-1::Definitions::VehicleA::vehicle states")))))
    )
  )
  (query (document "memory://snapshot/5_state_based_behavior_1.md") (range (start 201 11) (end 201 26)) (probe (position 201 11))
    (reference (id (source (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind perform-action) (ordinal 0))))) (kind referenceSubsetting) (ordinal 0) (authored-target "provide power")
      (outcome (status resolved) (target (node (document "memory://snapshot/5_state_based_behavior_1.md") (path (named (kind package) (name "5-State-based Behavior-1")) (named (kind package) (name "Usages")) (named (kind part) (name "vehicle1_c1")) (anonymous (kind perform-action) (ordinal 0)))))))
    )
  )
