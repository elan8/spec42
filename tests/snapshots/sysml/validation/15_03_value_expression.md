...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation true) (source-digest "blake3:ab6e6b6a6cd6a866eb38d6f8518d8a43a43df59027973ba7299092fb8c8c5b88") (contract-version "parser-owned-resolution-v2"))
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Wheel::outerDiameter"))) (kind attribute) (membership (kind feature) (visibility default)) (documentation (doc (text "\n\t         * This binds 'outDiameter' to the result of a computed attribute.\n\t         * There is no need to mark it as \"derived\".\n\t         "))) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "LengthValue")) (expressionOperand (reference "hubDiameter")) (memberAccessOperand (reference "tire::height")))))
  ...
  (relationships
    ...
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Tire::hasLegalProfileDepth"))) (target (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Tire"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Tire::height"))) (target (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Tire"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Tire::profileDepth"))) (target (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Tire"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Vehicle_1::leftFrontWheel"))) (target (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Vehicle_1"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Vehicle_1::length"))) (target (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Vehicle_1"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Vehicle_1::mass"))) (target (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Vehicle_1"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Vehicle_1::rightFrontWheel"))) (target (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Vehicle_1"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Wheel::hubDiameter"))) (target (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Wheel"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Wheel::outerDiameter"))) (target (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Wheel"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Wheel::tire"))) (target (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Wheel"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Wheel::width"))) (target (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Wheel"))) (provenance implied))
  )
  (evaluation
    ...
    (evaluated (declaration (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Wheel::outerDiameter"))) (state unsupported))
    ...
    (unit (declaration (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Tire::hasLegalProfileDepth"))) (ordinal 0) (authored "mm") (start 26 62) (end 26 64) (outcome (status catalog-unavailable)))
    (unit (declaration (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Tire::height"))) (ordinal 0) (authored "mm") (start 27 41) (end 27 43) (outcome (status catalog-unavailable)))
    (unit (declaration (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Tire::profileDepth"))) (ordinal 0) (authored "mm") (start 25 54) (end 25 56) (outcome (status catalog-unavailable)))
    (unit (declaration (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Vehicle_1::length"))) (ordinal 0) (authored "m") (start 6 46) (end 6 47) (outcome (status catalog-unavailable)))
    (unit (declaration (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Vehicle_1::mass"))) (ordinal 0) (authored "kg") (start 5 42) (end 5 44) (outcome (status catalog-unavailable)))
    (unit (declaration (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Wheel::hubDiameter"))) (ordinal 0) (authored "in") (start 12 46) (end 12 50) (outcome (status catalog-unavailable)))
    (unit (declaration (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Wheel::outerDiameter"))) (ordinal 0) (authored "mm") (start 14 80) (end 14 82) (outcome (status catalog-unavailable)))
    (unit (declaration (node (document "memory://snapshot/15_03_value_expression.md") (qualified-name "15_03-Value Expression::Wheel::width"))) (ordinal 0) (authored "mm") (start 13 44) (end 13 46) (outcome (status catalog-unavailable)))
  )
)
~~~
# TYPES
