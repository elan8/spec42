...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness parse-recovery,unsupported-syntax) (has-evaluation true) (source-digest "blake3:69f74b0751c962ce0cd0ebd8f57bdd0faafd0b4bd08338cdef5e11d903a54859") (contract-version "feature-value-expression-results-v5"))
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/cause_and_effect_example.md") (qualified-name "CauseAndEffectExample::causeA"))) (kind extended-usage) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (referenceSubsetting (reference "a")) (metadataAnnotation (reference "cause")))))
    (declaration (id (node (document "memory://snapshot/cause_and_effect_example.md") (qualified-name "CauseAndEffectExample::causeB"))) (kind extended-usage) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (referenceSubsetting (reference "b")) (metadataAnnotation (reference "cause")))))
    ...
    (declaration (id (node (document "memory://snapshot/cause_and_effect_example.md") (qualified-name "CauseAndEffectExample::effectC"))) (kind extended-usage) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (referenceSubsetting (reference "c")) (metadataAnnotation (reference "effect")))))
    (declaration (id (node (document "memory://snapshot/cause_and_effect_example.md") (qualified-name "CauseAndEffectExample::effectD"))) (kind extended-usage) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (referenceSubsetting (reference "d")) (metadataAnnotation (reference "effect")))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/cause_and_effect_example.md") (qualified-name "CauseAndEffectExample::causeA"))) (kind referenceSubsetting) (ordinal 0))
      (authored-target "a")
      (outcome (status resolved) (target (node (document "memory://snapshot/cause_and_effect_example.md") (qualified-name "CauseAndEffectExample::a")))))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect_example.md") (qualified-name "CauseAndEffectExample::causeA"))) (kind metadataAnnotation) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/cause_and_effect_example.md") (qualified-name "CauseAndEffectExample::causeB"))) (kind referenceSubsetting) (ordinal 0))
      (authored-target "b")
      (outcome (status resolved) (target (node (document "memory://snapshot/cause_and_effect_example.md") (qualified-name "CauseAndEffectExample::b")))))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect_example.md") (qualified-name "CauseAndEffectExample::causeB"))) (kind metadataAnnotation) (ordinal 0))
      (authored-target "cause")
      (outcome (status unresolved)))
    ...
    (reference (id (source (node (document "memory://snapshot/cause_and_effect_example.md") (qualified-name "CauseAndEffectExample::effectC"))) (kind referenceSubsetting) (ordinal 0))
      (authored-target "c")
      (outcome (status resolved) (target (node (document "memory://snapshot/cause_and_effect_example.md") (qualified-name "CauseAndEffectExample::c")))))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect_example.md") (qualified-name "CauseAndEffectExample::effectC"))) (kind metadataAnnotation) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/cause_and_effect_example.md") (qualified-name "CauseAndEffectExample::effectD"))) (kind referenceSubsetting) (ordinal 0))
      (authored-target "d")
      (outcome (status resolved) (target (node (document "memory://snapshot/cause_and_effect_example.md") (qualified-name "CauseAndEffectExample::d")))))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect_example.md") (qualified-name "CauseAndEffectExample::effectD"))) (kind metadataAnnotation) (ordinal 0))
      (authored-target "effect")
      (outcome (status unresolved)))
...
(navigation
  ...
  (query (document "memory://snapshot/cause_and_effect_example.md") (range (start 40 2) (end 40 7)) (probe (position 40 2))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect_example.md") (qualified-name "CauseAndEffectExample::causeA"))) (kind metadataAnnotation) (ordinal 0) (authored-target "cause")
      (outcome (status unresolved)))
    )
  )
  ...
  (query (document "memory://snapshot/cause_and_effect_example.md") (range (start 41 2) (end 41 7)) (probe (position 41 2))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect_example.md") (qualified-name "CauseAndEffectExample::causeB"))) (kind metadataAnnotation) (ordinal 0) (authored-target "cause")
      (outcome (status unresolved)))
    )
  )
  ...
  (query (document "memory://snapshot/cause_and_effect_example.md") (range (start 42 2) (end 42 8)) (probe (position 42 2))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect_example.md") (qualified-name "CauseAndEffectExample::effectC"))) (kind metadataAnnotation) (ordinal 0) (authored-target "effect")
      (outcome (status unresolved)))
    )
  )
  ...
  (query (document "memory://snapshot/cause_and_effect_example.md") (range (start 43 2) (end 43 8)) (probe (position 43 2))
    (reference (id (source (node (document "memory://snapshot/cause_and_effect_example.md") (qualified-name "CauseAndEffectExample::effectD"))) (kind metadataAnnotation) (ordinal 0) (authored-target "effect")
      (outcome (status unresolved)))
    )
  )
