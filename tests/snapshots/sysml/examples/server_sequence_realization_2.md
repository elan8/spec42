...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/server_sequence_realization_2.md") (qualified-name "ServerSequenceRealization_2::realization_2"))) (kind part) (membership (kind feature) (visibility default)) (documentation (comment (text " Accepts "))) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "PubSubSequence")))))
