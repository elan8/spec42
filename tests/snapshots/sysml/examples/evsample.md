...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/evsample.md") (path (named (kind package) (name "EVSample")) (named (kind part) (name "largeEVRangeContext")) (named (kind requirement) (name "largeEVRequirement")) (anonymous (kind subject) (ordinal 0))))) (kind subject) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "vehicle")))))
    ...
    (declaration (id (node (document "memory://snapshot/evsample.md") (path (named (kind package) (name "EVSample")) (named (kind part) (name "smallEVRangeContext")) (named (kind requirement) (name "smallEVRequirement")) (anonymous (kind subject) (ordinal 0))))) (kind subject) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "vehicle")))))
