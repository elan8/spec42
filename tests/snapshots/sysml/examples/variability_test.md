...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/variability_test.md") (qualified-name "VariabilityTest::V::x"))) (kind part) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Q")))))
    ...
    (declaration (id (node (document "memory://snapshot/variability_test.md") (qualified-name "VariabilityTest::r::r1"))) (kind requirement) (membership (kind feature) (visibility default)))
  ...
  (relationships
    ...
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/variability_test.md") (qualified-name "VariabilityTest::V::x"))) (target (node (document "memory://snapshot/variability_test.md") (qualified-name "VariabilityTest::V"))) (provenance implied))
    ...
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/variability_test.md") (qualified-name "VariabilityTest::r::r1"))) (target (node (document "memory://snapshot/variability_test.md") (qualified-name "VariabilityTest::r"))) (provenance implied))
  )
  (evaluation
  )
)
...
(types
    ...
    (declaration (id (node (document "memory://snapshot/variability_test.md") (qualified-name "VariabilityTest::V::x")))
      (featured-by (node (document "memory://snapshot/variability_test.md") (qualified-name "VariabilityTest::V")))
    ...
    (declaration (id (node (document "memory://snapshot/variability_test.md") (qualified-name "VariabilityTest::r::r1")))
      (featured-by (node (document "memory://snapshot/variability_test.md") (qualified-name "VariabilityTest::r")))
    )
    (declaration (id (node (document "memory://snapshot/variability_test.md") (qualified-name "VariabilityTest::v")))
