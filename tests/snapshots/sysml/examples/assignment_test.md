...
(semantic-model
  ...
  (relationships
    ...
    (relationship (kind expressionOperand) (source (node (document "memory://snapshot/assignment_test.md") (qualified-name "AssignmentTest::Increment"))) (target (node (document "memory://snapshot/assignment_test.md") (qualified-name "AssignmentTest::Increment::c"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/assignment_test.md") (qualified-name "AssignmentTest::Increment"))) (kind expressionOperand) (ordinal 1)))
    (relationship (kind memberAccessOperand) (source (node (document "memory://snapshot/assignment_test.md") (qualified-name "AssignmentTest::Increment"))) (target (node (document "memory://snapshot/assignment_test.md") (qualified-name "AssignmentTest::Counter::incr"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/assignment_test.md") (qualified-name "AssignmentTest::Increment"))) (kind memberAccessOperand) (ordinal 0)))
