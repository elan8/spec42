...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/part_test.md") (path (named (kind package) (name "PartTest")) (named (kind part-def) (name "B")) (anonymous (kind flow) (ordinal 0))))) (kind flow) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (flowSource (reference "x::p")) (flowTarget (reference "a1::aa::receiver")))))
    ...
    (declaration (id (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a1"))) (kind action) (membership (kind feature) (visibility default)) (facts (modifiers composite)))
    (declaration (id (node (document "memory://snapshot/part_test.md") (path (named (kind package) (name "PartTest")) (named (kind part-def) (name "B")) (named (kind action) (name "a1")) (anonymous (kind accept-action) (ordinal 0))))) (kind accept-action) (membership (kind feature) (visibility default)) (facts (modifiers composite)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "S")) (acceptVia (reference "x")))))
    (declaration (id (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a1::aa"))) (kind accept-action) (membership (kind feature) (visibility default)) (facts (modifiers composite)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "S")))))
    ...
    (declaration (id (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y"))) (kind ref) (membership (kind feature) (visibility private)) (facts (direction in)) (authored (membership (kind feature) (visibility private)) (relationships (featureTyping (reference "A")) (featureTyping (reference "B")))))
    (declaration (id (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y::B_b"))) (kind part) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "B::b")))))
    (declaration (id (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y::B_c"))) (kind part) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "B::c")))))
    (declaration (id (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y::B_x"))) (kind port) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "B::x")))))
    (declaration (id (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::z1"))) (kind alias) (membership (kind alias) (visibility default)) (authored (membership (kind alias) (visibility default)) (relationships (aliasBinding (reference "y")))))
    (declaration (id (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::z2"))) (kind alias) (membership (kind alias) (visibility default)) (authored (membership (kind alias) (visibility default)) (relationships (aliasBinding (reference "y")))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/part_test.md") (path (named (kind package) (name "PartTest")) (named (kind part-def) (name "B")) (anonymous (kind flow) (ordinal 0))))) (kind flowSource) (ordinal 0))
      (authored-target "x::p")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::x::p")))))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (path (named (kind package) (name "PartTest")) (named (kind part-def) (name "B")) (anonymous (kind flow) (ordinal 0))))) (kind flowTarget) (ordinal 0))
      (authored-target "a1::aa::receiver")
      (outcome (status unresolved)))
    ...
    (reference (id (source (node (document "memory://snapshot/part_test.md") (path (named (kind package) (name "PartTest")) (named (kind part-def) (name "B")) (named (kind action) (name "a1")) (anonymous (kind accept-action) (ordinal 0))))) (kind expressionOperand) (ordinal 0))
      (authored-target "S")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::S")))))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (path (named (kind package) (name "PartTest")) (named (kind part-def) (name "B")) (named (kind action) (name "a1")) (anonymous (kind accept-action) (ordinal 0))))) (kind acceptVia) (ordinal 0))
      (authored-target "x")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::x")))))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a1::aa"))) (kind expressionOperand) (ordinal 0))
      (authored-target "S")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::S")))))
    ...
    (reference (id (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::c2"))) (kind featureTyping) (ordinal 0))
      (authored-target "C")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C")))))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y"))) (kind featureTyping) (ordinal 0))
      (authored-target "A")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::A")))))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y"))) (kind featureTyping) (ordinal 1))
      (authored-target "B")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B")))))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y::B_b"))) (kind redefinition) (ordinal 0))
      (authored-target "B::b")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::b")))))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y::B_c"))) (kind redefinition) (ordinal 0))
      (authored-target "B::c")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::c")))))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y::B_x"))) (kind redefinition) (ordinal 0))
      (authored-target "B::x")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::x")))))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::z1"))) (kind aliasBinding) (ordinal 0))
      (authored-target "y")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y")))))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::z2"))) (kind aliasBinding) (ordinal 0))
      (authored-target "y")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y")))))
  ...
  (relationships
    ...
    (relationship (kind flowSource) (source (node (document "memory://snapshot/part_test.md") (path (named (kind package) (name "PartTest")) (named (kind part-def) (name "B")) (anonymous (kind flow) (ordinal 0))))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::x::p"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/part_test.md") (path (named (kind package) (name "PartTest")) (named (kind part-def) (name "B")) (anonymous (kind flow) (ordinal 0))))) (kind flowSource) (ordinal 0)))
    ...
    (relationship (kind expressionOperand) (source (node (document "memory://snapshot/part_test.md") (path (named (kind package) (name "PartTest")) (named (kind part-def) (name "B")) (named (kind action) (name "a1")) (anonymous (kind accept-action) (ordinal 0))))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::S"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/part_test.md") (path (named (kind package) (name "PartTest")) (named (kind part-def) (name "B")) (named (kind action) (name "a1")) (anonymous (kind accept-action) (ordinal 0))))) (kind expressionOperand) (ordinal 0)))
    (relationship (kind acceptVia) (source (node (document "memory://snapshot/part_test.md") (path (named (kind package) (name "PartTest")) (named (kind part-def) (name "B")) (named (kind action) (name "a1")) (anonymous (kind accept-action) (ordinal 0))))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::x"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/part_test.md") (path (named (kind package) (name "PartTest")) (named (kind part-def) (name "B")) (named (kind action) (name "a1")) (anonymous (kind accept-action) (ordinal 0))))) (kind acceptVia) (ordinal 0)))
    (relationship (kind expressionOperand) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a1::aa"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::S"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a1::aa"))) (kind expressionOperand) (ordinal 0)))
    ...
    (relationship (kind typing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::A"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y"))) (kind featureTyping) (ordinal 0)))
    (relationship (kind typing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y"))) (kind featureTyping) (ordinal 1)))
    (relationship (kind redefinition) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y::B_b"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::b"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y::B_b"))) (kind redefinition) (ordinal 0)))
    (relationship (kind redefinition) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y::B_c"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::c"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y::B_c"))) (kind redefinition) (ordinal 0)))
    (relationship (kind redefinition) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y::B_x"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::x"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y::B_x"))) (kind redefinition) (ordinal 0)))
    (relationship (kind aliasBinding) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::z1"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::z1"))) (kind aliasBinding) (ordinal 0)))
    (relationship (kind aliasBinding) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::z2"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::z2"))) (kind aliasBinding) (ordinal 0)))
    ...
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::A::b"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::A"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::A::c"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::A"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::A::x"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::A"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::A::y"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::A"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::A::z"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::A"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (path (named (kind package) (name "PartTest")) (named (kind part-def) (name "B")) (anonymous (kind flow) (ordinal 0))))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a1"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (path (named (kind package) (name "PartTest")) (named (kind part-def) (name "B")) (named (kind action) (name "a1")) (anonymous (kind accept-action) (ordinal 0))))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a1"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a1::aa"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a1"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a2"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::b"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::c"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::s1"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::s2"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::x"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::x::p"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::x"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::x::q"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::x"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::c1"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::c2"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y::B_b"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y::B_c"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y::B_x"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y"))) (provenance implied))
  )
  (evaluation
  )
)
...
(types
    (declaration (id (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::A")))
      ...
      (subtype (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y")) (scopes any))
    ...
    (declaration (id (node (document "memory://snapshot/part_test.md") (path (named (kind package) (name "PartTest")) (named (kind part-def) (name "B")) (anonymous (kind flow) (ordinal 0)))))
    ...
    (declaration (id (node (document "memory://snapshot/part_test.md") (path (named (kind package) (name "PartTest")) (named (kind part-def) (name "B")) (named (kind action) (name "a1")) (anonymous (kind accept-action) (ordinal 0)))))
    ...
    (declaration (id (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::b")))
      ...
      (subtype (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y::B_b")) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::c")))
      ...
      (supertype (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::A")) (scopes any))
      (supertype (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a")) (scopes any feature))
      (subtype (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y::B_c")) (scopes any feature))
    )
    ...
    (declaration (id (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::x")))
      ...
      (effective-type (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C")) (source direct))
      (supertype (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C")) (scopes any))
      (subtype (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y::B_x")) (scopes any feature))
    )
    ...
    (declaration (id (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y")))
      (featured-by (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C")))
      (type (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::A")) (provenance authored))
      (type (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B")) (provenance authored))
      (effective-type (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::A")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y::B_b")))
      (featured-by (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y")))
      (effective-type (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::A")) (source inherited) (from (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a"))))
      (supertype (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::A")) (scopes any))
      (supertype (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a")) (scopes any feature))
      (supertype (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::b")) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y::B_c")))
      (featured-by (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y")))
      (effective-type (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::A")) (source inherited) (from (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a"))))
      (supertype (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::A")) (scopes any))
      (supertype (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a")) (scopes any feature))
      (supertype (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::c")) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y::B_x")))
      (featured-by (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y")))
      (effective-type (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C")) (source inherited) (from (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::x"))))
      (supertype (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::x")) (scopes any feature))
      (supertype (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C")) (scopes any))
    )
...
(navigation
  ...
  (query (document "memory://snapshot/part_test.md") (range (start 24 18) (end 24 21)) (probe (position 24 18))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (path (named (kind package) (name "PartTest")) (named (kind part-def) (name "B")) (anonymous (kind flow) (ordinal 0))))) (kind flowSource) (ordinal 0) (authored-target "x::p")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::x::p")))))
    )
  )
  (query (document "memory://snapshot/part_test.md") (range (start 24 25) (end 24 39)) (probe (position 24 25))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (path (named (kind package) (name "PartTest")) (named (kind part-def) (name "B")) (anonymous (kind flow) (ordinal 0))))) (kind flowTarget) (ordinal 0) (authored-target "a1::aa::receiver")
      (outcome (status unresolved)))
    )
  )
  ...
  (query (document "memory://snapshot/part_test.md") (range (start 27 10) (end 27 11)) (probe (position 27 10))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (path (named (kind package) (name "PartTest")) (named (kind part-def) (name "B")) (named (kind action) (name "a1")) (anonymous (kind accept-action) (ordinal 0))))) (kind expressionOperand) (ordinal 0) (authored-target "S")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::S")))))
    )
  )
  (query (document "memory://snapshot/part_test.md") (range (start 27 16) (end 27 17)) (probe (position 27 16))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (path (named (kind package) (name "PartTest")) (named (kind part-def) (name "B")) (named (kind action) (name "a1")) (anonymous (kind accept-action) (ordinal 0))))) (kind acceptVia) (ordinal 0) (authored-target "x")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::x")))))
    )
  )
  (query (document "memory://snapshot/part_test.md") (range (start 28 20) (end 28 21)) (probe (position 28 20))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a1::aa"))) (kind expressionOperand) (ordinal 0) (authored-target "S")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::S")))))
    )
  )
  ...
  (query (document "memory://snapshot/part_test.md") (range (start 37 20) (end 37 21)) (probe (position 37 20))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y"))) (kind featureTyping) (ordinal 0) (authored-target "A")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::A")))))
    )
  )
  (query (document "memory://snapshot/part_test.md") (range (start 37 23) (end 37 24)) (probe (position 37 23))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y"))) (kind featureTyping) (ordinal 1) (authored-target "B")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B")))))
    )
  )
  (query (document "memory://snapshot/part_test.md") (range (start 38 25) (end 38 29)) (probe (position 38 25))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y::B_b"))) (kind redefinition) (ordinal 0) (authored-target "B::b")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::b")))))
    )
  )
  (query (document "memory://snapshot/part_test.md") (range (start 39 25) (end 39 29)) (probe (position 39 25))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y::B_c"))) (kind redefinition) (ordinal 0) (authored-target "B::c")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::c")))))
    )
  )
  (query (document "memory://snapshot/part_test.md") (range (start 40 25) (end 40 29)) (probe (position 40 25))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y::B_x"))) (kind redefinition) (ordinal 0) (authored-target "B::x")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::x")))))
    )
  )
  (query (document "memory://snapshot/part_test.md") (range (start 42 15) (end 42 16)) (probe (position 42 15))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::z1"))) (kind aliasBinding) (ordinal 0) (authored-target "y")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y")))))
    )
  )
  (query (document "memory://snapshot/part_test.md") (range (start 43 15) (end 43 16)) (probe (position 43 15))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::z2"))) (kind aliasBinding) (ordinal 0) (authored-target "y")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::C::y")))))
    )
  )
