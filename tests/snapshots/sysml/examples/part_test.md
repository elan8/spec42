...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a1::accept"))) (kind accept-action) (membership (kind feature) (visibility default)) (facts (modifiers composite)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "S")) (acceptVia (reference "x")))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a1::accept"))) (kind expressionOperand) (ordinal 0))
      (authored-target "S")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::S")))))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a1::accept"))) (kind acceptVia) (ordinal 0))
      (authored-target "x")
  ...
  (relationships
    ...
    (relationship (kind expressionOperand) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a1::accept"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::S"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a1::accept"))) (kind expressionOperand) (ordinal 0)))
    (relationship (kind acceptVia) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a1::accept"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::x"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a1::accept"))) (kind acceptVia) (ordinal 0)))
    ...
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a1::accept"))) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a1"))) (provenance implied))
...
(types
    ...
    (declaration (id (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a1::accept")))
      (featured-by (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a1")))
    )
...
(navigation
  ...
  (query (document "memory://snapshot/part_test.md") (range (start 27 10) (end 27 11)) (probe (position 27 10))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a1::accept"))) (kind expressionOperand) (ordinal 0) (authored-target "S")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::S")))))
    )
  )
  (query (document "memory://snapshot/part_test.md") (range (start 27 16) (end 27 17)) (probe (position 27 16))
    (reference (id (source (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::a1::accept"))) (kind acceptVia) (ordinal 0) (authored-target "x")
      (outcome (status resolved) (target (node (document "memory://snapshot/part_test.md") (qualified-name "PartTest::B::x")))))
    )
  )
