  ...
  (document "memory://snapshot/ahfsequences.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (source "semantic")
        (range (start 84 3) (end 85 41))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_interface_definition_member")
        (source "semantic")
        (range (start 86 3) (end 87 47))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_interface_definition_member")
        (source "semantic")
        (range (start 88 3) (end 89 29))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_interface_definition_member")
        (source "semantic")
        (range (start 90 3) (end 91 47))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_interface_definition_member")
        (source "semantic")
        (range (start 92 3) (end 93 47))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_interface_definition_member")
        (source "semantic")
        (range (start 94 3) (end 95 33))
      )
      (diagnostic
        (severity error)
