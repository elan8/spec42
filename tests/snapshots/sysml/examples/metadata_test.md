...
(semantic-model
  ...
  (evaluation
    ...
    (evaluated (declaration (node (document "memory://snapshot/metadata_test.md") (path (named (kind package) (name "MetadataTest")) (named (kind ref) (name "z")) (named (kind metadata) (name "Classified")) (anonymous (kind attribute) (ordinal 0))))) (state unresolved-operand))
  )
)
~~~
# TYPES
