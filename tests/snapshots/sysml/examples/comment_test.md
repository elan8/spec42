...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/comment_test.md") (qualified-name "CommentTest::cmt"))) (kind comment) (membership (kind feature) (visibility default)) (documentation (comment (text " Named Comment "))))
    (declaration (id (node (document "memory://snapshot/comment_test.md") (qualified-name "CommentTest::cmt_cmt"))) (kind comment) (membership (kind feature) (visibility default)) (documentation (comment (text " Comment about Comment "))))
  )
  (references
  )
  (relationships
