...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness parse-recovery) (has-evaluation false) (source-digest "blake3:161429c0dd614f928a85292a7c7f59528ada4f3eaebf79d2bb8facd801568277") (contract-version "constructor-expression-specialization-v9"))
  (declarations
  ...
  (relationships
    ...
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "A::p1"))) (target (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "A"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "A::p2"))) (target (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "A"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "B::q1"))) (target (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "B"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "B::q2"))) (target (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "B"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "System::a"))) (target (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "System"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "System::b"))) (target (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "System"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "System::engine"))) (target (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "System"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "System::myA"))) (target (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "System"))) (provenance implied))
  )
  (evaluation
  )
)
...
~~~sexpr
(types
    (declaration (id (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "A")))
      (subtype (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "System::a")) (scopes any))
      (subtype (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "System::engine")) (scopes any))
      (subtype (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "System::myA")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "A::p1")))
      (featured-by (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "A")))
    )
    (declaration (id (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "A::p2")))
      (featured-by (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "A")))
    )
    (declaration (id (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "B")))
      (subtype (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "System::b")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "B::q1")))
      (featured-by (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "B")))
    )
    (declaration (id (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "B::q2")))
      (featured-by (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "B")))
    )
    (declaration (id (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "System::a")))
      (featured-by (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "System")))
      (type (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "A")) (provenance authored))
      (effective-type (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "A")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "System::b")))
      (featured-by (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "System")))
      (type (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "B")) (provenance authored))
      (effective-type (node (document "memory://snapshot/coverage_connectors.md") (qualified-name "B")) (source direct))
