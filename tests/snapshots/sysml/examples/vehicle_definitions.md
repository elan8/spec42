...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/vehicle_definitions.md") (path (named (kind package) (name "VehicleDefinitions")) (named (kind interface-def) (name "Mounting")) (anonymous (kind flow) (ordinal 0))))) (kind flow) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (flowSource (reference "axleMount::transferredTorque")) (flowTarget (reference "hub::appliedTorque")))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/vehicle_definitions.md") (qualified-name "VehicleDefinitions::Lugbolt::tighteningTorque"))) (kind subsetting) (ordinal 0))
      (authored-target "ISQ::torque")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/vehicle_definitions.md") (path (named (kind package) (name "VehicleDefinitions")) (named (kind interface-def) (name "Mounting")) (anonymous (kind flow) (ordinal 0))))) (kind flowSource) (ordinal 0))
      (authored-target "axleMount::transferredTorque")
      (outcome (status resolved) (target (node (document "memory://snapshot/vehicle_definitions.md") (qualified-name "VehicleDefinitions::AxleMountIF::transferredTorque")))))
    (reference (id (source (node (document "memory://snapshot/vehicle_definitions.md") (path (named (kind package) (name "VehicleDefinitions")) (named (kind interface-def) (name "Mounting")) (anonymous (kind flow) (ordinal 0))))) (kind flowTarget) (ordinal 0))
      (authored-target "hub::appliedTorque")
      (outcome (status resolved) (target (node (document "memory://snapshot/vehicle_definitions.md") (qualified-name "VehicleDefinitions::WheelHubIF::appliedTorque")))))
  ...
  (relationships
    ...
    (relationship (kind flowSource) (source (node (document "memory://snapshot/vehicle_definitions.md") (path (named (kind package) (name "VehicleDefinitions")) (named (kind interface-def) (name "Mounting")) (anonymous (kind flow) (ordinal 0))))) (target (node (document "memory://snapshot/vehicle_definitions.md") (qualified-name "VehicleDefinitions::AxleMountIF::transferredTorque"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/vehicle_definitions.md") (path (named (kind package) (name "VehicleDefinitions")) (named (kind interface-def) (name "Mounting")) (anonymous (kind flow) (ordinal 0))))) (kind flowSource) (ordinal 0)))
    (relationship (kind flowTarget) (source (node (document "memory://snapshot/vehicle_definitions.md") (path (named (kind package) (name "VehicleDefinitions")) (named (kind interface-def) (name "Mounting")) (anonymous (kind flow) (ordinal 0))))) (target (node (document "memory://snapshot/vehicle_definitions.md") (qualified-name "VehicleDefinitions::WheelHubIF::appliedTorque"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/vehicle_definitions.md") (path (named (kind package) (name "VehicleDefinitions")) (named (kind interface-def) (name "Mounting")) (anonymous (kind flow) (ordinal 0))))) (kind flowTarget) (ordinal 0)))
    ...
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/vehicle_definitions.md") (path (named (kind package) (name "VehicleDefinitions")) (named (kind interface-def) (name "Mounting")) (anonymous (kind flow) (ordinal 0))))) (target (node (document "memory://snapshot/vehicle_definitions.md") (qualified-name "VehicleDefinitions::Mounting"))) (provenance implied))
...
(types
    ...
    (declaration (id (node (document "memory://snapshot/vehicle_definitions.md") (path (named (kind package) (name "VehicleDefinitions")) (named (kind interface-def) (name "Mounting")) (anonymous (kind flow) (ordinal 0)))))
...
~~~sexpr
(connections
  (connector (id (node (document "memory://snapshot/vehicle_definitions.md") (qualified-name "VehicleDefinitions::Mounting"))) (kind interface) (end (name (node (document "memory://snapshot/vehicle_definitions.md") (qualified-name "VehicleDefinitions::Mounting::axleMount"))) unconnected) (end (name (node (document "memory://snapshot/vehicle_definitions.md") (qualified-name "VehicleDefinitions::Mounting::hub"))) unconnected))
)
~~~
# NAVIGATION
~~~sexpr
(navigation
  ...
  (query (document "memory://snapshot/vehicle_definitions.md") (range (start 51 7) (end 51 34)) (probe (position 51 7))
    (reference (id (source (node (document "memory://snapshot/vehicle_definitions.md") (path (named (kind package) (name "VehicleDefinitions")) (named (kind interface-def) (name "Mounting")) (anonymous (kind flow) (ordinal 0))))) (kind flowSource) (ordinal 0) (authored-target "axleMount::transferredTorque")
      (outcome (status resolved) (target (node (document "memory://snapshot/vehicle_definitions.md") (qualified-name "VehicleDefinitions::AxleMountIF::transferredTorque")))))
    )
  )
  (query (document "memory://snapshot/vehicle_definitions.md") (range (start 51 38) (end 51 55)) (probe (position 51 38))
    (reference (id (source (node (document "memory://snapshot/vehicle_definitions.md") (path (named (kind package) (name "VehicleDefinitions")) (named (kind interface-def) (name "Mounting")) (anonymous (kind flow) (ordinal 0))))) (kind flowTarget) (ordinal 0) (authored-target "hub::appliedTorque")
      (outcome (status resolved) (target (node (document "memory://snapshot/vehicle_definitions.md") (qualified-name "VehicleDefinitions::WheelHubIF::appliedTorque")))))
    )
  )
