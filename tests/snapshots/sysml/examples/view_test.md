  ...
  (document "memory://snapshot/view_test.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (code "unsupported_view_definition_member")
        (source "semantic")
        (range (start 35 3) (end 35 12))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_view_definition_member")
        (source "semantic")
        (range (start 37 3) (end 37 16))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_view_definition_member")
        (source "semantic")
        (range (start 39 3) (end 39 20))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_view_definition_member")
        (source "semantic")
        (range (start 41 3) (end 41 20))
      )
    )
  )
)
...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::v"))) (kind view) (membership (kind feature) (visibility default)) (facts (multiplicity (lower 0) (upper unbounded))) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "V")))))
    (declaration (id (node (document "memory://snapshot/view_test.md") (path (named (kind package) (name "ViewTest")) (named (kind view-def) (name "V")) (named (kind view) (name "v")) (anonymous (kind expose) (ordinal 0))))) (kind expose) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (viewExpose (reference "P")))))
    (declaration (id (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::vp"))) (kind viewpoint) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "VP")))))
    (declaration (id (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::vp::c1"))) (kind frame) (membership (kind feature) (visibility default)))
    (declaration (id (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::vp::c2"))) (kind concern) (membership (kind feature) (visibility default)))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::v"))) (kind featureTyping) (ordinal 0))
      (authored-target "V")
      (outcome (status resolved) (target (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V")))))
    (reference (id (source (node (document "memory://snapshot/view_test.md") (path (named (kind package) (name "ViewTest")) (named (kind view-def) (name "V")) (named (kind view) (name "v")) (anonymous (kind expose) (ordinal 0))))) (kind viewExpose) (ordinal 0))
      (authored-target "P")
      (outcome (status resolved) (target (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::P")))))
    (reference (id (source (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::vp"))) (kind featureTyping) (ordinal 0))
      (authored-target "VP")
      (outcome (status resolved) (target (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::VP")))))
  ...
  (relationships
    ...
    (relationship (kind typing) (source (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::v"))) (target (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::v"))) (kind featureTyping) (ordinal 0)))
    (relationship (kind viewExpose) (source (node (document "memory://snapshot/view_test.md") (path (named (kind package) (name "ViewTest")) (named (kind view-def) (name "V")) (named (kind view) (name "v")) (anonymous (kind expose) (ordinal 0))))) (target (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::P"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/view_test.md") (path (named (kind package) (name "ViewTest")) (named (kind view-def) (name "V")) (named (kind view) (name "v")) (anonymous (kind expose) (ordinal 0))))) (kind viewExpose) (ordinal 0)))
    (relationship (kind typing) (source (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::vp"))) (target (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::VP"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::vp"))) (kind featureTyping) (ordinal 0)))
    ...
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::C::s"))) (target (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::C"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::v"))) (target (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/view_test.md") (path (named (kind package) (name "ViewTest")) (named (kind view-def) (name "V")) (named (kind view) (name "v")) (anonymous (kind expose) (ordinal 0))))) (target (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::v"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::vp"))) (target (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::vp::c1"))) (target (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::vp"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::vp::c2"))) (target (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::vp"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::VP::c"))) (target (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::VP"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/view_test.md") (path (named (kind package) (name "ViewTest")) (named (kind concern) (name "c")) (anonymous (kind stakeholder) (ordinal 0))))) (target (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::c"))) (provenance implied))
  )
  (evaluation
  )
)
...
(types
    ...
    (declaration (id (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V")))
      (subtype (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::v")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::v")))
      (featured-by (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V")))
      (type (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V")) (provenance authored))
      (effective-type (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V")) (source direct))
      (supertype (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/view_test.md") (path (named (kind package) (name "ViewTest")) (named (kind view-def) (name "V")) (named (kind view) (name "v")) (anonymous (kind expose) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::v")))
    )
    (declaration (id (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::vp")))
      (featured-by (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V")))
      (type (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::VP")) (provenance authored))
      (effective-type (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::VP")) (source direct))
      (supertype (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::VP")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::vp::c1")))
      (featured-by (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::vp")))
    )
    (declaration (id (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::vp::c2")))
      (featured-by (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::vp")))
    )
    (declaration (id (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::VP")))
      (subtype (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::vp")) (scopes any))
    )
...
(navigation
  ...
  (query (document "memory://snapshot/view_test.md") (range (start 33 10) (end 33 11)) (probe (position 33 10))
    (reference (id (source (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::v"))) (kind featureTyping) (ordinal 0) (authored-target "V")
      (outcome (status resolved) (target (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V")))))
    )
  )
  (query (document "memory://snapshot/view_test.md") (range (start 34 10) (end 34 14)) (probe (position 34 10))
    (reference (id (source (node (document "memory://snapshot/view_test.md") (path (named (kind package) (name "ViewTest")) (named (kind view-def) (name "V")) (named (kind view) (name "v")) (anonymous (kind expose) (ordinal 0))))) (kind viewExpose) (ordinal 0) (authored-target "P")
      (outcome (status resolved) (target (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::P")))))
    )
  )
  (query (document "memory://snapshot/view_test.md") (range (start 27 16) (end 27 18)) (probe (position 27 16))
    (reference (id (source (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::V::vp"))) (kind featureTyping) (ordinal 0) (authored-target "VP")
      (outcome (status resolved) (target (node (document "memory://snapshot/view_test.md") (qualified-name "ViewTest::VP")))))
    )
  )
