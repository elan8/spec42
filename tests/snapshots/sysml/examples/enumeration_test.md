...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/enumeration_test.md") (path (named (kind package) (name "EnumerationTest")) (named (kind enum-def) (name "SizeChoice")) (anonymous (kind enum-literal) (ordinal 0))))) (kind enum-literal) (membership (kind feature) (visibility default)))
    (declaration (id (node (document "memory://snapshot/enumeration_test.md") (path (named (kind package) (name "EnumerationTest")) (named (kind enum-def) (name "SizeChoice")) (anonymous (kind enum-literal) (ordinal 1))))) (kind enum-literal) (membership (kind feature) (visibility default)))
    (declaration (id (node (document "memory://snapshot/enumeration_test.md") (path (named (kind package) (name "EnumerationTest")) (named (kind enum-def) (name "SizeChoice")) (anonymous (kind enum-literal) (ordinal 2))))) (kind enum-literal) (membership (kind feature) (visibility default)))
