...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation true) (source-digest "blake3:8e305049c91ab2ce85183f91e42ea59caff5c4bbbaa247997f62b8943c736fb6") (contract-version "owned-cross-feature-typing-v4"))
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/parameter_test.md") (qualified-name "ParameterTest::b"))) (kind attribute) (membership (kind feature) (visibility default)) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "a")) (invocationCallee (reference "A")))))
    (declaration (id (node (document "memory://snapshot/parameter_test.md") (qualified-name "ParameterTest::c"))) (kind attribute) (membership (kind feature) (visibility default)) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (invocationCallee (reference "A")))))
    (declaration (id (node (document "memory://snapshot/parameter_test.md") (qualified-name "ParameterTest::f"))) (kind attribute) (membership (kind feature) (visibility default)) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "a")) (invocationCallee (reference "F")))))
    (declaration (id (node (document "memory://snapshot/parameter_test.md") (qualified-name "ParameterTest::g"))) (kind attribute) (membership (kind feature) (visibility default)) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (expressionOperand (reference "a")) (invocationCallee (reference "F")))))
  )
  (references
