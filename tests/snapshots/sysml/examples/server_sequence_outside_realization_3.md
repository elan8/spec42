...
(types
    ...
    (declaration (id (node (document "memory://snapshot/server_sequence_outside_realization_3.md") (path (named (kind package) (name "ServerSequenceOutsideRealization_3")) (named (kind package) (name "Configuration")) (named (kind part) (name "server_3")) (named (kind perform-action) (name "serverBehavior")) (anonymous (kind merge) (ordinal 0)))))
    ...
    (declaration (id (node (document "memory://snapshot/server_sequence_outside_realization_3.md") (path (named (kind package) (name "ServerSequenceOutsideRealization_3")) (named (kind package) (name "Configuration")) (named (kind part) (name "server_3")) (named (kind perform-action) (name "serverBehavior")) (anonymous (kind then-continuation) (ordinal 1)))))
      (featured-by (node (document "memory://snapshot/server_sequence_outside_realization_3.md") (qualified-name "ServerSequenceOutsideRealization_3::Configuration::server_3::serverBehavior")))
    )
