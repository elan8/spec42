  ...
  (document "memory://snapshot/server_sequence_outside_realization_3.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (code "unsupported_interface_definition_member")
        (source "semantic")
        (range (start 95 3) (end 95 114))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_interface_definition_member")
        (source "semantic")
        (range (start 96 3) (end 96 109))
      )
      (diagnostic
        (severity information)
        (code "untyped_part_usage")
      ...
      (diagnostic
        ...
        (code "unsupported_part_usage_member")
        (source "semantic")
        (range (start 140 2) (end 144 3))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_part_usage_member")
        (source "semantic")
        (range (start 146 2) (end 150 3))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_part_usage_member")
        (source "semantic")
        (range (start 152 2) (end 156 3))
      )
    )
  )
)
...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness unsupported-syntax) (has-evaluation true) (source-digest "blake3:aefa4f1db4a595393294d1458ea7bc4f05b68a9ee899de0c2fabc47881071250") (contract-version "parser-owned-resolution-v1"))
  (declarations
