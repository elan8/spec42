...
~~~sexpr
(connections
  (connector (id (node (document "memory://snapshot/alias_test.md") (path (named (kind package) (name "AliasTest")) (anonymous (kind bare-connect) (ordinal 0))))) (kind connection) (end bare (feature-chain (resolved (node (document "memory://snapshot/alias_test.md") (qualified-name "AliasTest::p1::po1"))) "p1::po1")) (end bare (feature-chain (resolved (node (document "memory://snapshot/alias_test.md") (qualified-name "AliasTest::p2::pdest"))) "p2::pdest")))
