...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness parse-recovery,unsupported-syntax) (has-evaluation true) (source-digest "blake3:c9177640324998bea3516aa02bd078a8abb67fdfab27000797838daab7c9a5a1"))
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::uc2::actor"))) (kind default-reference) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "user")))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::uc2::actor"))) (kind redefinition) (ordinal 0))
      (authored-target "user")
      (outcome (status resolved) (target (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::user")))))
    ...
    (reference (id (source (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::uc3"))) (kind memberAccessOperand) (ordinal 0))
      ...
      (outcome (status resolved) (target (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::system::uc1")))))
  ...
  (relationships
    ...
    (relationship (kind redefinition) (source (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::uc2::actor"))) (target (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::user"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::uc2::actor"))) (kind redefinition) (ordinal 0)))
    ...
    (relationship (kind memberAccessOperand) (source (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::uc3"))) (target (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::system::uc1"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::uc3"))) (kind memberAccessOperand) (ordinal 0)))
    ...
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::uc2::actor"))) (target (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::uc2"))) (provenance implied))
  )
  (evaluation
...
(types
    ...
    (declaration (id (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::u")))
      ...
      (supertype (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::UseSystem")) (scopes any))
      (subtype (node (document "memory://snapshot/use_case_test.md") (path (named (kind package) (name "UseCaseTest")) (named (kind part) (name "system")) (anonymous (kind perform-action) (ordinal 0)))) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::uc2::actor")))
      (featured-by (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::uc2")))
      (effective-type (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::User")) (source inherited) (from (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::user"))))
      (supertype (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::User")) (scopes any))
      (supertype (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::user")) (scopes any feature))
    )
    (declaration (id (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::user")))
      (type (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::User")) (provenance authored))
      (effective-type (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::User")) (source direct))
      (supertype (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::User")) (scopes any))
      (subtype (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::uc2::actor")) (scopes any feature))
    )
)
~~~
# EXPRESSIONS
...
(navigation
  ...
  (query (document "memory://snapshot/use_case_test.md") (range (start 26 12) (end 26 16)) (probe (position 26 12))
    (reference (id (source (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::uc2::actor"))) (kind redefinition) (ordinal 0) (authored-target "user")
      (outcome (status resolved) (target (node (document "memory://snapshot/use_case_test.md") (qualified-name "UseCaseTest::user")))))
    )
  )
