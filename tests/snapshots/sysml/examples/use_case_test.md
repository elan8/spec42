...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/use_case_test.md") (path (named (kind package) (name "UseCaseTest")) (named (kind use-case-def) (name "UseSystem")) (named (kind use-case) (name "uc2")) (anonymous (kind subject) (ordinal 0))))) (kind subject) (membership (kind feature) (visibility default)))
