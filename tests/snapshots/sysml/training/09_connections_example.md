...
(semantic-model
  ...
  (relationships
    ...
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/09_connections_example.md") (path (named (kind package) (name "Connections Example")) (named (kind part) (name "wheelHubAssembly")) (anonymous (kind bare-connect) (ordinal 0))))) (target (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/09_connections_example.md") (path (named (kind package) (name "Connections Example")) (named (kind part) (name "wheelHubAssembly")) (anonymous (kind bare-connect) (ordinal 1))))) (target (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::hub"))) (target (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::hub::h"))) (target (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::hub"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::lugBoltJoints"))) (target (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel"))) (target (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel::t"))) (target (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel::t::bead"))) (target (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel::t"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel::w"))) (target (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel::w::mountingHoles"))) (target (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel::w"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel::w::rim"))) (target (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel::w"))) (provenance implied))
  )
  (evaluation
  )
)
...
~~~sexpr
(types
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::Hub")))
      (subtype (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::hub")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::LugBoltJoint")))
      (subtype (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::lugBoltJoints")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::LugBoltMountingHole")))
      (subtype (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel::w::mountingHoles")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::LugBoltThreadableHole")))
      (subtype (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::hub::h")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::Tire")))
      (subtype (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel::t")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::TireBead")))
      (subtype (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel::t::bead")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::TireMountingRim")))
      (subtype (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel::w::rim")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::Wheel")))
      (subtype (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel::w")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::WheelAssembly")))
      (subtype (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::WheelHubAssembly")))
      (subtype (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly")))
      (type (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::WheelHubAssembly")) (provenance authored))
      (effective-type (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::WheelHubAssembly")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (path (named (kind package) (name "Connections Example")) (named (kind part) (name "wheelHubAssembly")) (anonymous (kind bare-connect) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly")))
    )
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (path (named (kind package) (name "Connections Example")) (named (kind part) (name "wheelHubAssembly")) (anonymous (kind bare-connect) (ordinal 1)))))
      (featured-by (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly")))
    )
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::hub")))
      (featured-by (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly")))
      (type (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::Hub")) (provenance authored))
      (effective-type (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::Hub")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::hub::h")))
      (featured-by (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::hub")))
      (type (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::LugBoltThreadableHole")) (provenance authored))
      (effective-type (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::LugBoltThreadableHole")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::lugBoltJoints")))
      (featured-by (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly")))
      (type (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::LugBoltJoint")) (provenance authored))
      (effective-type (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::LugBoltJoint")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel")))
      (featured-by (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly")))
      (type (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::WheelAssembly")) (provenance authored))
      (effective-type (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::WheelAssembly")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel::t")))
      (featured-by (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel")))
      (type (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::Tire")) (provenance authored))
      (effective-type (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::Tire")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel::t::bead")))
      (featured-by (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel::t")))
      (type (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::TireBead")) (provenance authored))
      (effective-type (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::TireBead")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel::w")))
      (featured-by (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel")))
      (type (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::Wheel")) (provenance authored))
      (effective-type (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::Wheel")) (source direct))
      (supertype (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::Wheel")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel::w::mountingHoles")))
      (featured-by (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel::w")))
      (type (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::LugBoltMountingHole")) (provenance authored))
      (effective-type (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::LugBoltMountingHole")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel::w::rim")))
      (featured-by (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::wheelHubAssembly::wheel::w")))
      (type (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::TireMountingRim")) (provenance authored))
      (effective-type (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::TireMountingRim")) (source direct))
