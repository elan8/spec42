...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation false) (source-digest "blake3:457ea7f7731fde8b9fa2f3fa09ade51ab64e58eb3129433ad5cf3552353222f2") (contract-version "lossless-publication-completeness-v3"))
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::PressureSeat::bead"))) (kind part) (membership (kind feature) (visibility default)) (facts (modifiers end)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "TireBead")))))
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (path (named (kind package) (name "Connections Example")) (named (kind connection-def) (name "PressureSeat")) (named (kind part) (name "bead")) (anonymous (kind ref) (ordinal 0))))) (kind ref) (membership (kind feature) (visibility default)) (facts (multiplicity (lower 1) (upper 1))))
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::PressureSeat::mountingRim"))) (kind part) (membership (kind feature) (visibility default)) (facts (modifiers end)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "TireMountingRim")))))
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (path (named (kind package) (name "Connections Example")) (named (kind connection-def) (name "PressureSeat")) (named (kind part) (name "mountingRim")) (anonymous (kind ref) (ordinal 0))))) (kind ref) (membership (kind feature) (visibility default)) (facts (multiplicity (lower 1) (upper 1))))
  ...
  (relationships
    ...
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/09_connections_example.md") (path (named (kind package) (name "Connections Example")) (named (kind connection-def) (name "PressureSeat")) (named (kind part) (name "bead")) (anonymous (kind ref) (ordinal 0))))) (target (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::PressureSeat::bead"))) (provenance implied))
    ...
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/09_connections_example.md") (path (named (kind package) (name "Connections Example")) (named (kind connection-def) (name "PressureSeat")) (named (kind part) (name "mountingRim")) (anonymous (kind ref) (ordinal 0))))) (target (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::PressureSeat::mountingRim"))) (provenance implied))
...
(types
    ...
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (path (named (kind package) (name "Connections Example")) (named (kind connection-def) (name "PressureSeat")) (named (kind part) (name "bead")) (anonymous (kind ref) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::PressureSeat::bead")))
    )
    ...
    (declaration (id (node (document "memory://snapshot/09_connections_example.md") (path (named (kind package) (name "Connections Example")) (named (kind connection-def) (name "PressureSeat")) (named (kind part) (name "mountingRim")) (anonymous (kind ref) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/09_connections_example.md") (qualified-name "Connections Example::PressureSeat::mountingRim")))
    )
