...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation true) (source-digest "blake3:8845fda36be87b67f5235ca54c41e890d079eda091444f67733f3a3957cfcb86") (contract-version "lossless-publication-completeness-v3"))
  (declarations
  ...
  (evaluation
    (evaluated (declaration (node (document "memory://snapshot/30_calculation_usages_2.md") (qualified-name "Calculation Usages-2::VehicleDynamics::updateState::totalPower"))) (state unsupported))
  )
)
~~~
# TYPES
