...
(semantic-model
  ...
  (relationships
    ...
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/21_messaging_with_ports.md") (qualified-name "Messaging Example::camera::takePicture::send"))) (target (node (document "memory://snapshot/21_messaging_with_ports.md") (qualified-name "Messaging Example::camera::takePicture"))) (provenance implied))
