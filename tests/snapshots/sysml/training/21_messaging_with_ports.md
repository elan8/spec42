...
(semantic-model
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/21_messaging_with_ports.md") (path (named (kind package) (name "Messaging Example")) (named (kind part) (name "camera")) (named (kind action) (name "takePicture")) (anonymous (kind send-action) (ordinal 0))))) (kind memberAccessOperand) (ordinal 0))
      ...
      (outcome (status resolved) (target (node (document "memory://snapshot/21_messaging_with_ports.md") (qualified-name "Messaging Example::camera::takePicture::shoot::picture")))))
