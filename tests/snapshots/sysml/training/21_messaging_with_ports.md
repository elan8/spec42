...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation false) (source-digest "blake3:feb91c879d2638e3bb574cfb56398fb3cc26ba87e69fea1960c2a020c15da8f3") (contract-version "parser-owned-resolution-v1"))
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/21_messaging_with_ports.md") (qualified-name "Messaging Example::camera::takePicture::send"))) (kind action) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (memberAccessOperand (reference "shoot::picture")) (invocationCallee (reference "Show")) (acceptVia (reference "displayPort")))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/21_messaging_with_ports.md") (qualified-name "Messaging Example::camera::takePicture::send"))) (kind memberAccessOperand) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/21_messaging_with_ports.md") (qualified-name "Messaging Example::camera::takePicture::send"))) (kind invocationCallee) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/21_messaging_with_ports.md") (qualified-name "Messaging Example::camera::takePicture::send"))) (kind acceptVia) (ordinal 0))
  ...
  (relationships
    ...
    (relationship (kind memberAccessOperand) (source (node (document "memory://snapshot/21_messaging_with_ports.md") (qualified-name "Messaging Example::camera::takePicture::send"))) (target (node (document "memory://snapshot/21_messaging_with_ports.md") (qualified-name "Messaging Example::Shoot::picture"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/21_messaging_with_ports.md") (qualified-name "Messaging Example::camera::takePicture::send"))) (kind memberAccessOperand) (ordinal 0)))
    (relationship (kind invocationCallee) (source (node (document "memory://snapshot/21_messaging_with_ports.md") (qualified-name "Messaging Example::camera::takePicture::send"))) (target (node (document "memory://snapshot/21_messaging_with_ports.md") (qualified-name "Messaging Example::Show"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/21_messaging_with_ports.md") (qualified-name "Messaging Example::camera::takePicture::send"))) (kind invocationCallee) (ordinal 0)))
    (relationship (kind acceptVia) (source (node (document "memory://snapshot/21_messaging_with_ports.md") (qualified-name "Messaging Example::camera::takePicture::send"))) (target (node (document "memory://snapshot/21_messaging_with_ports.md") (qualified-name "Messaging Example::camera::displayPort"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/21_messaging_with_ports.md") (qualified-name "Messaging Example::camera::takePicture::send"))) (kind acceptVia) (ordinal 0)))
...
(types
    ...
    (declaration (id (node (document "memory://snapshot/21_messaging_with_ports.md") (qualified-name "Messaging Example::camera::takePicture::send")))
      (featured-by (node (document "memory://snapshot/21_messaging_with_ports.md") (qualified-name "Messaging Example::camera::takePicture")))
    )
...
(navigation
  ...
  (query (document "memory://snapshot/21_messaging_with_ports.md") (range (start 36 22) (end 36 35)) (probe (position 36 22))
    (reference (id (source (node (document "memory://snapshot/21_messaging_with_ports.md") (qualified-name "Messaging Example::camera::takePicture::send"))) (kind memberAccessOperand) (ordinal 0) (authored-target "shoot::picture")
      (outcome (status resolved) (target (node (document "memory://snapshot/21_messaging_with_ports.md") (qualified-name "Messaging Example::Shoot::picture")))))
    )
  )
  (query (document "memory://snapshot/21_messaging_with_ports.md") (range (start 36 17) (end 36 21)) (probe (position 36 17))
    (reference (id (source (node (document "memory://snapshot/21_messaging_with_ports.md") (qualified-name "Messaging Example::camera::takePicture::send"))) (kind invocationCallee) (ordinal 0) (authored-target "Show")
      (outcome (status resolved) (target (node (document "memory://snapshot/21_messaging_with_ports.md") (qualified-name "Messaging Example::Show")))))
    )
  )
  (query (document "memory://snapshot/21_messaging_with_ports.md") (range (start 36 41) (end 36 52)) (probe (position 36 41))
    (reference (id (source (node (document "memory://snapshot/21_messaging_with_ports.md") (qualified-name "Messaging Example::camera::takePicture::send"))) (kind acceptVia) (ordinal 0) (authored-target "displayPort")
      (outcome (status resolved) (target (node (document "memory://snapshot/21_messaging_with_ports.md") (qualified-name "Messaging Example::camera::displayPort")))))
    )
  )
