...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/01_comment_example.md") (qualified-name "Comment Example::Comment1"))) (kind comment) (membership (kind feature) (visibility default)) (documentation (comment (text " This is a named comment. "))))
