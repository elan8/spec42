  ...
  (document "memory://snapshot/42_views_example.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (code "view_expose_unresolved")
        (source "semantic")
        (range (start 24 10) (end 24 30))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_view_definition_member")
        (source "semantic")
        (range (start 25 3) (end 25 33))
      )
      (diagnostic
        (severity warning)
        (code "view_expose_unresolved")
        (source "semantic")
        (range (start 29 10) (end 29 36))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_view_definition_member")
        (source "semantic")
        (range (start 30 3) (end 30 33))
      )
    )
  )
)
...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness unsupported-syntax) (has-evaluation false) (source-digest "blake3:75e1b12ea33488b2c3ff36d83083c66bb25c8b324aad65f842a384cc07595467"))
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/42_views_example.md") (path (named (kind package) (name "Views Example")) (named (kind rendering) (name "asTextualNotationTable")) (anonymous (kind view) (ordinal 0))))) (kind view) (membership (kind feature) (visibility default)) (facts (multiplicity (lower 1) (upper 1))) (effective-identification (name unresolved) (short-name unresolved) (provenance first-redefinition)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "columnView")))))
    ...
    (declaration (id (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::vehicle tabular views::non-safety features view"))) (kind view) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Part Structure View")))))
    (declaration (id (node (document "memory://snapshot/42_views_example.md") (path (named (kind package) (name "Views Example")) (named (kind view) (name "vehicle tabular views")) (named (kind view) (name "non-safety features view")) (anonymous (kind expose) (ordinal 0))))) (kind expose) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (viewExpose (reference "vehicle")))))
    (declaration (id (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::vehicle tabular views::safety features view"))) (kind view) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Part Structure View")))))
    (declaration (id (node (document "memory://snapshot/42_views_example.md") (path (named (kind package) (name "Views Example")) (named (kind view) (name "vehicle tabular views")) (named (kind view) (name "safety features view")) (anonymous (kind expose) (ordinal 0))))) (kind expose) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (viewExpose (reference "vehicle")))))
  )
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/42_views_example.md") (path (named (kind package) (name "Views Example")) (named (kind view) (name "vehicle structure view")) (anonymous (kind expose) (ordinal 0))))) (kind viewExpose) (ordinal 0))
      ...
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::vehicle tabular views::non-safety features view"))) (kind featureTyping) (ordinal 0))
      (authored-target "Part Structure View")
      (outcome (status resolved) (target (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::Part Structure View")))))
    (reference (id (source (node (document "memory://snapshot/42_views_example.md") (path (named (kind package) (name "Views Example")) (named (kind view) (name "vehicle tabular views")) (named (kind view) (name "non-safety features view")) (anonymous (kind expose) (ordinal 0))))) (kind viewExpose) (ordinal 0))
      (authored-target "vehicle")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::vehicle tabular views::safety features view"))) (kind featureTyping) (ordinal 0))
      (authored-target "Part Structure View")
      (outcome (status resolved) (target (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::Part Structure View")))))
    (reference (id (source (node (document "memory://snapshot/42_views_example.md") (path (named (kind package) (name "Views Example")) (named (kind view) (name "vehicle tabular views")) (named (kind view) (name "safety features view")) (anonymous (kind expose) (ordinal 0))))) (kind viewExpose) (ordinal 0))
      (authored-target "vehicle")
      (outcome (status unresolved)))
  )
  (relationships
    ...
    (relationship (kind typing) (source (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::vehicle tabular views::non-safety features view"))) (target (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::Part Structure View"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::vehicle tabular views::non-safety features view"))) (kind featureTyping) (ordinal 0)))
    (relationship (kind typing) (source (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::vehicle tabular views::safety features view"))) (target (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::Part Structure View"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::vehicle tabular views::safety features view"))) (kind featureTyping) (ordinal 0)))
    ...
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::vehicle tabular views::non-safety features view"))) (target (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::vehicle tabular views"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/42_views_example.md") (path (named (kind package) (name "Views Example")) (named (kind view) (name "vehicle tabular views")) (named (kind view) (name "non-safety features view")) (anonymous (kind expose) (ordinal 0))))) (target (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::vehicle tabular views::non-safety features view"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::vehicle tabular views::safety features view"))) (target (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::vehicle tabular views"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/42_views_example.md") (path (named (kind package) (name "Views Example")) (named (kind view) (name "vehicle tabular views")) (named (kind view) (name "safety features view")) (anonymous (kind expose) (ordinal 0))))) (target (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::vehicle tabular views::safety features view"))) (provenance implied))
  )
  (evaluation
...
(types
    (declaration (id (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::Part Structure View")))
      ...
      (subtype (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::vehicle tabular views::non-safety features view")) (scopes any))
      (subtype (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::vehicle tabular views::safety features view")) (scopes any))
    )
    ...
    (declaration (id (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::vehicle tabular views::non-safety features view")))
      (featured-by (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::vehicle tabular views")))
      (type (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::Part Structure View")) (provenance authored))
      (effective-type (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::Part Structure View")) (source direct))
      (supertype (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::Part Structure View")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/42_views_example.md") (path (named (kind package) (name "Views Example")) (named (kind view) (name "vehicle tabular views")) (named (kind view) (name "non-safety features view")) (anonymous (kind expose) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::vehicle tabular views::non-safety features view")))
    )
    (declaration (id (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::vehicle tabular views::safety features view")))
      (featured-by (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::vehicle tabular views")))
      (type (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::Part Structure View")) (provenance authored))
      (effective-type (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::Part Structure View")) (source direct))
      (supertype (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::Part Structure View")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/42_views_example.md") (path (named (kind package) (name "Views Example")) (named (kind view) (name "vehicle tabular views")) (named (kind view) (name "safety features view")) (anonymous (kind expose) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::vehicle tabular views::safety features view")))
    )
)
~~~
# NAVIGATION
...
(navigation
  ...
  (query (document "memory://snapshot/42_views_example.md") (range (start 28 36) (end 28 57)) (probe (position 28 36))
    (reference (id (source (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::vehicle tabular views::non-safety features view"))) (kind featureTyping) (ordinal 0) (authored-target "Part Structure View")
      (outcome (status resolved) (target (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::Part Structure View")))))
    )
  )
  (query (document "memory://snapshot/42_views_example.md") (range (start 29 10) (end 29 36)) (probe (position 29 10))
    (reference (id (source (node (document "memory://snapshot/42_views_example.md") (path (named (kind package) (name "Views Example")) (named (kind view) (name "vehicle tabular views")) (named (kind view) (name "non-safety features view")) (anonymous (kind expose) (ordinal 0))))) (kind viewExpose) (ordinal 0) (authored-target "vehicle")
      (outcome (status unresolved)))
    )
  )
  (query (document "memory://snapshot/42_views_example.md") (range (start 23 32) (end 23 53)) (probe (position 23 32))
    (reference (id (source (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::vehicle tabular views::safety features view"))) (kind featureTyping) (ordinal 0) (authored-target "Part Structure View")
      (outcome (status resolved) (target (node (document "memory://snapshot/42_views_example.md") (qualified-name "Views Example::Part Structure View")))))
    )
  )
  (query (document "memory://snapshot/42_views_example.md") (range (start 24 10) (end 24 30)) (probe (position 24 10))
    (reference (id (source (node (document "memory://snapshot/42_views_example.md") (path (named (kind package) (name "Views Example")) (named (kind view) (name "vehicle tabular views")) (named (kind view) (name "safety features view")) (anonymous (kind expose) (ordinal 0))))) (kind viewExpose) (ordinal 0) (authored-target "vehicle")
      (outcome (status unresolved)))
    )
  )
)
