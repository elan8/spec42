...
(semantic-model
  ...
  (evaluation
    (evaluated (declaration (node (document "memory://snapshot/32_requirement_usages.md") (path (named (kind package) (name "Requirement Usages")) (named (kind requirement) (name "emptyVehicleMassLimit")) (anonymous (kind assume-constraint) (ordinal 0))))) (state non-constant))
    ...
    (evaluated (declaration (node (document "memory://snapshot/32_requirement_usages.md") (path (named (kind package) (name "Requirement Usages")) (named (kind requirement) (name "fullVehicleMassLimit")) (anonymous (kind assume-constraint) (ordinal 0))))) (state non-constant))
...
~~~sexpr
(expressions
  (declaration (id (node (document "memory://snapshot/32_requirement_usages.md") (path (named (kind package) (name "Requirement Usages")) (named (kind requirement) (name "emptyVehicleMassLimit")) (anonymous (kind assume-constraint) (ordinal 0))))) (outcome resolved) (operator "==" (feature-reference "vehicle::fuelMass" (target unresolved)) (literal (value (kind quantity) (magnitude (value (kind integer) (integer 0))) (unit "kg")))))
  (declaration (id (node (document "memory://snapshot/32_requirement_usages.md") (path (named (kind package) (name "Requirement Usages")) (named (kind requirement) (name "emptyVehicleMassLimit")) (anonymous (kind attribute) (ordinal 0)) (anonymous (kind kerml-expression) (ordinal 0))))) (outcome resolved) (literal (value (kind quantity) (magnitude (value (kind integer) (integer 1500))) (unit "kg"))))
  (declaration (id (node (document "memory://snapshot/32_requirement_usages.md") (path (named (kind package) (name "Requirement Usages")) (named (kind requirement) (name "fullVehicleMassLimit")) (anonymous (kind assume-constraint) (ordinal 0))))) (outcome resolved) (operator "==" (feature-reference "vehicle::fuelMass" (target unresolved)) (feature-reference "vehicle::fuelFullMass" (target unresolved))))
