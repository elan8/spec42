...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation false) (source-digest "blake3:acdb51406f99c0c590ae7188a5528530f6059abf3d66f527e8fb367a820d8898") (contract-version "constructor-expression-specialization-v9"))
  (declarations
  ...
  (relationships
    ...
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Vehicle::driver"))) (target (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Vehicle"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Vehicle::eng"))) (target (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Vehicle"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Vehicle::mass"))) (target (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Vehicle"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Vehicle::status"))) (target (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Vehicle"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::VehicleStatus::acceleratorPosition"))) (target (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::VehicleStatus"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::VehicleStatus::gearSetting"))) (target (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::VehicleStatus"))) (provenance implied))
  )
  (evaluation
  )
)
...
~~~sexpr
(types
    (declaration (id (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Engine")))
      (subtype (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Vehicle::eng")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Person")))
      (subtype (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Vehicle::driver")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Vehicle::driver")))
      (featured-by (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Vehicle")))
      (type (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Person")) (provenance authored))
      (effective-type (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Person")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Vehicle::eng")))
      (featured-by (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Vehicle")))
      (type (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Engine")) (provenance authored))
      (effective-type (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Engine")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Vehicle::mass")))
      (featured-by (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Vehicle")))
    )
    (declaration (id (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Vehicle::status")))
      (featured-by (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Vehicle")))
      (type (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::VehicleStatus")) (provenance authored))
      (effective-type (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::VehicleStatus")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::VehicleStatus")))
      (subtype (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::Vehicle::status")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::VehicleStatus::acceleratorPosition")))
      (featured-by (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::VehicleStatus")))
    )
    (declaration (id (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::VehicleStatus::gearSetting")))
      (featured-by (node (document "memory://snapshot/02_part_definition_example.md") (qualified-name "Part Definition Example::VehicleStatus")))
    )
)
~~~
