...
(semantic-model
  ...
  (relationships
    ...
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/21_messaging_example.md") (qualified-name "Messaging Example::takePicture::send"))) (target (node (document "memory://snapshot/21_messaging_example.md") (qualified-name "Messaging Example::takePicture"))) (provenance implied))
