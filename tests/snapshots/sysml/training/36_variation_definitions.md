...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/36_variation_definitions.md") (path (named (kind package) (name "Variation Definitions")) (named (kind part) (name "4cylEngine")) (anonymous (kind part) (ordinal 0))))) (kind part) (membership (kind feature) (visibility default)) (facts (multiplicity (lower 4) (upper 4))) (effective-identification (name "cylinder") (short-name absent) (provenance first-redefinition)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "cylinder")))))
    ...
    (declaration (id (node (document "memory://snapshot/36_variation_definitions.md") (path (named (kind package) (name "Variation Definitions")) (named (kind part) (name "6cylEngine")) (anonymous (kind part) (ordinal 0))))) (kind part) (membership (kind feature) (visibility default)) (facts (multiplicity (lower 6) (upper 6))) (effective-identification (name "cylinder") (short-name absent) (provenance first-redefinition)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "cylinder")))))
    ...
    (declaration (id (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::EngineChoices"))) (kind part-def) (membership (kind owning) (visibility default)) (facts (modifiers variation)) (authored (membership (kind owning) (visibility default)) (relationships (specialization (reference "Engine")))))
    (declaration (id (node (document "memory://snapshot/36_variation_definitions.md") (path (named (kind package) (name "Variation Definitions")) (named (kind part-def) (name "EngineChoices")) (anonymous (kind ref) (ordinal 0))))) (kind ref) (membership (kind owning) (visibility default) (role variant)) (authored (membership (kind owning) (visibility default) (role variant)) (relationships (subsetting (reference "4cylEngine")))))
    (declaration (id (node (document "memory://snapshot/36_variation_definitions.md") (path (named (kind package) (name "Variation Definitions")) (named (kind part-def) (name "EngineChoices")) (anonymous (kind ref) (ordinal 1))))) (kind ref) (membership (kind owning) (visibility default) (role variant)) (authored (membership (kind owning) (visibility default) (role variant)) (relationships (subsetting (reference "6cylEngine")))))
  )
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::EngineChoices"))) (kind specialization) (ordinal 0))
      (authored-target "Engine")
      (outcome (status resolved) (target (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::Engine")))))
    (reference (id (source (node (document "memory://snapshot/36_variation_definitions.md") (path (named (kind package) (name "Variation Definitions")) (named (kind part-def) (name "EngineChoices")) (anonymous (kind ref) (ordinal 0))))) (kind subsetting) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/36_variation_definitions.md") (path (named (kind package) (name "Variation Definitions")) (named (kind part-def) (name "EngineChoices")) (anonymous (kind ref) (ordinal 1))))) (kind subsetting) (ordinal 0))
  ...
  (relationships
    ...
    (relationship (kind subsetting) (source (node (document "memory://snapshot/36_variation_definitions.md") (path (named (kind package) (name "Variation Definitions")) (named (kind part-def) (name "EngineChoices")) (anonymous (kind ref) (ordinal 0))))) (target (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::4cylEngine"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/36_variation_definitions.md") (path (named (kind package) (name "Variation Definitions")) (named (kind part-def) (name "EngineChoices")) (anonymous (kind ref) (ordinal 0))))) (kind subsetting) (ordinal 0)))
    (relationship (kind subsetting) (source (node (document "memory://snapshot/36_variation_definitions.md") (path (named (kind package) (name "Variation Definitions")) (named (kind part-def) (name "EngineChoices")) (anonymous (kind ref) (ordinal 1))))) (target (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::6cylEngine"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/36_variation_definitions.md") (path (named (kind package) (name "Variation Definitions")) (named (kind part-def) (name "EngineChoices")) (anonymous (kind ref) (ordinal 1))))) (kind subsetting) (ordinal 0)))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/36_variation_definitions.md") (path (named (kind package) (name "Variation Definitions")) (named (kind part) (name "4cylEngine")) (anonymous (kind part) (ordinal 0))))) (target (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::4cylEngine"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/36_variation_definitions.md") (path (named (kind package) (name "Variation Definitions")) (named (kind part) (name "6cylEngine")) (anonymous (kind part) (ordinal 0))))) (target (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::6cylEngine"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::Cylinder::diameter"))) (target (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::Cylinder"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::Engine::cylinder"))) (target (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::Engine"))) (provenance implied))
  )
  (evaluation
  )
)
...
(types
    (declaration (id (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::4cylEngine")))
      ...
      (subtype (node (document "memory://snapshot/36_variation_definitions.md") (path (named (kind package) (name "Variation Definitions")) (named (kind part-def) (name "EngineChoices")) (anonymous (kind ref) (ordinal 0)))) (scopes any feature))
    )
    ...
    (declaration (id (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::6cylEngine")))
      ...
      (effective-type (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::Engine")) (source direct))
      (supertype (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::Engine")) (scopes any))
      (subtype (node (document "memory://snapshot/36_variation_definitions.md") (path (named (kind package) (name "Variation Definitions")) (named (kind part-def) (name "EngineChoices")) (anonymous (kind ref) (ordinal 1)))) (scopes any feature))
    )
    ...
    (declaration (id (node (document "memory://snapshot/36_variation_definitions.md") (path (named (kind package) (name "Variation Definitions")) (named (kind part-def) (name "EngineChoices")) (anonymous (kind ref) (ordinal 0)))))
      (effective-type (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::Engine")) (source inherited) (from (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::4cylEngine"))))
      (supertype (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::4cylEngine")) (scopes any feature))
      (supertype (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::Engine")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/36_variation_definitions.md") (path (named (kind package) (name "Variation Definitions")) (named (kind part-def) (name "EngineChoices")) (anonymous (kind ref) (ordinal 1)))))
      (effective-type (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::Engine")) (source inherited) (from (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::6cylEngine"))))
      (supertype (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::6cylEngine")) (scopes any feature))
      (supertype (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::Engine")) (scopes any))
    )
)
~~~
...
(navigation
  ...
  (query (document "memory://snapshot/36_variation_definitions.md") (range (start 30 10) (end 30 22)) (probe (position 30 10))
    (reference (id (source (node (document "memory://snapshot/36_variation_definitions.md") (path (named (kind package) (name "Variation Definitions")) (named (kind part-def) (name "EngineChoices")) (anonymous (kind ref) (ordinal 0))))) (kind subsetting) (ordinal 0) (authored-target "4cylEngine")
      (outcome (status resolved) (target (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::4cylEngine")))))
    )
  )
  (query (document "memory://snapshot/36_variation_definitions.md") (range (start 31 10) (end 31 22)) (probe (position 31 10))
    (reference (id (source (node (document "memory://snapshot/36_variation_definitions.md") (path (named (kind package) (name "Variation Definitions")) (named (kind part-def) (name "EngineChoices")) (anonymous (kind ref) (ordinal 1))))) (kind subsetting) (ordinal 0) (authored-target "6cylEngine")
      (outcome (status resolved) (target (node (document "memory://snapshot/36_variation_definitions.md") (qualified-name "Variation Definitions::6cylEngine")))))
    )
  )
)
