...
(semantic-model
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/16_conditional_succession_example_1.md") (path (named (kind package) (name "Conditional Succession Example-1")) (named (kind action) (name "takePicture")) (anonymous (kind flow) (ordinal 0))))) (kind flowTarget) (ordinal 0))
      ...
      (outcome (status resolved) (target (node (document "memory://snapshot/16_conditional_succession_example_1.md") (qualified-name "Conditional Succession Example-1::Shoot::image")))))
  ...
  (relationships
    ...
    (relationship (kind flowTarget) (source (node (document "memory://snapshot/16_conditional_succession_example_1.md") (path (named (kind package) (name "Conditional Succession Example-1")) (named (kind action) (name "takePicture")) (anonymous (kind flow) (ordinal 0))))) (target (node (document "memory://snapshot/16_conditional_succession_example_1.md") (qualified-name "Conditional Succession Example-1::Shoot::image"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/16_conditional_succession_example_1.md") (path (named (kind package) (name "Conditional Succession Example-1")) (named (kind action) (name "takePicture")) (anonymous (kind flow) (ordinal 0))))) (kind flowTarget) (ordinal 0)))
