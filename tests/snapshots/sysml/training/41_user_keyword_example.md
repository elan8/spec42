...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness unsupported-syntax) (has-evaluation true) (source-digest "blake3:b67a8c645e7b6c2fe182f63260be6d01a995d648542e390c9f164fa4ad04810c") (contract-version "lossless-publication-completeness-v3"))
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/41_user_keyword_example.md") (qualified-name "User Keyword Example::DeviceFailure::battery old"))) (kind extended-usage) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (metadataAnnotation (reference "cause")))))
    (declaration (id (node (document "memory://snapshot/41_user_keyword_example.md") (path (named (kind package) (name "User Keyword Example")) (named (kind extended-definition) (name "DeviceFailure")) (named (kind extended-usage) (name "battery old")) (anonymous (kind attribute) (ordinal 0))))) (kind attribute) (membership (kind feature) (visibility default)) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "probability")))))
    ...
    (declaration (id (node (document "memory://snapshot/41_user_keyword_example.md") (qualified-name "User Keyword Example::DeviceFailure::device shutoff"))) (kind extended-usage) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (metadataAnnotation (reference "failure")))))
    (declaration (id (node (document "memory://snapshot/41_user_keyword_example.md") (path (named (kind package) (name "User Keyword Example")) (named (kind extended-definition) (name "DeviceFailure")) (named (kind extended-usage) (name "device shutoff")) (anonymous (kind attribute) (ordinal 0))))) (kind attribute) (membership (kind feature) (visibility default)) (feature-value (kind bind)) (authored (membership (kind feature) (visibility default)) (relationships (redefinition (reference "severity")) (expressionOperand (reference "LevelEnum::high")))))
    ...
    (declaration (id (node (document "memory://snapshot/41_user_keyword_example.md") (qualified-name "User Keyword Example::DeviceFailure::power low"))) (kind extended-usage) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (metadataAnnotation (reference "situation")))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/41_user_keyword_example.md") (qualified-name "User Keyword Example::DeviceFailure::battery old"))) (kind metadataAnnotation) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/41_user_keyword_example.md") (qualified-name "User Keyword Example::DeviceFailure::device shutoff"))) (kind metadataAnnotation) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/41_user_keyword_example.md") (path (named (kind package) (name "User Keyword Example")) (named (kind extended-definition) (name "DeviceFailure")) (named (kind extended-usage) (name "device shutoff")) (anonymous (kind attribute) (ordinal 0))))) (kind redefinition) (ordinal 0))
      ...
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/41_user_keyword_example.md") (path (named (kind package) (name "User Keyword Example")) (named (kind extended-definition) (name "DeviceFailure")) (named (kind extended-usage) (name "device shutoff")) (anonymous (kind attribute) (ordinal 0))))) (kind expressionOperand) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/41_user_keyword_example.md") (qualified-name "User Keyword Example::DeviceFailure::minPower"))) (kind featureTyping) (ordinal 0))
      (authored-target "Real")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/41_user_keyword_example.md") (qualified-name "User Keyword Example::DeviceFailure::power low"))) (kind metadataAnnotation) (ordinal 0))
  ...
  (evaluation
    (evaluated (declaration (node (document "memory://snapshot/41_user_keyword_example.md") (path (named (kind package) (name "User Keyword Example")) (named (kind extended-definition) (name "DeviceFailure")) (named (kind extended-usage) (name "battery old")) (anonymous (kind attribute) (ordinal 0))))) (state literal) (value (kind real) (real 0.01)))
    (evaluated (declaration (node (document "memory://snapshot/41_user_keyword_example.md") (path (named (kind package) (name "User Keyword Example")) (named (kind extended-definition) (name "DeviceFailure")) (named (kind extended-usage) (name "device shutoff")) (anonymous (kind attribute) (ordinal 0))))) (state unresolved-operand))
...
(navigation
  ...
  (query (document "memory://snapshot/41_user_keyword_example.md") (range (start 15 3) (end 15 8)) (probe (position 15 3))
    (reference (id (source (node (document "memory://snapshot/41_user_keyword_example.md") (qualified-name "User Keyword Example::DeviceFailure::battery old"))) (kind metadataAnnotation) (ordinal 0) (authored-target "cause")
      (outcome (status unresolved)))
    )
  )
  ...
  (query (document "memory://snapshot/41_user_keyword_example.md") (range (start 27 3) (end 27 10)) (probe (position 27 3))
    (reference (id (source (node (document "memory://snapshot/41_user_keyword_example.md") (qualified-name "User Keyword Example::DeviceFailure::device shutoff"))) (kind metadataAnnotation) (ordinal 0) (authored-target "failure")
      (outcome (status unresolved)))
    )
  )
  ...
  (query (document "memory://snapshot/41_user_keyword_example.md") (range (start 28 18) (end 28 33)) (probe (position 28 18))
    (reference (id (source (node (document "memory://snapshot/41_user_keyword_example.md") (path (named (kind package) (name "User Keyword Example")) (named (kind extended-definition) (name "DeviceFailure")) (named (kind extended-usage) (name "device shutoff")) (anonymous (kind attribute) (ordinal 0))))) (kind expressionOperand) (ordinal 0) (authored-target "LevelEnum::high")
      (outcome (status unresolved)))
    )
  )
  ...
  (query (document "memory://snapshot/41_user_keyword_example.md") (range (start 21 3) (end 21 12)) (probe (position 21 3))
    (reference (id (source (node (document "memory://snapshot/41_user_keyword_example.md") (qualified-name "User Keyword Example::DeviceFailure::power low"))) (kind metadataAnnotation) (ordinal 0) (authored-target "situation")
      (outcome (status unresolved)))
    )
  )
