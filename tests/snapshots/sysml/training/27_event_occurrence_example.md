...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation false) (source-digest "blake3:da535832be0b11f483e1f8407c97f16accae2b8c4bfc9d742e736ce9b64407ae") (contract-version "constructor-expression-specialization-v9"))
  (declarations
  ...
  (relationships
    ...
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::driver::setSpeedSent"))) (target (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::driver"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::cruiseController"))) (target (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::cruiseController::fuelCommandSent"))) (target (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::cruiseController"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::cruiseController::sensedSpeedReceived"))) (target (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::cruiseController"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::cruiseController::setSpeedReceived"))) (target (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::cruiseController"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::engine"))) (target (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::engine::fuelCommandReceived"))) (target (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::engine"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::speedometer"))) (target (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::speedometer::sensedSpeedSent"))) (target (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::speedometer"))) (provenance implied))
  )
  (evaluation
  )
)
...
~~~sexpr
(types
    (declaration (id (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::CruiseController")))
      (subtype (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::cruiseController")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::Driver")))
      (subtype (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::driver")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::Engine")))
      (subtype (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::engine")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::Speedometer")))
      (subtype (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::speedometer")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::Vehicle")))
      (subtype (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle")) (scopes any))
    )
    (declaration (id (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::driver")))
      (type (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::Driver")) (provenance authored))
      (effective-type (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::Driver")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::driver::setSpeedSent")))
      (featured-by (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::driver")))
    )
    (declaration (id (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle")))
      (type (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::Vehicle")) (provenance authored))
      (effective-type (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::Vehicle")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::cruiseController")))
      (featured-by (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle")))
      (type (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::CruiseController")) (provenance authored))
      (effective-type (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::CruiseController")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::cruiseController::fuelCommandSent")))
      (featured-by (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::cruiseController")))
    )
    (declaration (id (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::cruiseController::sensedSpeedReceived")))
      (featured-by (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::cruiseController")))
    )
    (declaration (id (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::cruiseController::setSpeedReceived")))
      (featured-by (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::cruiseController")))
    )
    (declaration (id (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::engine")))
      (featured-by (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle")))
      (type (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::Engine")) (provenance authored))
      (effective-type (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::Engine")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::engine::fuelCommandReceived")))
      (featured-by (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::engine")))
    )
    (declaration (id (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::speedometer")))
      (featured-by (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle")))
      (type (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::Speedometer")) (provenance authored))
      (effective-type (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::Speedometer")) (source direct))
    ...
    (declaration (id (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::speedometer::sensedSpeedSent")))
      (featured-by (node (document "memory://snapshot/27_event_occurrence_example.md") (qualified-name "Event Occurrence Example::vehicle::speedometer")))
    )
)
~~~
# NAVIGATION
