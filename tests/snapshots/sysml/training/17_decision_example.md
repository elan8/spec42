...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation true) (source-digest "blake3:b4c682eb8f56fcb40c60c69fefa6cf3b1c10ee71080937769745bb2552e2c6d2") (contract-version "lossless-publication-completeness-v3"))
  (declarations
  ...
  (evaluation
    ...
    (evaluated (declaration (node (document "memory://snapshot/17_decision_example.md") (qualified-name "Decision Example::ChargeBattery::addCharge::charge"))) (state unsupported))
  )
)
~~~
# TYPES
