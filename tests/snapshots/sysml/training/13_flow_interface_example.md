...
(connections
  ...
  (connector (id (node (document "memory://snapshot/13_flow_interface_example.md") (path (named (kind package) (name "Flow Interface Example")) (named (kind part) (name "vehicle")) (anonymous (kind interface) (ordinal 0))))) (kind interface) (type (resolved (node (document "memory://snapshot/13_flow_interface_example.md") (qualified-name "Flow Interface Example::FuelInterface")))) (end bare (feature-chain (root (node (document "memory://snapshot/13_flow_interface_example.md") (qualified-name "Flow Interface Example::vehicle::tankAssy"))) (terminal unresolved) "tankAssy::fuelTankPort")) (end bare (feature-chain (root (node (document "memory://snapshot/13_flow_interface_example.md") (qualified-name "Flow Interface Example::vehicle::eng"))) (terminal unresolved) "eng::engineFuelPort")))
)
~~~
# NAVIGATION
~~~sexpr
