  ...
  (document "memory://snapshot/27_interaction_realization_1.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (source "semantic")
        (range (start 50 2) (end 50 81))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_occurrence_definition_member")
        (source "semantic")
        (range (start 51 2) (end 51 107))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_occurrence_definition_member")
        (source "semantic")
        (range (start 52 2) (end 52 111))
      )
    )
  )
)
...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness unsupported-syntax) (has-evaluation false) (source-digest "blake3:44f0afb918cd2e030af601da4a84161de808c2966bb6c40aa4863e9d1789a493") (contract-version "parser-owned-resolution-v1"))
  (declarations
