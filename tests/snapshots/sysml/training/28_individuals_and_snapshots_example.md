  ...
  (document "memory://snapshot/28_individuals_and_snapshots_example.md"
    (diagnostics
      ...
      (diagnostic
        ...
        (code "unsupported_attribute_member")
        (source "semantic")
        (range (start 16 4) (end 16 24))
      )
      (diagnostic
        (severity warning)
        (code "unsupported_attribute_member")
        (source "semantic")
        (range (start 17 4) (end 17 34))
      )
    )
  )
)
...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness unsupported-syntax) (has-evaluation true) (source-digest "blake3:b258241d80976f581202691a49bd3dc13faf10a7cb0fc91a5f0fe26e74b83a19") (contract-version "parser-owned-resolution-v1"))
  (declarations
