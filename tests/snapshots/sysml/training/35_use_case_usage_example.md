...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/35_use_case_usage_example.md") (path (named (kind package) (name "Use Case Usage Example")) (named (kind use-case) (name "provide transportation")) (anonymous (kind succession) (ordinal 0))))) (kind succession) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (succession (reference "start")))))
    (declaration (id (node (document "memory://snapshot/35_use_case_usage_example.md") (path (named (kind package) (name "Use Case Usage Example")) (named (kind use-case) (name "provide transportation")) (anonymous (kind then-continuation) (ordinal 0))))) (kind then-continuation) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (thenTarget (reference "done")))))
    (declaration (id (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation::drive vehicle"))) (kind use-case) (membership (kind feature) (visibility default)) (authored (membership (kind feature) (visibility default)) (relationships (includeUseCase (reference "add fuel")))))
    (declaration (id (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation::drive vehicle::vehicle"))) (kind subject) (membership (kind feature) (visibility default)))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation"))) (kind featureTyping) (ordinal 0))
      ...
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/35_use_case_usage_example.md") (path (named (kind package) (name "Use Case Usage Example")) (named (kind use-case) (name "provide transportation")) (anonymous (kind succession) (ordinal 0))))) (kind succession) (ordinal 0))
      (authored-target "start")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/35_use_case_usage_example.md") (path (named (kind package) (name "Use Case Usage Example")) (named (kind use-case) (name "provide transportation")) (anonymous (kind then-continuation) (ordinal 0))))) (kind thenTarget) (ordinal 0))
      (authored-target "done")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation::drive vehicle"))) (kind includeUseCase) (ordinal 0))
      (authored-target "add fuel")
      (outcome (status resolved) (target (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::add fuel")))))
  ...
  (relationships
    ...
    (relationship (kind includeUseCase) (source (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation::drive vehicle"))) (target (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::add fuel"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation::drive vehicle"))) (kind includeUseCase) (ordinal 0)))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::add fuel::fuel station"))) (target (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::add fuel"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::add fuel::fueler"))) (target (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::add fuel"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::add fuel::vehicle"))) (target (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::add fuel"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/35_use_case_usage_example.md") (path (named (kind package) (name "Use Case Usage Example")) (named (kind use-case) (name "provide transportation")) (anonymous (kind succession) (ordinal 0))))) (target (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/35_use_case_usage_example.md") (path (named (kind package) (name "Use Case Usage Example")) (named (kind use-case) (name "provide transportation")) (anonymous (kind then-continuation) (ordinal 0))))) (target (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation::drive vehicle"))) (target (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation::drive vehicle::vehicle"))) (target (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation::drive vehicle"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation::enter vehicle"))) (target (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation::enter vehicle::vehicle"))) (target (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation::enter vehicle"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation::exit vehicle"))) (target (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation::exit vehicle::vehicle"))) (target (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation::exit vehicle"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation::vehicle"))) (target (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation"))) (provenance implied))
  )
  (evaluation
  )
)
...
(types
    ...
    (declaration (id (node (document "memory://snapshot/35_use_case_usage_example.md") (path (named (kind package) (name "Use Case Usage Example")) (named (kind use-case) (name "provide transportation")) (anonymous (kind succession) (ordinal 0)))))
    ...
    (declaration (id (node (document "memory://snapshot/35_use_case_usage_example.md") (path (named (kind package) (name "Use Case Usage Example")) (named (kind use-case) (name "provide transportation")) (anonymous (kind then-continuation) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation")))
    )
    (declaration (id (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation::drive vehicle")))
      (featured-by (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation")))
    )
    (declaration (id (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation::drive vehicle::vehicle")))
      (featured-by (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation::drive vehicle")))
    )
...
(navigation
  ...
  (query (document "memory://snapshot/35_use_case_usage_example.md") (range (start 9 8) (end 9 13)) (probe (position 9 8))
    (reference (id (source (node (document "memory://snapshot/35_use_case_usage_example.md") (path (named (kind package) (name "Use Case Usage Example")) (named (kind use-case) (name "provide transportation")) (anonymous (kind succession) (ordinal 0))))) (kind succession) (ordinal 0) (authored-target "start")
      (outcome (status unresolved)))
    )
  )
  (query (document "memory://snapshot/35_use_case_usage_example.md") (range (start 34 7) (end 34 11)) (probe (position 34 7))
    (reference (id (source (node (document "memory://snapshot/35_use_case_usage_example.md") (path (named (kind package) (name "Use Case Usage Example")) (named (kind use-case) (name "provide transportation")) (anonymous (kind then-continuation) (ordinal 0))))) (kind thenTarget) (ordinal 0) (authored-target "done")
      (outcome (status unresolved)))
    )
  )
  (query (document "memory://snapshot/35_use_case_usage_example.md") (range (start 22 11) (end 22 21)) (probe (position 22 11))
    (reference (id (source (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::provide transportation::drive vehicle"))) (kind includeUseCase) (ordinal 0) (authored-target "add fuel")
      (outcome (status resolved) (target (node (document "memory://snapshot/35_use_case_usage_example.md") (qualified-name "Use Case Usage Example::add fuel")))))
    )
  )
