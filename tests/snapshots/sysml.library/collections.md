...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation true) (source-digest "blake3:a4bca9c80db0a608a8328ca0f3b7ef13e8aef68ca5f220fe37f0925a1bdafb5b") (contract-version "parser-owned-resolution-v2"))
  (declarations
  ...
  (evaluation
    ...
    (evaluated (declaration (node (document "memory://snapshot/collections.md") (qualified-name "Collections::Array::flattenedSize"))) (state unsupported))
