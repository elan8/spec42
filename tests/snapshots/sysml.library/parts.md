...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness complete) (has-evaluation false) (source-digest "blake3:23f4184b21d02572131ed39a5454f7fdf3a3fb2b76940077e2469fcaaa795f82") (contract-version "constructor-expression-specialization-v9"))
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/parts.md") (qualified-name "Parts::Part::ownedActions::this"))) (kind part) (membership (kind feature) (visibility default)) (facts (modifiers reference)) (documentation (doc (text "\n\t\t\t\t * The \"this\" reference of an ownedAction is always its owning Part.\n\t\t\t\t "))) (feature-value (kind bind) (value (node (document "memory://snapshot/parts.md") (path (named (kind library-package) (name "Parts")) (named (kind part-def) (name "Part")) (named (kind action) (name "ownedActions")) (named (kind part) (name "this")) (anonymous (kind kerml-expression) (ordinal 0))))) (result (node (document "memory://snapshot/parts.md") (path (named (kind library-package) (name "Parts")) (named (kind part-def) (name "Part")) (named (kind action) (name "ownedActions")) (named (kind part) (name "this")) (anonymous (kind kerml-expression) (ordinal 0)) (anonymous (kind kerml-feature) (ordinal 0)))))) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Part")) (redefinition (reference "Action::this")) (redefinition (reference "ownedPerformances::this")))))
    (declaration (id (node (document "memory://snapshot/parts.md") (path (named (kind library-package) (name "Parts")) (named (kind part-def) (name "Part")) (named (kind action) (name "ownedActions")) (named (kind part) (name "this")) (anonymous (kind kerml-expression) (ordinal 0))))) (kind kerml-expression) (membership (kind owning) (visibility default)) (facts (expression-result (node (document "memory://snapshot/parts.md") (path (named (kind library-package) (name "Parts")) (named (kind part-def) (name "Part")) (named (kind action) (name "ownedActions")) (named (kind part) (name "this")) (anonymous (kind kerml-expression) (ordinal 0)) (anonymous (kind kerml-feature) (ordinal 0)))))))
  ...
  (relationships
    ...
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/parts.md") (path (named (kind library-package) (name "Parts")) (named (kind part-def) (name "Part")) (named (kind action) (name "ownedActions")) (named (kind part) (name "this")) (anonymous (kind kerml-expression) (ordinal 0)) (anonymous (kind kerml-feature) (ordinal 0))))) (target (node (document "memory://snapshot/parts.md") (path (named (kind library-package) (name "Parts")) (named (kind part-def) (name "Part")) (named (kind action) (name "ownedActions")) (named (kind part) (name "this")) (anonymous (kind kerml-expression) (ordinal 0))))) (provenance implied))
...
(types
    ...
    (declaration (id (node (document "memory://snapshot/parts.md") (path (named (kind library-package) (name "Parts")) (named (kind part-def) (name "Part")) (named (kind action) (name "ownedActions")) (named (kind part) (name "this")) (anonymous (kind kerml-expression) (ordinal 0)) (anonymous (kind kerml-feature) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/parts.md") (path (named (kind library-package) (name "Parts")) (named (kind part-def) (name "Part")) (named (kind action) (name "ownedActions")) (named (kind part) (name "this")) (anonymous (kind kerml-expression) (ordinal 0)))))
    )
