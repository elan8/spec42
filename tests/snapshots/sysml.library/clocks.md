...
(semantic-model
  ...
  (evaluation
    ...
    (evaluated (declaration (node (document "memory://snapshot/clocks.md") (path (named (kind library-package) (name "Clocks")) (named (kind kerml-function) (name "DurationOf")) (named (kind parameter) (name "duration")) (anonymous (kind kerml-expression) (ordinal 0))))) (state unsupported))
...
(expressions
  ...
  (contextual (context (node (document "memory://snapshot/clocks.md") (qualified-name "Clocks::BasicTimeOf"))) (element (node (document "memory://snapshot/clocks.md") (qualified-name "Clocks::TimeOf::timeContinuityConstraint"))) (effective-element (node (document "memory://snapshot/clocks.md") (qualified-name "Clocks::TimeOf::timeContinuityConstraint"))) (authored-element (node (document "memory://snapshot/clocks.md") (qualified-name "Clocks::TimeOf::timeContinuityConstraint"))) (outcome unsupported))
  (contextual (context (node (document "memory://snapshot/clocks.md") (qualified-name "Clocks::BasicTimeOf"))) (element (node (document "memory://snapshot/clocks.md") (qualified-name "Clocks::TimeOf::timeOrderingConstraint"))) (effective-element (node (document "memory://snapshot/clocks.md") (qualified-name "Clocks::TimeOf::timeOrderingConstraint"))) (authored-element (node (document "memory://snapshot/clocks.md") (qualified-name "Clocks::TimeOf::timeOrderingConstraint"))) (outcome unsupported))
