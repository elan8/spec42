...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/causation_connections.md") (qualified-name "CausationConnections::Causation::theCauses"))) (kind connection) (membership (kind feature) (visibility default)) (facts (multiplicity (lower unbounded) (upper unbounded)) (positional-end 0)))
    (declaration (id (node (document "memory://snapshot/causation_connections.md") (qualified-name "CausationConnections::Causation::theEffects"))) (kind connection) (membership (kind feature) (visibility default)) (facts (multiplicity (lower unbounded) (upper unbounded)) (positional-end 1)))
  ...
  (relationships
    ...
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/causation_connections.md") (qualified-name "CausationConnections::Causation::theCauses"))) (target (node (document "memory://snapshot/causation_connections.md") (qualified-name "CausationConnections::Causation"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/causation_connections.md") (qualified-name "CausationConnections::Causation::theEffects"))) (target (node (document "memory://snapshot/causation_connections.md") (qualified-name "CausationConnections::Causation"))) (provenance implied))
...
(types
    ...
    (declaration (id (node (document "memory://snapshot/causation_connections.md") (qualified-name "CausationConnections::Causation::theEffects")))
      (featured-by (node (document "memory://snapshot/causation_connections.md") (qualified-name "CausationConnections::Causation")))
    )
