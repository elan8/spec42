...
(semantic-model
  ...
  (evaluation
    (evaluated (declaration (node (document "memory://snapshot/derivation_connections.md") (qualified-name "DerivationConnections::Derivation::originalImpliesDerived"))) (state non-constant))
...
~~~sexpr
(expressions
  (declaration (id (node (document "memory://snapshot/derivation_connections.md") (qualified-name "DerivationConnections::Derivation::originalImpliesDerived"))) (outcome resolved) (operator "implies" (feature-reference "originalRequirement::result" (target unresolved)) (unsupported (feature-reference "derivedRequirements::result" (target unresolved)))))
