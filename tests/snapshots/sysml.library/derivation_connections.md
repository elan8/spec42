...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/derivation_connections.md") (path (named (kind library-package) (name "DerivationConnections")) (named (kind connection-def) (name "Derivation")) (anonymous (kind ref) (ordinal 0))))) (kind ref) (membership (kind feature) (visibility default)) (facts (multiplicity (lower 1) (upper unbounded))) (effective-identification (name "derivedRequirements") (short-name absent) (provenance first-redefinition)) (documentation (doc (text " The one or more requirements that are derived from the original requirement. "))) (authored (membership (kind feature) (visibility default)) (relationships (subsetting (reference "participant")) (redefinition (reference "derivedRequirements")))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/derivation_connections.md") (qualified-name "DerivationConnections::Derivation::originalNotDerived"))) (kind expressionOperand) (ordinal 0))
      (authored-target "derivedRequirements")
      (outcome (status resolved) (target (node (document "memory://snapshot/derivation_connections.md") (path (named (kind library-package) (name "DerivationConnections")) (named (kind connection-def) (name "Derivation")) (anonymous (kind ref) (ordinal 0)))))))
  ...
  (relationships
    ...
    (relationship (kind expressionOperand) (source (node (document "memory://snapshot/derivation_connections.md") (qualified-name "DerivationConnections::Derivation::originalNotDerived"))) (target (node (document "memory://snapshot/derivation_connections.md") (path (named (kind library-package) (name "DerivationConnections")) (named (kind connection-def) (name "Derivation")) (anonymous (kind ref) (ordinal 0))))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/derivation_connections.md") (qualified-name "DerivationConnections::Derivation::originalNotDerived"))) (kind expressionOperand) (ordinal 0)))
...
~~~sexpr
(expressions
  (declaration (id (node (document "memory://snapshot/derivation_connections.md") (qualified-name "DerivationConnections::Derivation::originalImpliesDerived"))) (outcome unsupported))
  ...
  (contextual (context (node (document "memory://snapshot/derivation_connections.md") (qualified-name "DerivationConnections::derivations"))) (element (node (document "memory://snapshot/derivation_connections.md") (qualified-name "DerivationConnections::Derivation::originalImpliesDerived"))) (effective-element (node (document "memory://snapshot/derivation_connections.md") (qualified-name "DerivationConnections::Derivation::originalImpliesDerived"))) (authored-element (node (document "memory://snapshot/derivation_connections.md") (qualified-name "DerivationConnections::Derivation::originalImpliesDerived"))) (outcome unsupported))
