...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/parameters_of_interest_metadata.md") (qualified-name "ParametersOfInterestMetadata::measuresOfEffectiveness"))) (kind attribute-def) (membership (kind owning) (visibility default)) (facts (modifiers nonunique) (multiplicity (lower unbounded) (upper unbounded))) (documentation (doc (text " Base feature for attributes that are measures of effectiveness. "))))
    (declaration (id (node (document "memory://snapshot/parameters_of_interest_metadata.md") (qualified-name "ParametersOfInterestMetadata::measuresOfPerformance"))) (kind attribute-def) (membership (kind owning) (visibility default)) (facts (modifiers nonunique) (multiplicity (lower unbounded) (upper unbounded))) (documentation (doc (text " Base feature for attributes that are measures of performance. "))))
  )
  (references
