...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/connections.md") (qualified-name "Connections::BinaryConnection::source"))) (kind connection) (membership (kind feature) (visibility default)) (facts (positional-end 0)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Anything")) (redefinition (reference "BinaryLinkObject::source")))))
    (declaration (id (node (document "memory://snapshot/connections.md") (qualified-name "Connections::BinaryConnection::target"))) (kind connection) (membership (kind feature) (visibility default)) (facts (positional-end 1)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Anything")) (redefinition (reference "BinaryLinkObject::target")))))
  ...
  (references
    ...
    (reference (id (source (node (document "memory://snapshot/connections.md") (qualified-name "Connections::BinaryConnection::source"))) (kind featureTyping) (ordinal 0))
      ...
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/connections.md") (qualified-name "Connections::BinaryConnection::source"))) (kind redefinition) (ordinal 0))
      (authored-target "BinaryLinkObject::source")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/connections.md") (qualified-name "Connections::BinaryConnection::target"))) (kind featureTyping) (ordinal 0))
      (authored-target "Anything")
      (outcome (status unresolved)))
    (reference (id (source (node (document "memory://snapshot/connections.md") (qualified-name "Connections::BinaryConnection::target"))) (kind redefinition) (ordinal 0))
      (authored-target "BinaryLinkObject::target")
      (outcome (status unresolved)))
...
(navigation
  ...
  (query (document "memory://snapshot/connections.md") (range (start 42 33) (end 42 57)) (probe (position 42 33))
    (reference (id (source (node (document "memory://snapshot/connections.md") (qualified-name "Connections::BinaryConnection::source"))) (kind redefinition) (ordinal 0) (authored-target "BinaryLinkObject::source")
      (outcome (status unresolved)))
    )
  )
  ...
  (query (document "memory://snapshot/connections.md") (range (start 43 33) (end 43 57)) (probe (position 43 33))
    (reference (id (source (node (document "memory://snapshot/connections.md") (qualified-name "Connections::BinaryConnection::target"))) (kind redefinition) (ordinal 0) (authored-target "BinaryLinkObject::target")
      (outcome (status unresolved)))
    )
  )
