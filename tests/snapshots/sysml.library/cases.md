...
(semantic-model
  ...
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/cases.md") (qualified-name "Cases::Case::self"))) (kind case) (membership (kind feature) (visibility default)) (facts (modifiers reference)) (authored (membership (kind feature) (visibility default)) (relationships (featureTyping (reference "Case")) (redefinition (reference "Calculation::self")))))
