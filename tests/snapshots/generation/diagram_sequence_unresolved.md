...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness unsupported-syntax) (has-evaluation true) (source-digest "blake3:eaed36cecf940a559efe2d04a551b1fb5ca6dface7d64a8d171729a1f39f9c4f") (contract-version "lossless-publication-completeness-v3") (admitted (standard-library 94)))
  (declarations
  ...
  (relationships
    ...
    (relationship (kind specialization) (source (node (document "memory://snapshot/diagram_sequence_unresolved.md") (qualified-name "SequenceNegative::selected"))) (target (node (document "memory://snapshot/sysml.library/views.md") (qualified-name "Views::views"))) (provenance implied))
    ...
    (relationship (kind specialization) (source (node (document "memory://snapshot/diagram_sequence_unresolved.md") (qualified-name "SequenceNegative::unrelated"))) (target (node (document "memory://snapshot/sysml.library/parts.md") (qualified-name "Parts::parts"))) (provenance implied))
  )
  (evaluation
  )
)
...
{
  "schemaVersion": 5,
  "modelDigest": "blake3:0250a6f80b60ae93d50d30a79670508bedf486ae5ea5743cd106fa8e4e141e09",
  "documents": [
    {
