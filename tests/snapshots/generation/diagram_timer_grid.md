# META
~~~ini
description=Grid View over the realistic timer repository example
type=generate
libraries=standard
...
viewKind=grid-view
viewDocument=diagram_timer_grid.md
viewQualifiedName=TimerGrid::selected
~~~
# SOURCE
~~~sysml
package TimerGrid {
    ...
    import KitchenTimer::*;
    view selected : GridView { expose KitchenTimer::timerInstance; }
}
~~~
# DIAGNOSTICS
~~~sexpr
(fixture-diagnostics
  (document "memory://snapshot/diagram_timer_grid.md"
    (diagnostics
    )
  )
...
~~~sexpr
(semantic-model
  (publication (phase resolved) (completeness unsupported-syntax) (has-evaluation true) (source-digest "blake3:6712ca894708512d790d5f15e84d6414ba497b94147da3d14a73d727cf11db8d") (contract-version "lossless-publication-completeness-v3") (admitted (standard-library 94)))
  (declarations
    ...
    (declaration (id (node (document "memory://snapshot/diagram_timer_grid.md") (path (named (kind package) (name "TimerGrid")) (anonymous (kind import) (ordinal 1))))) (kind import) (membership (kind import) (visibility default)) (authored (membership (kind import) (visibility default)) (relationships (namespaceImport (reference "KitchenTimer") (import (shape namespace) (recursive false))))))
  ...
  (references
    (reference (id (source (node (document "memory://snapshot/diagram_timer_grid.md") (path (named (kind package) (name "TimerGrid")) (anonymous (kind import) (ordinal 0))))) (kind namespaceImport) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/diagram_timer_grid.md") (path (named (kind package) (name "TimerGrid")) (anonymous (kind import) (ordinal 1))))) (kind namespaceImport) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/diagram_timer_grid.md") (qualified-name "TimerGrid::selected"))) (kind featureTyping) (ordinal 0))
    ...
    (reference (id (source (node (document "memory://snapshot/diagram_timer_grid.md") (path (named (kind package) (name "TimerGrid")) (named (kind view) (name "selected")) (anonymous (kind expose) (ordinal 0))))) (kind viewExpose) (ordinal 0))
  ...
  (relationships
    (relationship (kind typing) (source (node (document "memory://snapshot/diagram_timer_grid.md") (qualified-name "TimerGrid::selected"))) (target (node (document "memory://snapshot/sysml.library/standard_view_definitions.md") (qualified-name "StandardViewDefinitions::GridView"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/diagram_timer_grid.md") (qualified-name "TimerGrid::selected"))) (kind featureTyping) (ordinal 0)))
    (relationship (kind viewExpose) (source (node (document "memory://snapshot/diagram_timer_grid.md") (path (named (kind package) (name "TimerGrid")) (named (kind view) (name "selected")) (anonymous (kind expose) (ordinal 0))))) (target (node (document "memory://snapshot/examples/timer/KitchenTimer.sysml") (qualified-name "KitchenTimer::timerInstance"))) (provenance authored) (authored-reference (source (node (document "memory://snapshot/diagram_timer_grid.md") (path (named (kind package) (name "TimerGrid")) (named (kind view) (name "selected")) (anonymous (kind expose) (ordinal 0))))) (kind viewExpose) (ordinal 0)))
    ...
    (relationship (kind specialization) (source (node (document "memory://snapshot/diagram_timer_grid.md") (qualified-name "TimerGrid::selected"))) (target (node (document "memory://snapshot/sysml.library/views.md") (qualified-name "Views::views"))) (provenance implied))
    (relationship (kind typeFeaturing) (source (node (document "memory://snapshot/diagram_timer_grid.md") (path (named (kind package) (name "TimerGrid")) (named (kind view) (name "selected")) (anonymous (kind expose) (ordinal 0))))) (target (node (document "memory://snapshot/diagram_timer_grid.md") (qualified-name "TimerGrid::selected"))) (provenance implied))
  )
  (evaluation
...
~~~sexpr
(types
    (declaration (id (node (document "memory://snapshot/diagram_timer_grid.md") (qualified-name "TimerGrid::selected")))
    ...
    (declaration (id (node (document "memory://snapshot/diagram_timer_grid.md") (path (named (kind package) (name "TimerGrid")) (named (kind view) (name "selected")) (anonymous (kind expose) (ordinal 0)))))
      (featured-by (node (document "memory://snapshot/diagram_timer_grid.md") (qualified-name "TimerGrid::selected")))
    )
...
~~~sexpr
(navigation
  (query (document "memory://snapshot/diagram_timer_grid.md") (range (start 1 19) (end 1 45)) (probe (position 1 19))
    (reference (id (source (node (document "memory://snapshot/diagram_timer_grid.md") (path (named (kind package) (name "TimerGrid")) (anonymous (kind import) (ordinal 0))))) (kind namespaceImport) (ordinal 0) (authored-target "StandardViewDefinitions")
      (outcome (status resolved) (target (node (document "memory://snapshot/sysml.library/standard_view_definitions.md") (qualified-name "StandardViewDefinitions")))))
    )
  )
  (query (document "memory://snapshot/diagram_timer_grid.md") (range (start 2 11) (end 2 26)) (probe (position 2 11))
    (reference (id (source (node (document "memory://snapshot/diagram_timer_grid.md") (path (named (kind package) (name "TimerGrid")) (anonymous (kind import) (ordinal 1))))) (kind namespaceImport) (ordinal 0) (authored-target "KitchenTimer")
      (outcome (status resolved) (target (node (document "memory://snapshot/examples/timer/KitchenTimer.sysml") (qualified-name "KitchenTimer")))))
    )
  )
  (query (document "memory://snapshot/diagram_timer_grid.md") (range (start 3 20) (end 3 28)) (probe (position 3 20))
    (reference (id (source (node (document "memory://snapshot/diagram_timer_grid.md") (qualified-name "TimerGrid::selected"))) (kind featureTyping) (ordinal 0) (authored-target "GridView")
      (outcome (status resolved) (target (node (document "memory://snapshot/sysml.library/standard_view_definitions.md") (qualified-name "StandardViewDefinitions::GridView")))))
    )
  )
  (query (document "memory://snapshot/diagram_timer_grid.md") (range (start 3 38) (end 3 65)) (probe (position 3 38))
    (reference (id (source (node (document "memory://snapshot/diagram_timer_grid.md") (path (named (kind package) (name "TimerGrid")) (named (kind view) (name "selected")) (anonymous (kind expose) (ordinal 0))))) (kind viewExpose) (ordinal 0) (authored-target "KitchenTimer::timerInstance")
      (outcome (status resolved) (target (node (document "memory://snapshot/examples/timer/KitchenTimer.sysml") (qualified-name "KitchenTimer::timerInstance")))))
    )
  )
...
{
  "schemaVersion": 5,
  "modelDigest": "blake3:baf4b944979766528836f7747372626dbc54a4125463b29464f737209d26d64a",
  "documents": [
    {
  ...
  "references": [
    {
      "document": 0,
      "kind": "qualified-name",
      "qualifiedName": "TimerGrid::selected"
    },
    {
      "document": 1,
      "kind": "qualified-name",
