...
The workspace pins `sysml-v2-parser` in the root `Cargo.toml` as a git dependency on `https://github.com/elan8/sysml-v2-parser` with an explicit tag (currently `v0.15.0`). When updating parser behavior:
