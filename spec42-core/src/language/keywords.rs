...
pub const RESERVED_KEYWORDS: &[&str] = &[
    ...
    "perform", "port", "private", "protected", "provides", "public", "redefines", "ref",
...
pub fn sysml_keywords() -> &'static [&'static str] {
    &[
        ...
        "allocate", "abstract", "def", "variant", "references", "private", "public", "entry",
        "exit", "state", "do", "then", "transition", "constraint", "exhibit",
    ]
}
...
pub fn keyword_hover_markdown(keyword: &str) -> Option<String> {
    let (desc, syntax): (&str, Option<&str>) = match keyword {
        ...
        "value" | "item" | "references" | "private" | "public" => (keyword_doc(keyword)?, None),
