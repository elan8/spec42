...
- **Bumped the pinned `sysml-v2-parser` revision `49bdf3f` -> `f52100f`.** The 24-commit "corpus
  coverage wave 1" bump closes seven entries in `planning/UPSTREAM_PARSER_GAPS.md` (62, 68, 72, 76,
  77, 78, 79) and narrows five more (61, 66, 69, 73, 74). Visible behavior changes: a metadata body
