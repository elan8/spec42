...
library provenance and reaches semantic validation. The remaining report contains 9 diagnostics:
4 `ambiguous_reference`, 3 `unresolved_reference`, and one each of
