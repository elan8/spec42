...
describe("Extension Test Suite", () => {
  ...
  it("Model Explorer reveals the selected source element", async function () {
    ...
    await vscode.commands.executeCommand("sysml.debug.syncModelExplorerSelection");
    ...
    const presentation = buildElementPresentation(
      {
        ...
        relationships: [{ type: "typing", source: "Drone::body", target: "Drone::Airframe", name: null }],
        errors: null,
      },
      uri,
      undefined,
    ...
    const presentation = buildElementPresentation(
      {
        ...
        children: [],
        attributes: {},
        relationships: [{ type: "specializes", source: "Drone::Advanced", target: "Drone::Base", name: null }],
        errors: null,
      },
      uri,
      parentItem,
