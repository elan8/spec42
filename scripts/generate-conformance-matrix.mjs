...
lines.push("Generated from `docs/reference/conformance-metadata.json`. Do not edit this file by hand; run `node scripts/generate-conformance-matrix.mjs`.", "");
...
if (check) {
  ...
  if (current !== next) {
    throw new Error("docs/reference/CONFORMANCE-MATRIX.md is out of date. Run `node scripts/generate-conformance-matrix.mjs`.");
  }
} else {
